...
export declare const ts: {
    ...
    isPartOfTypeOnlyImportOrExportDeclaration(node: import("typescript").Node): boolean;
    ...
    isJsxCallLike(node: import("typescript").Node): node is import("typescript").JsxCallLike;
    ...
    isInternalDeclaration(node: import("typescript").Node, sourceFile?: SourceFile): boolean;
    ...
    parseBuildCommand(commandLine: readonly string[]): import("typescript").ParsedBuildCommand;
    ...
    isBuildCommand(commandLineArgs: readonly string[]): boolean;
