...
function createTerminalProfileMarkdownDescription(
...
export function registerTerminalDefaultProfileConfiguration(
	detectedProfiles?: { os: OperatingSystem; profiles: ITerminalProfile[] },
	...
	defaultProfilesConfiguration = {
		...
		properties: {
			[TerminalSettingId.DefaultProfileLinux]: {
				...
				default: null,
				enum:
					detectedProfiles?.os === OperatingSystem.Linux
						? profileEnum?.values
						: undefined,
			...
			[TerminalSettingId.DefaultProfileMacOs]: {
				...
				default: null,
				enum:
					detectedProfiles?.os === OperatingSystem.Macintosh
						? profileEnum?.values
						: undefined,
				markdownEnumDescriptions:
					detectedProfiles?.os === OperatingSystem.Macintosh
			...
			[TerminalSettingId.DefaultProfileWindows]: {
				...
				default: null,
				enum:
					detectedProfiles?.os === OperatingSystem.Windows
						? profileEnum?.values
						: undefined,
				markdownEnumDescriptions:
					detectedProfiles?.os === OperatingSystem.Windows
