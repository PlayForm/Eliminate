...
export const inlineEditIndicatorForeground = registerColor(
...
export const inlineEditIndicatorBorder = registerColor(
...
export class InlineEditsIndicator extends Disposable {
	private readonly _indicator = h(
		"div.inline-edits-view-indicator",
		{
			style: {
				position: "absolute",
				overflow: "visible",
		...
		[
			h("div.icon", {}, [renderIcon(Codicon.arrowLeft)]),
			h("div.label", {}, [" inline edit"]),
		],
	);

	constructor(
		private readonly _editorObs: ObservableCodeEditor,
		private readonly _state: IObservable<
			IInlineEditsIndicatorState | undefined
		>,
		...
		this._register(
			addDisposableListener(this._indicator.root, "click", () => {
