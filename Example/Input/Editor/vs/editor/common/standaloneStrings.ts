...
export namespace AccessibilityHelpNLS {
	...
	export const codeFolding = nls.localize(
		"codeFolding",
	...
	export const intellisense = nls.localize(
		"intellisense",
	...
	export const addToWatch = nls.localize(
	...
	export const debugExecuteSelection = nls.localize(
