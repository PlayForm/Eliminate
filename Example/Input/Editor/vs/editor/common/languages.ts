...
{
	private _tokenizationSupport: Promise<
		(TSupport & IDisposable) | null
	> | null = null;
 ...
 * @internal
 */
export const TreeSitterTokenizationRegistry: ITokenizationRegistry<ITreeSitterTokenizationSupport> =
	new TokenizationRegistryImpl();
