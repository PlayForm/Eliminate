 ...
 * @deprecated
 */
type CompatLanguageModelToolInvocationOptions<T = any> =
	vscode.LanguageModelToolInvocationOptions<T> & { parameters?: any };

/**
 * @deprecated
 */
type CompactLanguageModelToolInvocationPrepareOptions<T> =
	vscode.LanguageModelToolInvocationPrepareOptions<T> & { parameters: any };
	...
	implements ExtHostLanguageModelToolsShape
{
	...
	async invokeTool(
		toolId: string,
		options: CompatLanguageModelToolInvocationOptions<any>,
		token?: CancellationToken,
	...
	async $invokeTool(
		...
		const options: CompatLanguageModelToolInvocationOptions<Object> = {
			...
			toolInvocationToken: dto.context as
		...
		return {
			confirmationMessages: result.confirmationMessages
				? {
						...
						message:
							typeof result.confirmationMessages.message ===
							"string"
