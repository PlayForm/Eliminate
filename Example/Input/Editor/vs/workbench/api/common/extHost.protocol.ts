...
export interface MainThreadChatAgentsShape2 extends IDisposable {
	...
	$handleAnchorResolve(
		requestId: string,
		handle: string,
		anchor: Dto<IChatContentInlineReference>,
	): void;
...
export interface ExtHostChatAgentsShape2 {
	...
	$provideWelcomeMessage(
		handle: number,
		token: CancellationToken,
	): Promise<IChatWelcomeMessageContent | undefined>;
	$provideChatTitle(
		handle: number,
...
export const MainContext = {
	...
	MainThreadCodeMapper: createProxyIdentifier<MainThreadCodeMapperShape>(
...
export const ExtHostContext = {
	ExtHostCodeMapper:
		createProxyIdentifier<ExtHostCodeMapperShape>("ExtHostCodeMapper"),
	ExtHostCommands:
