...
interface IImportedXtermAddonMap
	...
	> {
	get<K extends keyof IXtermAddonNameToCtor>(
		name: K,
	): IXtermAddonNameToCtor[K] | undefined;
	set<K extends keyof IXtermAddonNameToCtor>(
		name: K,
		value: IXtermAddonNameToCtor[K],
	): this;
}
...
export class XtermAddonImporter {
	async importAddon<T extends keyof IXtermAddonNameToCtor>(
		name: T,
