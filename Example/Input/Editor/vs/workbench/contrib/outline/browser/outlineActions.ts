...
registerAction2(
	class CollapseAll extends ViewAction<IOutlinePane> {
		constructor() {
			super({
...
registerAction2(
	class ExpandAll extends ViewAction<IOutlinePane> {
		constructor() {
			super({
				viewId: IOutlinePane.Id,
				id: "outline.expand",
...
registerAction2(
	class FollowCursor extends ViewAction<IOutlinePane> {
		constructor() {
			super({
				viewId: IOutlinePane.Id,
...
registerAction2(
	class FilterOnType extends ViewAction<IOutlinePane> {
		constructor() {
			super({
				viewId: IOutlinePane.Id,
...
registerAction2(
	class SortByPosition extends ViewAction<IOutlinePane> {
		constructor() {
			super({
				viewId: IOutlinePane.Id,
...
registerAction2(
	class SortByName extends ViewAction<IOutlinePane> {
		constructor() {
			super({
				viewId: IOutlinePane.Id,
...
registerAction2(
	class SortByKind extends ViewAction<IOutlinePane> {
		constructor() {
			super({
				viewId: IOutlinePane.Id,
