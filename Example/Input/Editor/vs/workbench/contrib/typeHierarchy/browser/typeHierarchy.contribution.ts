...
const _ctxHasTypeHierarchyProvider = new RawContextKey<boolean>(
...
const _ctxTypeHierarchyVisible = new RawContextKey<boolean>(
...
const _ctxTypeHierarchyDirection = new RawContextKey<string>(
	"typeHierarchyDirection",
	undefined,
	{
		type: "string",
...
function sanitizedDirection(candidate: string): TypeHierarchyDirection {
	return candidate === TypeHierarchyDirection.Subtypes ||
		candidate === TypeHierarchyDirection.Supertypes
		? candidate
...
class TypeHierarchyController implements IEditorContribution {
	...
	private _showTypeHierarchyWidget(
		...
		model: Promise<TypeHierarchyModel | undefined>,
