...
gettingStartedContentRegistry.registerProvider(
	"vs/workbench/contrib/welcomeGettingStarted/common/media/empty",
	() => "",
);
...
export type BuiltinGettingStartedStartEntry = {
	...
	icon: ThemeIcon;
	when?: string;
	content: { type: "startEntry"; command: string };
};
			...
			steps: [
				...
				},
				{
					...
					media: {
						type: "svg",
						altText:
							"Comparing menu dropdown with the visible menu bar.",
						path: "menuBar.svg",
					},
				},
				{
			...
			steps: [
				...
				},
				{
					...
					media: {
						type: "svg",
						altText:
							"Integrated terminal running a few npm commands",
						path: "terminal.svg",
					},
				},
				{
