...
export const JavaLibrariesToLookFor: {
	...
	{
		"predicate": (groupId, artifactId) =>
			groupId === "com.azure" && artifactId === "azure-ai-formrecognizer",
	...
	{
		"predicate": (groupId, artifactId) =>
			groupId === "com.azure" && artifactId === "azure-ai-personalizer",
	...
	{
		"predicate": (groupId, artifactId) =>
			groupId === "com.azure" && artifactId === "azure-ai-contentsafety",
	...
	{
		"predicate": (groupId, artifactId) =>
			groupId === "com.azure" && artifactId === "azure-ai-textanalytics",
		"tag": "azure-ai-textanalytics",
	},
	{
		"predicate": (groupId, artifactId) =>
			groupId === "com.azure" && artifactId === "azure-search-documents",
	...
	{
		"predicate": (groupId, artifactId) =>
			groupId === "com.azure" && artifactId === "azure-ai-vision-face",
