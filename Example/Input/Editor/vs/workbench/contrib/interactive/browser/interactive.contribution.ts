...
} from "../../notebook/common/notebookContextKeys.js";
import { INotebookKernelService } from "../../notebook/common/notebookKernelService.js";
import { INotebookService } from "../../notebook/common/notebookService.js";
import {
	isReplEditorControl,
	ReplEditorControl,
} from "../../replNotebook/browser/replEditor.js";
import {
		...
		async run(
			...
			if (resource && extname(resource) === ".interactive") {
				...
				if (editors.length) {
					...
					const editorControl =
						editor?.getControl() as ReplEditorControl;
		...
		async run(
			...
			if (
				...
				if (
					...
					const ctrl = InlineChatController.get(
						editorControl.activeCodeEditor,
					);
					if (ctrl) {
						ctrl.acceptHunk();
