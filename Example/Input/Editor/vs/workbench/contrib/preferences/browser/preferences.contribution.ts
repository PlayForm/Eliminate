...
const SETTINGS_EDITOR_COMMAND_FOCUS_SETTINGS_FROM_SEARCH =
	"settings.action.focusSettingsFromSearch";
const SETTINGS_EDITOR_COMMAND_FOCUS_SETTINGS_LIST =
	"settings.action.focusSettingsList";
const SETTINGS_EDITOR_COMMAND_FOCUS_TOC = "settings.action.focusTOC";
const SETTINGS_EDITOR_COMMAND_FOCUS_CONTROL =
						...
						super({
							...
							menu: {
								...
								when: ContextKeyExpr.notEquals(
									...
									that.userDataProfilesService.defaultProfile
										.id,
								),
							},
						});
...
class SettingsEditorTitleContribution
	extends Disposable
	implements IWorkbenchContribution
{
	constructor(
