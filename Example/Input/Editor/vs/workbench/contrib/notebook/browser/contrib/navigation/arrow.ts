	...
	class FocusNextCellAction extends NotebookCellAction {
		...
		async runWithContext(
			...
			if (
				...
				const newFocusMode =
					newCell.cellKind === CellKind.Markup &&
		...
		constructor() {
			super({
				...
				keybinding: {
					...
					mac: {
						primary:
							KeyMod.WinCtrl | KeyMod.CtrlCmd | KeyCode.UpArrow,
					},
					weight: KeybindingWeight.WorkbenchContrib,
				},
				precondition: ContextKeyExpr.and(
