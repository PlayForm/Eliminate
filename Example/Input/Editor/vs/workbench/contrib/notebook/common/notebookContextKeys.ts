...
export const IS_COMPOSITE_NOTEBOOK = new RawContextKey<boolean>(
	"isCompositeNotebook",
	false,
);
...
export const KERNEL_HAS_VARIABLE_PROVIDER = new RawContextKey<boolean>(
	"kernelHasVariableProvider",
	false,
);
