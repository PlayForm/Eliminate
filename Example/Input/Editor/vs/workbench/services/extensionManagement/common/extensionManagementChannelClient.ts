	...
	implements IProfileAwareExtensionManagementService
{
	...
	protected override async onInstallExtensionEvent(
	...
	protected override async onDidInstallExtensionsEvent(
	...
	protected override async onUninstallExtensionEvent(
	...
	protected override async onDidUninstallExtensionEvent(
	...
	protected override async onDidUpdateExtensionMetadataEvent(
