...
export class DataTree<TInput, T, TFilterData = void> extends AbstractTree<T | null, TFilterData, T | null> {
    ...
    constructor(private user: string, container: HTMLElement, delegate: IListVirtualDelegate<T>, renderers: ITreeRenderer<T, TFilterData, any>[], private dataSource: IDataSource<TInput, T>, options: IDataTreeOptions<T, TFilterData> = {}) {
    ...
    private iterate(element: TInput | T, isCollapsed?: (el: T) => boolean | undefined): {
