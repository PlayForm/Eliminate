...
class BranchNode implements ISplitView<ILayoutContext>, IDisposable {
    ...
    constructor(readonly orientation: Orientation, readonly layoutController: LayoutController, styles: IGridViewStyles, readonly splitviewProportionalLayout: boolean, size: number = 0, orthogonalSize: number = 0, edgeSnapping: boolean = false, childDescriptors?: INodeDescriptor[]) {
        this._styles = styles;
        this._size = size;
...
class LeafNode implements ISplitView<ILayoutContext>, IDisposable {
    ...
    constructor(readonly view: IView, readonly orientation: Orientation, readonly layoutController: LayoutController, orthogonalSize: number, size: number = 0) {
        this._orthogonalSize = orthogonalSize;
        this._size = size;
...
export class GridView implements IDisposable {
    ...
    private getNode(location: GridLocation, node: Node = this.root, path: BranchNode[] = []): [
        BranchNode[],
        Node
    ] {
