...
export abstract class AbstractScrollbar extends Widget {
    ...
    protected _createSlider(top: number, left: number, width: number | undefined, height: number | undefined): void {
        ...
        this._register(dom.addDisposableListener(this.slider.domNode, dom.EventType.POINTER_DOWN, (e: PointerEvent) => {
            if (e.button === 0) {
                e.preventDefault();
    ...
    private _sliderPointerDown(e: PointerEvent): void {
        ...
        this._pointerMoveMonitor.startMonitoring(e.target, e.pointerId, e.buttons, (pointerMoveData: PointerEvent) => {
