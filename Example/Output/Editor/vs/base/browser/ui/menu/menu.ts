...
class SubmenuMenuActionViewItem extends BaseMenuActionViewItem {
    ...
    constructor(action: IAction, private submenuActions: ReadonlyArray<IAction>, private parentData: ISubMenuData, private submenuOptions: IMenuOptions, menuStyles: IMenuStyles) {
    ...
    private calculateSubmenuMenuLayout(windowDimensions: Dimension, submenu: Dimension, entry: IDomNodePagePosition, expandDirection: IMenuDirection): {
        top: number;
        left: number;
    } {
