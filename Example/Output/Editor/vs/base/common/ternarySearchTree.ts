...
export class TernarySearchTree<K, V> {
    ...
    findSuperstr(key: K): IterableIterator<[
        K,
        V
    ]> | undefined {
        return this._findSuperstrOrElement(key, false);
    }
    private _findSuperstrOrElement(key: K, allowValue: true): IterableIterator<[
        K,
        V
    ]> | V | undefined;
    private _findSuperstrOrElement(key: K, allowValue: false): IterableIterator<[
        K,
        V
    ]> | undefined;
    private _findSuperstrOrElement(key: K, allowValue: boolean): IterableIterator<[
        K,
        V
    ]> | V | undefined {
        const iter = this._iter.reset(key);
    ...
    *[Symbol.iterator](): IterableIterator<[
    ...
    private _entries(node: TernarySearchTreeNode<K, V> | undefined): IterableIterator<[
        K,
        V
    ]> {
        const result: [
