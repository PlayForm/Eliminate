...
class Node<T, C> implements IResourceNode<T, C> {
    ...
    constructor(readonly uri: URI, readonly relativePath: string, readonly context: C, public element: T | undefined = undefined, readonly parent: IResourceNode<T, C> | undefined = undefined) { }
