...
export function derived<T>(computeFnOrOwner: ((reader: IReader) => T) | DebugOwner, computeFn?: ((reader: IReader) => T) | undefined): IObservable<T> {
    ...
    return new Derived(new DebugNameData(undefined, undefined, computeFnOrOwner as any), computeFnOrOwner as any, undefined, undefined, undefined, strictEquals);
}
...
export function derivedOpts<T>(options: IDebugNameData & {
 ...
 * @see derived
 */
export function derivedHandleChanges<T, TChangeSummary>(options: IDebugNameData & {
