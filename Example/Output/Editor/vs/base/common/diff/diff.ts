...
export class LcsDiff {
    ...
    private static _getElements(sequence: ISequence): [
        string[],
        Int32Array,
        boolean
    ] {
    ...
    private _findBetterContiguousSequence(originalStart: number, originalLength: number, modifiedStart: number, modifiedLength: number, desiredLength: number): [
        number,
        number
    ] | null {
