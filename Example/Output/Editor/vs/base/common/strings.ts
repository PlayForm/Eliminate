...
export class AmbiguousCharacters {
    private static readonly ambiguousCharacterData = new Lazy<Record<string | '_common' | '_default', 
    ...
    private static _locales = new Lazy<string[]>(() => Object.keys(AmbiguousCharacters.ambiguousCharacterData.value).filter((k) => !k.startsWith('_')));
