...
class WebSocketFlowManager extends Disposable {
    ...
    constructor(private readonly _tracer: ISocketTracer, permessageDeflate: boolean, inflateBytes: VSBuffer | null, recordInflateBytes: boolean, private readonly _onData: Emitter<VSBuffer>, private readonly _writeFn: (data: VSBuffer, options: FrameOptions) => void) {
        super();
...
class ZlibInflateStream extends Disposable {
    ...
    constructor(private readonly _tracer: ISocketTracer, private readonly _recordInflateBytes: boolean, inflateBytes: VSBuffer | null, options: ZlibOptions) {
        super();
