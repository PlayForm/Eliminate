...
import { Extensions, IExtensionFeaturesRegistry, IExtensionFeatureTableRenderer, IRenderedData, IRowData, ITableData, } from "../../extensionManagement/common/extensionFeatures.js";
        ...
        configurationExtPoint.setHandler((extensions, delta) => {
            for (const extension of delta.added) {
                ...
                for (const colorContribution of extensionValue) {
                    if (typeof colorContribution.id !== "string" ||
...
class ColorDataRenderer extends Disposable implements IExtensionFeatureTableRenderer {
    ...
    render(manifest: IExtensionManifest): IRenderedData<ITableData> {
        ...
        const toColor = (colorReference: string): Color | undefined => colorReference[0] === "#"
