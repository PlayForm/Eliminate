...
import { ExtensionMessageCollector, ExtensionsRegistry, IExtensionPoint, } from "../../extensions/common/extensionsRegistry.js";
import { ExtensionData, IThemeExtensionPoint, VS_DARK_THEME, VS_HC_LIGHT_THEME, VS_HC_THEME, VS_LIGHT_THEME, } from "./workbenchThemeService.js";
...
export class ThemeRegistry<T extends IThemeData> implements IDisposable {
    ...
    public findThemeByExtensionLocation(extLocation: URI | undefined): T[] {
        if (extLocation) {
            return this.getThemes().filter((t) => t.location &&
