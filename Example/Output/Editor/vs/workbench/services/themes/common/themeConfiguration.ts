...
import { Extensions as ConfigurationExtensions, ConfigurationScope, IConfigurationNode, IConfigurationPropertySchema, IConfigurationRegistry, } from "../../../../platform/configuration/common/configurationRegistry.js";
...
import { IColorCustomizations, ISemanticTokenColorCustomizations, ITokenColorCustomizations, IWorkbenchColorTheme, IWorkbenchFileIconTheme, IWorkbenchProductIconTheme, ThemeSettingDefaults, ThemeSettings, ThemeSettingTarget, } from "./workbenchThemeService.js";
...
const colorThemeSettingSchema: IConfigurationPropertySchema = {
    ...
    }, "Specifies the color theme used in the workbench when {0} is not enabled.", formatSettingAsLink(ThemeSettings.DETECT_COLOR_SCHEME)),
    default: isWeb
...
const preferredDarkThemeSettingSchema: IConfigurationPropertySchema = {
    ...
    markdownDescription: nls.localize({
        ...
        comment: ["{0} will become a link to another setting."],
    }, "Specifies the color theme when system color mode is dark and {0} is enabled.", formatSettingAsLink(ThemeSettings.DETECT_COLOR_SCHEME)),
...
const preferredLightThemeSettingSchema: IConfigurationPropertySchema = {
    ...
    markdownDescription: nls.localize({
        ...
        comment: ["{0} will become a link to another setting."],
    }, "Specifies the color theme when system color mode is light and {0} is enabled.", formatSettingAsLink(ThemeSettings.DETECT_COLOR_SCHEME)),
...
const preferredHCDarkThemeSettingSchema: IConfigurationPropertySchema = {
    ...
    markdownDescription: nls.localize({
        ...
        comment: ["{0} will become a link to another setting."],
    }, "Specifies the color theme when in high contrast dark mode and {0} is enabled.", formatSettingAsLink(ThemeSettings.DETECT_HC)),
...
const preferredHCLightThemeSettingSchema: IConfigurationPropertySchema = {
    ...
    markdownDescription: nls.localize({
        ...
        comment: ["{0} will become a link to another setting."],
    }, "Specifies the color theme when in high contrast light mode and {0} is enabled.", formatSettingAsLink(ThemeSettings.DETECT_HC)),
...
const detectColorSchemeSettingSchema: IConfigurationPropertySchema = {
    ...
    }, "If enabled, will automatically select a color theme based on the system color mode. If the system color mode is dark, {0} is used, else {1}.", formatSettingAsLink(ThemeSettings.PREFERRED_DARK_THEME), formatSettingAsLink(ThemeSettings.PREFERRED_LIGHT_THEME)),
    default: false,
    tags: [COLOR_THEME_CONFIGURATION_SETTINGS_TAG],
};
