...
import { ColorIdentifier, Extensions as ColorRegistryExtensions, DEFAULT_COLOR_CONFIG_VALUE, editorBackground, editorForeground, IColorRegistry, } from "../../../../platform/theme/common/colorRegistry.js";
import { ColorScheme } from "../../../../platform/theme/common/theme.js";
import { getThemeTypeSelector, ITokenStyle, } from "../../../../platform/theme/common/themeService.js";
import { getTokenClassificationRegistry, parseClassifierString, ProbeScope, SemanticTokenRule, TokenStyle, TokenStyleData, TokenStyleValue, } from "../../../../platform/theme/common/tokenClassificationRegistry.js";
import { parse as parsePList } from "./plistParser.js";
import { createMatchers, Matcher, MatcherWithPriority, } from "./textMateScopeMatcher.js";
import { convertSettings } from "./themeCompatibility.js";
import { ThemeConfiguration } from "./themeConfiguration.js";
import { ExtensionData, IColorCustomizations, IColorMap, ISemanticTokenColorCustomizations, ISemanticTokenColorizationSetting, ISemanticTokenRules, ITextMateThemingRule, IThemeExtensionPoint, IThemeScopableCustomizations, IThemeScopedCustomizations, ITokenColorCustomizations, IWorkbenchColorTheme, THEME_SCOPE_CLOSE_PAREN, THEME_SCOPE_OPEN_PAREN, THEME_SCOPE_WILDCARD, themeScopeRegex, VS_HC_LIGHT_THEME, VS_HC_THEME, VS_LIGHT_THEME, } from "./workbenchThemeService.js";
...
async function _loadColorTheme(extensionResourceLoaderService: IExtensionResourceLoaderService, themeLocation: URI, result: {
    ...
    if (resources.extname(themeLocation) === ".json") {
        ...
        if (errors.length > 0) {
            return Promise.reject(new Error(nls.localize("error.cannotparsejson", "Problems parsing JSON theme file: {0}", errors
...
function _loadSyntaxTokens(extensionResourceLoaderService: IExtensionResourceLoaderService, themeLocation: URI, result: {
    textMateRules: ITextMateThemingRule[];
    colors: IColorMap;
}): Promise<any> {
...
export function findMetadata(colorThemeData: ColorThemeData, captureNames: string[], languageId: number): number {
    ...
    switch (definitions.foreground?.settings.fontStyle) {
        ...
        case "strikethrough":
            metadata |=
                FontStyle.Strikethrough | MetadataConsts.STRIKETHROUGH_MASK;
            break;
    }
