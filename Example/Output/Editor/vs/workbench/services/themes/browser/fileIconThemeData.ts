...
export class FileIconThemeLoader {
    constructor(private readonly fileService: IExtensionResourceLoaderService, private readonly languageService: ILanguageService) { }
    ...
    private loadIconThemeDocument(location: URI): Promise<IconThemeDocument> {
        return this.fileService
            ...
            if (errors.length > 0) {
                return Promise.reject(new Error(nls.localize("error.cannotparseicontheme", "Problems parsing file icons file: {0}", errors
    ...
    private processIconThemeDocument(id: string, iconThemeDocumentLocation: URI, iconThemeDocument: IconThemeDocument): {
        content: string;
        hasFileIcons: boolean;
        hasFolderIcons: boolean;
        hidesExplorerArrows: boolean;
        ...
        function collectSelectors(associations: IconsAssociation | undefined, baseThemeClassName?: string) {
            ...
            if (associations) {
                ...
                const rootFolderExpanded = associations.rootFolderExpanded ||
