...
import { combinedDisposable, Disposable, DisposableStore, dispose, IDisposable, MutableDisposable, toDisposable, } from "../../../../base/common/lifecycle.js";
...
import { FileChangesEvent, FileChangeType, FileOperation, FileOperationError, FileOperationEvent, FileOperationResult, IFileService, whenProviderRegistered, } from "../../../../platform/files/common/files.js";
...
import { APPLY_ALL_PROFILES_SETTING, ConfigurationKey, FOLDER_SCOPES, FOLDER_SETTINGS_NAME, IConfigurationCache, LAUNCH_CONFIGURATION_KEY, REMOTE_MACHINE_SCOPES, TASKS_CONFIGURATION_KEY, WORKSPACE_SCOPES, } from "../common/configuration.js";
...
export class DefaultConfiguration extends BaseDefaultConfiguration {
    ...
    constructor(private readonly configurationCache: IConfigurationCache, environmentService: IBrowserWorkbenchEnvironmentService, logService: ILogService) {
        super(logService);
...
export class ApplicationConfiguration extends UserSettings {
    ...
    constructor(userDataProfilesService: IUserDataProfilesService, fileService: IFileService, uriIdentityService: IUriIdentityService, logService: ILogService) {
        super(userDataProfilesService.defaultProfile.settingsResource, {
            scopes: [ConfigurationScope.APPLICATION],
            skipUnregistered: true,
        }, uriIdentityService.extUri, fileService, logService);
...
export class UserConfiguration extends Disposable {
    ...
    get hasTasksLoaded(): boolean {
        return (this.userConfiguration.value instanceof
            FileServiceBasedConfiguration);
    }
    constructor(private settingsResource: URI, private tasksResource: URI | undefined, private configurationParseOptions: ConfigurationParseOptions, private readonly fileService: IFileService, private readonly uriIdentityService: IUriIdentityService, private readonly logService: ILogService) {
        super();
        ...
        this.userConfigurationChangeDisposable.value =
            this.userConfiguration.value.onDidChange(() => this.reloadConfigurationScheduler.schedule());
...
class FileServiceBasedConfiguration extends Disposable {
    ...
    constructor(name: string, private readonly settingsResource: URI, private readonly standAloneConfigurationResources: [
        string,
        URI
    ][], configurationParseOptions: ConfigurationParseOptions, private readonly fileService: IFileService, private readonly uriIdentityService: IUriIdentityService, private readonly logService: ILogService) {
        super();
        this.allResources = [
    ...
    async resolveContents(donotResolveSettings?: boolean): Promise<[
        string | undefined,
        [
            string,
            string | undefined
    ...
    private consolidate(settingsConfiguration?: ConfigurationModel): void {
        this._cache = (settingsConfiguration ??
            this._folderSettingsModelParser.configurationModel).merge(...this._standAloneConfigurations);
    }
...
export class RemoteUserConfiguration extends Disposable {
    ...
    constructor(remoteAuthority: string, configurationCache: IConfigurationCache, fileService: IFileService, uriIdentityService: IUriIdentityService, remoteAgentService: IRemoteAgentService, logService: ILogService) {
        ...
        this._userConfiguration = this._cachedConfiguration =
            new CachedRemoteUserConfiguration(remoteAuthority, configurationCache, { scopes: REMOTE_MACHINE_SCOPES }, logService);
...
class FileServiceBasedRemoteUserConfiguration extends Disposable {
    ...
    constructor(private readonly configurationResource: URI, configurationParseOptions: ConfigurationParseOptions, private readonly fileService: IFileService, private readonly uriIdentityService: IUriIdentityService, private readonly logService: ILogService) {
        super();
...
class CachedRemoteUserConfiguration extends Disposable {
    ...
    constructor(remoteAuthority: string, private readonly configurationCache: IConfigurationCache, configurationParseOptions: ConfigurationParseOptions, logService: ILogService) {
        super();
...
export class WorkspaceConfiguration extends Disposable {
    ...
    constructor(private readonly configurationCache: IConfigurationCache, private readonly fileService: IFileService, private readonly uriIdentityService: IUriIdentityService, private readonly logService: ILogService) {
        super();
    ...
    private async waitAndInitialize(workspaceIdentifier: IWorkspaceIdentifier): Promise<void> {
        ...
        if (!(this._workspaceConfiguration instanceof
...
class FileServiceBasedWorkspaceConfiguration extends Disposable {
    ...
    readonly onDidChange: Event<void> = this._onDidChange.event;
    constructor(private readonly fileService: IFileService, uriIdentityService: IUriIdentityService, private readonly logService: ILogService) {
        super();
        this.workspaceConfigurationModelParser =
            new WorkspaceConfigurationModelParser("", logService);
        this.workspaceSettings =
            ConfigurationModel.createEmptyModel(logService);
        this._register(Event.any(Event.filter(this.fileService.onDidFilesChange, (e) => !!this._workspaceIdentifier &&
            e.contains(this._workspaceIdentifier.configPath)), Event.filter(this.fileService.onDidRunOperation, (e) => !!this._workspaceIdentifier &&
    ...
    async load(workspaceIdentifier: IWorkspaceIdentifier, configurationParseOptions: ConfigurationParseOptions): Promise<void> {
        if (!this._workspaceIdentifier ||
            ...
            this._workspaceIdentifier = workspaceIdentifier;
            this.workspaceConfigurationModelParser =
                new WorkspaceConfigurationModelParser(this._workspaceIdentifier.id, this.logService);
    ...
    private consolidate(): void {
        this.workspaceSettings =
            this.workspaceConfigurationModelParser.settingsModel.merge(this.workspaceConfigurationModelParser.launchModel, this.workspaceConfigurationModelParser.tasksModel);
    }
...
class CachedWorkspaceConfiguration {
    ...
    workspaceConfigurationModelParser: WorkspaceConfigurationModelParser;
    workspaceSettings: ConfigurationModel;
    constructor(private readonly configurationCache: IConfigurationCache, private readonly logService: ILogService) {
        this.workspaceConfigurationModelParser =
            new WorkspaceConfigurationModelParser("", logService);
        this.workspaceSettings =
            ConfigurationModel.createEmptyModel(logService);
    ...
    async load(workspaceIdentifier: IWorkspaceIdentifier, configurationParseOptions: ConfigurationParseOptions): Promise<void> {
        try {
            ...
            if (parsed.content) {
                this.workspaceConfigurationModelParser =
                    new WorkspaceConfigurationModelParser(key.key, this.logService);
...
class CachedFolderConfiguration {
    ...
    private configurationModel: ConfigurationModel;
    private readonly key: ConfigurationKey;
    constructor(folder: URI, configFolderRelativePath: string, configurationParseOptions: ConfigurationParseOptions, private readonly configurationCache: IConfigurationCache, private readonly logService: ILogService) {
        this.key = {
            type: "folder",
    ...
    async loadConfiguration(): Promise<ConfigurationModel> {
        try {
            ...
            const { content: configurationContents, }: {
                content: IStringDictionary<string>;
    ...
    async updateConfiguration(settingsContent: string | undefined, standAloneConfigurationContents: [
        string,
        string | undefined
    ][]): Promise<void> {
        const content: any = {};
...
export class FolderConfiguration extends Disposable {
    ...
    constructor(useCache: boolean, readonly workspaceFolder: IWorkspaceFolder, configFolderRelativePath: string, private readonly workbenchState: WorkbenchState, private workspaceTrusted: boolean, fileService: IFileService, uriIdentityService: IUriIdentityService, logService: ILogService, private readonly configurationCache: IConfigurationCache) {
        super();
        this.scopes =
