...
import { IConfigurationChange, IConfigurationModel, IConfigurationOverrides, IConfigurationValue, toValuesTree, } from "../../../../platform/configuration/common/configuration.js";
        ...
        const compare = (fromKeys: string[], toKeys: string[], overrideIdentifier?: string): string[] => {
            ...
            keys.push(...fromKeys.filter((key) => {
                ...
                return (this._workspace &&
                    this._workspace.folders.some((folder) => !equals(this.getValue(key, {
                        resource: folder.uri,
                        overrideIdentifier,
                    }), other.getValue(key, {
                        resource: folder.uri,
