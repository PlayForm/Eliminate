...
export class LineContext {
    constructor(readonly leadingLineContent: string, readonly characterCountDelta: number) { }
}
const enum Refilter {
    Nothing = 0,
    All = 1,
...
export class SimpleCompletionModel {
    ...
    constructor(private readonly _items: SimpleCompletionItem[], private _lineContext: LineContext, readonly replacementIndex: number, readonly replacementLength: number) { }
    ...
    private _createCachedState(): void {
        ...
        const source = this._refilterKind === Refilter.All
            ? this._items
            : this._filteredItems!;
        ...
        // user-configuration
        const scoreFn: FuzzyScorer = !this._options.filterGraceful || source.length > 2000
            ? fuzzyScore
        ...
        this._filteredItems = target.sort((a, b) => {
            ...
            let score = 0;
            if ((a.completion.isKeyword && a.labelLow !== wordLow) ||
