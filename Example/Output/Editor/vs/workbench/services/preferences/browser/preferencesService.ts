...
export class PreferencesService extends Disposable implements IPreferencesService {
    ...
    private shouldOpenJsonByDefault(): boolean {
        return (this.configurationService.getValue("workbench.settings.editor") ===
            "json");
    }
        ...
        try {
            ...
            if ((<FileOperationError>error).fileOperationResult ===
                ...
                try {
                    ...
                    throw new Error(nls.localize("fail.createSettings", "Unable to create '{0}' ({1}).", this.labelService.getUriLabel(resource, {
                        relative: true,
