...
import { IFilter, IMatch, matchesCamelCase, matchesContiguousSubString, matchesPrefix, matchesWords, or, } from "../../../../base/common/filters.js";
import { AriaLabelProvider, ModifierLabels as ModLabels, UILabelProvider, UserSettingsLabelProvider, } from "../../../../base/common/keybindingLabels.js";
import { ResolvedChord, ResolvedKeybinding, } from "../../../../base/common/keybindings.js";
import { Language, OperatingSystem } from "../../../../base/common/platform.js";
...
import { IKeybindingItem, IKeybindingItemEntry, KeybindingMatch, KeybindingMatches, } from "../common/preferences.js";
...
export class KeybindingsEditorModel extends EditorModel {
    ...
    fetch(searchValue: string, sortByPrecedence: boolean = false): IKeybindingItemEntry[] {
        ...
        if (commandIdMatches && commandIdMatches[1]) {
            ...
            return filteredKeybindingItems.map((keybindingItem): IKeybindingItemEntry => ({
        ...
        if (!searchValue) {
            return keybindingItems.map((keybindingItem): IKeybindingItemEntry => ({
                id: KeybindingsEditorModel.getId(keybindingItem),
                keybindingItem,
                templateId: KEYBINDING_ENTRY_TEMPLATE_ID,
            }));
    ...
    private filterByWhen(keybindingItems: IKeybindingItem[], command: string, when: string): IKeybindingItem[] {
        ...
        return [
            KeybindingsEditorModel.toKeybindingEntry(command, keybindingItem, actionLabels, this.getExtensionsMapping()),
        ];
    }
...
class KeybindingItemMatches {
    ...
    private matchesKeybinding(keybinding: ResolvedKeybinding, searchValue: string, words: string[], completeMatch: boolean): KeybindingMatches | null {
        ...
        if (completeMatch) {
            ...
            if (!isEmptyObject(chordPartMatch) &&
