...
import { FileSearchProvider2, FileSearchProviderOptions, ProviderResult, Range, TextSearchComplete2, TextSearchCompleteMessage, TextSearchContext2, TextSearchMatch2, TextSearchProvider2, TextSearchProviderOptions, TextSearchQuery2, TextSearchResult2, } from "./searchExtTypes.js";
...
function validateProviderResult(result: TextSearchResult): boolean {
    if (extensionResultIsMatch(result)) {
        if (Array.isArray(result.ranges)) {
            ...
            if ((<Range[]>result.preview.matches).length !==
