...
import { ITextSearchMatch, ITextSearchPreviewOptions, ITextSearchQuery, ITextSearchResult, TextSearchMatch, } from "./search.js";
...
export function getTextSearchMatchWithModelContext(matches: ITextSearchMatch[], model: ITextModel, query: ITextSearchQuery): ITextSearchResult[] {
    ...
    for (let i = 0; i < matches.length; i++) {
        ...
        if (typeof query.surroundingContext === "number" &&
