...
import { DEFAULT_MAX_SEARCH_RESULTS, excludeToGlobPattern, hasSiblingFn, IFileMatch, IFileQuery, IFileSearchProviderStats, IFolderQuery, ISearchCompleteStats, QueryGlobTester, resolvePatternsForProvider, } from "./search.js";
