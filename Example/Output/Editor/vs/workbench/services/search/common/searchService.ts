...
import { editorMatchesToTextSearchResults, getTextSearchMatchWithModelContext, } from "./searchHelpers.js";
    ...
    textSearchSplitSyncAsync(query: ITextQuery, token?: CancellationToken | undefined, onProgress?: ((result: ISearchProgressItem) => void) | undefined, notebookFilesToIgnore?: ResourceSet, asyncNotebookFilesToIgnore?: Promise<ResourceSet>): {
        ...
        if (onProgress) {
            arrays
                ...
                .filter((e) => !(notebookFilesToIgnore &&
    ...
    private getOpenEditorResults(query: ITextQuery): {
        ...
        if (query.type === QueryType.Text) {
            ...
            models.forEach((model) => {
                ...
                let matches = model.findMatches(query.contentPattern.pattern, false, !!query.contentPattern.isRegExp, !!query.contentPattern.isCaseSensitive, query.contentPattern.isWordMatch
