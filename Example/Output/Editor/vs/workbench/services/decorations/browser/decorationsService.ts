...
import { createCSSRule, createStyleSheet, removeCSSRulesContainingSelector, } from "../../../../base/browser/dom.js";
...
import { IDecoration, IDecorationData, IDecorationsProvider, IDecorationsService, IResourceDecorationChangeEvent, } from "../common/decorations.js";
...
class DecorationStyles {
    ...
    asDecoration(data: IDecorationData[], onlyChildren: boolean): IDecoration {
        ...
        let tooltip = distinct(data
            .filter((d) => !isFalsyOrWhitespace(d.tooltip))
            .map((d) => d.tooltip)).join(" • ");
