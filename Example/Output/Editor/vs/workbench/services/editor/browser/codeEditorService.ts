...
import { getCodeEditor, ICodeEditor, isCodeEditor, isCompositeEditor, isDiffEditor, } from "../../../../editor/browser/editorBrowser.js";
...
export class CodeEditorService extends AbstractCodeEditorService {
    ...
    private async doOpenCodeEditor(input: IResourceEditorInput, source: ICodeEditor | null, sideBySide?: boolean): Promise<ICodeEditor | null> {
        ...
        const enablePreviewFromCodeNavigation = this.configurationService.getValue<IWorkbenchEditorConfiguration>()
