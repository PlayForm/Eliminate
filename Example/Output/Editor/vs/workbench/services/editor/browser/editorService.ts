...
import { ICodeEditor, IDiffEditor, isCodeEditor, isCompositeEditor, isDiffEditor, } from "../../../../editor/browser/editorBrowser.js";
import { IConfigurationChangeEvent, IConfigurationService, } from "../../../../platform/configuration/common/configuration.js";
import { EditorActivation, IEditorOptions, IResourceEditorInput, IResourceEditorInputIdentifier, ITextResourceEditorInput, } from "../../../../platform/editor/common/editor.js";
import { FileChangesEvent, FileChangeType, FileOperation, FileOperationEvent, IFileService, } from "../../../../platform/files/common/files.js";
...
import { EditorServiceImpl, IEditorGroupView, } from "../../../browser/parts/editor/editor.js";
...
import { EditorInputCapabilities, EditorInputWithOptions, EditorResourceAccessor, EditorsOrder, GroupIdentifier, IEditorCloseEvent, IEditorControl, IEditorIdentifier, IEditorPane, IEditorWillOpenEvent, IFindEditorOptions, IResourceDiffEditorInput, IRevertOptions, isEditorInput, isEditorInputWithOptions, isEditorInputWithOptionsAndGroup, isResourceDiffEditorInput, isResourceEditorInput, isResourceMergeEditorInput, ITextDiffEditorPane, IUntitledTextResourceEditorInput, IUntypedEditorInput, IVisibleEditorPane, IWorkbenchEditorConfiguration, SaveReason, SideBySideEditor, } from "../../../common/editor.js";
...
import { GroupsOrder, ICloseEditorOptions, IEditorGroup, IEditorGroupsContainer, IEditorGroupsService, IEditorReplacement, isEditorReplacement, } from "../common/editorGroupsService.js";
import { IEditorResolverService, ResolvedStatus, } from "../common/editorResolverService.js";
import { IBaseSaveRevertAllEditorOptions, IEditorsChangeEvent, IEditorService, IOpenEditorsOptions, IRevertAllEditorsOptions, ISaveAllEditorsOptions, ISaveEditorsOptions, ISaveEditorsResult, isPreferredGroup, IUntypedEditorReplacement, PreferredGroup, } from "../common/editorService.js";
export class EditorService extends Disposable implements EditorServiceImpl {
    ...
    constructor(editorGroupsContainer: IEditorGroupsContainer | undefined, 
    ...
    createScoped(editorGroupsContainer: IEditorGroupsContainer | "main", disposables: DisposableStore): IEditorService {
        return disposables.add(new EditorService(editorGroupsContainer === "main"
            ? this.editorGroupService.mainPart
            : editorGroupsContainer, this.editorGroupService, this.instantiationService, this.fileService, this.configurationService, this.contextService, this.uriIdentityService, this.editorResolverService, this.workspaceTrustRequestService, this.hostService, this.textEditorService));
    }
    ...
    private onConfigurationUpdated(e?: IConfigurationChangeEvent): void {
        ...
        if (typeof configuration.workbench?.editor?.closeOnFileDelete ===
            "boolean") {
            ...
            (async () => {
                ...
                if (this.closeOnFileDelete || !isExternal) {
                    ...
                    if (arg1 instanceof FileChangesEvent) {
                        ...
                        matches =
                            this.uriIdentityService.extUri.isEqualOrParent(resource, arg1);
                    }
                    if (!matches) {
                        return;
                    }
    ...
    get activeTextEditorControl(): ICodeEditor | IDiffEditor | undefined {
        ...
        if (activeEditorPane) {
            ...
            if (isCompositeEditor(activeControl) &&
        ...
        switch (order) {
            ...
            case EditorsOrder.MOST_RECENTLY_ACTIVE:
                if (options?.excludeSticky) {
                    return this.editorsObserver.editors.filter(({ groupId, editor }) => !this.editorGroupsContainer
                        .getGroup(groupId)
                        ?.isSticky(editor));
                }
    ...
    private extractEditorResources(editors: Array<EditorInputWithOptions | IUntypedEditorInput>): {
        resources: URI[];
        diffMode?: boolean;
        mergeMode?: boolean;
    } {
    ...
    findEditors(arg1: URI | IResourceEditorInputIdentifier, options: IFindEditorOptions | undefined, arg2?: IEditorGroup | GroupIdentifier): readonly IEditorIdentifier[] | readonly EditorInput[] | EditorInput | undefined {
        ...
        if (!isUndefined(arg2)) {
            const targetGroup = typeof arg2 === "number"
    ...
    async replaceEditors(replacements: Array<IEditorReplacement | IUntypedEditorReplacement>, group: IEditorGroup | GroupIdentifier): Promise<void> {
        const targetGroup = typeof group === "number"
    ...
    async save(editors: IEditorIdentifier | IEditorIdentifier[], options?: ISaveEditorsOptions): Promise<ISaveEditorsResult> {
        ...
        for (const { groupId, editor } of editorsToSaveSequentially) {
            ...
            if (!editor.matches(result)) {
                const targetGroups = editor.hasCapability(EditorInputCapabilities.Untitled)
