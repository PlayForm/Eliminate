...
import { IWorkspaceTrustEnablementService, IWorkspaceTrustInfo, IWorkspaceTrustManagementService, IWorkspaceTrustRequestService, IWorkspaceTrustTransitionParticipant, IWorkspaceTrustUriInfo, WorkspaceTrustRequestOptions, WorkspaceTrustUriResponse, } from "../../../../platform/workspace/common/workspaceTrust.js";
...
export class CanonicalWorkspace implements IWorkspace {
    constructor(private readonly originalWorkspace: IWorkspace, private readonly canonicalFolderUris: URI[], private readonly canonicalConfiguration: URI | null | undefined) { }
...
export class WorkspaceTrustManagementService extends Disposable implements IWorkspaceTrustManagementService {
    ...
    private registerListeners(): void {
        ...
        this._register(this.storageService.onDidChangeValue(StorageScope.APPLICATION, this.storageKey, this._store)(async () => {
            ...
            if (JSON.stringify(this._trustStateInfo) !==
        ...
        for (const uri of uris) {
            if (trusted) {
                ...
                this._trustStateInfo.uriTrustInfo =
                    this._trustStateInfo.uriTrustInfo.filter((trustInfo) => !this.uriIdentityService.extUri.isEqual(trustInfo.uri, uri));
    ...
    private isEmptyWorkspace(): boolean {
        ...
        if (workspace) {
            return (isTemporaryWorkspace(this.workspaceService.getWorkspace()) &&
...
export class WorkspaceTrustRequestService extends Disposable implements IWorkspaceTrustRequestService {
    ...
    private resolveWorkspaceTrustRequest(trusted?: boolean): void {
        if (this._workspaceTrustRequestResolver) {
            this._workspaceTrustRequestResolver(trusted ??
