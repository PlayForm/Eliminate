...
import { AutoSaveConfiguration, FILES_READONLY_EXCLUDE_CONFIG, FILES_READONLY_INCLUDE_CONFIG, hasReadonlyCapability, HotExitConfiguration, IBaseFileStat, IFilesConfiguration, IFilesConfigurationNode, IFileService, IFileStatWithMetadata, } from "../../../../platform/files/common/files.js";
...
export class FilesConfigurationService extends Disposable implements IFilesConfigurationService {
    ...
    protected onFilesConfigurationChange(configuration: IFilesConfiguration, fromEvent: boolean): void {
        ...
        this.autoSaveAfterShortDelayContext.set(this.getAutoSaveMode(undefined).mode ===
        ...
        if (resource) {
            ...
            if (!resourceAutoSaveConfiguration) {
                resourceAutoSaveConfiguration =
                    this.computeAutoSaveConfiguration(resource, this.textResourceConfigurationService.getValue<IFilesConfigurationNode>(resource, "files"));
    ...
    private computeAutoSaveConfiguration(resource: URI | undefined, filesConfiguration: IFilesConfigurationNode | undefined): ICachedAutoSaveConfiguration {
        ...
        switch (filesConfiguration?.autoSave ??
    ...
    getAutoSaveMode(resourceOrEditor: EditorInput | URI | undefined, saveReason?: SaveReason): IAutoSaveMode {
        ...
        if (typeof saveReason === "number") {
            if ((autoSaveConfiguration.autoSave === "afterDelay" &&
