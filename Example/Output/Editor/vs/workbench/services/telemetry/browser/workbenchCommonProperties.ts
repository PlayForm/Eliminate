...
import { firstSessionDateStorageKey, ICommonProperties, lastSessionDateStorageKey, machineIdKey, } from "../../../../platform/telemetry/common/telemetry.js";
...
export function resolveWorkbenchCommonProperties(storageService: IStorageService, commit: string | undefined, version: string | undefined, isInternalTelemetry: boolean, remoteAuthority?: string, productIdentifier?: string, removeMachineId?: boolean, resolveAdditionalProperties?: () => {
    [key: string]: any;
}): ICommonProperties {
