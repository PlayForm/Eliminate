...
import { basename, dirname, extname, isEqual, joinPath, toLocalResource, } from "../../../../base/common/resources.js";
...
import { FileOperationError, FileOperationResult, ICreateFileOptions, IFileService, IFileStatWithMetadata, IFileStreamContent, } from "../../../../platform/files/common/files.js";
...
import { ICreateFileOperation, IFileOperationUndoRedoInfo, IWorkingCopyFileService, } from "../../workingCopy/common/workingCopyFileService.js";
import { DecodeStreamError, DecodeStreamErrorKind, encodingExists, IDecodeStreamResult, toDecodeStream, toEncodeReadable, UTF8, UTF8_with_bom, UTF16be, UTF16le, } from "../common/encoding.js";
import { TextFileEditorModelManager } from "../common/textFileEditorModelManager.js";
import { IEncodingSupport, IReadTextFileEncodingOptions, IReadTextFileOptions, IResourceEncoding, IResourceEncodings, ITextFileContent, ITextFileEditorModelManager, ITextFileSaveAsOptions, ITextFileSaveOptions, ITextFileService, ITextFileStreamContent, IWriteTextFileOptions, stringToSnapshot, TextFileEditorModelState, TextFileOperationError, TextFileOperationResult, toBufferOrReadable, } from "../common/textfiles.js";
export abstract class AbstractTextFileService extends Disposable implements ITextFileService {
    ...
    private async doRead(resource: URI, options?: IReadTextFileOptions & {
        ...
        try {
            ...
            if ((<DecodeStreamError>error).decodeStreamErrorKind ===
    ...
    private async doSaveAsTextFile(sourceModel: IResolvedTextEditorModel | ITextModel, source: URI, target: URI, options?: ITextFileSaveOptions): Promise<boolean> {
        ...
        // Otherwise create the target file empty if it does not exist already and resolve it from there
            ...
            try {
                ...
                if (targetExists) {
                    if ((<TextFileOperationError>error)
    ...
    isDirty(resource: URI): boolean {
        const model = resource.scheme === Schemas.untitled
...
export class EncodingOracle extends Disposable implements IResourceEncodings {
    ...
    private registerListeners(): void {
        ...
        this._register(this.contextService.onDidChangeWorkspaceFolders(() => (this.encodingOverrides =
    ...
    async getWriteEncoding(resource: URI, options?: IWriteTextFileOptions): Promise<{
        encoding: string;
        addBOM: boolean;
    }> {
    ...
    async getPreferredReadEncoding(resource: URI, options?: IReadTextFileEncodingOptions, detectedEncoding?: string): Promise<IResourceEncoding> {
        ...
        if (options?.encoding) {
            if (detectedEncoding === UTF8_with_bom &&
