...
import { DEFAULT_EDITOR_ASSOCIATION, EditorExtensions, IEditorFactoryRegistry, IFileEditorInput, isResourceDiffEditorInput, isResourceMergeEditorInput, isResourceSideBySideEditorInput, IUntitledTextResourceEditorInput, IUntypedEditorInput, IUntypedFileEditorInput, } from "../../../common/editor.js";
...
export class TextEditorService extends Disposable implements ITextEditorService {
    ...
    createTextEditor(input: IUntypedEditorInput | IUntypedFileEditorInput): EditorInput | IFileEditorInput {
        ...
        if (textResourceEditorInput.resource instanceof URI) {
            ...
            const label = textResourceEditorInput.label ||
