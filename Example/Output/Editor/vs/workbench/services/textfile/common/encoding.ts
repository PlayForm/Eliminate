...
import { listenStream, newWriteableStream, Readable, ReadableStream, } from "../../../../base/common/stream.js";
...
export class DecodeStreamError extends Error {
    constructor(message: string, readonly decodeStreamErrorKind: DecodeStreamErrorKind) {
        super(message);
    }
}
...
export async function toEncodeReadable(readable: Readable<string>, encoding: string, options?: {
    addBOM?: boolean;
...
async function guessEncodingByBuffer(buffer: VSBuffer, candidateGuessEncodings?: string[]): Promise<string | null> {
    ...
    const guessed = jschardet.detect(binaryString, candidateGuessEncodings
