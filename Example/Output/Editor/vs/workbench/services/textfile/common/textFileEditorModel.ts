...
import { ETAG_DISABLED, FileChangesEvent, FileChangeType, FileOperationError, FileOperationResult, IFileService, IFileStatWithMetadata, NotModifiedSinceFileOperationError, } from "../../../../platform/files/common/files.js";
...
import { IWorkingCopyBackup, IWorkingCopyBackupMeta, NO_TYPE_ID, WorkingCopyCapabilities, } from "../../workingCopy/common/workingCopy.js";
import { IResolvedWorkingCopyBackup, IWorkingCopyBackupService, } from "../../workingCopy/common/workingCopyBackup.js";
import { IWorkingCopyService } from "../../workingCopy/common/workingCopyService.js";
import { UTF8, UTF8_with_bom, UTF16be, UTF16le } from "./encoding.js";
import { EncodingMode, IResolvedTextFileEditorModel, ITextFileEditorModel, ITextFileEditorModelSaveEvent, ITextFileResolveOptions, ITextFileSaveAsOptions, ITextFileService, ITextFileStreamContent, TextFileEditorModelState, TextFileResolveReason, } from "./textfiles.js";
...
export class TextFileEditorModel extends BaseTextEditorModel implements ITextFileEditorModel {
    ...
    constructor(readonly resource: URI, private preferredEncoding: string | undefined, // encoding as chosen by the user
    ...
    private async onDidFilesChange(e: FileChangesEvent): Promise<void> {
        ...
        if (fileEventImpactsModel &&
            ...
            if (this.inOrphanMode !== newInOrphanModeValidated &&
                !this.isDisposed()) {
    ...
    private async resolveFromBuffer(buffer: ITextBufferFactory, options?: ITextFileResolveOptions): Promise<void> {
        ...
        try {
            ...
            this.setOrphaned(error.fileOperationResult ===
                FileOperationResult.FILE_NOT_FOUND);
        }
    ...
    private async resolveFromFile(options?: ITextFileResolveOptions): Promise<void> {
        ...
        const allowBinary = this.isResolved() /* always allow if we resolved previously */ ||
            options?.allowBinary;
        // Decide on etag
    ...
    async save(options: ITextFileSaveAsOptions = Object.create(null)): Promise<boolean> {
        ...
        if ((this.hasState(TextFileEditorModelState.CONFLICT) ||
        ...
        return this.saveSequentializer.run(versionId, (async () => {
            ...
            if (this.isResolved() && !options.skipSaveParticipants) {
                try {
                    ...
                    if (options.reason === SaveReason.AUTO &&
                        typeof this.lastModelContentChangeFromUndoRedo ===
                            "number") {
                        const timeFromUndoRedoToSave = Date.now() -
                    ...
                    if (!saveCancellation.token.isCancellationRequested) {
                        ...
                        try {
                            ...
                            }, progress, saveCancellation.token);
                        }
                        catch (err) {
    ...
    private handleSaveError(error: Error, versionId: number, options: ITextFileSaveAsOptions): void {
        (options.ignoreErrorHandler
            ...
            : this.logService.error).apply(this.logService, [
