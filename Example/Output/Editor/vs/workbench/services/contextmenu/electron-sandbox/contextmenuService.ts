...
import { ActionRunner, IAction, IActionRunner, Separator, SubmenuAction, WorkbenchActionExecutedClassification, WorkbenchActionExecutedEvent, } from "../../../../base/common/actions.js";
...
class NativeContextMenuService extends Disposable implements IContextMenuService {
    ...
    showContextMenu(delegate: IContextMenuDelegate | IContextMenuMenuDelegate): void {
        ...
        if (actions.length) {
            ...
            if (dom.isHTMLElement(anchor)) {
                ...
                if (delegate.anchorAxisAlignment ===
    ...
    private createMenuItem(delegate: IContextMenuDelegate, entry: IAction, actionRunner: IActionRunner, onHide: () => void, submenuIds: Set<string>): IContextMenuItem | undefined {
        ...
        // Normal Menu Item
            ...
            if (!!entry.checked) {
                if (typeof delegate.getCheckedActionsRepresentation ===
                    "function") {
