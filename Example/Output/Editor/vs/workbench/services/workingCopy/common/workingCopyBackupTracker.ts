...
import { ILifecycleService, InternalBeforeShutdownEvent, LifecyclePhase, ShutdownReason, } from "../../lifecycle/common/lifecycle.js";
...
export abstract class WorkingCopyBackupTracker extends Disposable {
    ...
    protected readonly pendingBackupOperations = new Map<IWorkingCopyIdentifier, {
    ...
    private cancelBackupOperation(workingCopy: IWorkingCopy): void {
        ...
        for (const [identifier] of this.pendingBackupOperations) {
            if (identifier.resource.toString() ===
    ...
    private doClearPendingBackupOperation(workingCopyIdentifier: IWorkingCopyIdentifier, options?: {
        cancel: boolean;
    }): void {
