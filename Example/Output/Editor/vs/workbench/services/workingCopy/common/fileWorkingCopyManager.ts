...
import { basename, dirname, isEqual, joinPath, toLocalResource, } from "../../../../base/common/resources.js";
...
import { IStoredFileWorkingCopyManager, IStoredFileWorkingCopyManagerResolveOptions, StoredFileWorkingCopyManager, } from "./storedFileWorkingCopyManager.js";
...
export class FileWorkingCopyManager<S extends IStoredFileWorkingCopyModel, U extends IUntitledFileWorkingCopyModel> extends Disposable implements IFileWorkingCopyManager<S, U> {
    ...
    readonly stored: IStoredFileWorkingCopyManager<S>;
    readonly untitled: IUntitledFileWorkingCopyManager<U>;
    constructor(private readonly workingCopyTypeId: string, private readonly storedWorkingCopyModelFactory: IStoredFileWorkingCopyModelFactory<S>, private readonly untitledWorkingCopyModelFactory: IUntitledFileWorkingCopyModelFactory<U>, 
    @IFileService
    ...
    async saveAs(source: URI, target?: URI, options?: IFileWorkingCopySaveAsOptions): Promise<IStoredFileWorkingCopy<S> | undefined> {
        ...
        if (this.fileService.hasProvider(source) &&
            ...
            return ((await this.doSave(source, options)) ??
    ...
    private async doResolveSaveTarget(source: URI, target: URI): Promise<{
