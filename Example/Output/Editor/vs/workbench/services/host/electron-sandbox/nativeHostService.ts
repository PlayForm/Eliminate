...
import { IOpenEmptyWindowOptions, IOpenWindowOptions, IPoint, IRectangle, isFolderToOpen, isWorkspaceToOpen, IWindowOpenable, } from "../../../../platform/window/common/window.js";
...
class WorkbenchHostService extends Disposable implements IHostService {
    ...
    private doOpenWindow(toOpen: IWindowOpenable[], options?: IOpenWindowOptions): Promise<void> {
        ...
        if (!!remoteAuthority) {
            toOpen.forEach((openable) => (openable.label =
    ...
    async moveTop(targetWindow: Window): Promise<void> {
        ...
        return this.nativeHostService.moveWindowTop(isAuxiliaryWindow(targetWindow)
