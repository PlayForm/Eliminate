...
export class TokenizationSupportWithLineLimit extends Disposable implements ITokenizationSupport {
    ...
    constructor(private readonly _encodedLanguageId: LanguageId, private readonly _actual: ITokenizationSupport, disposable: IDisposable, private readonly _maxTokenizationLineLength: IObservable<number>) {
        super();
