...
import { ILifecycleService, ShutdownReason, StartupKind, } from "../common/lifecycle.js";
...
export class BrowserLifecycleService extends AbstractLifecycleService {
    ...
    withExpectedShutdown(reason: ShutdownReason | {
        disableShutdownHandling: true;
    }, callback?: Function): Promise<void> | void {
        // Standard shutdown
