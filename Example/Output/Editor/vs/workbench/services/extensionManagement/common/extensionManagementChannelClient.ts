...
import { DidUninstallExtensionEvent, DidUpdateExtensionMetadata, IGalleryExtension, ILocalExtension, InstallExtensionEvent, InstallExtensionInfo, InstallExtensionResult, InstallOptions, IProductVersion, Metadata, UninstallExtensionEvent, UninstallExtensionInfo, UninstallOptions, } from "../../../../platform/extensionManagement/common/extensionManagement.js";
...
export abstract class ProfileAwareExtensionManagementChannelClient extends BaseExtensionManagementChannelClient implements IProfileAwareExtensionManagementService {
    ...
    constructor(channel: IChannel, protected readonly userDataProfileService: IUserDataProfileService, protected readonly uriIdentityService: IUriIdentityService) {
        super(channel);
