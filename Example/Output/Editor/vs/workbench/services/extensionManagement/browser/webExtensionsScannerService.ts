...
import { areSameExtensions, getExtensionId, getGalleryExtensionId, } from "../../../../platform/extensionManagement/common/extensionManagementUtil.js";
...
import { ExtensionType, IBuiltinExtensionsScannerService, IExtension, IExtensionIdentifier, IExtensionManifest, IRelaxedExtensionManifest, parseEnabledApiProposalNames, TargetPlatform, } from "../../../../platform/extensions/common/extensions.js";
...
export class WebExtensionsScannerService extends Disposable implements IWebExtensionsScannerService {
    ...
    private _customBuiltinExtensionsInfoPromise: Promise<{
    ...
    private async getCustomBuiltinExtensionsFromCache(): Promise<IWebExtension[]> {
        ...
        for (const webExtension of cachedCustomBuiltinExtensions) {
            ...
            if (webExtension.metadata?.isPreReleaseVersion &&
    ...
    private async toWebExtensionFromGallery(galleryExtension: IGalleryExtension, metadata?: Metadata): Promise<IWebExtension> {
        const extensionLocation = this.extensionResourceLoaderService.getExtensionGalleryResourceURL({
            ...
            targetPlatform: galleryExtension.properties.targetPlatform ===
                TargetPlatform.WEB
                ? TargetPlatform.WEB
                : undefined,
        }, "extension");
        ...
        return this.toWebExtensionFromExtensionGalleryResource(extensionLocation, galleryExtension.identifier, galleryExtension.assets.readme
            ? URI.parse(galleryExtension.assets.readme.uri)
            : undefined, galleryExtension.assets.changelog
            ? URI.parse(galleryExtension.assets.changelog.uri)
            : undefined, metadata);
    }
    private async toWebExtensionFromExtensionGalleryResource(extensionLocation: URI, identifier?: IExtensionIdentifier, readmeUri?: URI, changelogUri?: URI, metadata?: Metadata): Promise<IWebExtension> {
        ...
        return this.toWebExtension(extensionLocation, identifier, undefined, packageNLSResources, fallbackPackageNLSResource
            ? URI.parse(fallbackPackageNLSResource)
            : null, readmeUri, changelogUri, metadata);
    }
    ...
    private async toWebExtension(extensionLocation: URI, identifier?: IExtensionIdentifier, manifest?: IExtensionManifest, packageNLSUris?: Map<string, URI>, fallbackPackageNLSUri?: URI | ITranslations | null, readmeUri?: URI, changelogUri?: URI, metadata?: Metadata): Promise<IWebExtension> {
        ...
        const defaultManifestTranslations: ITranslations | null | undefined = fallbackPackageNLSUri
    ...
    private async toScannedExtension(webExtension: IWebExtension, isBuiltin: boolean, type: ExtensionType = ExtensionType.User): Promise<IScannedExtension> {
        ...
        const fallbackPackageNLS = webExtension.defaultManifestTranslations ??
    ...
    registerAction2(class extends Action2 {
        ...
        run(serviceAccessor: ServicesAccessor): void {
            ...
            editorService.openEditor({
                resource: userDataProfileService.currentProfile
                    .extensionsResource,
            });
        }
    });
