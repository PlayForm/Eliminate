...
import { getLogs, IAutomatedWindow, } from "../../../../platform/log/browser/log.js";
...
import { AbstractExtensionService, checkEnabledAndProposedAPI, IExtensionHostFactory, ResolvedExtensions, } from "../common/abstractExtensionService.js";
...
export class ExtensionService extends AbstractExtensionService implements IExtensionService {
    ...
    private async _scanWebExtensions(): Promise<IExtensionDescription[]> {
        ...
        try {
            await Promise.all([
                ...
                this._webExtensionsScannerService
                    .scanUserExtensions(this._userDataProfileService.currentProfile
                    .extensionsResource, { skipInvalidExtensions: true })
    ...
    protected async _resolveExtensionsDefault() {
        ...
        return new ResolvedExtensions(localExtensions, remoteExtensions, 
...
class BrowserExtensionHostFactory implements IExtensionHostFactory {
    constructor(private readonly _extensionsProposedApi: ExtensionsProposedApi, private readonly _scanWebExtensions: () => Promise<IExtensionDescription[]>, private readonly _getExtensionRegistrySnapshotWhenReady: () => Promise<ExtensionDescriptionRegistrySnapshot>, 
    @IInstantiationService
