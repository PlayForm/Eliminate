...
import { createMessageOfType, ExtensionHostExitCode, IExtensionHostInitData, isMessageOfType, MessageType, UIKind, } from "../common/extensionHostProtocol.js";
...
export class WebWorkerExtensionHost extends Disposable implements IExtensionHost {
    ...
    private readonly _onDidExit = this._register(new Emitter<[
        number,
        string | null
    ]>());
    ...
    constructor(public readonly runningLocation: LocalWebWorkerRunningLocation, public readonly startup: ExtensionHostStartup, private readonly _initDataProvider: IWebWorkerExtensionHostDataProvider, 
    @ITelemetryService
    ...
    private async _getWebWorkerExtensionHostIframeSrc(): Promise<string> {
        ...
        if (this._environmentService.debugExtensionHost &&
    ...
    private async _startInsideIframe(): Promise<IMessagePassingProtocol> {
        ...
        this._register(dom.addDisposableListener(mainWindow, "message", (event) => {
            ...
            if (event.data.vscodeWebWorkerExtHostId !==
    ...
    private async _createExtHostInitData(): Promise<IExtensionHostInitData> {
        ...
        return {
            ...
            environment: {
                ...
                appHost: this._productService.embedderIdentifier ??
