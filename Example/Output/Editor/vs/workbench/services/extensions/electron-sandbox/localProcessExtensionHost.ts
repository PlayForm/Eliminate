...
import { IExtensionHostInitData, isMessageOfType, MessageType, NativeLogMarkers, UIKind, } from "../common/extensionHostProtocol.js";
...
export class ExtensionHostProcess {
    ...
    constructor(id: string, private readonly _extensionHostStarter: IExtensionHostStarter) {
        this._id = id;
    }
    public start(opts: IExtensionHostProcessOptions): Promise<{
...
export class NativeLocalProcessExtensionHost implements IExtensionHost {
    ...
    private readonly _onExit: Emitter<[
        number,
        string
    ]> = new Emitter<[
        number,
    ...
    constructor(public readonly runningLocation: LocalProcessRunningLocation, public readonly startup: ExtensionHostStartup.EagerAutoStart | ExtensionHostStartup.EagerManualStart, private readonly _initDataProvider: ILocalProcessExtensionHostDataProvider, 
    ...
    private async _start(): Promise<IMessagePassingProtocol> {
        ...
        const onOutput = Event.any(Event.map(onStdout.event, (o) => ({
            data: `%c${o}`,
            format: [""],
        ...
        this._toDispose.add(onDebouncedOutput((output) => {
            const inspectorUrlMatch = output.data &&
    ...
    private async _createExtHostInitData(): Promise<IExtensionHostInitData> {
        ...
        return {
            ...
            environment: {
                ...
                globalStorageHome: this._userDataProfilesService.defaultProfile
                    .globalStorageHome,
                workspaceStorageHome: this._environmentService.workspaceStorageHome,
                extensionLogLevel: this._environmentService.extensionLogLevel,
            },
            workspace: this._contextService.getWorkbenchState() ===
            ...
            consoleForward: {
                ...
                logNative: !this._isExtensionDevTestFromCli &&
                    this._isExtensionDevHost,
            },
