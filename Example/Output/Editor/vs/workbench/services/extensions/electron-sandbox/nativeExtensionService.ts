...
import { getRemoteAuthorityPrefix, IRemoteAuthorityResolverService, RemoteAuthorityResolverError, RemoteConnectionType, ResolverResult, } from "../../../../platform/remote/common/remoteAuthorityResolver.js";
...
import { AbstractExtensionService, checkEnabledAndProposedAPI, ExtensionHostCrashTracker, extensionIsEnabled, IExtensionHostFactory, ResolvedExtensions, } from "../common/abstractExtensionService.js";
import { ExtensionDescriptionRegistrySnapshot } from "../common/extensionDescriptionRegistry.js";
import { parseExtensionDevOptions } from "../common/extensionDevOptions.js";
import { ExtensionHostKind, extensionHostKindToString, ExtensionRunningPreference, extensionRunningPreferenceToString, IExtensionHostKindPicker, } from "../common/extensionHostKind.js";
...
import { ExtensionHostExtensions, ExtensionHostStartup, IExtensionHost, IExtensionService, toExtension, webWorkerExtHostConfig, WebWorkerExtHostConfigValue, } from "../common/extensions.js";
...
export class NativeExtensionService extends AbstractExtensionService implements IExtensionService {
    ...
    protected async _resolveExtensions(): Promise<ResolvedExtensions> {
        ...
        if (remoteAuthority) {
            ...
            updateProxyConfigurationsScope(remoteEnv.useHostProxy
    ...
    private async _startLocalExtensionHost(remoteExtensions: IExtensionDescription[] = []): Promise<ResolvedExtensions> {
        ...
        return new ResolvedExtensions(await this._scanAllLocalExtensions(), remoteExtensions, 
    ...
    protected async _onExtensionHostExit(code: number): Promise<void> {
        ...
        const connection = this._remoteAgentService.getConnection();
        connection?.dispose();
        if (parseExtensionDevOptions(this._environmentService)
...
class NativeExtensionHostFactory implements IExtensionHostFactory {
    ...
    constructor(private readonly _extensionsProposedApi: ExtensionsProposedApi, private readonly _extensionScanner: CachedExtensionScanner, private readonly _getExtensionRegistrySnapshotWhenReady: () => Promise<ExtensionDescriptionRegistrySnapshot>, 
    @IInstantiationService
    ...
    private readonly _logService: ILogService) {
        this._webWorkerExtHostEnablement =
            determineLocalWebWorkerExtHostEnablement(environmentService, configurationService);
    }
    public createExtensionHost(runningLocations: ExtensionRunningLocationTracker, runningLocation: ExtensionRunningLocation, isInitialStart: boolean): IExtensionHost | null {
        switch (runningLocation.kind) {
            ...
            case ExtensionHostKind.LocalWebWorker: {
                if (this._webWorkerExtHostEnablement !==
    ...
    public static pickExtensionHostKind(extensionKinds: ExtensionKind[], isInstalledLocally: boolean, isInstalledRemotely: boolean, preference: ExtensionRunningPreference, hasRemoteExtHost: boolean, hasWebWorkerExtHost: boolean): ExtensionHostKind | null {
        ...
        for (const extensionKind of extensionKinds) {
            if (extensionKind === "ui" && isInstalledLocally) {
                ...
                if (preference === ExtensionRunningPreference.None ||
