...
import { getRemoteAuthorityPrefix, RemoteAuthorityResolverErrorCode, } from "../../../../platform/remote/common/remoteAuthorityResolver.js";
...
import { IRPCProtocolLogger, RequestInitiator, ResponsiveState, RPCProtocol, } from "./rpcProtocol.js";
...
export class ExtensionHostManager extends Disposable implements IExtensionHostManager {
    public readonly onDidExit: Event<[
        number,
        string | null
    ]>;
    ...
    constructor(extensionHost: IExtensionHost, initialActivationEvents: string[], private readonly _internalExtensionService: IInternalExtensionService, 
...
class TelemetryRPCLogger implements IRPCProtocolLogger {
    ...
    logIncoming(msgLength: number, req: number, initiator: RequestInitiator, str: string): void {
        if (initiator === RequestInitiator.LocalSide &&
        ...
        if (initiator === RequestInitiator.OtherSide &&
