...
import { determineExtensionHostKinds, ExtensionHostKind, ExtensionRunningPreference, IExtensionHostKindPicker, } from "./extensionHostKind.js";
...
export class ExtensionRunningLocationTracker {
    ...
    constructor(private readonly _registry: IReadOnlyExtensionDescriptionRegistry, private readonly _extensionHostKindPicker: IExtensionHostKindPicker, 
    ...
    private _computeAffinity(inputExtensions: IExtensionDescription[], extensionHostKind: ExtensionHostKind, isInitialAllocation: boolean): {
        ...
        if (!this._environmentService.isExtensionDevelopment) {
            ...
            const configuredAffinities = this._configurationService.getValue<{
                [extensionId: string]: number;
            } | undefined>("extensions.experimental.affinity") || {};
    ...
    private _doComputeRunningLocation(existingRunningLocation: ExtensionIdentifierMap<ExtensionRunningLocation | null>, localExtensions: IExtensionDescription[], remoteExtensions: IExtensionDescription[], isInitialAllocation: boolean): {
