...
import { getRemoteAuthorityPrefix, IRemoteAuthorityResolverService, RemoteAuthorityResolverError, RemoteAuthorityResolverErrorCode, ResolverResult, } from "../../../../platform/remote/common/remoteAuthorityResolver.js";
import { IRemoteExtensionsScannerService } from "../../../../platform/remote/common/remoteExtensionsScanner.js";
import { ITelemetryService } from "../../../../platform/telemetry/common/telemetry.js";
import { IWorkspaceContextService } from "../../../../platform/workspace/common/workspace.js";
import { IWorkbenchEnvironmentService } from "../../environment/common/environmentService.js";
import { Extensions as ExtensionFeaturesExtensions, IExtensionFeatureMarkdownRenderer, IExtensionFeaturesRegistry, IRenderedData, } from "../../extensionManagement/common/extensionFeatures.js";
...
import { ActivationKind, ActivationTimes, ExtensionActivationReason, ExtensionHostStartup, ExtensionPointContribution, IExtensionHost, IExtensionService, IExtensionsStatus, IInternalExtensionService, IMessage, IResponsiveStateChangeEvent, IWillActivateEvent, toExtension, toExtensionDescription, WillStopExtensionHostsEvent, } from "./extensions.js";
...
import { checkActivateWorkspaceContainsExtension, checkGlobFileExists, IExtensionActivationHost as IWorkspaceContainsActivationHost, } from "./workspaceContains.js";
...
export abstract class AbstractExtensionService extends Disposable implements IExtensionService {
    ...
    private readonly _onDidChangeExtensions = this._register(new Emitter<{
    ...
    constructor(private readonly _extensionsProposedApi: ExtensionsProposedApi, private readonly _extensionHostFactory: IExtensionHostFactory, private readonly _extensionHostKindPicker: IExtensionHostKindPicker, 
    ...
    private async _deltaExtensions(lock: ExtensionDescriptionRegistryLock, _toAdd: IExtension[], _toRemove: string[] | IExtension[]): Promise<void> {
        ...
        for (let i = 0, len = _toRemove.length; i < len; i++) {
            ...
            const extensionId = typeof extensionOrId === "string"
                ? extensionOrId
        ...
        if (result.removedDueToLooping.length > 0) {
            this._notificationService.notify({
                ...
                message: nls.localize("looping", "The following extensions contain dependency loops and have been disabled: {0}", result.removedDueToLooping
    ...
    public canRemoveExtension(extension: IExtensionDescription): boolean {
        ...
        if (this._extensionStatus.get(extensionDescription.identifier)
            ?.activationStarted) {
    ...
    private _processExtensions(lock: ExtensionDescriptionRegistryLock, resolvedExtensions: ResolvedExtensions): void {
        ...
        const remoteExtensionsThatNeedToRunLocally = allowRemoteExtensionsInLocalWebWorker
            ? this._runningLocations.filterByExtensionHostKind(remoteExtensions, ExtensionHostKind.LocalWebWorker)
            : [];
        const localProcessExtensions = hasLocalProcess
            ? this._runningLocations.filterByExtensionHostKind(localExtensions, ExtensionHostKind.LocalProcess)
            : [];
    ...
    private _releaseBarrier(): void {
        ...
        this._onDidChangeExtensionsStatus.fire(this._registry
    ...
    protected async _resolveAuthorityOnExtensionHosts(kind: ExtensionHostKind, remoteAuthority: string): Promise<ResolverResult> {
        ...
        for (const result of results) {
            ...
            const bestErrorIsUnknown = bestErrorResult.error.code ===
    ...
    private _createExtensionHostManager(runningLocation: ExtensionRunningLocation, isInitialStart: boolean, initialActivationEvents: string[]): null | [
    ...
    protected _doCreateExtensionHostManager(extensionHost: IExtensionHost, initialActivationEvents: string[]): IExtensionHostManager {
        ...
        if (extensionHost.startup === ExtensionHostStartup.Lazy &&
    ...
    public async getInspectPorts(extensionHostKind: ExtensionHostKind, tryEnableInspector: boolean): Promise<{
        port: number;
        host: string;
    }[]> {
...
class ExtensionHostManagerData {
    constructor(public readonly extensionHost: IExtensionHostManager, public readonly disposableStore: DisposableStore) { }
    public dispose(): void {
...
export class ResolvedExtensions {
    constructor(public readonly local: IExtensionDescription[], public readonly remote: IExtensionDescription[], public readonly hasLocalProcess: boolean, public readonly allowRemoteExtensionsInLocalWebWorker: boolean) { }
}
export interface IExtensionHostFactory {
    createExtensionHost(runningLocations: ExtensionRunningLocationTracker, runningLocation: ExtensionRunningLocation, isInitialStart: boolean): IExtensionHost | null;
}
class DeltaExtensionsQueueItem {
    constructor(public readonly toAdd: IExtension[], public readonly toRemove: string[] | IExtension[]) { }
}
/**
