...
export type Dto<T> = T extends {
    toJSON(): infer U;
} ? U : T extends VSBuffer // VSBuffer is understood by rpc-logic
 ? T : T extends CancellationToken // CancellationToken is understood by rpc-logic
 ? T : T extends Function // functions are dropped during JSON-stringify
 ? never : T extends object // recurse
 ? {
