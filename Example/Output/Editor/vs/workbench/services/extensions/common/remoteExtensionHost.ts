...
import { connectRemoteAgentExtensionHost, IConnectionOptions, IRemoteExtensionHostStartParams, } from "../../../../platform/remote/common/remoteAgentConnection.js";
...
import { createMessageOfType, IExtensionHostInitData, isMessageOfType, MessageType, UIKind, } from "./extensionHostProtocol.js";
...
export class RemoteExtensionHost extends Disposable implements IExtensionHost {
    ...
    constructor(public readonly runningLocation: RemoteRunningLocation, private readonly _initDataProvider: IRemoteExtensionHostDataProvider, 
