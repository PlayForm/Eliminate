...
import { IActivationEventsGenerator, ImplicitActivationEvents, } from "../../../../platform/extensionManagement/common/implicitActivationEvents.js";
import { EXTENSION_CATEGORIES, ExtensionIdentifierSet, IExtensionDescription, } from "../../../../platform/extensions/common/extensions.js";
...
export class ExtensionPointUserDelta<T> {
    ...
    constructor(public readonly added: readonly IExtensionPointUser<T>[], public readonly removed: readonly IExtensionPointUser<T>[]) { }
}
