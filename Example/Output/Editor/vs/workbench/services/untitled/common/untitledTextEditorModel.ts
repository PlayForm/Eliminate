...
import { IWorkingCopy, IWorkingCopyBackup, IWorkingCopySaveEvent, NO_TYPE_ID, WorkingCopyCapabilities, } from "../../workingCopy/common/workingCopy.js";
...
export class UntitledTextEditorModel extends BaseTextEditorModel implements IUntitledTextEditorModel {
    ...
    //#endregion
    constructor(readonly resource: URI, readonly hasAssociatedFilePath: boolean, private readonly initialValue: string | undefined, private preferredLanguageId: string | undefined, private preferredEncoding: string | undefined, 
    @ILanguageService
    ...
    private onConfigurationChange(e: ITextResourceConfigurationChangeEvent | undefined, fromEvent: boolean): void {
        ...
        // Label Format
        if (!e ||
            e.affectsConfiguration(this.resource, "workbench.editor.untitled.labelFormat")) {
    ...
    override async resolve(): Promise<void> {
        ...
        if (createdUntitledModel) {
            ...
            this.setDirty(this.hasAssociatedFilePath ||
                !!hasBackup ||
                !!this.initialValue);
    ...
    private onModelContentChanged(textEditorModel: ITextModel, e: IModelContentChangedEvent): void {
        ...
        if (e.changes.some((change) => (change.range.startLineNumber === 1 ||
    ...
    private updateNameFromFirstLine(textEditorModel: ITextModel): void {
        ...
        let firstLineText = textEditorModel
            ...
            endLineNumber: 1,
            startColumn: 1,
            endColumn: UntitledTextEditorModel.FIRST_LINE_NAME_CANDIDATE_MAX_LENGTH +
