...
import { IMenuItem, ISubmenuItem, MenuId, MenuRegistry, } from "../../../../platform/actions/common/actions.js";
...
import { Extensions as ExtensionFeaturesExtensions, IExtensionFeaturesRegistry, IExtensionFeatureTableRenderer, IRenderedData, IRowData, ITableData, } from "../../extensionManagement/common/extensionFeatures.js";
import { isProposedApiEnabled } from "../../extensions/common/extensions.js";
import { ExtensionMessageCollector, ExtensionsRegistry, IExtensionPointUser, } from "../../extensions/common/extensionsRegistry.js";
interface IAPIMenu {
    readonly key: string;
    readonly id: MenuId;
...
namespace schema {
    ...
    export const menusContribution: IJSONSchema = {
        ...
        properties: index(apiMenus, (menu) => menu.key, (menu) => ({
            markdownDescription: menu.proposed
                ...
                : menu.description,
            type: "array",
            items: menu.supportsSubmenus === false
                ? menuItem
    ...
    export type IUserFriendlyIcon = string | {
        light: string;
        dark: string;
    };
    ...
    function isValidIcon(icon: IUserFriendlyIcon | undefined, collector: ExtensionMessageCollector): boolean {
        ...
        else if (typeof icon.dark === "string" &&
...
export const commandsExtensionPoint = ExtensionsRegistry.registerExtensionPoint<schema.IUserFriendlyCommand | schema.IUserFriendlyCommand[]>({
    ...
    activationEventsGenerator: (contribs: schema.IUserFriendlyCommand[], result: {
    ...
    function handleCommand(userFriendlyCommand: schema.IUserFriendlyCommand, extension: IExtensionPointUser<any>) {
        ...
        _commandRegistrations.add(MenuRegistry.addCommand({
            ...
            source: {
                ...
                title: extension.description.displayName ??
...
const menusExtensionPoint = ExtensionsRegistry.registerExtensionPoint<{
    [loc: string]: (schema.IUserFriendlyMenuItem | schema.IUserFriendlySubmenuItem)[];
}>({
