...
class BaseBadge implements IBadge {
    constructor(protected readonly descriptorFn: (arg: any) => string, private readonly stylesFn: ((theme: IColorTheme) => IBadgeStyles | undefined) | undefined) {
    }
    getDescription(): string {
...
export class IconBadge extends BaseBadge {
    constructor(readonly icon: ThemeIcon, descriptorFn: () => string, stylesFn?: (theme: IColorTheme) => IBadgeStyles | undefined) {
