...
import { IMMUTABLE_CODE_TO_KEY_CODE, KeyCode, KeyCodeUtils, NATIVE_WINDOWS_KEY_CODE_TO_KEY_CODE, ScanCode, ScanCodeUtils, } from "../../../../base/common/keyCodes.js";
...
export class WindowsNativeResolvedKeybinding extends BaseResolvedKeybinding<KeyCodeChord> {
    ...
    protected _getSingleModifierChordDispatch(chord: KeyCodeChord): SingleModifierChord | null {
        if (chord.keyCode === KeyCode.Ctrl &&
            !chord.shiftKey &&
            !chord.altKey &&
            !chord.metaKey) {
            return "ctrl";
        }
        if (chord.keyCode === KeyCode.Shift &&
            !chord.ctrlKey &&
            !chord.altKey &&
            !chord.metaKey) {
            return "shift";
        }
        if (chord.keyCode === KeyCode.Alt &&
            !chord.ctrlKey &&
            !chord.shiftKey &&
            !chord.metaKey) {
            return "alt";
        }
        if (chord.keyCode === KeyCode.Meta &&
            !chord.ctrlKey &&
            !chord.shiftKey &&
            !chord.altKey) {
            return "meta";
...
export class WindowsKeyboardMapper implements IKeyboardMapper {
    ...
    private _getLabelForKeyCode(keyCode: KeyCode): string {
        return (this._keyCodeToLabel[keyCode] ||
