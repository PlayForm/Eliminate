...
export class BrowserKeyboardMapperFactoryBase extends Disposable {
    ...
    protected constructor(private readonly _configurationService: IConfigurationService) {
        super();
        ...
        if ((<INavigatorWithKeyboard>navigator).keyboard &&
    ...
    setActiveKeyMapping(keymap: IKeyboardMapping | null) {
        ...
        if (matchedKeyboardLayout) {
            ...
            if (!this._activeKeymapInfo) {
                ...
                if (matchedKeyboardLayout.result.getScore(keymap) >
...
class UserKeyboardLayout extends Disposable {
    ...
    constructor(private readonly keyboardLayoutResource: URI, private readonly fileService: IFileService) {
        super();
        ...
        try {
            ...
            if (getNodeType(value) === "object") {
                ...
                this._keyboardLayout =
                    KeymapInfo.createKeyboardLayoutFromDebugInfo(layoutInfo, mappings, true);
            }
            else {
                this._keyboardLayout = null;
            }
