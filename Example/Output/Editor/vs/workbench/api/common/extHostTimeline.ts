...
import { ExtHostTimelineShape, IMainContext, MainContext, MainThreadTimelineShape, } from "./extHost.protocol.js";
import { CommandsConverter, ExtHostCommands } from "./extHostCommands.js";
import { MarkdownString } from "./extHostTypeConverters.js";
import { MarkdownString as MarkdownStringType, ThemeIcon, } from "./extHostTypes.js";
...
export class ExtHostTimeline implements IExtHostTimeline {
    ...
    private _providers = new Map<string, {
            ...
            processArgument: (arg, extension) => {
                if (arg && arg.$mid === MarshalledId.TimelineActionContext) {
                    if (this._providers.get(arg.source) &&
                        ExtensionIdentifier.equals(extension, this._providers.get(arg.source)?.extension)) {
                        const uri = arg.uri === undefined
                            ? undefined
                            : URI.revive(arg.uri);
