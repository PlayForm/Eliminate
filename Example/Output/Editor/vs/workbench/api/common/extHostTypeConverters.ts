...
import { CoverageDetails, denamespaceTestTag, DetailType, ICoverageCount, IFileCoverage, ISerializedTestResults, ITestErrorMessage, ITestItem, ITestTag, namespaceTestTag, TestMessageType, TestResultItem, } from "../../contrib/testing/common/testTypes.js";
...
export namespace MarkdownString {
    ...
    function _uriMassage(part: string, bucket: {
        [n: string]: UriComponents;
    }): string {
        if (!part) {
            return part;
        }
            ...
            return {
                ...
                hoverMessage: Array.isArray(r.hoverMessage)
                    ...
                    : r.hoverMessage
                        ...
                        : undefined,
                renderOptions: <any>r.renderOptions,
            };
        });
    }
    else {
                    ...
                    if (entry.options?.contents) {
                        if (ArrayBuffer.isView(entry.options.contents)) {
                            ...
                            contents = {
                                type: "dataTransferItem",
                                id: (entry.options
                                    .contents as types.DataTransferFile)._itemId,
                            };
                        }
                    }
                    // file operation
    ...
    export function to(value: extHostProtocol.IWorkspaceEditDto) {
        ...
        for (const edit of value.edits) {
            if ((<extHostProtocol.IWorkspaceTextEditDto>edit).textEdit) {
                ...
                result.renameFile(URI.revive((<extHostProtocol.IWorkspaceFileEditDto>edit)
                    .oldResource!), URI.revive((<extHostProtocol.IWorkspaceFileEditDto>edit)
                    .newResource!), (<extHostProtocol.IWorkspaceFileEditDto>edit).options);
            }
        }
...
export namespace SymbolKind {
    const _fromMapping: {
        [kind: number]: languages.SymbolKind;
    } = Object.create(null);
    ...
    export function from(value: vscode.Location | vscode.DefinitionLink): languages.LocationLink {
        ...
        return {
            ...
            uri: definitionLink.targetUri
                ...
                : location.uri,
            range: Range.from(definitionLink.targetRange
    ...
    export function to(suggestion: languages.CompletionItem, converter?: Command.ICommandsConverter): types.CompletionItem {
        ...
        result.keepWhitespace =
            typeof suggestion.insertTextRules === "undefined"
                ? false
                : Boolean(suggestion.insertTextRules &
...
export namespace Color {
    ...
    export function from(color: types.Color): [
        number,
        number,
        number,
        number
...
export namespace ProgressLocation {
    export function from(loc: vscode.ProgressLocation | {
        viewId: string;
...
export namespace TextEditorOpenOptions {
    export function from(options?: TextEditorOpenOptions): ITextEditorOptions | undefined {
        if (options) {
            return {
                pinned: typeof options.preview === "boolean"
                    ? !options.preview
                    : undefined,
                inactive: options.background,
                preserveFocus: options.preserveFocus,
                selection: typeof options.selection === "object"
                    ? Range.from(options.selection)
                    : undefined,
                override: typeof options.override === "boolean"
...
export namespace GlobPattern {
    ...
    export function from(pattern: vscode.GlobPattern | undefined | null): string | extHostProtocol.IRelativePatternDto | undefined | null {
        ...
        if (isRelativePatternShape(pattern) ||
    ...
    function isRelativePatternShape(obj: unknown): obj is {
        base: string;
        baseUri: URI;
        pattern: string;
    } {
    ...
    function isLegacyRelativePatternShape(obj: unknown): obj is {
        base: string;
        pattern: string;
    } {
...
export namespace NotebookCellExecutionSummary {
    export function to(data: notebooks.NotebookCellInternalMetadata): vscode.NotebookCellExecutionSummary {
        return {
            timing: typeof data.runStartTime === "number" &&
...
export namespace NotebookCellData {
    ...
    export function to(data: extHostProtocol.NotebookCellDataDto): vscode.NotebookCellData {
        return new types.NotebookCellData(NotebookCellKind.to(data.cellKind), data.source, data.language, data.mime, data.outputs ? data.outputs.map(NotebookCellOutput.to) : undefined, data.metadata, data.internalMetadata
...
export namespace NotebookExclusiveDocumentPattern {
    ...
    export function to(pattern: string | extHostProtocol.IRelativePatternDto | {
    ...
    function isExclusivePattern<T>(obj: any): obj is {
        include?: T;
        exclude?: T;
    } {
        const ep = obj as {
...
export namespace TestMessage {
    ...
    export function to(item: ITestErrorMessage.Serialized): vscode.TestMessage {
        const message = new types.TestMessage(typeof item.message === "string"
            ? item.message
...
export namespace TestCoverage {
    ...
    export function fromFile(controllerId: string, id: string, coverage: vscode.FileCoverage): IFileCoverage.Serialized {
        ...
        return {
            ...
            declaration: coverage.declarationCoverage &&
                fromCoverageCount(coverage.declarationCoverage),
            testIds: coverage instanceof types.FileCoverage &&
                coverage.fromTests.length
                ? coverage.fromTests.map((t) => TestId.fromExtHostTestItem(t, controllerId).toString())
                : undefined,
        };
    }
}
        ...
        return {
            ...
            fileData: fileValue
                ? {
                    name: fileValue.name,
                    uri: fileValue.uri,
                    id: (fileValue as types.DataTransferFile)._itemId ??
...
export namespace DataTransfer {
    ...
    export async function from(dataTransfer: Iterable<readonly [
        string,
        vscode.DataTransferItem | IDataTransferItem
...
export namespace ChatResponseReferencePart {
    ...
    export function to(part: Dto<IChatContentReference>): vscode.ChatResponseReferencePart {
        ...
        const mapValue = (value: URI | languages.Location): vscode.Uri | vscode.Location => URI.isUri(value) ? value : Location.to(value);
        return new types.ChatResponseReferencePart(typeof value.reference === "string"
            ...
            : "variableName" in value.reference
                ...
                : mapValue(value.reference)) as vscode.ChatResponseReferencePart; // 'value' is extended with variableName
    }
}
        ...
        return {
            ...
            value: isUriComponents(value)
                ...
                : value &&
                    ...
                    : variable.isImage
                        ? new types.ChatReferenceBinaryData(variable.mimeType ?? "image/png", () => Promise.resolve(new Uint8Array(Object.values(value))))
                        : value,
        ...
        if (event.action.kind === "command") {
            ...
            return {
                action: {
                    ...
                    outcome: event.action.outcome === "accepted"
