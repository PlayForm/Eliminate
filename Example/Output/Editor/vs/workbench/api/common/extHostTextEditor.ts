    ...
    public assign(newOptions: vscode.TextEditorOptions) {
        ...
        if (typeof newOptions.lineNumbers !== "undefined") {
            if (this._lineNumbers !== newOptions.lineNumbers) {
                ...
                hasUpdate = true;
                bulkConfigurationUpdate.lineNumbers =
                    TypeConverters.TextEditorLineNumbersStyle.from(newOptions.lineNumbers);
            }
        }
        if (hasUpdate) {
...
export class ExtHostTextEditor {
    ...
    constructor(readonly id: string, private readonly _proxy: MainThreadTextEditorsShape, private readonly _logService: ILogService, document: Lazy<vscode.TextDocument>, selections: Selection[], options: IResolvedTextEditorConfiguration, visibleRanges: Range[], viewColumn: vscode.ViewColumn | undefined) {
        ...
        this.value = Object.freeze({
            ...
            // --- snippet edit
            insertSnippet(snippet: SnippetString, where?: Position | readonly Position[] | Range | readonly Range[], options: {
                undoStopBefore: boolean;
                undoStopAfter: boolean;
            } = {
                undoStopBefore: true,
            ...
            setDecorations(decorationType: vscode.TextEditorDecorationType, ranges: Range[] | vscode.DecorationOptions[]): void {
                ...
                if (willBeEmpty &&
                    !that._hasDecorationsForKey.has(decorationType.key)) {
