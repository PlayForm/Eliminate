 ...
 * @deprecated
 */
type CompatLanguageModelToolInvocationOptions<T = any> = vscode.LanguageModelToolInvocationOptions<T> & {
    parameters?: any;
};
/**
 * @deprecated
 */
type CompactLanguageModelToolInvocationPrepareOptions<T> = vscode.LanguageModelToolInvocationPrepareOptions<T> & {
    parameters: any;
};
export class ExtHostLanguageModelTools implements ExtHostLanguageModelToolsShape {
    /** A map of tools that were registered in this EH */
    private readonly _registeredTools = new Map<string, {
    ...
    /* call ID */ string, (text: string, token?: vscode.CancellationToken) => Thenable<number>>();
    ...
    async invokeTool(toolId: string, options: CompatLanguageModelToolInvocationOptions<any>, token?: CancellationToken): Promise<vscode.LanguageModelToolResult> {
        ...
        if (options.toolInvocationToken &&
            !isToolInvocationContext(options.toolInvocationToken)) {
    ...
    async $invokeTool(dto: IToolInvocation, token: CancellationToken): Promise<IToolResult> {
        ...
        const options: CompatLanguageModelToolInvocationOptions<Object> = {
    ...
    async $prepareToolInvocation(toolId: string, parameters: any, token: CancellationToken): Promise<IPreparedToolInvocation | undefined> {
        ...
        const options: CompactLanguageModelToolInvocationPrepareOptions<any> = {
            parameters,
            input: parameters,
        };
        ...
        return {
            confirmationMessages: result.confirmationMessages
                ? {
                    ...
                    message: typeof result.confirmationMessages.message ===
                        "string"
