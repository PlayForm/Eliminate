...
export class ExtHostEditors extends Disposable implements ExtHostEditorsShape {
    ...
    constructor(mainContext: IMainContext, private readonly _extHostDocumentsAndEditors: ExtHostDocumentsAndEditors) {
        super();
        ...
        if (typeof columnOrOptions === "number") {
            ...
            options = {
                ...
                selection: typeof columnOrOptions.selection === "object"
                    ...
                    : undefined,
                pinned: typeof columnOrOptions.preview === "boolean"
