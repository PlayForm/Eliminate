...
import { extUri, extUriIgnorePathCase, IExtUri, } from "../../../base/common/resources.js";
...
export class ExtHostConsumerFileSystem {
    ...
    private readonly _fileSystemProvider = new Map<string, {
    ...
    fileSystemInfo: IExtHostFileSystemInfo) {
        ...
        this.value = Object.freeze({
            async stat(uri: vscode.Uri): Promise<vscode.FileStat> {
                try {
                    ...
                    return {
                        ...
                        mtime: stat.mtime,
                        size: stat.size,
                        permissions: stat.permissions === files.FilePermission.Readonly
                            ? 1
                            : undefined,
                    };
                }
            ...
            async writeFile(uri: vscode.Uri, content: Uint8Array): Promise<void> {
                try {
                    ...
                    if (provider && !provider.isReadonly) {
                        ...
                        return await that._writeQueue.queueFor(uri, () => Promise.resolve(provider.impl.writeFile(uri, content, {
                            create: true,
                            overwrite: true,
                        })));
                    }
            ...
            async copy(source: vscode.Uri, destination: vscode.Uri, options?: {
                overwrite?: boolean;
            }): Promise<void> {
                try {
                    // no shortcut: potentially involves different schemes, does mkdirp
