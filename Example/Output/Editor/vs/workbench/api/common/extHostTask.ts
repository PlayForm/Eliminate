...
import { ExtHostTaskShape, MainContext, MainThreadTaskShape, } from "./extHost.protocol.js";
...
export abstract class ExtHostTaskBase implements ExtHostTaskShape, IExtHostTask {
    ...
    public $provideTasks(handle: number, validTypes: {
        [key: string]: boolean;
    ...
    public abstract $resolveVariables(uriComponents: UriComponents, toResolve: {
        process?: {
            name: string;
            cwd?: string;
            path?: string;
