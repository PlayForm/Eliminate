...
export class ExtHostTerminalShellIntegration extends Disposable implements IExtHostTerminalShellIntegration {
    ...
    /*instanceId*/ number, InternalTerminalShellIntegration> = new Map();
...
class InternalTerminalShellIntegration extends Disposable {
    ...
    constructor(private readonly _terminal: vscode.Terminal, private readonly _onDidStartTerminalShellExecution: Emitter<vscode.TerminalShellExecutionStartEvent>) {
        super();
        const that = this;
        this.value = {
    ...
    startShellExecution(commandLine: vscode.TerminalShellExecutionCommandLine, cwd: URI | undefined, fireEventInMicrotask?: boolean): InternalTerminalShellExecution {
        if (this._ignoreNextExecution && this._currentExecution) {
            ...
            const currentExecution = (this._currentExecution =
                new InternalTerminalShellExecution(commandLine, cwd ?? this._cwd));
            if (fireEventInMicrotask) {
                queueMicrotask(() => this._onDidStartTerminalShellExecution.fire({
                    terminal: this._terminal,
                    shellIntegration: this.value,
...
class InternalTerminalShellExecution {
    ...
    constructor(private _commandLine: vscode.TerminalShellExecutionCommandLine, readonly cwd: URI | undefined) {
        const that = this;
        this.value = {
