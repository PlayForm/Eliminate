...
import { configurationDefaultsSchemaId, ConfigurationScope, Extensions, getAllConfigurationProperties, getDefaultValue, IConfigurationDefaults, IConfigurationDelta, IConfigurationNode, IConfigurationRegistry, OVERRIDE_PROPERTY_REGEX, parseScope, validateProperty, } from "../../../platform/configuration/common/configurationRegistry.js";
...
import { launchSchemaId, tasksSchemaId, workspaceSettingsSchemaId, } from "../../services/configuration/common/configuration.js";
import { Extensions as ExtensionFeaturesExtensions, IExtensionFeaturesRegistry, IExtensionFeatureTableRenderer, IRenderedData, IRowData, ITableData, } from "../../services/extensionManagement/common/extensionFeatures.js";
...
defaultConfigurationExtPoint.setHandler((extensions, { added, removed }) => {
    ...
    if (removed.length) {
        const removedDefaultConfigurations = removed.map<IConfigurationDefaults>((extension) => ({
