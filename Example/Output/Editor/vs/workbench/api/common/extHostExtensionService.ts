...
import { extUriBiasedIgnorePathCase, joinPath, originalFSPath, } from "../../../base/common/resources.js";
...
import { getRemoteAuthorityPrefix, IRemoteConnectionData, ManagedRemoteConnection, RemoteAuthorityResolverErrorCode, ResolvedAuthority, ResolvedOptions, TunnelInformation, WebSocketRemoteConnection, } from "../../../platform/remote/common/remoteAuthorityResolver.js";
...
import { ActivationKind, checkProposedApiEnabled, ExtensionActivationReason, isProposedApiEnabled, MissingExtensionDependency, } from "../../services/extensions/common/extensions.js";
import { Dto } from "../../services/extensions/common/proxyIdentifier.js";
import { checkActivateWorkspaceContainsExtension, IExtensionActivationHost, } from "../../services/extensions/common/workspaceContains.js";
...
import { ActivatedExtension, EmptyExtension, ExtensionActivationTimes, ExtensionActivationTimesBuilder, ExtensionActivationTimesFragment, ExtensionsActivator, HostExtension, IExtensionAPI, IExtensionModule, } from "./extHostExtensionActivator.js";
...
import { ExtensionKind, ExtensionMode, ExtensionRuntime, ManagedResolvedAuthority as ExtHostManagedResolvedAuthority, RemoteAuthorityResolverError, } from "./extHostTypes.js";
...
export abstract class AbstractExtHostExtensionService extends Disposable implements ExtHostExtensionServiceShape {
    ...
    @IExtHostRpcService
    extHostContext: IExtHostRpcService, 
    @IExtHostWorkspace
    ...
    storagePath: IExtensionStoragePaths, 
    @IExtHostTunnelService
    extHostTunnelService: IExtHostTunnelService, 
    ...
    private async _handleWorkspaceContainsEagerExtension(folders: ReadonlyArray<vscode.WorkspaceFolder>, desc: IExtensionDescription): Promise<void> {
        ...
        const localWithRemote = !this._initData.remote.isRemote &&
        ...
        return new Promise<number>((resolve, reject) => {
            const oldTestRunnerCallback = (error: Error, failures: number | undefined) => {
                if (error) {
                    ...
                    resolve(typeof failures === "number" && failures > 0
                        ? 1 /* ERROR */
                        : 0 /* OK */);
                }
            };
            ...
            if (runResult && runResult.then) {
                runResult
                    ...
                    reject(err instanceof Error && err.stack
                        ? err.stack
                        : String(err));
                });
            }
        ...
        const tunnelInformation: TunnelInformation = {
            ...
            features: result.tunnelFeatures
                ? {
                    ...
                    protocol: result.tunnelFeatures.protocol === undefined
                        ? true
...
function applyExtensionsDelta(activationEventsReader: SyncedActivationEventsReader, oldGlobalRegistry: ExtensionDescriptionRegistry, oldMyRegistry: ExtensionDescriptionRegistry, extensionsDelta: IExtensionDescriptionDelta) {
    ...
    const myExtensionsSet = new ExtensionIdentifierSet(oldMyRegistry
...
export class ExtensionPaths {
    constructor(private _searchTree: TernarySearchTree<URI, IExtensionDescription>) { }
