...
import { ILogger, ILoggerService, isLogLevel, LogLevel, } from "../../../platform/log/common/log.js";
...
export class ExtHostTelemetry extends Disposable implements ExtHostTelemetryShape {
    ...
    private updateLoggerVisibility(): void {
        this.loggerService.setVisibility(this.extHostTelemetryLogFile, this._telemetryIsSupported &&
...
export class ExtHostTelemetryLogger {
    static validateSender(sender: vscode.TelemetrySender): void {
        ...
        if (typeof sender.flush !== "undefined" &&
    ...
    constructor(sender: vscode.TelemetrySender, options: vscode.TelemetryLoggerOptions | undefined, private readonly _extension: IExtensionDescription, private readonly _logger: ILogger, private readonly _inLoggingOnlyMode: boolean, private readonly _commonProperties: Record<string, any>, telemetryEnablements: {
        isUsageEnabled: boolean;
        isErrorsEnabled: boolean;
    }) {
