...
const newCommands: ApiCommand[] = [
    ...
    new ApiCommand("vscode.executeSelectionRangeProvider", "_executeSelectionRangeProvider", "Execute selection range provider.", [
        ApiCommandArgument.Uri,
        new ApiCommandArgument<types.Position[], IPosition[]>("position", "A position in a text document", (v) => Array.isArray(v) &&
            v.every((v) => types.Position.isPosition(v)), (v) => v.map(typeConverters.Position.from)),
    ...
    ], new ApiCommandResult<IWorkspaceEditDto & {
        rejectReason?: string;
    ...
    new ApiCommand("vscode.executeCodeLensProvider", "_executeCodeLensProvider", "Execute code lens provider.", [
        ...
        return tryMapWith<languages.CodeLens, vscode.CodeLens>((item) => {
            return new types.CodeLens(typeConverters.Range.to(item.range), item.command &&
    ...
    new ApiCommand("vscode.executeCodeActionProvider", "_executeCodeActionProvider", "Execute code action provider.", [
        ...
        return tryMapWith<CustomCodeAction, vscode.CodeAction | vscode.Command | undefined>((codeAction) => {
            if (codeAction._isSynthetic) {
                ...
                const ret = new types.CodeAction(codeAction.title, codeAction.kind
    ...
    new ApiCommand("vscode.executeColorPresentationProvider", "_executeColorPresentationProvider", "Execute color presentation provider.", [
        ...
        new ApiCommandArgument<{
            ...
            uri: URI;
            range: IRange;
        }>("context", "Context object with uri and range", (_v) => true, (v) => ({
            uri: v.uri,
    ...
    new ApiCommand("vscode.executeInlineValueProvider", "_executeInlineValueProvider", "Execute inline value provider", [
        ApiCommandArgument.Uri,
        ApiCommandArgument.Range,
        new ApiCommandArgument<types.InlineValueContext, IInlineValueContextDto>("context", "An InlineValueContext", (v) => v &&
            typeof v.frameId === "number" &&
            v.stoppedLocation instanceof types.Range, (v) => typeConverters.InlineValueContext.from(v)),
    ...
    new ApiCommand("vscode.open", "_workbench.open", "Opens the provided resource in the editor. Can be a text or binary file, or an http(s) URL. If you need more control over the options for opening a text file, use vscode.window.showTextDocument instead.", [
        new ApiCommandArgument<URI | string>("uriOrString", "Uri-instance or string (only http/https)", (v) => URI.isUri(v) ||
            (typeof v === "string" &&
                matchesSomeScheme(v, Schemas.http, Schemas.https)), (v) => v),
        new ApiCommandArgument<vscode.ViewColumn | typeConverters.TextEditorOpenOptions | undefined, [
            vscode.ViewColumn?,
            ITextEditorOptions?
        ] | undefined>("columnOrOptions", "Either the column in which to open or editor options, see vscode.TextDocumentShowOptions", (v) => v === undefined ||
            typeof v === "number" ||
            typeof v === "object", (v) => !v
            ? v
            : typeof v === "number"
    ...
    new ApiCommand("vscode.diff", "_workbench.diff", "Opens the provided resources in the diff editor to compare their contents.", [
        ...
        new ApiCommandArgument<typeConverters.TextEditorOpenOptions | undefined, [
            number?,
            ITextEditorOptions?
        ] | undefined>("columnOrOptions", "Either the column in which to open or editor options, see vscode.TextDocumentShowOptions", (v) => v === undefined || typeof v === "object", (v) => v && [
            typeConverters.ViewColumn.from(v.viewColumn),
            typeConverters.TextEditorOpenOptions.from(v),
        ]).optional(),
    ], ApiCommandResult.Void),
