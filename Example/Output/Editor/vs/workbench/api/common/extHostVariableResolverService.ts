...
class ExtHostVariableResolverService extends AbstractVariableResolverService {
    constructor(extensionService: IExtHostExtensionService, workspaceService: IExtHostWorkspace, editorService: IExtHostDocumentsAndEditors, editorTabs: IExtHostEditorTabs, configProvider: ExtHostConfigProvider, context: DynamicContext, homeDir: string | undefined) {
...
export class ExtHostVariableResolverProviderService extends Disposable implements IExtHostVariableResolverProvider {
    ...
    @IExtHostEditorTabs
    private readonly editorTabs: IExtHostEditorTabs) {
        super();
    }
