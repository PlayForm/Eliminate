...
import { ExtHostWebview, ExtHostWebviews, serializeWebviewOptions, shouldSerializeBuffersForPostMessage, toExtensionData, } from "./extHostWebview.js";
...
class ExtHostWebviewPanel extends Disposable implements vscode.WebviewPanel {
    ...
    public reveal(viewColumn?: vscode.ViewColumn, preserveFocus?: boolean): void {
        ...
        this.#proxy.$reveal(this.#handle, {
            viewColumn: typeof viewColumn === "undefined"
                ? undefined
...
export class ExtHostWebviewPanels extends Disposable implements extHostProtocol.ExtHostWebviewPanelsShape {
    ...
    constructor(mainContext: extHostProtocol.IMainContext, private readonly webviews: ExtHostWebviews, private readonly workspace: IExtHostWorkspace | undefined) {
        super();
    ...
    public createWebviewPanel(extension: IExtensionDescription, viewType: string, title: string, showOptions: vscode.ViewColumn | {
        viewColumn: vscode.ViewColumn;
        preserveFocus?: boolean;
    }, options: vscode.WebviewPanelOptions & vscode.WebviewOptions = {}): vscode.WebviewPanel {
        const viewColumn = typeof showOptions === "object"
    ...
    public registerWebviewPanelSerializer(extension: IExtensionDescription, viewType: string, serializer: vscode.WebviewPanelSerializer): vscode.Disposable {
    ...
    async $deserializeWebviewPanel(webviewHandle: extHostProtocol.WebviewHandle, viewType: string, initData: {
        title: string;
        state: any;
