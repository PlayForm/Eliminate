...
import { ChatEditorTabInput, CustomEditorTabInput, InteractiveWindowInput, NotebookDiffEditorTabInput, NotebookEditorTabInput, TerminalEditorTabInput, TextDiffTabInput, TextMergeTabInput, TextMultiDiffTabInput, TextTabInput, WebviewEditorTabInput, } from "./extHostTypes.js";
...
class ExtHostEditorTabGroup {
    ...
    acceptTabOperation(operation: TabOperation): ExtHostEditorTab {
        ...
        else if (this._activeTabId === operation.tabDto.id &&
...
export class ExtHostEditorTabs implements IExtHostEditorTabs {
    ...
    $acceptTabGroupUpdate(groupDto: IEditorTabGroupDto) {
        ...
        this._onDidChangeTabGroups.fire(Object.freeze({
