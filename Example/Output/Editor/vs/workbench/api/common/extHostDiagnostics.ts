...
import { ExtHostDiagnosticsShape, IMainContext, MainContext, MainThreadDiagnosticsShape, } from "./extHost.protocol.js";
...
export class DiagnosticCollection implements vscode.DiagnosticCollection {
            ...
            if (diagnostics) {
                ...
                if (diagnostics.length > this._maxDiagnosticsPerFile) {
                    ...
                    marker.push({
                        ...
                        }, "Not showing {0} further errors and warnings.", diagnostics.length - this._maxDiagnosticsPerFile),
    ...
    *[Symbol.iterator](): IterableIterator<[
    ...
    private static _compareIndexedTuplesByUri(a: [
        vscode.Uri,
...
export class ExtHostDiagnostics implements ExtHostDiagnosticsShape {
    ...
    private readonly _fileSystemInfoService: IExtHostFileSystemInfo, private readonly _extHostDocumentsAndEditors: ExtHostDocumentsAndEditors) {
