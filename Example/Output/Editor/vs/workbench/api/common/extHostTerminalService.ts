...
import { ICreateContributedTerminalProfileOptions, IProcessProperty, IProcessPropertyMap, IProcessReadyEvent, IShellLaunchConfigDto, ITerminalChildProcess, ITerminalLaunchError, ITerminalProfile, ProcessPropertyType, TerminalIcon, TerminalLocation, } from "../../../platform/terminal/common/terminal.js";
import { TerminalDataBufferer } from "../../../platform/terminal/common/terminalDataBuffering.js";
import { ISerializedTerminalInstanceContext } from "../../contrib/terminal/common/terminal.js";
import { EditorGroupColumn } from "../../services/editor/common/editorGroupColumn.js";
import { ExtHostTerminalIdentifier, ExtHostTerminalServiceShape, ICommandDto, ITerminalCommandDto, ITerminalDimensionsDto, ITerminalLinkDto, ITerminalQuickFixOpenerDto, ITerminalQuickFixTerminalCommandDto, MainContext, MainThreadTerminalServiceShape, TerminalCommandMatchResultDto, } from "./extHost.protocol.js";
import { IExtHostCommands } from "./extHostCommands.js";
import { IExtHostRpcService } from "./extHostRpcService.js";
import { TerminalQuickFix, ViewColumn } from "./extHostTypeConverters.js";
import { EnvironmentVariableMutatorType, TerminalExitReason, Disposable as VSCodeDisposable, } from "./extHostTypes.js";
...
export class ExtHostTerminal extends Disposable {
    ...
    constructor(private _proxy: MainThreadTerminalServiceShape, public _id: ExtHostTerminalIdentifier, private readonly _creationOptions: vscode.TerminalOptions | vscode.ExtensionTerminalOptions, private _name?: string) {
        super();
    ...
    public async create(options: vscode.TerminalOptions, internalOptions?: ITerminalInternalOptions): Promise<void> {
    ...
    private _serializeParentTerminal(location?: TerminalLocation | vscode.TerminalEditorLocationOptions | vscode.TerminalSplitLocationOptions, parentTerminal?: ExtHostTerminalIdentifier): TerminalLocation | {
...
export abstract class BaseExtHostTerminalService extends Disposable implements IExtHostTerminalService, ExtHostTerminalServiceShape {
    ...
    constructor(supportsProcesses: boolean, 
    @IExtHostCommands
    ...
    public createExtensionTerminal(options: vscode.ExtensionTerminalOptions, internalOptions?: ITerminalInternalOptions): vscode.Terminal {
        ...
        terminal
            .createExtensionTerminal(options.location, internalOptions, this._serializeParentTerminal(options, internalOptions)
            .resolvedExtHostIdentifier, asTerminalIcon(options.iconPath), asTerminalColor(options.color))
            .then((id) => {
    ...
    public $acceptProcessRequestCwd(id: number): void {
        this._terminalProcesses
            .get(id)
            ?.getCwd()
            .then((cwd) => this._proxy.$sendProcessProperty(id, {
    ...
    public $initEnvironmentVariableCollections(collections: [
        string,
...
class UnifiedEnvironmentVariableCollection extends Disposable {
    ...
    private _setIfDiffers(variable: string, mutator: vscode.EnvironmentVariableMutator & {
    ...
    clear(scope: vscode.EnvironmentVariableScope | undefined): void {
        if (scope?.workspaceFolder) {
            for (const [key, mutator] of this.map) {
                if (mutator.scope?.workspaceFolder?.index ===
...
function asTerminalIcon(iconPath?: vscode.Uri | {
    light: vscode.Uri;
    dark: vscode.Uri;
