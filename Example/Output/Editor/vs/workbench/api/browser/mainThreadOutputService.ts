...
import { Extensions, IOutputChannel, IOutputChannelRegistry, IOutputService, OUTPUT_VIEW_ID, OutputChannelUpdateMode, } from "../../services/output/common/output.js";
import { IViewsService } from "../../services/views/common/viewsService.js";
import { ExtHostContext, ExtHostOutputServiceShape, MainContext, MainThreadOutputServiceShape, } from "../common/extHost.protocol.js";
...
export class MainThreadOutputService extends Disposable implements MainThreadOutputServiceShape {
    ...
    public async $register(label: string, file: UriComponents, languageId: string | undefined, extensionId: string): Promise<string> {
        const idCounter = (MainThreadOutputService._extensionIdPool.get(extensionId) || 0) +
            1;
