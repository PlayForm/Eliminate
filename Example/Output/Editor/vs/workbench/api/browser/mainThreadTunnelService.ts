...
import { ITunnelProvider, ITunnelService, PortAttributesProvider, ProvidedPortAttributes, RemoteTunnel, TunnelCreationOptions, TunnelOptions, TunnelProtocol, TunnelProviderFeatures, } from "../../../platform/tunnel/common/tunnel.js";
...
import { CandidatePort, forwardedPortsFeaturesEnabled, makeAddress, TunnelCloseReason, TunnelSource, } from "../../services/remote/common/tunnelModel.js";
import { CandidatePortSource, ExtHostContext, ExtHostTunnelServiceShape, MainContext, MainThreadTunnelServiceShape, PortAttributesSelector, TunnelDto, } from "../common/extHost.protocol.js";
    ...
    async providePortAttributes(ports: number[], pid: number | undefined, commandLine: string | undefined, token: CancellationToken): Promise<ProvidedPortAttributes[]> {
        ...
        const appropriateHandles = Array.from(this.portsAttributesProviders.entries())
            ...
            const portInRange = portRange
                ...
                : true;
            const commandMatches = !selector.commandPattern ||
            ...
            forwardPort: (tunnelOptions: TunnelOptions, tunnelCreationOptions: TunnelCreationOptions) => {
                ...
                return forward.then((tunnelOrError) => {
                    ...
                    return {
                        ...
                        tunnelLocalPort: typeof tunnel.localAddress !== "string"
