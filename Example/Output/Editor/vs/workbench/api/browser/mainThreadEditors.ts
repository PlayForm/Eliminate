...
import { EditorActivation, EditorResolution, IResourceEditorInput, ITextEditorOptions, } from "../../../platform/editor/common/editor.js";
...
export class MainThreadTextEditors implements MainThreadTextEditorsShape {
    ...
    private _textEditorsListenersMap: {
        [editorId: string]: IDisposable[];
    };
    private _editorPositionData: ITextEditorPositionData | null;
    private _registeredDecorationTypes: {
        [decorationType: string]: boolean;
    };
    constructor(private readonly _editorLocator: IMainThreadEditorLocator, extHostContext: IExtHostContext, 
    @ICodeEditorService
