...
import { isUntitledWorkspace, IWorkspace, IWorkspaceContextService, WorkbenchState, WorkspaceFolder, } from "../../../platform/workspace/common/workspace.js";
...
export class MainThreadWorkspace implements MainThreadWorkspaceShape {
    ...
    // --- save & edit resources ---
    async $save(uriComponents: UriComponents, options: {
        saveAs: boolean;
