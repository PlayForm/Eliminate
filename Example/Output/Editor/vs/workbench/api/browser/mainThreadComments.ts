...
import { IViewContainersRegistry, IViewDescriptorService, IViewsRegistry, ViewContainer, ViewContainerLocation, Extensions as ViewExtensions, } from "../../common/views.js";
...
import { CommentProviderFeatures, CommentThreadChanges, ExtHostCommentsShape, ExtHostContext, MainContext, MainThreadCommentsShape, } from "../common/extHost.protocol.js";
export class MainThreadCommentThread<T> implements languages.CommentThread<T> {
    ...
    constructor(public commentThreadHandle: number, public controllerHandle: number, public extensionId: string, public threadId: string, public resource: string, private _range: T | undefined, comments: languages.Comment[] | undefined, private _canReply: boolean, private _isTemplate: boolean, public editorId?: string) {
...
export class MainThreadCommentController implements ICommentController {
    ...
    constructor(private readonly _proxy: ExtHostCommentsShape, private readonly _commentService: ICommentService, private readonly _handle: number, private readonly _uniqueId: string, private readonly _id: string, private readonly _label: string, private _features: CommentProviderFeatures) { }
    get activeComment() {
