...
import { MainContext, MainThreadMessageOptions, MainThreadMessageServiceShape, } from "../common/extHost.protocol.js";
...
export class MainThreadMessageService implements MainThreadMessageServiceShape {
    ...
    private _showMessage(severity: Severity, message: string, commands: {
        title: string;
        isCloseAffordance: boolean;
        handle: number;
    }[], options: MainThreadMessageOptions): Promise<number | undefined> {
    ...
    private async _showModalMessage(severity: Severity, message: string, detail: string | undefined, commands: {
        title: string;
        isCloseAffordance: boolean;
        handle: number;
