...
export class MainThreadChatTask implements IChatTask {
    ...
    public get onDidAddProgress(): Event<IChatWarningMessage | IChatContentReference> {
...
export class MainThreadChatAgents2 extends Disposable implements MainThreadChatAgentsShape2 {
    ...
    /* requestId */ string, Map</* id */ string, IChatContentInlineReference>>();
    ...
    async $handleProgressChunk(requestId: string, progress: IChatProgressDto, responsePartHandle?: number): Promise<number | void> {
        ...
        if (revivedProgress.kind === "inlineReference" &&
            revivedProgress.resolveId) {
    ...
    $registerAgentCompletionsProvider(handle: number, id: string, triggerCharacters: string[]): void {
        ...
        this._agentCompletionProviders.set(handle, this._languageFeaturesService.completionProvider.register({
                            ...
                            arguments: [
                                {
                                    ...
                                    variableData: revive(v.value) as any,
                                    command: v.command,
    ...
    $registerChatParticipantDetectionProvider(handle: number): void {
        this._chatParticipantDetectionProviders.set(handle, this._chatAgentService.registerChatParticipantDetectionProvider(handle, {
            provideParticipantDetection: async (request: IChatAgentRequest, history: IChatAgentHistoryEntry[], options: {
...
function computeCompletionRanges(model: ITextModel, position: Position, reg: RegExp): {
    insert: Range;
    replace: Range;
} | undefined {
