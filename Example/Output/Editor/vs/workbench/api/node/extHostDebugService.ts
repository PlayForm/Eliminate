...
class DebugTerminalCollection {
    ...
    private _terminalInstances = new Map<vscode.Terminal, {
        lastUsedAt: number;
        config: string;
    }>();
