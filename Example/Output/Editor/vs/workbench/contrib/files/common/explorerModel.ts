...
import { equalsIgnoreCase, rtrim, startsWithIgnoreCase, } from "../../../../base/common/strings.js";
import { assertIsDefined } from "../../../../base/common/types.js";
import { URI } from "../../../../base/common/uri.js";
import { IConfigurationService } from "../../../../platform/configuration/common/configuration.js";
import { FileSystemProviderCapabilities, IFileService, IFileStat, } from "../../../../platform/files/common/files.js";
...
export class ExplorerModel implements IDisposable {
    ...
    constructor(private readonly contextService: IWorkspaceContextService, private readonly uriIdentityService: IUriIdentityService, fileService: IFileService, configService: IConfigurationService, filesConfigService: IFilesConfigurationService) {
...
export class ExplorerItem {
    ...
    constructor(public resource: URI, private readonly fileService: IFileService, private readonly configService: IConfigurationService, private readonly filesConfigService: IFilesConfigurationService, private _parent: ExplorerItem | undefined, private _isDirectory?: boolean, private _isSymbolicLink?: boolean, private _readonly?: boolean, private _locked?: boolean, private _name: string = basenameOrAuthority(resource), private _mtime?: number, private _unknown = false) {
    ...
    private getPlatformAwareName(name: string): string {
        return this.fileService.hasCapability(this.resource, FileSystemProviderCapabilities.PathCaseSensitive)
            ? name
            : name.toLowerCase();
    }
    /**
