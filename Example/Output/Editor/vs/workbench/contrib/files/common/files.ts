...
import { FileChangeType, IFileService, IFilesConfiguration as PlatformIFilesConfiguration, } from "../../../../platform/files/common/files.js";
import { EditorResourceAccessor, IEditorIdentifier, IWorkbenchEditorConfiguration, SideBySideEditor, } from "../../../common/editor.js";
...
export const FoldersViewVisibleContext = new RawContextKey<boolean>("foldersViewVisible", true, {
    type: "boolean",
...
export const ExplorerResourceParentReadOnlyContext = new RawContextKey<boolean>("explorerResourceParentReadonly", false, {
    type: "boolean",
...
export const ViewHasSomeCollapsibleRootItemContext = new RawContextKey<boolean>("viewHasSomeCollapsibleItem", false, {
    type: "boolean",
