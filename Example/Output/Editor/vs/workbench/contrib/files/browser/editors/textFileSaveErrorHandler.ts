...
import { INotificationActions, INotificationHandle, INotificationService, Severity, } from "../../../../../platform/notification/common/notification.js";
...
import { ISaveErrorHandler, ITextFileEditorModel, ITextFileSaveAsOptions, ITextFileSaveOptions, ITextFileService, } from "../../../../services/textfile/common/textfiles.js";
...
class SaveModelElevatedAction extends Action {
    constructor(private model: ITextFileEditorModel, private options: ITextFileSaveOptions, private triedToUnlock: boolean) {
...
class RetrySaveModelAction extends Action {
    constructor(private model: ITextFileEditorModel, private options: ITextFileSaveOptions) {
