...
import { CLOSE_EDITOR_COMMAND_ID, CLOSE_EDITORS_IN_GROUP_COMMAND_ID, CLOSE_OTHER_EDITORS_IN_GROUP_COMMAND_ID, CLOSE_SAVED_EDITORS_COMMAND_ID, REOPEN_WITH_COMMAND_ID, } from "../../../browser/parts/editor/editorCommands.js";
import { ActiveEditorAvailableEditorIdsContext, ActiveEditorCanRevertContext, ActiveEditorContext, DirtyWorkingCopiesContext, EnterMultiRootWorkspaceSupportContext, HasWebFileSystemAccess, MultipleEditorsSelectedInGroupContext, ResourceContextKey, SelectedEditorsInGroupFileOrUntitledResourceContextKey, SidebarFocusContext, TwoEditorsSelectedInGroupContext, WorkbenchStateContext, WorkspaceFolderCountContext, } from "../../../common/contextkeys.js";
import { AutoSaveAfterShortDelayContext } from "../../../services/filesConfiguration/common/filesConfigurationService.js";
import { ExplorerFolderContext, ExplorerResourceAvailableEditorIdsContext, ExplorerResourceCut, ExplorerResourceMoveableToTrash, ExplorerResourceNotReadonlyContext, ExplorerRootContext, FilesExplorerFocusCondition, FoldersViewVisibleContext, } from "../common/files.js";
import { acceptLocalChangesCommand, CONFLICT_RESOLUTION_CONTEXT, revertLocalChangesCommand, } from "./editors/textFileSaveErrorHandler.js";
import { CompareNewUntitledTextFilesAction, CompareWithClipboardAction, COPY_FILE_LABEL, copyFileHandler, cutFileHandler, deleteFileHandler, DOWNLOAD_COMMAND_ID, DOWNLOAD_LABEL, FileCopiedContext, FocusFilesExplorer, GlobalCompareResourcesAction, MOVE_FILE_TO_TRASH_LABEL, moveFileToTrashHandler, NEW_FILE_COMMAND_ID, NEW_FILE_LABEL, NEW_FOLDER_COMMAND_ID, NEW_FOLDER_LABEL, OpenActiveFileInEmptyWorkspace, openFilePreserveFocusHandler, PASTE_FILE_LABEL, pasteFileHandler, renameHandler, ResetActiveEditorReadonlyInSession, SetActiveEditorReadonlyInSession, SetActiveEditorWriteableInSession, ShowActiveFileInExplorer, ToggleActiveEditorReadonlyInSession, ToggleAutoSaveAction, TRIGGER_RENAME_LABEL, UPLOAD_COMMAND_ID, UPLOAD_LABEL, } from "./fileActions.js";
import { newWindowCommand, openWindowCommand } from "./fileCommands.js";
import { COMPARE_RESOURCE_COMMAND_ID, COMPARE_SELECTED_COMMAND_ID, COMPARE_WITH_SAVED_COMMAND_ID, COPY_PATH_COMMAND_ID, COPY_RELATIVE_PATH_COMMAND_ID, NEW_UNTITLED_FILE_COMMAND_ID, NEW_UNTITLED_FILE_LABEL, OPEN_TO_SIDE_COMMAND_ID, OPEN_WITH_EXPLORER_COMMAND_ID, OpenEditorsDirtyEditorContext, OpenEditorsGroupContext, OpenEditorsReadonlyEditorContext, OpenEditorsSelectedFileOrUntitledContext, REMOVE_ROOT_FOLDER_COMMAND_ID, REMOVE_ROOT_FOLDER_LABEL, ResourceSelectedForCompareContext, REVEAL_IN_EXPLORER_COMMAND_ID, REVERT_FILE_COMMAND_ID, SAVE_ALL_COMMAND_ID, SAVE_ALL_IN_GROUP_COMMAND_ID, SAVE_FILE_AS_COMMAND_ID, SAVE_FILE_AS_LABEL, SAVE_FILE_COMMAND_ID, SAVE_FILE_LABEL, SAVE_FILE_WITHOUT_FORMATTING_COMMAND_ID, SAVE_FILE_WITHOUT_FORMATTING_LABEL, SAVE_FILES_COMMAND_ID, SELECT_FOR_COMPARE_COMMAND_ID, } from "./fileConstants.js";
...
export function appendEditorTitleContextMenuItem(id: string, title: string, when: ContextKeyExpression | undefined, group: string, supportsMultiSelect: boolean, order?: number): void {
    const precondition = supportsMultiSelect !== true
