...
import { DEFAULT_EDITOR_ASSOCIATION, EditorInputCapabilities, findViewStateForEditor, GroupIdentifier, IEditorDescriptor, IEditorPane, IFileEditorInput, IFileEditorInputOptions, IMoveResult, isResourceEditorInput, IUntypedEditorInput, IUntypedFileEditorInput, Verbosity, } from "../../../../common/editor.js";
...
import { EncodingMode, ITextFileEditorModel, ITextFileService, TextFileEditorModelState, TextFileOperationError, TextFileOperationResult, TextFileResolveReason, } from "../../../../services/textfile/common/textfiles.js";
import { BINARY_FILE_EDITOR_ID, FILE_EDITOR_INPUT_ID, TEXT_FILE_EDITOR_ID, } from "../../common/files.js";
...
export class FileEditorInput extends AbstractTextResourceEditorInput implements IFileEditorInput {
    ...
    override isSaving(): boolean {
        if (this.model?.hasState(TextFileEditorModelState.SAVED) ||
        ...
        try {
            ...
            if (!this.cachedTextFileModelReference) {
                this.cachedTextFileModelReference =
                    (await this.textModelService.createModelReference(this.resource)) as IReference<ITextFileEditorModel>;
            }
            ...
            if ((<TextFileOperationError>error).textFileOperationResult ===
