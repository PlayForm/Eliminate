...
export class ExplorerService implements IExplorerService {
    ...
    private readonly telemetryService: ITelemetryService) {
        ...
        this.revealExcludeMatcher = new ResourceGlobMatcher((uri) => getRevealExcludes(configurationService.getValue<IFilesConfiguration>({ resource: uri })), (event) => event.affectsConfiguration('explorer.autoRevealExclude'), contextService, configurationService);
