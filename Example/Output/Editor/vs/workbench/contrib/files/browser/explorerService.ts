...
import { FileChangesEvent, FileChangeType, FileOperation, FileOperationEvent, IFileService, IResolveFileOptions, } from "../../../../platform/files/common/files.js";
import { IProgressCompositeOptions, IProgressOptions, IProgressService, ProgressLocation, } from "../../../../platform/progress/common/progress.js";
...
import { IFilesConfiguration, ISortOrderConfiguration, LexicographicOptions, SortOrder, } from "../common/files.js";
...
export class ExplorerService implements IExplorerService {
    ...
    private readonly telemetryService: ITelemetryService) {
        ...
        this.disposables.add(Event.any<{
            scheme: string;
        }>(this.fileService.onDidChangeFileSystemProviderRegistrations, this.fileService.onDidChangeFileSystemProviderCapabilities)(async (e) => {
            let affected = false;
        ...
        this.revealExcludeMatcher = new ResourceGlobMatcher((uri) => getRevealExcludes(configurationService.getValue<IFilesConfiguration>({
            resource: uri,
    ...
    async applyBulkEdit(edit: ResourceFileEdit[], options: {
        undoLabel: string;
    ...
    async refresh(reveal = true): Promise<void> {
        ...
        if (this.view) {
            ...
            const autoReveal = this.configurationService.getValue<IFilesConfiguration>()
                .explorer.autoReveal;
    ...
    private async onDidRunOperation(e: FileOperationEvent): Promise<void> {
        ...
        // Add
        if (e.isOperation(FileOperation.CREATE) ||
    ...
    private async onConfigurationUpdated(event: IConfigurationChangeEvent): Promise<void> {
        ...
        if (this.config.sortOrderLexicographicOptions !==
...
function getRevealExcludes(configuration: IFilesConfiguration): IExpression {
    const revealExcludes = configuration &&
