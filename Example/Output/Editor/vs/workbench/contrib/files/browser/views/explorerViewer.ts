...
import { ElementsDragAndDropData, ExternalElementsDragAndDropData, ListViewTargetSector, NativeDragAndDropData, } from "../../../../../base/browser/ui/list/listView.js";
import { IListAccessibilityProvider } from "../../../../../base/browser/ui/list/listWidget.js";
import { ITreeCompressionDelegate } from "../../../../../base/browser/ui/tree/asyncDataTree.js";
import { ICompressedTreeNode } from "../../../../../base/browser/ui/tree/compressedObjectTreeModel.js";
import { ICompressibleTreeRenderer } from "../../../../../base/browser/ui/tree/objectTree.js";
import { IAsyncDataSource, ITreeDragAndDrop, ITreeDragOverReaction, ITreeFilter, ITreeNode, ITreeSorter, TreeDragOverBubble, TreeVisibility, } from "../../../../../base/browser/ui/tree/tree.js";
import { mainWindow } from "../../../../../base/browser/window.js";
import { timeout } from "../../../../../base/common/async.js";
import { compareFileExtensionsDefault, compareFileExtensionsLower, compareFileExtensionsUnicode, compareFileExtensionsUpper, compareFileNamesDefault, compareFileNamesLower, compareFileNamesUnicode, compareFileNamesUpper, } from "../../../../../base/common/comparers.js";
...
import { dirname, distinctParents, joinPath, } from "../../../../../base/common/resources.js";
...
import { FileChangeType, FileKind, FileOperationError, FileOperationResult, IFileService, } from "../../../../../platform/files/common/files.js";
...
import { explorerFileContribRegistry, IExplorerFileContribution, } from "../explorerFileContrib.js";
...
export class ExplorerDataSource implements IAsyncDataSource<ExplorerItem | ExplorerItem[], ExplorerItem> {
    constructor(private fileFilter: FilesFilter, 
    @IProgressService
    ...
    hasChildren(element: ExplorerItem | ExplorerItem[]): boolean {
        ...
        return (Array.isArray(element) ||
            element.hasChildren((stat) => this.fileFilter.filter(stat, TreeVisibility.Visible)));
    }
...
export class FilesRenderer implements ICompressibleTreeRenderer<ExplorerItem, FuzzyScore, IFileTemplateData>, IListAccessibilityProvider<ExplorerItem>, IDisposable {
    ...
    constructor(container: HTMLElement, private labels: ResourceLabels, private updateWidth: (stat: ExplorerItem) => void, 
    @IContextViewService
    ...
    renderCompressedElements(node: ITreeNode<ICompressedTreeNode<ExplorerItem>, FuzzyScore>, index: number, templateData: IFileTemplateData, height: number | undefined): void {
        ...
        const editableData = editable.length === 0
            ? undefined
    ...
    private renderStat(stat: ExplorerItem, label: string | string[], domId: string | undefined, filterData: FuzzyScore | undefined, templateData: IFileTemplateData): void {
        ...
        const themeIsUnhappyWithNesting = theme.hasFileIcons &&
    ...
    getActiveDescendantId(stat: ExplorerItem): string | undefined {
        return (this.compressedNavigationControllers.get(stat)?.[0]?.currentId ??
            undefined);
    }
    dispose(): void {
...
export class FilesFilter implements ITreeFilter<ExplorerItem, FuzzyScore> {
    ...
    private async processIgnoreFile(root: string, ignoreFileResource: URI, update?: boolean) {
        ...
        if (update) {
            ...
            if (!this.ignoreFileResourcesPerRoot
                .get(root)
    ...
    private isVisible(stat: ExplorerItem, parentVisibility: TreeVisibility): boolean {
        ...
        const isIgnoredByIgnoreFile = isIncludedInTraversal === undefined
            ? false
            : !isIncludedInTraversal;
        if (isIgnoredByIgnoreFile || globMatch || stat.parent?.isExcluded) {
            stat.isExcluded = true;
            const editors = this.editorService.visibleEditors;
            const editor = editors.find((e) => e.resource &&
                this.uriIdentityService.extUri.isEqualOrParent(e.resource, stat.resource));
            if (editor &&
                stat.root ===
...
export class FileDragAndDrop implements ITreeDragAndDrop<ExplorerItem> {
    ...
    constructor(private isCollapsed: (item: ExplorerItem) => boolean, 
    @IExplorerService
    ...
    private handleDragOver(data: IDragAndDropData, target: ExplorerItem | undefined, targetIndex: number | undefined, targetSector: ListViewTargetSector | undefined, originalEvent: DragEvent): boolean | ITreeDragOverReaction {
        ...
        const effectType = isNative || isCopy
        ...
        // All (target = file/folder)
            ...
            if (this.contextService
                .getWorkspace()
                .folders.every((folder) => folder.uri.toString() !==
    ...
    async drop(data: IDragAndDropData, target: ExplorerItem | undefined, targetIndex: number | undefined, targetSector: ListViewTargetSector | undefined, originalEvent: DragEvent): Promise<void> {
        ...
        if (!target) {
            target =
                this.explorerService.roots[this.explorerService.roots.length - 1];
    ...
    private async handleExplorerDrop(data: ElementsDragAndDropData<ExplorerItem, ExplorerItem[]>, target: ExplorerItem, targetIndex: number | undefined, targetSector: ListViewTargetSector | undefined, originalEvent: DragEvent): Promise<void> {
        ...
        const isCopy = (originalEvent.ctrlKey && !isMacintosh) ||
            (originalEvent.altKey && isMacintosh);
        // Handle confirm setting
        const confirmDragAndDrop = !isCopy &&
            this.configurationService.getValue<boolean>(FileDragAndDrop.CONFIRM_DND_SETTING_KEY);
    ...
    private async doHandleExplorerDropOnCopy(sources: ExplorerItem[], target: ExplorerItem): Promise<void> {
        ...
        await this.explorerService.applyBulkEdit(resourceFileEdits, {
            confirmBeforeUndo: explorerConfig.confirmUndo === UndoConfirmLevel.Default ||
    ...
    private async doHandleExplorerDropOnMove(sources: ExplorerItem[], target: ExplorerItem): Promise<void> {
        ...
        const labelSuffix = getFileOrFolderLabelSuffix(sources);
        const options = {
            confirmBeforeUndo: this.configurationService.getValue<IFilesConfiguration>()
    ...
    private static getStatsFromDragAndDropData(data: ElementsDragAndDropData<ExplorerItem, ExplorerItem[]>, dragStartEvent?: DragEvent): ExplorerItem[] {
        ...
        if (dragStartEvent && data.elements.length === 1) {
            data.context = [
                FileDragAndDrop.getCompressedStatFromDragEvent(data.elements[0], dragStartEvent),
            ];
            return data.context;
        }
...
function getIconLabelNameFromHTMLElement(target: HTMLElement | EventTarget | Element | null): {
    element: HTMLElement;
    count: number;
    index: number;
} | null {
    ...
    while (element && !element.classList.contains("monaco-list-row")) {
        if (element.classList.contains("label-name") &&
