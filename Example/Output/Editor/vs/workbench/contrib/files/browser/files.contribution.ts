...
import { Extensions as ConfigurationExtensions, ConfigurationScope, IConfigurationPropertySchema, IConfigurationRegistry, } from "../../../../platform/configuration/common/configurationRegistry.js";
import { AutoSaveConfiguration, FILES_ASSOCIATIONS_CONFIG, FILES_EXCLUDE_CONFIG, FILES_READONLY_EXCLUDE_CONFIG, FILES_READONLY_FROM_PERMISSIONS_CONFIG, FILES_READONLY_INCLUDE_CONFIG, HotExitConfiguration, } from "../../../../platform/files/common/files.js";
...
import { EditorExtensions, IEditorFactoryRegistry, IFileEditorInput, } from "../../../common/editor.js";
...
import { BINARY_TEXT_FILE_MODE, FILE_EDITOR_INPUT_ID, IFilesConfiguration, LexicographicOptions, SortOrder, UndoConfirmLevel, } from "../common/files.js";
...
Registry.as<IEditorPaneRegistry>(EditorExtensions.EditorPane).registerEditorPane(EditorPaneDescriptor.create(TextFileEditor, TextFileEditor.ID, nls.localize("textFileEditor", "Text File Editor")), [new SyncDescriptor(FileEditorInput)]);
Registry.as<IEditorPaneRegistry>(EditorExtensions.EditorPane).registerEditorPane(EditorPaneDescriptor.create(BinaryFileEditor, BinaryFileEditor.ID, nls.localize("binaryFileEditor", "Binary File Editor")), [new SyncDescriptor(FileEditorInput)]);
...
UndoCommand.addImplementation(110, "explorer", (accessor: ServicesAccessor) => {
    ...
    const explorerCanUndo = configurationService.getValue<IFilesConfiguration>().explorer
        .enableUndo;
