...
import { IListContextMenuEvent, IListDragAndDrop, IListDragOverReaction, IListRenderer, IListVirtualDelegate, ListDragOverEffectPosition, ListDragOverEffectType, } from "../../../../../base/browser/ui/list/list.js";
...
import { ActionRunner, IAction, WorkbenchActionExecutedClassification, WorkbenchActionExecutedEvent, } from "../../../../../base/common/actions.js";
import { RunOnceScheduler } from "../../../../../base/common/async.js";
import { Codicon } from "../../../../../base/common/codicons.js";
import { compareFileNamesDefault } from "../../../../../base/common/comparers.js";
import { memoize } from "../../../../../base/common/decorators.js";
import { KeyCode, KeyMod } from "../../../../../base/common/keyCodes.js";
import { DisposableMap, dispose, IDisposable, } from "../../../../../base/common/lifecycle.js";
...
import { fillEditorsDragData, ResourcesDropHandler, } from "../../../../browser/dnd.js";
...
import { MultipleEditorGroupsContext, ResourceContextKey, } from "../../../../common/contextkeys.js";
import { EditorCloseMethod, EditorResourceAccessor, GroupModelChangeKind, IEditorIdentifier, preventEditorClose, SideBySideEditor, Verbosity, } from "../../../../common/editor.js";
import { EditorInput } from "../../../../common/editor/editorInput.js";
import { IViewDescriptorService } from "../../../../common/views.js";
import { GroupOrientation, GroupsOrder, IEditorGroup, IEditorGroupsService, } from "../../../../services/editor/common/editorGroupsService.js";
...
import { ExplorerFocusedContext, IFilesConfiguration, OpenEditor, OpenEditorsFocusedContext, } from "../../common/files.js";
import { CloseGroupAction, SaveAllInGroupAction } from "../fileActions.js";
import { NEW_UNTITLED_FILE_COMMAND_ID, OpenEditorsDirtyEditorContext, OpenEditorsGroupContext, OpenEditorsReadonlyEditorContext, OpenEditorsSelectedFileOrUntitledContext, SAVE_ALL_COMMAND_ID, SAVE_ALL_LABEL, } from "../fileConstants.js";
const $ = dom.$;
export class OpenEditorsView extends ViewPane {
    ...
    protected override renderBody(container: HTMLElement): void {
        ...
        this.list = this.instantiationService.createInstance(WorkbenchList, "OpenEditors", container, delegate, [
            ...
            identityProvider: {
                getId: (element: OpenEditor | IEditorGroup) => element instanceof OpenEditor
                    ? element.getId()
                    : element.id.toString(),
            },
            dnd: this.dnd,
    ...
    private getIndex(group: IEditorGroup, editor: EditorInput | undefined | null): number {
        ...
        return this.elements.findIndex((e) => e instanceof OpenEditor &&
            e.editor === editor &&
            e.group.id === group.id);
    }
    private openEditor(element: OpenEditor, options: {
    ...
    private getMaxExpandedBodySize(): number {
        ...
        return (Math.max(this.elementCount, minVisibleOpenEditors) *
...
class EditorGroupRenderer implements IListRenderer<IEditorGroup, IEditorGroupTemplateData> {
    ...
    constructor(private keybindingService: IKeybindingService, private instantiationService: IInstantiationService) {
        // noop
    }
    get templateId() {
        return EditorGroupRenderer.ID;
...
class OpenEditorRenderer implements IListRenderer<OpenEditor, IOpenEditorTemplateData> {
    ...
    constructor(private labels: ResourceLabels, private instantiationService: IInstantiationService, private keybindingService: IKeybindingService, private configurationService: IConfigurationService) {
        // noop
    }
    get templateId() {
        return OpenEditorRenderer.ID;
    ...
    renderElement(openedEditor: OpenEditor, _index: number, templateData: IOpenEditorTemplateData): void {
        ...
        templateData.root.setResource({
            ...
            fileDecorations: this.configurationService.getValue<IFilesConfiguration>()
...
class OpenEditorsDragAndDrop implements IListDragAndDrop<OpenEditor | IEditorGroup> {
    ...
    constructor(sortOrder: "editorOrder" | "alphabetical" | "fullPath", private instantiationService: IInstantiationService, private editorGroupService: IEditorGroupsService) {
        this._sortOrder = sortOrder;
    }
    @memoize
    private get dropHandler(): ResourcesDropHandler {
    ...
    drop(data: IDragAndDropData, targetElement: OpenEditor | IEditorGroup | undefined, _targetIndex: number, targetSector: ListViewTargetSector | undefined, originalEvent: DragEvent): void {
        let group = targetElement instanceof OpenEditor
            ? targetElement.group
            : targetElement ||
                this.editorGroupService.groups[this.editorGroupService.count - 1];
        ...
        switch (targetSector) {
            case ListViewTargetSector.TOP:
            case ListViewTargetSector.CENTER_TOP:
                if (targetElement instanceof EditorGroupView &&
                    group.index !== 0) {
...
registerAction2(class extends Action2 {
    ...
    async run(accessor: ServicesAccessor): Promise<void> {
        ...
        const newOrientation = editorGroupService.orientation === GroupOrientation.VERTICAL
