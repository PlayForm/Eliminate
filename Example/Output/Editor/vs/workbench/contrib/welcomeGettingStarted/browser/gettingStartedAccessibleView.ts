...
import { AccessibleContentProvider, AccessibleViewProviderId, AccessibleViewType, ExtensionContentProvider, IAccessibleViewContentProvider, } from "../../../../platform/accessibility/browser/accessibleView.js";
...
class GettingStartedAccessibleProvider extends Disposable implements IAccessibleViewContentProvider {
    ...
    constructor(private contextService: IContextKeyService, private readonly _gettingStartedPage: GettingStartedPage, private readonly _focusedItem: IResolvedWalkthrough, private readonly _focusedStep?: string | undefined) {
        super();
        this._activeWalkthroughSteps = _focusedItem.steps.filter((step) => !step.when ||
