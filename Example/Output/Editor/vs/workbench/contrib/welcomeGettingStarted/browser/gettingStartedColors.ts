...
import { contrastBorder, darken, editorWidgetBackground, inputBackground, lighten, registerColor, textLinkForeground, } from "../../../../platform/theme/common/colorRegistry.js";
...
export const welcomePageTileBorder = registerColor("welcomePage.tileBorder", {
    dark: "#ffffff1a",
    light: "#0000001a",
