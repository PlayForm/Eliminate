...
import { findMatchingThemeRule, ThemeRule, } from "../../../services/textMate/common/TMHelper.js";
...
async function captureTokens(accessor: ServicesAccessor, resource: URI | undefined, treeSitter: boolean = false) {
    ...
    if (!resource) {
        ...
        const file = editorService.activeEditor
            ? EditorResourceAccessor.getCanonicalUri(editorService.activeEditor, { filterByScheme: Schemas.file })
            : null;
        if (file) {
