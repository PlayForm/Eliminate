...
export const JavaLibrariesToLookFor: {
    ...
    {
        "predicate": (groupId, artifactId) => groupId === "com.microsoft.azure" &&
            artifactId.startsWith("azure-mgmt-"),
        "tag": "azure",
    },
    {
        "predicate": (groupId, artifactId) => groupId.startsWith("com.microsoft.azure") &&
            artifactId.startsWith("azure-mgmt-"),
        "tag": "azure",
    },
    {
        "predicate": (groupId, artifactId) => groupId === "com.azure.resourcemanager" &&
    ...
    {
        "predicate": (groupId, artifactId) => groupId === "com.microsoft.sqlserver" &&
            artifactId === "mssql-jdbc",
        "tag": "jdbc",
    },
    {
        "predicate": (groupId, artifactId) => groupId === "com.oracle.database.jdbc" &&
    ...
    {
        "predicate": (groupId, artifactId) => groupId === "org.eclipse.persistence" &&
    ...
    // redis
    {
        "predicate": (groupId, artifactId) => groupId === "org.springframework.data" &&
    ...
    // unit test
    {
        "predicate": (groupId, artifactId) => groupId === "org.junit.jupiter" &&
    ...
    // service bus
    {
        "predicate": (groupId, artifactId) => groupId === "com.azure" &&
    ...
    {
        "predicate": (groupId, artifactId) => groupId === "com.azure" &&
            artifactId === "azure-ai-anomalydetector",
    ...
    {
        "predicate": (groupId, artifactId) => groupId === "com.azure" &&
            artifactId === "azure-ai-documentintelligence",
        "tag": "azure-ai-documentintelligence",
    },
    {
        "predicate": (groupId, artifactId) => groupId === "com.azure" &&
            artifactId === "azure-ai-translation-document",
    ...
    {
        "predicate": (groupId, artifactId) => groupId === "com.azure" &&
            artifactId === "azure-ai-translation-text",
    ...
    {
        "predicate": (groupId, artifactId) => groupId === "com.azure" &&
            artifactId === "azure-ai-vision-imageanalysis",
    ...
    {
        "predicate": (groupId, artifactId) => groupId === "com.azure" &&
            artifactId === "azure-ai-documenttranslator",
    ...
    {
        "predicate": (groupId, artifactId) => groupId === "com.azure" &&
            artifactId === "azure-ai-openai-assistants",
    ...
    // Azure Functions
    {
        "predicate": (groupId, artifactId) => groupId === "com.microsoft.azure.functions" &&
