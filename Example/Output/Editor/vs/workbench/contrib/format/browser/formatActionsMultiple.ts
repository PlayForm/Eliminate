...
Registry.as<IWorkbenchContributionsRegistry>(WorkbenchExtensions.Workbench).registerWorkbenchContribution(DefaultFormatter, LifecyclePhase.Restored);
...
function logFormatterTelemetry<T extends {
    extensionId?: ExtensionIdentifier;
}>(telemetryService: ITelemetryService, mode: 'document' | 'range', options: T[], pick?: T) {
    type FormatterPicks = {
        mode: 'document' | 'range';
        extensions: string[];
        pick: string;
