...
import { ICommonModel, WorkerTextModelSyncServer, } from "../../../../editor/common/services/textModelSync/textModelSync.impl.js";
...
export class OutputLinkComputer implements IRequestHandler {
    ...
    static createPatterns(workspaceFolder: URI): RegExp[] {
        ...
        const workspaceFolderPath = workspaceFolder.scheme === Schemas.file
