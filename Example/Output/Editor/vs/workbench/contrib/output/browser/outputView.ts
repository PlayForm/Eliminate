...
import { CONTEXT_IN_OUTPUT, CONTEXT_OUTPUT_SCROLL_LOCK, IOutputChannel, OUTPUT_VIEW_ID, } from "../../../services/output/common/output.js";
export class OutputViewPane extends ViewPane {
    ...
    hoverService: IHoverService) {
        ...
        const editorInstantiationService = this._register(instantiationService.createChild(new ServiceCollection([
            IContextKeyService,
