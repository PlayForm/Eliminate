...
import { ILoggerService, ILogService, LogLevelToString, } from "../../../../platform/log/common/log.js";
import { Registry } from "../../../../platform/registry/common/platform.js";
import { IStorageService, StorageScope, StorageTarget, } from "../../../../platform/storage/common/storage.js";
import { ILifecycleService } from "../../../services/lifecycle/common/lifecycle.js";
import { ACTIVE_OUTPUT_CHANNEL_CONTEXT, CONTEXT_ACTIVE_FILE_OUTPUT, CONTEXT_ACTIVE_OUTPUT_LEVEL, CONTEXT_ACTIVE_OUTPUT_LEVEL_IS_DEFAULT, CONTEXT_ACTIVE_OUTPUT_LEVEL_SETTABLE, Extensions, IOutputChannel, IOutputChannelDescriptor, IOutputChannelRegistry, IOutputService, LOG_MIME, OUTPUT_MIME, OUTPUT_VIEW_ID, OutputChannelUpdateMode, } from "../../../services/output/common/output.js";
...
class OutputChannel extends Disposable implements IOutputChannel {
    ...
    languageService: ILanguageService) {
        ...
        this.model = this._register(outputChannelModelService.createOutputChannelModel(this.id, this.uri, outputChannelDescriptor.languageId
            ? languageService.createById(outputChannelDescriptor.languageId)
            : languageService.createByMimeType(outputChannelDescriptor.log
                ? LOG_MIME
                : OUTPUT_MIME), outputChannelDescriptor.file));
    }
...
export class OutputService extends Disposable implements IOutputService, ITextModelContentProvider {
    ...
    private readonly defaultLogLevelsService: IDefaultLogLevelsService) {
        ...
        if (!this.activeChannel) {
            ...
            this.setActiveChannel(channels && channels.length > 0
    ...
    private setLevelContext(): void {
        ...
        const channelLogLevel = descriptor?.log
            ...
            : undefined;
        this.activeOutputChannelLevelContext.set(channelLogLevel !== undefined
    ...
    private setActiveChannel(channel: OutputChannel | undefined): void {
        ...
        this.activeOutputChannelLevelSettableContext.set(descriptor !== undefined &&
