...
import { IViewContainersRegistry, IViewsRegistry, ViewContainer, Extensions as ViewContainerExtensions, ViewContainerLocation, } from "../../../common/views.js";
...
import { ACTIVE_OUTPUT_CHANNEL_CONTEXT, CONTEXT_ACTIVE_FILE_OUTPUT, CONTEXT_ACTIVE_OUTPUT_LEVEL, CONTEXT_ACTIVE_OUTPUT_LEVEL_IS_DEFAULT, CONTEXT_ACTIVE_OUTPUT_LEVEL_SETTABLE, CONTEXT_IN_OUTPUT, CONTEXT_OUTPUT_SCROLL_LOCK, Extensions, IFileOutputChannelDescriptor, IOutputChannelDescriptor, IOutputChannelRegistry, IOutputService, LOG_MIME, LOG_MODE_ID, OUTPUT_MIME, OUTPUT_MODE_ID, OUTPUT_VIEW_ID, } from "../../../services/output/common/output.js";
                ...
                async run(accessor: ServicesAccessor): Promise<void> {
                    ...
                    if (channel) {
                        ...
                        if (channelDescriptor?.log &&
                            ...
                            return accessor
                                .get(ILoggerService)
                                .setLogLevel(channelDescriptor.file, logLevel);
                        }
                    }
                }
            }));
                ...
                if (channel) {
                    ...
                    if (channelDescriptor?.log &&
                        ...
                        return await accessor
                            ...
                            .setDefaultLogLevel(logLevel, channelDescriptor.extensionId);
                    }
                }
            }
        }));
        ...
        this._register(registerAction2(class extends Action2 {
            ...
            async run(accessor: ServicesAccessor, args?: unknown): Promise<void> {
                ...
                if (!entry) {
                    ...
                    entry = <IOutputChannelQuickPickItem | undefined>(await quickInputService.pick(entries, {
