...
import { Command, CompletionContext, CompletionItem, CompletionItemInsertTextRule, CompletionItemKind, CompletionItemLabel, CompletionItemProvider, CompletionList, CompletionTriggerKind, } from "../../../../editor/common/languages.js";
...
export class SnippetCompletionProvider implements CompletionItemProvider {
    ...
    async provideCompletionItems(model: ITextModel, position: Position, context: CompletionContext): Promise<CompletionList> {
        ...
        for (const snippet of snippets) {
            ...
            let endColumn = endsWithPrefixRest === 0
        ...
        if (!triggerCharacterLow &&
            ...
            for (const snippet of snippets) {
                ...
                const replace = lineContentLow.indexOf(snippet.prefixLow, columnOffset) ===
                    columnOffset
