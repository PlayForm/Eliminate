            ...
            for (const extension of extensions) {
                for (const contribution of extension.value) {
                    ...
                    if (file) {
                        ...
                        const file = new SnippetFile(SnippetSource.Extension, validContribution.location, validContribution.language
                            ? [validContribution.language]
                            : undefined, extension.description, this._fileService, this._extensionResourceLoaderService);
