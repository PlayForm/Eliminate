...
import { combinedDisposable, DisposableStore, dispose, MutableDisposable, } from "../../../../base/common/lifecycle.js";
    ...
    private readonly _labelService: ILabelService) {
        ...
        this._store.add(_configService.onDidChangeConfiguration((e) => {
            if (!e.affectsConfiguration(key) &&
                !e.affectsConfiguration(InlineChatConfigKeys.AcceptedOrDiscardBeforeSave)) {
                return;
            }
            if (this._isDisabled()) {
