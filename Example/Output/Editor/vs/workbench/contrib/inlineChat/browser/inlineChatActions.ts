            ...
            menu: [
                {
                    ...
                    group: "0_main",
                    order: 2,
                    when: ContextKeyExpr.and(ChatContextKeys.inputHasText.toNegated(), CTX_INLINE_CHAT_REQUEST_IN_PROGRESS.negate(), CTX_INLINE_CHAT_RESPONSE_TYPE.isEqualTo(InlineChatResponseType.MessagesAndEdits), CTX_INLINE_CHAT_EDIT_MODE.isEqualTo(EditMode.Live)),
                },
                {
                    id: MENU_INLINE_CHAT_ZONE,
                    group: "navigation",
            ...
            menu: [
                {
                    ...
                    group: "0_main",
                    order: 1,
                    when: ContextKeyExpr.and(CTX_INLINE_CHAT_REQUEST_IN_PROGRESS.negate(), ContextKeyExpr.or(CTX_INLINE_CHAT_RESPONSE_TYPE.isEqualTo(InlineChatResponseType.Messages), CTX_INLINE_CHAT_EDIT_MODE.isEqualTo(EditMode.Preview))),
                },
            ],
        });
    }
