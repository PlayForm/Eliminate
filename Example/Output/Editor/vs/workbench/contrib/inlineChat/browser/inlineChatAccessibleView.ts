...
export class InlineChatAccessibleView implements IAccessibleViewImplentation {
    ...
    getProvider(accessor: ServicesAccessor) {
        ...
        return new AccessibleContentProvider(AccessibleViewProviderId.InlineChat, { type: AccessibleViewType.View }, () => renderMarkdownAsPlaintext(new MarkdownString(responseContent), true), () => controller.focus(), AccessibilityVerbositySettingId.InlineChat);
    }
}
