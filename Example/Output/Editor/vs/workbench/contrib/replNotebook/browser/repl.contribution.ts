...
Registry.as<IEditorPaneRegistry>(EditorExtensions.EditorPane).registerEditorPane(EditorPaneDescriptor.create(ReplEditor, REPL_EDITOR_ID, "REPL Editor"), [new SyncDescriptor(ReplEditorInput)]);
Registry.as<IEditorFactoryRegistry>(EditorExtensions.EditorFactory).registerEditorSerializer(ReplEditorInput.ID, ReplEditorSerializer);
    ...
    private readonly configurationService: IConfigurationService) {
        ...
        ` `, {
            ...
            createUntitledEditorInput: async ({ resource, options }) => {
                ...
                return {
                    editor: this.instantiationService.createInstance(ReplEditorInput, resource!, label),
                    options,
                };
            },
...
class ReplWindowWorkingCopyEditorHandler extends Disposable implements IWorkbenchContribution, IWorkingCopyEditorHandler {
    ...
    isOpen(workingCopy: IWorkingCopyIdentifier, editor: EditorInput): boolean {
        ...
        return (editor instanceof ReplEditorInput &&
...
async function executeReplInput(bulkEditService: IBulkEditService, historyService: IInteractiveHistoryService, notebookEditorService: INotebookEditorService, editorControl: ReplEditorControl) {
    if (editorControl &&
