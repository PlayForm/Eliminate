...
import { IModelDecorationOptions, IModelDeltaDecoration, OverviewRulerLane, TrackedRangeStickiness, } from "../../../../editor/common/model.js";
...
export class TypeHierarchyTreePeekWidget extends peekView.PeekViewWidget {
    ...
    constructor(editor: ICodeEditor, private readonly _where: IPosition, private _direction: TypeHierarchyDirection, 
    @IThemeService
    ...
    private async _updatePreview() {
        ...
        if (this._direction === TypeHierarchyDirection.Supertypes) {
            ...
            previewUri = element.parent
                ? element.parent.item.uri
                : element.model.root.uri;
        }
        else {
