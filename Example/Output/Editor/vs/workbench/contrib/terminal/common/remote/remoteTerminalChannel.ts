...
export class RemoteTerminalChannelClient implements IPtyHostController {
    ...
    constructor(private readonly _remoteAuthority: string, private readonly _channel: IChannel, 
    ...
    async createProcess(shellLaunchConfig: IShellLaunchConfigDto, configuration: ICompleteTerminalConfiguration, activeWorkspaceRootUri: URI | undefined, options: ITerminalProcessOptions, shouldPersistTerminal: boolean, cols: number, rows: number, unicodeVersion: '6' | '11'): Promise<ICreateTerminalProcessResult> {
