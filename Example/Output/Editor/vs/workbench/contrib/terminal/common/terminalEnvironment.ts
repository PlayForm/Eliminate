...
import { IProcessEnvironment, isMacintosh, isWindows, language, OperatingSystem, } from "../../../../base/common/platform.js";
    ...
    if (os === OperatingSystem.Windows) {
        ...
        if (shellType !== undefined) {
            if (shellType === WindowsShellType.GitBash) {
                ...
                return (backend?.getWslPath(originalPath, "win-to-unix") ||
                    originalPath);
            }
            else if (hasSpace) {
                return `"${originalPath}"`;
