...
export class TerminalEditorService extends Disposable implements ITerminalEditorService {
    ...
    contextKeyService: IContextKeyService) {
        ...
        this._register(this._editorService.onDidActiveEditorChange(() => {
            ...
            const instance = activeEditor instanceof TerminalEditorInput
        ...
        this._register(this._editorService.onDidVisibleEditorsChange(() => {
            ...
            const unknownEditor = terminalEditors.find((input) => {
                const inputId = input instanceof TerminalEditorInput
            ...
            if (unknownEditor instanceof TerminalEditorInput &&
        ...
        this._register(this._editorService.onDidCloseEditor((e) => {
            const instance = e.editor instanceof TerminalEditorInput
                ? e.editor.terminalInstance
                : undefined;
            if (instance) {
                const instanceIndex = this.instances.findIndex((e) => e === instance);
                if (instanceIndex !== -1) {
                    const wasActiveInstance = this.instances[instanceIndex] ===
                        this.activeInstance;
    ...
    private _getActiveTerminalEditors(): EditorInput[] {
        return this._editorService.visibleEditors.filter((e) => e instanceof TerminalEditorInput &&
