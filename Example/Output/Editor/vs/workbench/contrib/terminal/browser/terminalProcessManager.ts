...
export class TerminalProcessManager extends Disposable implements ITerminalProcessManager {
    ...
    get shouldPersist(): boolean {
        return (!!this.reconnectionProperties ||
    ...
    get reconnectionProperties(): IReconnectionProperties | undefined {
        return (this._shellLaunchConfig?.attachPersistentProcess
    ...
    constructor(private readonly _instanceId: number, cwd: string | URI | undefined, environmentVariableCollections: ReadonlyMap<string, IEnvironmentVariableCollection> | undefined, shellIntegrationNonce: string | undefined, 
    @IHistoryService
    ...
    private readonly _notificationService: INotificationService) {
        ...
        this._register(this._dataFilter.onProcessData((ev) => {
            ...
            if (beforeProcessDataEvent.data &&
                ...
                this._onProcessData.fire(typeof ev !== "string"
                    ? ev
                    : {
        ...
        if (environmentVariableCollections) {
            this._extEnvironmentVariableCollection =
                new MergedEnvironmentVariableCollection(environmentVariableCollections);
            this._register(this._environmentVariableService.onDidChangeCollections((newCollection) => this._onEnvironmentVariableCollectionChange(newCollection)));
            this.environmentVariableInfo =
                this._instantiationService.createInstance(EnvironmentVariableInfoChangesActive, this._extEnvironmentVariableCollection);
    ...
    async createProcess(shellLaunchConfig: IShellLaunchConfig, cols: number, rows: number, reset: boolean = true): Promise<ITerminalLaunchError | {
        injectedArgs: string[];
    } | undefined> {
        ...
        if (shellLaunchConfig.customPtyImplementation) {
            ...
            if (!!this.remoteAuthority) {
                ...
                const shouldPersist = ((this._configurationService.getValue(TaskSettingId.Reconnection) &&
                ...
                if (!newProcess) {
                    ...
                    const options: ITerminalProcessOptions = {
                        ...
                        windowsEnableConpty: this._terminalConfigurationService.config
                            .windowsEnableConpty,
                        windowsUseConptyDll: this._terminalConfigurationService.config
                    ...
                    try {
                        ...
                        cols, rows, this._terminalConfigurationService.config
                            .unicodeVersion, env, // TODO:
    ...
    async relaunch(shellLaunchConfig: IShellLaunchConfig, cols: number, rows: number, reset: boolean): Promise<ITerminalLaunchError | {
        injectedArgs: string[];
    } | undefined> {
        this.ptyProcessReady = this._createPtyProcessReadyPromise();
    ...
    private async _launchLocalProcess(backend: ITerminalBackend, shellLaunchConfig: IShellLaunchConfig, cols: number, rows: number, userHome: string | undefined, variableResolver: terminalEnvironment.VariableResolver | undefined): Promise<ITerminalChildProcess> {
        await this._terminalProfileResolverService.resolveShellLaunchConfig(shellLaunchConfig, {
        ...
        const options: ITerminalProcessOptions = {
            ...
            windowsUseConptyDll: this._terminalConfigurationService.config.experimental
    ...
    private _onEnvironmentVariableCollectionChange(newCollection: IMergedEnvironmentVariableCollection): void {
        ...
        if (diff === undefined) {
            ...
            if (this.environmentVariableInfo instanceof
        ...
        this.environmentVariableInfo =
            this._instantiationService.createInstance(EnvironmentVariableInfoStale, diff, this._instanceId, newCollection);
        this._onEnvironmentVariableInfoChange.fire(this.environmentVariableInfo);
    }
...
class SeamlessRelaunchDataFilter extends Disposable {
    ...
    private _createRecorder(process: ITerminalChildProcess): [
        TerminalRecorder,
        IDisposable
    ] {
