...
import { ITerminalProfile, TerminalLocation, TerminalSettingId, } from "../../../../platform/terminal/common/terminal.js";
...
export class TerminalViewPane extends ViewPane {
    ...
    private readonly _accessibilityService: IAccessibilityService) {
        ...
        this._register(this._configurationService.onDidChangeConfiguration((e) => {
            if (this._parentDomElement &&
                (e.affectsConfiguration(TerminalSettingId.ShellIntegrationDecorationsEnabled) ||
    ...
    private _gutterDecorationsEnabled(): boolean {
        ...
        return ((decorationsEnabled === "both" ||
    ...
    protected override renderBody(container: HTMLElement): void {
        ...
        this._register(this.configurationService.onDidChangeConfiguration((e) => {
            if (e.affectsConfiguration(TerminalSettingId.FontFamily) ||
            ...
            case TerminalCommandId.New: {
                if (action instanceof MenuItemAction) {
                    ...
                    this._newDropdown.value =
                        new DropdownWithPrimaryActionViewItem(action, actions.dropdownAction, actions.dropdownMenuActions, actions.className, { hoverDelegate: options.hoverDelegate }, this._contextMenuService, this._keybindingService, this._notificationService, this._contextKeyService, this._themeService, this._accessibilityService);
    ...
    private _getKeybindingLabel(action: IAction): string | undefined {
        return (this._keybindingService.lookupKeybinding(action.id)?.getLabel() ??
            undefined);
    }
...
class SwitchTerminalActionViewItem extends SelectActionViewItem {
    ...
    terminalProfileService: ITerminalProfileService) {
        super(null, action, getTerminalSelectOpenItems(_terminalService, _terminalGroupService), _terminalGroupService.activeGroupIndex, contextViewService, defaultSelectBoxStyles, {
...
class SingleTerminalTabActionViewItem extends MenuEntryActionViewItem {
    ...
    constructor(action: MenuItemAction, private readonly _actions: IAction[], 
    @IKeybindingService
    keybindingService: IKeybindingService, 
    @INotificationService
    ...
    private readonly _terminalService: ITerminalService, 
    @ITerminalConfigurationService
    private readonly _terminaConfigurationService: ITerminalConfigurationService, 
    @ITerminalGroupService
    private readonly _terminalGroupService: ITerminalGroupService, 
    @IContextMenuService
    ...
    _accessibilityService: IAccessibilityService) {
        ...
        this._register(Event.debounce<ITerminalInstance | undefined, Set<ITerminalInstance>>(Event.any(this._terminalService.onAnyInstancePrimaryStatusChange, this._terminalGroupService.onDidChangeActiveInstance, Event.map(this._terminalService.onAnyInstanceIconChange, (e) => e.instance), this._terminalService.onAnyInstanceTitleChange, this._terminalService.onDidChangeInstanceCapability), (last, e) => {
            if (!last) {
                last = new Set();
            }
            if (e) {
