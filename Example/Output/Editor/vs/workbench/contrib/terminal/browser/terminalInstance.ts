...
import { AutoOpenBarrier, Barrier, disposableTimeout, Promises, timeout, } from "../../../../base/common/async.js";
...
import { Disposable, DisposableStore, dispose, IDisposable, ImmortalReference, MutableDisposable, toDisposable, type IReference, } from "../../../../base/common/lifecycle.js";
...
import { getXtermScaledDimensions, XtermTerminal, } from "./xterm/xtermTerminal.js";
...
export class TerminalInstance extends Disposable implements ITerminalInstance {
    ...
    get reconnectionProperties(): IReconnectionProperties | undefined {
        return (this.shellLaunchConfig.attachPersistentProcess
    ...
    get description(): string | undefined {
        ...
        const type = this.shellLaunchConfig.attachPersistentProcess?.type ||
    ...
    private readonly _onIconChanged = this._register(new Emitter<{
    ...
    constructor(private readonly _terminalShellTypeContextKey: IContextKey<string>, private _shellLaunchConfig: IShellLaunchConfig, 
    @IContextKeyService
    ...
    private readonly _viewDescriptorService: IViewDescriptorService) {
        ...
        this._xtermReadyPromise
            ...
            if (this.shellLaunchConfig.attachPersistentProcess) {
                ...
                this._setTitle(this.shellLaunchConfig.attachPersistentProcess.title, this.shellLaunchConfig.attachPersistentProcess
                    .titleSource);
        ...
        this._register(this._configurationService.onDidChangeConfiguration(async (e) => {
            ...
            if (e.affectsConfiguration(TerminalSettingId.TerminalTitle) ||
    ...
    private _getDimension(width: number, height: number): ICanvasDimensions | undefined {
        ...
        TerminalInstance._lastKnownCanvasDimensions = new dom.Dimension(Math.min(Constants.MaxCanvasWidth, width - horizontalPadding), height -
            verticalPadding +
    ...
    protected async _createXterm(): Promise<XtermTerminal | undefined> {
        ...
        disposableTimeout(() => {
            this._register(xterm.raw.onBell(() => {
                if (this._configurationService.getValue(TerminalSettingId.EnableBell) ||
                    this._configurationService.getValue(TerminalSettingId.EnableVisualBell)) {
                    this.statusList.add({
    ...
    private _open(): void {
        ...
        xterm.raw.attachCustomKeyEventHandler((event: KeyboardEvent): boolean => {
            ...
            if (resolveResult.kind === ResultKind.KbFound &&
    ...
    private _setShellIntegrationContextKey(): void {
        if (this.xterm) {
            this._terminalShellIntegrationEnabledContextKey.set(this.xterm.shellIntegration.status ===
    ...
    private _refreshAltBufferContextKey() {
        this._terminalAltBufferActiveContextKey.set(!!(this.xterm &&
    ...
    protected _createProcessManager(): TerminalProcessManager {
        ...
        if (this.shellLaunchConfig.attachPersistentProcess
            ...
            deserializedCollections = deserializeEnvironmentVariableCollections(this.shellLaunchConfig.attachPersistentProcess
                .environmentVariableCollections);
        }
        const processManager = this._scopedInstantiationService.createInstance(TerminalProcessManager, this._instanceId, this.shellLaunchConfig?.cwd, deserializedCollections, this.shellLaunchConfig.attachPersistentProcess
        ...
        this._register(processManager.onProcessReady(async (e) => {
            ...
            if (!this._labelComputer) {
                ...
                this._register(this._labelComputer.onDidChangeLabel((e) => {
                    const wasChanged = this._title !== e.title ||
                    ...
                    this._xtermReadyPromise.then((xterm) => {
                        if (xterm) {
                            this._messageTitleDisposable.value =
                                xterm.raw.onTitleChange((e) => this._onTitleChange(e));
                        }
                    });
                });
    ...
    private async _createProcess(): Promise<void> {
        ...
        await this._processManager
            .createProcess(this._shellLaunchConfig, this._cols || Constants.DefaultCols, this._rows || Constants.DefaultRows)
            .then((result) => {
            if (result) {
        ...
        if (waitOnExit &&
            ...
            this._xtermReadyPromise.then((xterm) => {
                ...
                switch (typeof waitOnExit) {
                    case "string":
                        xterm.raw.write(formatMessageForTerminal(waitOnExit, {
            ...
            if (exitMessage) {
                const failedDuringLaunch = this._processManager.processState ===
                    ProcessState.KilledDuringLaunch;
                if (failedDuringLaunch ||
                    ...
                    this._notificationService.notify({
                        ...
                        actions: {
                            primary: [
                                this._scopedInstantiationService.createInstance(TerminalLaunchHelpAction),
                            ],
                        },
                    });
                }
    ...
    async reuseTerminal(shell: IShellLaunchConfig, reset: boolean = false): Promise<void> {
        ...
        await this._processManager
            .relaunch(this._shellLaunchConfig, this._cols || Constants.DefaultCols, this._rows || Constants.DefaultRows, reset)
            .then((result) => {
            if (result) {
                if ("message" in result) {
                    this._onProcessExit(result);
    ...
    private _setAriaLabel(xterm: XTermTerminal | undefined, terminalId: number, title: string | undefined): void {
        ...
        if (xterm && xterm.textarea) {
            ...
            const accessibilityHelpKeybinding = this._keybindingService
                ...
                ?.getLabel();
            if (this._configurationService.getValue(AccessibilityVerbositySettingId.Terminal) &&
    ...
    async handleMouseEvent(event: MouseEvent, contextMenu: IMenu): Promise<{
...
class TerminalInstanceDragAndDropController extends Disposable implements dom.IDragAndDropObserverCallbacks {
    ...
    async onDrop(e: DragEvent) {
        ...
        if (!path &&
            ...
            getPathForFile(e.dataTransfer.files[0])) {
...
export class TerminalLabelComputer extends Disposable {
    ...
    private readonly _onDidChangeLabel = this._register(new Emitter<{
        title: string;
        description: string;
    }>());
    ...
    computeLabel(instance: Pick<ITerminalInstance, "shellLaunchConfig" | "cwd" | "fixedCols" | "fixedRows" | "initialCwd" | "processName" | "sequence" | "userHome" | "workspaceFolder" | "staticTitle" | "capabilities" | "title" | "description">, labelTemplate: string, labelType: TerminalLabelType, reset?: boolean) {
        const type = instance.shellLaunchConfig.attachPersistentProcess?.type ||
        ...
        const detection = instance.capabilities.has(TerminalCapability.CwdDetection) ||
        ...
        if (templateProperties.cwd &&
            ...
            if (multiRootWorkspace) {
                ...
                showCwd =
                    cwdUri.fsPath.localeCompare(instance.workspaceFolder.uri.fsPath, undefined, { sensitivity: caseSensitive ? "case" : "base" }) !== 0;
            }
            if (showCwd) {
        ...
        const label = template(labelTemplate, templateProperties as unknown as {
...
export function parseExitResult(exitCodeOrError: ITerminalLaunchError | number | undefined, shellLaunchConfig: IShellLaunchConfig, processState: ProcessState, initialCwd: string | undefined): {
    ...
    const code = typeof exitCodeOrError === "number"
        ? exitCodeOrError
    ...
    switch (typeof exitCodeOrError) {
        ...
        case "object": {
            ...
            if (conptyError) {
                const errorCode = conptyError.length > 1
...
export class TerminalInstanceColorProvider implements IXtermColorProvider {
    constructor(private readonly _target: IReference<TerminalLocation | undefined>, 
    @IViewDescriptorService
    private readonly _viewDescriptorService: IViewDescriptorService) { }
