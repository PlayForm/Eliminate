...
import { IKeyMods, IPickOptions, IQuickInputButton, IQuickInputService, IQuickPickItem, IQuickPickSeparator, } from "../../../../platform/quickinput/common/quickInput.js";
...
import { createColorStyleElement, getColorClass, getUriClasses, } from "./terminalIcon.js";
...
export class TerminalProfileQuickpick {
    ...
    private _createProfileQuickPickItem(profile: ITerminalProfile): IProfileQuickPickItem {
        ...
        const icon = profile.icon && ThemeIcon.isThemeIcon(profile.icon)
            ? profile.icon
            : Codicon.terminal;
