...
import { IExtensionTerminalProfile, IShellLaunchConfig, ITerminalExecutable, ITerminalProfile, ITerminalProfileObject, TerminalSettingId, TerminalSettingPrefix, } from "../../../../platform/terminal/common/terminal.js";
...
export class TerminalProfileService extends Disposable implements ITerminalProfileService {
    ...
    /*ext id*/ string, Map</*provider id*/ string, ITerminalProfileProvider>> = new Map();
    ...
    private async _detectProfiles(includeDetectedProfiles?: boolean): Promise<ITerminalProfile[]> {
        ...
        this._defaultProfileName =
            this._configurationService.getValue(`${TerminalSettingPrefix.DefaultProfile}${platform}`) ?? undefined;
