...
import { InternalTestItem, ITestItem, ITestRunProfile, TestRunProfileBitset, testRunProfileBitsetList, } from "./testTypes.js";
 ...
 */
export const canUseProfileWithTest = (profile: ITestRunProfile, test: InternalTestItem) => profile.controllerId === test.controllerId &&
 ...
 * them.
 */
export const capabilityContextKeys = (capabilities: number): [
    key: string,
    value: boolean
][] => [
    [
