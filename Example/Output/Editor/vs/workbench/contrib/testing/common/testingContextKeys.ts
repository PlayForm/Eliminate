...
export namespace TestingContextKeys {
    ...
    export const canRefreshTests = new RawContextKey("testing.canRefresh", false, {
        type: "boolean",
        description: localize("testing.canRefresh", "Indicates whether any test controller has an attached refresh handler."),
    });
    export const isRefreshingTests = new RawContextKey("testing.isRefreshing", false, {
        type: "boolean",
        description: localize("testing.isRefreshing", "Indicates whether any test controller is currently refreshing tests."),
    });
    export const isContinuousModeOn = new RawContextKey("testing.isContinuousModeOn", false, {
        type: "boolean",
    ...
    export const hasCoverableTests = new RawContextKey("testing.hasCoverableTests", false, {
        type: "boolean",
    ...
    export const hasNonDefaultProfile = new RawContextKey("testing.hasNonDefaultProfile", false, {
        type: "boolean",
    ...
    export const hasConfigurableProfile = new RawContextKey("testing.hasConfigurableProfile", false, {
        type: "boolean",
        description: localize("testing.hasConfigurableConfig", "Indicates whether any test configuration can be configured"),
    });
    export const supportsContinuousRun = new RawContextKey("testing.supportsContinuousRun", false, {
        type: "boolean",
        description: localize("testing.supportsContinuousRun", "Indicates whether continous test running is supported"),
    });
    export const isParentRunningContinuously = new RawContextKey("testing.isParentRunningContinuously", false, {
        type: "boolean",
    ...
    export const canGoToRelatedTest = new RawContextKey("testing.canGoToRelatedTest", false, {
        type: "boolean",
    ...
    export const peekHasStack = new RawContextKey("testing.peekHasStack", false, {
        type: "boolean",
