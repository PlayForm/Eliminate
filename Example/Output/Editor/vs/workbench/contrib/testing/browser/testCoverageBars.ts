...
import { autorun, ITransaction, observableValue, } from "../../../../base/common/observable.js";
...
import { getTestingConfiguration, ITestingCoverageBarThresholds, observeTestingConfiguration, TestingConfigKeys, } from "../common/configuration.js";
...
export class ManagedTestCoverageBars extends Disposable {
    ...
    constructor(protected readonly options: TestCoverageBarsOptions, 
        ...
        if (!this._coverage) {
            ...
            ds.add(this.configurationService.onDidChangeConfiguration((c) => {
                ...
                if (c.affectsConfiguration(TestingConfigKeys.CoveragePercent) ||
                    c.affectsConfiguration(TestingConfigKeys.CoverageBarThresholds)) {
    ...
    private doRender(coverage: CoverageBarSource) {
        ...
        if ("tpcBar" in el) {
            ...
            renderBar(el.function, coverage.declaration &&
                coverUtils.percent(coverage.declaration), coverage.declaration?.total === 0, thresholds);
...
const fnCoverageText = (coverage: CoverageBarSource) => coverage.declaration &&
...
const branchCoverageText = (coverage: CoverageBarSource) => coverage.branch &&
...
export class ExplorerTestCoverageBars extends ManagedTestCoverageBars implements IExplorerFileContribution {
    ...
    constructor(options: TestCoverageBarsOptions, 
    @IConfigurationService
