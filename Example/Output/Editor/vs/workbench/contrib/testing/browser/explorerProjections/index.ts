...
import { InternalTestItem, ITestItemContext, TestItemExpandState, TestResultState, } from "../../common/testTypes.js";
...
export class TestTreeErrorMessage {
    ...
    constructor(public readonly message: string | IMarkdownString, public readonly parent: TestExplorerTreeElement) { }
}
