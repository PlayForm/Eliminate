...
import { InternalTestItem, IRichLocation, ITestItem, ITestMessage, ITestMessageMenuArgs, ITestRunTask, ITestTaskState, TestMessageType, TestResultItem, } from "../../common/testTypes.js";
...
export const inspectSubjectHasStack = (subject: InspectSubject | undefined) => subject instanceof MessageSubject && !!subject.stack?.length;
...
export const equalsSubject = (a: InspectSubject, b: InspectSubject) => (a instanceof MessageSubject &&
