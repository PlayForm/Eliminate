...
import { applyTestItemUpdate, InternalTestItem, ITestItemUpdate, TestDiffOpType, TestItemExpandState, TestResultState, TestsDiff, } from "../../common/testTypes.js";
import { getChildrenForParent, ITestTreeProjection, TestExplorerTreeElement, testIdentityProvider, TestItemTreeElement, TestTreeErrorMessage, } from "./index.js";
import { isCollapsedInSerializedTestTree, ISerializedTestTreeCollapseState, } from "./testingViewState.js";
const computedStateAccessor: IComputedStateAndDurationAccessor<TreeTestItemElement> = {
    getOwnState: (i) => i instanceof TestItemTreeElement
        ? i.ownState
    ...
    getChildren: (i) => Iterable.filter(i.children.values(), (t): t is TreeTestItemElement => t instanceof TreeTestItemElement),
    *getParents(i) {
...
class TreeTestItemElement extends TestItemTreeElement {
    ...
    constructor(test: InternalTestItem, parent: null | TreeTestItemElement, protected readonly addedOrRemoved: (n: TestItemTreeElement) => void) {
...
export class TreeProjection extends Disposable implements ITestTreeProjection {
    ...
    private readonly results: ITestResultService) {
        ...
        this._register(results.onTestChanged((ev) => {
            ...
            const refreshDuration = ev.reason === TestResultItemChangeReason.OwnStateChange &&
        ...
        for (const op of diff) {
            switch (op.op) {
                ...
                case TestDiffOpType.Update: {
                    ...
                    const needsParentUpdate = existing.test.expand ===
