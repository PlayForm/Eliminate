...
class OutlineTreeSorter<E> implements ITreeSorter<E> {
    constructor(private _comparator: IOutlineComparator<E>, public order: OutlineSortOrder) { }
...
export class OutlinePane extends ViewPane implements IOutlinePane {
    ...
    private async _handleEditorControlChanged(pane: IEditorPane | undefined): Promise<void> {
        ...
        this._editorControlDisposables.add(tree.onDidChangeFindMode((mode) => (this._outlineViewState.filterOnType =
        ...
        const updateAllCollapsedCtx = () => {
            this._ctxAllCollapsed.set(tree
                .getNode(null)
