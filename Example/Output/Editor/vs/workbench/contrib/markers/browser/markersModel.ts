...
export class Marker {
    ...
    constructor(readonly id: string, readonly marker: IMarker, readonly relatedInformation: RelatedInformation[] = []) { }
    toString(): string {
...
export class MarkerTableItem extends Marker {
    constructor(marker: Marker, readonly sourceMatches?: IMatch[], readonly codeMatches?: IMatch[], readonly messageMatches?: IMatch[], readonly fileMatches?: IMatch[], readonly ownerMatches?: IMatch[]) {
        super(marker.id, marker.marker, marker.relatedInformation);
    }
}
export class RelatedInformation {
    constructor(readonly id: string, readonly marker: IMarker, readonly raw: IRelatedInformation) { }
}
...
export class MarkersModel {
    ...
    getResourceMarkers(resource: URI): ResourceMarkers | null {
        return (this.resourcesByUri.get(extUri.getComparisonKey(resource, true)) ??
            null);
    }
