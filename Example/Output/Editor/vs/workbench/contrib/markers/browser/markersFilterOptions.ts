...
import { getEmptyExpression, IExpression, parse, ParsedExpression, splitGlobAware, } from "../../../../base/common/glob.js";
...
export class ResourceGlobMatcher {
    ...
    private readonly expressionsByRoot: TernarySearchTree<URI, {
        root: URI;
...
export class FilterOptions {
    ...
    constructor(readonly filter: string, filesExclude: {
        root: URI;
        expression: IExpression;
