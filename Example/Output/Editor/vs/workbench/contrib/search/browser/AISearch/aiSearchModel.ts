...
import { AI_TEXT_SEARCH_RESULT_ID, FILE_MATCH_PREFIX, FOLDER_MATCH_PREFIX, getFileMatches, IChangeEvent, ISearchModel, ISearchResult, ISearchTreeFileMatch, ISearchTreeFolderMatch, ISearchTreeFolderMatchWithResource, ISearchTreeFolderMatchWorkspaceRoot, ITextSearchHeading, TEXT_SEARCH_HEADING_PREFIX, } from "../searchTreeModel/searchTreeCommon.js";
...
export class AITextSearchHeadingImpl extends TextSearchHeadingImpl<IAITextQuery> {
    constructor(parent: ISearchResult, 
...
export class AIFolderMatchWorkspaceRootImpl extends Disposable implements ISearchTreeFolderMatchWorkspaceRoot {
    ...
    constructor(private _resource: URI, _id: string, private _index: number, private _query: IAITextQuery, private _parent: ITextSearchHeading, 
    @IInstantiationService
...
class AIFileMatch extends FileMatchImpl implements ISearchTreeAIFileMatch {
    constructor(_query: string, _previewOptions: ITextSearchPreviewOptions | undefined, _maxResults: number | undefined, _parent: ISearchTreeFolderMatch, rawMatch: IFileMatch, _closestRoot: ISearchTreeFolderMatchWorkspaceRoot | null, private readonly _id: string, public readonly rank: number, 
    @IModelService
