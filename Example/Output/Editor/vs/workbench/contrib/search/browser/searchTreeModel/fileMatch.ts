...
import { FindMatch, IModelDeltaDecoration, ITextModel, MinimapPosition, TrackedRangeStickiness, } from "../../../../../editor/common/model.js";
...
import { DEFAULT_MAX_SEARCH_RESULTS, IFileMatch, IPatternInfo, ITextSearchContext, ITextSearchPreviewOptions, ITextSearchResult, resultIsMatch, } from "../../../../services/search/common/search.js";
...
export class FileMatchImpl extends Disposable implements ISearchTreeFileMatch {
    ...
    private static getDecorationOption(selected: boolean): ModelDecorationOptions {
        return selected
            ? FileMatchImpl._CURRENT_FIND_MATCH
            : FileMatchImpl._FIND_MATCH;
    }
    ...
    constructor(protected _query: IPatternInfo, private _previewOptions: ITextSearchPreviewOptions | undefined, private _maxResults: number | undefined, private _parent: ISearchTreeFolderMatch, protected rawMatch: IFileMatch, private _closestRoot: ISearchTreeFolderMatchWorkspaceRoot | null, 
    @IModelService
    ...
    addContext(results: ITextSearchResult[] | undefined) {
        ...
        const contexts = results.filter(((result) => !resultIsMatch(result)) as (a: any) => a is ITextSearchContext);
