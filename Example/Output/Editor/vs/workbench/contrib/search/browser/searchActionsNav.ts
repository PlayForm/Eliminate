...
import { FileMatchOrMatch, ISearchResult, isSearchTreeFolderMatch, RenderableMatch, } from "./searchTreeModel/searchTreeCommon.js";
    ...
    run(accessor: ServicesAccessor, ...args: any[]) {
        ...
        if (contextService.getValue(SearchEditorConstants.InSearchEditor.serialize())) {
            (accessor.get(IEditorService)
                .activeEditorPane as SearchEditor).toggleQueryDetails(args[0]?.show);
        }
    ...
    constructor() {
        super({
            ...
            keybinding: Object.assign({
                weight: KeybindingWeight.WorkbenchContrib,
                when: isMacintosh
                    ? ContextKeyExpr.and(Constants.SearchContext
                        .SearchViewFocusedKey, Constants.SearchContext.FileMatchOrFolderMatchFocusKey.toNegated())
