...
import { ISearchTreeFileMatch, ISearchTreeMatch, MATCH_PREFIX, } from "./searchTreeCommon.js";
...
export class MatchImpl implements ISearchTreeMatch {
    ...
    constructor(protected _parent: ISearchTreeFileMatch, private _fullPreviewLines: string[], _fullPreviewRange: ISearchRange, _documentRange: ISearchRange, private readonly _isReadonly: boolean = false) {
        ...
        const adjustedEndCol = _fullPreviewRange.startLineNumber ===
    ...
    fullMatchText(includeSurrounding = false): string {
        ...
        if (includeSurrounding) {
            ...
            thisMatchPreviewLines[thisMatchPreviewLines.length - 1] =
                thisMatchPreviewLines[thisMatchPreviewLines.length - 1].slice(0, this._fullPreviewRange.endColumn);
