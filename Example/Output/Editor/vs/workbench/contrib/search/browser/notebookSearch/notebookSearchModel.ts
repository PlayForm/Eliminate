...
import { IFileMatch, IPatternInfo, ISearchRange, ITextSearchContext, ITextSearchMatch, ITextSearchPreviewOptions, resultIsMatch, } from "../../../../services/search/common/search.js";
...
import { ISearchTreeFolderMatch, ISearchTreeFolderMatchWorkspaceRoot, ISearchTreeMatch, MATCH_PREFIX, } from "../searchTreeModel/searchTreeCommon.js";
...
export class MatchInNotebook extends MatchImpl implements IMatchInNotebook {
    ...
    override get isReadonly(): boolean {
        return (super.isReadonly ||
            !this._cellParent.hasCellViewModel() ||
            this.isWebviewMatch());
    }
    get cellIndex() {
...
export class CellMatch implements ICellMatch {
    ...
    constructor(private readonly _parent: INotebookFileInstanceMatch, private _cell: ICellViewModel | undefined, private readonly _cellIndex: number) {
...
export class NotebookCompatibleFileMatch extends FileMatchImpl implements INotebookFileInstanceMatch {
    ...
    constructor(_query: IPatternInfo, _previewOptions: ITextSearchPreviewOptions | undefined, _maxResults: number | undefined, _parent: ISearchTreeFolderMatch, rawMatch: IFileMatch, _closestRoot: ISearchTreeFolderMatchWorkspaceRoot | null, private readonly searchInstanceID: string, 
    @IModelService
    ...
    bindNotebookEditorWidget(widget: NotebookEditorWidget) {
        ...
        this._editorWidgetListener =
            this._notebookEditorWidget.textModel?.onDidChangeContent((e) => {
                if (!e.rawEvents.some((event) => event.kind ===
    ...
    private updateNotebookMatches(matches: CellFindMatchWithIndex[], modelChange: boolean): void {
        ...
        if (this._notebookEditorWidget.getId() !==
    ...
    async updateMatchesForEditorWidget(): Promise<void> {
        ...
        const wordSeparators = this._query.isWordMatch && this._query.wordSeparators
