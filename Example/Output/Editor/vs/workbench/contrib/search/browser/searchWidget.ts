...
import { appendKeyBindingLabel, getSearchView, isSearchViewFocused, } from "./searchActionsBase.js";
import { SearchFindInput } from "./searchFindInput.js";
import { searchHideReplaceIcon, searchReplaceAllIcon, searchShowContextIcon, searchShowReplaceIcon, } from "./searchIcons.js";
...
export class SearchWidget extends Widget {
    ...
    constructor(container: HTMLElement, options: ISearchWidgetOptions, 
    @IContextViewService
    ...
    @IClipboardService
    private readonly clipboardServce: IClipboardService, 
    ...
    private readonly editorService: IEditorService) {
        ...
        this.searchInputBoxFocused =
            Constants.SearchContext.SearchInputBoxFocusedKey.bindTo(this.contextKeyService);
        this.replaceInputBoxFocused =
            Constants.SearchContext.ReplaceInputBoxFocusedKey.bindTo(this.contextKeyService);
    ...
    private renderSearchInput(parent: HTMLElement, options: ISearchWidgetOptions): void {
        ...
        if (options.showContextToggle) {
            ...
            this.contextLinesInput.value =
                "" +
                    (this.configurationService.getValue<ISearchConfigurationProperties>("search").searchEditor.defaultNumberOfContextLines ?? 1);
