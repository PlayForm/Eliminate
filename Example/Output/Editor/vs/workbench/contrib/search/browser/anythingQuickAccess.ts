...
import { compareItemsByFuzzyScore, FuzzyScorerCache, IPreparedQuery, prepareQuery, scoreItemFuzzy, } from "../../../../base/common/fuzzyScorer.js";
...
import { basenameOrAuthority, dirname, toLocalResource, } from "../../../../base/common/resources.js";
...
import { FastAndSlowPicks, IPickerQuickAccessItem, PickerQuickAccessProvider, Picks, PicksWithActive, TriggerAction, } from "../../../../platform/quickinput/browser/pickerQuickAccess.js";
...
import { IKeyMods, IQuickInputButton, IQuickInputService, IQuickPick, IQuickPickItemWithResource, IQuickPickSeparator, QuickInputHideReason, quickPickItemScorerAccessor, QuickPickItemScorerAccessor, } from "../../../../platform/quickinput/common/quickInput.js";
import { Registry } from "../../../../platform/registry/common/platform.js";
import { IUriIdentityService } from "../../../../platform/uriIdentity/common/uriIdentity.js";
import { IWorkspaceContextService } from "../../../../platform/workspace/common/workspace.js";
import { IWorkbenchQuickAccessConfiguration, PickerEditorState, } from "../../../browser/quickaccess.js";
import { EditorResourceAccessor, isEditorInput, IWorkbenchEditorConfiguration, } from "../../../common/editor.js";
...
import { ISearchComplete, ISearchService, } from "../../../services/search/common/search.js";
...
import { extractRangeFromFilter, getOutOfWorkspaceEditorResources, IWorkbenchSearchConfiguration, } from "../common/search.js";
...
export class AnythingQuickAccessProvider extends PickerQuickAccessProvider<IAnythingQuickPickItem> {
    ...
    private readonly pickState = this._register(new (class extends Disposable {
        ...
        constructor(private readonly provider: AnythingQuickAccessProvider, private readonly instantiationService: IInstantiationService) {
            super();
        }
        set(picker: IQuickPick<IAnythingQuickPickItem, {
            useSeparators: true;
        }>): void {
            // Picker for this run
            this.picker = picker;
    ...
    @IQuickChatService
    private readonly quickChatService: IQuickChatService, 
    @ILogService
    ...
    private get configuration() {
        const editorConfig = this.configurationService.getValue<IWorkbenchEditorConfiguration>()
            .workbench?.editor;
        const searchConfig = this.configurationService.getValue<IWorkbenchSearchConfiguration>()
            .search;
        const quickAccessConfig = this.configurationService.getValue<IWorkbenchQuickAccessConfiguration>()
            .workbench.quickOpen;
        return {
    ...
    override provide(picker: IQuickPick<IAnythingQuickPickItem, {
        useSeparators: true;
    ...
    protected _getPicks(originalFilter: string, disposables: DisposableStore, token: CancellationToken, runOptions?: AnythingQuickAccessProviderRunOptions): Picks<IAnythingQuickPickItem> | Promise<Picks<IAnythingQuickPickItem>> | FastAndSlowPicks<IAnythingQuickPickItem> | null {
        ...
        if (picks && activePick) {
            ...
            const activePickIsNoResultsInEditorSymbols = activePick === AnythingQuickAccessProvider.NO_RESULTS_PICK &&
                filter.indexOf(GotoSymbolQuickAccessProvider.PREFIX) >= 0;
            if (!activePickIsEditorSymbol &&
    ...
    private doGetPicks(filter: string, options: AnythingQuickAccessProviderRunOptions & {
        enableEditorSymbolSearch: boolean;
    }, disposables: DisposableStore, token: CancellationToken): Picks<IAnythingQuickPickItem> | Promise<Picks<IAnythingQuickPickItem>> | FastAndSlowPicks<IAnythingQuickPickItem> {
    ...
    private getHelpPicks(query: IPreparedQuery, token: CancellationToken, runOptions?: AnythingQuickAccessProviderRunOptions): IAnythingQuickPickItem[] {
        ...
        const providers: IHelpAnythingQuickPickItem[] = this.lazyRegistry.value
            ...
            const providerSpecificOptions: AnythingQuickAccessProviderRunOptions | undefined = {
                ...runOptions,
                includeHelp: provider.prefix ===
                    AnythingQuickAccessProvider.PREFIX
                    ? false
                    : runOptions?.includeHelp,
            };
            const label = helpEntry.commandCenterLabel ??
    ...
    private getEditorSymbolPicks(query: IPreparedQuery, disposables: DisposableStore, token: CancellationToken): Promise<Picks<IAnythingQuickPickItem>> | null {
        ...
        const filter = filterSegments.length > 1
    ...
    //#endregion
    //#region Helpers
    private createAnythingPick(resourceOrEditor: URI | EditorInput | IResourceEditorInput, configuration: {
    ...
    private async openAnything(resourceOrEditor: URI | EditorInput | IResourceEditorInput, options: {
        keyMods?: IKeyMods;
        ...
        const editorOptions: ITextEditorOptions = {
            ...
            pinned: options.keyMods?.ctrlCmd ||
                options.forcePinned ||
