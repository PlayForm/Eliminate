...
import { getOutOfWorkspaceEditorResources, IWorkbenchSearchConfiguration, } from "../../common/search.js";
import { searchComparer } from "../searchCompare.js";
import { searchActivityBarIcon, searchDetailsIcon, searchOpenInFileIcon, } from "../searchIcons.js";
import { SearchModelImpl } from "../searchTreeModel/searchModel.js";
import { ISearchResult, ISearchTreeFileMatch, ISearchTreeMatch, RenderableMatch, SearchModelLocation, } from "../searchTreeModel/searchTreeCommon.js";
import { getEditorSelectionFromMatch, SearchView } from "../searchView.js";
...
export class TextSearchQuickAccess extends PickerQuickAccessProvider<ITextSearchQuickAccessItem> {
    ...
    override provide(picker: IQuickPick<ITextSearchQuickAccessItem, {
        useSeparators: true;
    ...
    private get configuration() {
        const editorConfig = this._configurationService.getValue<IWorkbenchEditorConfiguration>()
            .workbench?.editor;
        const searchConfig = this._configurationService.getValue<IWorkbenchSearchConfiguration>()
            .search;
        return {
    ...
    private async moveToSearchViewlet(currentElem: RenderableMatch | undefined) {
        ...
        this.searchModel =
            this._instantiationService.createInstance(SearchModelImpl);
        this.searchModel.location = SearchModelLocation.QUICK_ACCESS;
    ...
    private async handleAccept(iFileInstanceMatch: ISearchTreeFileMatch, options: {
        keyMods?: IKeyMods;
    ...
    protected _getPicks(contentPattern: string, disposables: DisposableStore, token: CancellationToken): Picks<IQuickPickItem> | Promise<Picks<IQuickPickItem> | FastAndSlowPicks<IQuickPickItem>> | FastAndSlowPicks<IQuickPickItem> | null {
        ...
        disposables.add(token.onCancellationRequested(() => {
            if (searchModelAtTimeOfSearch.location ===
