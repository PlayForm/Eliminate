...
import { arrayContainsElementOrParent, ISearchResult, isSearchResult, isSearchTreeFileMatch, isSearchTreeFolderMatch, isSearchTreeMatch, isTextSearchHeading, RenderableMatch, } from "./searchTreeModel/searchTreeCommon.js";
    ...
    if (focusElement) {
        ...
        if (nextFocusElement) {
            ...
            if (isSearchTreeMatch(nextFocusElement)) {
                const useReplacePreview = configurationService.getValue<ISearchConfiguration>().search
                    .useReplacePreview;
