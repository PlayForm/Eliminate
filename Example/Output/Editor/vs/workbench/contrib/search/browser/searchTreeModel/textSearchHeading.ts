...
import { IChangeEvent, IPlainTextSearchHeading, ISearchResult, ISearchTreeFileMatch, ISearchTreeFolderMatch, ISearchTreeFolderMatchNoRoot, ISearchTreeFolderMatchWithResource, ISearchTreeFolderMatchWorkspaceRoot, ISearchTreeMatch, isSearchTreeFileMatch, isSearchTreeFolderMatch, ITextSearchHeading, PLAIN_TEXT_SEARCH__RESULT_ID, TEXT_SEARCH_HEADING_PREFIX, } from "./searchTreeCommon.js";
export abstract class TextSearchHeadingImpl<QueryType extends ITextSearchQuery> extends Disposable implements ITextSearchHeading {
    ...
    protected clearQuery(): void {
        ...
        this._folderMatchesMap =
            TernarySearchTree.forUris<ISearchTreeFolderMatchWithResource>((key) => this.uriIdentityService.extUri.ignorePathCasing(key));
    }
