...
import { getIDFromINotebookCellMatch, isINotebookFileMatchWithModel, } from "../notebookSearch/searchNotebookHelpers.js";
import { IReplaceService } from "./../replace.js";
import { FileMatchImpl } from "./fileMatch.js";
import { textSearchResultToMatches } from "./match.js";
import { FOLDER_MATCH_PREFIX, getFileMatches, IChangeEvent, ISearchModel, ISearchResult, ISearchTreeFileMatch, ISearchTreeFolderMatch, ISearchTreeFolderMatchNoRoot, ISearchTreeFolderMatchWithResource, ISearchTreeFolderMatchWorkspaceRoot, isSearchTreeFolderMatchNoRoot, isSearchTreeFolderMatchWorkspaceRoot, ITextSearchHeading, } from "./searchTreeCommon.js";
export class FolderMatchImpl extends Disposable implements ISearchTreeFolderMatch {
    ...
    constructor(protected _resource: URI | null, _id: string, protected _index: number, protected _query: ITextQuery, private _parent: ITextSearchHeading | FolderMatchImpl, private _searchResult: ISearchResult, private _closestRoot: ISearchTreeFolderMatchWorkspaceRoot | null, 
    @IReplaceService
    ...
    protected readonly uriIdentityService: IUriIdentityService) {
        ...
        this._folderMatchesMap =
            TernarySearchTree.forUris<FolderMatchWithResourceImpl>((key) => this.uriIdentityService.extUri.ignorePathCasing(key));
        ...
        this._name = new Lazy(() => this.resource
    ...
    addFileMatch(raw: IFileMatch[], silent: boolean, searchInstanceID: string): void {
        ...
        raw.forEach((rawFileMatch) => {
            ...
            if (existingFileMatch) {
                ...
                if (isSearchTreeFolderMatchWorkspaceRoot(this) ||
                    isSearchTreeFolderMatchNoRoot(this)) {
...
export class FolderMatchWithResourceImpl extends FolderMatchImpl implements ISearchTreeFolderMatchWithResource {
    ...
    constructor(_resource: URI, _id: string, _index: number, _query: ITextQuery, _parent: ITextSearchHeading | FolderMatchImpl, _searchResult: ISearchResult, _closestRoot: ISearchTreeFolderMatchWorkspaceRoot | null, 
    @IReplaceService
