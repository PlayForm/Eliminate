...
export const languageModelExtensionPoint = ExtensionsRegistry.registerExtensionPoint<IUserFriendlyLanguageModel | IUserFriendlyLanguageModel[]>({
    ...
    activationEventsGenerator: (contribs: IUserFriendlyLanguageModel[], result: {
...
export class LanguageModelsService implements ILanguageModelsService {
    ...
    async sendChatRequest(identifier: string, from: ExtensionIdentifier, messages: IChatMessage[], options: {
        [name: string]: any;
    }, token: CancellationToken): Promise<ILanguageModelChatResponse> {
