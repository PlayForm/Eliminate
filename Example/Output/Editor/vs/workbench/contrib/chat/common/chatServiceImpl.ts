...
class CancellableRequest implements IDisposable {
    constructor(public readonly cancellationTokenSource: CancellationTokenSource, public requestId?: string | undefined) { }
    dispose() {
...
export class ChatService extends Disposable implements IChatService {
    ...
    private readonly _onDidDisposeSession = this._register(new Emitter<{
        sessionId: string;
