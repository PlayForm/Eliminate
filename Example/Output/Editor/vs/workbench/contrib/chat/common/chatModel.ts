...
export class ChatRequestModel implements IChatRequestModel {
    ...
    constructor(private _session: ChatModel, public readonly message: IParsedChatRequest, private _variableData: IChatRequestVariableData, private _attempt: number = 0, private _confirmation?: string, private _locationData?: IChatLocationData, private _attachedContext?: IChatRequestVariableEntry[], private _workingSet?: URI[], public readonly isCompleteAddedRequest = false) {
...
export class Response extends Disposable implements IResponse {
    ...
    private _updateRepr(quiet?: boolean) {
        const inlineRefToRepr = (part: IChatContentInlineReference) => 'uri' in part.inlineReference
...
export function isSerializableSessionData(obj: unknown): obj is ISerializableChatData {
    ...
    return isExportableSessionData(obj) &&
        ...
        obj.requests.every((request: ISerializableChatRequestData) => !request.usedContext /* for backward compat allow missing usedContext */ || isIUsedContext(request.usedContext));
}
...
export class ChatModel extends Disposable implements IChatModel {
    ...
    constructor(private readonly initialData: ISerializableChatData | IExportableChatData | undefined, private readonly _initialLocation: ChatAgentLocation, 
    @ILogService
