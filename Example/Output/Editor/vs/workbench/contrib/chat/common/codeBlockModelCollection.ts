...
export class CodeBlockModelCollection extends Disposable {
    ...
    updateSync(sessionId: string, chat: IChatRequestViewModel | IChatResponseViewModel, codeBlockIndex: number, content: {
        text: string;
        languageId?: string;
    }) {
    ...
    async update(sessionId: string, chat: IChatRequestViewModel | IChatResponseViewModel, codeBlockIndex: number, content: {
        text: string;
        languageId?: string;
    }) {
        const entry = this.getOrCreate(sessionId, chat, codeBlockIndex);
