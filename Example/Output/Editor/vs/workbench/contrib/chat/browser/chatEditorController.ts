        ...
        this._editor.changeViewZones((viewZoneChangeAccessor) => {
            ...
            for (const diffEntry of diff.changes) {
                ...
                for (const i of diffEntry.innerChanges || []) {
                    decorations.push(new InlineDecoration(i.originalRange.delta(-(diffEntry.original.startLineNumber - 1)), diffDeleteDecoration.className!, InlineDecorationType.Regular));
