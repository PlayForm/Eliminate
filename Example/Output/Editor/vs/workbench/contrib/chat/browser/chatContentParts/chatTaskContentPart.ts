...
export class ChatTaskContentPart extends Disposable implements IChatContentPart {
    ...
    constructor(private readonly task: IChatTask, contentReferencesListPool: CollapsibleListPool, renderer: MarkdownRenderer, context: IChatContentPartRenderContext, 
