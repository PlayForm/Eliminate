...
export class InlineAnchorWidget extends Disposable {
    ...
    constructor(private readonly element: HTMLAnchorElement | HTMLElement, public readonly inlineReference: IChatContentInlineReference, 
    @IContextKeyService
    originalContextKeyService: IContextKeyService, 
    @IContextMenuService
    ...
    telemetryService: ITelemetryService) {
        ...
        if (this.data.kind === 'symbol') {
            ...
            const providerContexts: ReadonlyArray<[
                IContextKey<boolean>,
                LanguageFeatureRegistry<unknown>
            ]> = [
            ...
            this._register(dom.addDisposableListener(element, 'click', () => {
                telemetryService.publicLog2<{
                    ...
                    anchorId: {
                        ...
                        comment: 'Unique identifier for the current anchor.';
                    };
                    owner: 'mjbvz';
