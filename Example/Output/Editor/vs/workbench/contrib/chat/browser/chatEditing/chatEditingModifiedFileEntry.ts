...
export class ChatEditingModifiedFileEntry extends Disposable implements IModifiedFileEntry {
    ...
    constructor(public readonly resource: URI, resourceRef: IReference<IResolvedTextEditorModel>, private readonly _multiDiffEntryDelegate: {
        collapse: (transaction: ITransaction | undefined) => void;
    }, private _telemetryInfo: IModifiedEntryTelemetryInfo, kind: ChatEditKind, 
    @IModelService
    ...
    @IBulkEditService
    public readonly bulkEditService: IBulkEditService, 
    @IChatService
