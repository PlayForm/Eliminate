...
export class ChatViewWelcomeController extends Disposable {
    ...
    constructor(private readonly container: HTMLElement, private readonly delegate: IViewWelcomeDelegate, private readonly location: ChatAgentLocation, 
    @IContextKeyService
...
export class ChatViewWelcomePart extends Disposable {
    ...
    constructor(content: IChatViewWelcomeContent, options: IChatViewWelcomeRenderOptions | undefined, 
    @IOpenerService
