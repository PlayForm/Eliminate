...
export class ChatEditingSession extends Disposable implements IChatEditingSession {
    ...
    constructor(public readonly chatSessionId: string, private editorPane: MultiDiffEditor | undefined, private editingSessionFileLimitPromise: Promise<number>, 
    ...
    @IBulkEditService
    public readonly _bulkEditService: IBulkEditService, 
    ...
    @IFileDialogService
    private readonly _dialogService: IFileDialogService, 
    @IChatAgentService
