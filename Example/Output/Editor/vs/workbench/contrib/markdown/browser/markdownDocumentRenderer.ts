 ...
 */
export async function renderMarkdownDocument(text: string, extensionService: IExtensionService, languageService: ILanguageService, options?: IRenderMarkdownDocumentOptions): Promise<string> {
...
namespace MarkedHighlight {
    ...
    export function markedHighlight(options: marked.MarkedOptions & {
