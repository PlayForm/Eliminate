...
export class ElectronWebviewElement extends WebviewElement {
    ...
    constructor(initInfo: WebviewInitInfo, webviewThemeDataProvider: WebviewThemeDataProvider, 
    @IContextMenuService
    ...
    accessibilityService: IAccessibilityService) {
        ...
        this._webviewMainService =
            ProxyChannel.toService<IWebviewManagerService>(mainProcessService.getChannel("webview"));
