...
namespace WebviewState {
    ...
    export class Initializing {
        ...
        constructor(public pendingMessages: Array<{
...
export class WebviewElement extends Disposable implements IWebview, WebviewFindDelegate {
    ...
    constructor(initInfo: WebviewInitInfo, protected readonly webviewThemeDataProvider: WebviewThemeDataProvider, 
    ...
    private readonly _onDidScroll = this._register(new Emitter<{
    ...
    private readonly _onFatalError = this._register(new Emitter<{
