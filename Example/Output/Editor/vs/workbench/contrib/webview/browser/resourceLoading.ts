...
export namespace WebviewResourceResponse {
    ...
    export class StreamSuccess {
        ...
        constructor(public readonly stream: VSBufferReadableStream, public readonly etag: string | undefined, public readonly mtime: number | undefined, public readonly mimeType: string) { }
    }
    ...
    export class NotModified {
        ...
        constructor(public readonly mimeType: string, public readonly mtime: number | undefined) { }
    }
    export type StreamResponse = StreamSuccess | typeof Failed | typeof AccessDenied | NotModified;
}
export async function loadLocalResource(requestUri: URI, options: {
