...
import { $, append, clearNode, Dimension, isActiveElement, isPointerEvent, trackFocus, } from "../../../../base/browser/dom.js";
...
import { IAsyncDataSource, ITreeContextMenuEvent, ITreeDragAndDrop, ITreeDragOverReaction, ITreeFilter, ITreeNode, ITreeSorter, } from "../../../../base/browser/ui/tree/tree.js";
...
import { combinedDisposable, Disposable, DisposableMap, DisposableStore, dispose, IDisposable, MutableDisposable, toDisposable, } from "../../../../base/common/lifecycle.js";
...
import { Action2, IAction2Options, IMenu, IMenuService, MenuId, MenuItemAction, MenuRegistry, registerAction2, } from "../../../../platform/actions/common/actions.js";
...
function processResourceFilterData(uri: URI, filterData: FuzzyScore | LabelFuzzyScore | undefined): [
    IMatch[] | undefined,
    IMatch[] | undefined
] {
    if (!filterData) {
...
class InputRenderer implements ICompressibleTreeRenderer<ISCMInput, FuzzyScore, InputTemplate> {
    ...
    constructor(private outerLayout: ISCMLayout, private overflowWidgetsDomNode: HTMLElement, private updateHeight: (input: ISCMInput, height: number) => void, 
...
class ResourceGroupRenderer implements ICompressibleTreeRenderer<ISCMResourceGroup, FuzzyScore, ResourceGroupTemplate> {
    ...
    constructor(private actionViewItemProvider: IActionViewItemProvider, 
    @ISCMViewService
...
class ResourceRenderer implements ICompressibleTreeRenderer<ISCMResource | IResourceNode<ISCMResource, ISCMResourceGroup>, FuzzyScore | LabelFuzzyScore, ResourceTemplate> {
    ...
    constructor(private viewMode: () => ViewMode, private labels: ResourceLabels, private actionViewItemProvider: IActionViewItemProvider, private actionRunner: ActionRunner, 
    @ILabelService
    ...
    renderElement(node: ITreeNode<ISCMResource, FuzzyScore | LabelFuzzyScore> | ITreeNode<ISCMResource | IResourceNode<ISCMResource, ISCMResourceGroup>, FuzzyScore | LabelFuzzyScore>, index: number, template: ResourceTemplate): void {
        ...
        const fileKind = ResourceTree.isResourceNode(resourceOrFolder)
            ? FileKind.FOLDER
            : FileKind.FILE;
        const tooltip = (!ResourceTree.isResourceNode(resourceOrFolder) &&
...
export class SCMTreeSorter implements ITreeSorter<TreeElement> {
    constructor(private readonly viewMode: () => ViewMode, private readonly viewSortKey: () => ViewSortKey) { }
...
class RepositoryVisibilityActionController {
    ...
    scmService: ISCMService) {
        this.repositoryCountContextKey =
            ContextKeys.RepositoryCount.bindTo(contextKeyService);
...
class SetListViewModeAction extends ViewAction<SCMViewPane> {
    constructor(id = "workbench.scm.action.setListViewMode", menu: Partial<IAction2Options["menu"]> = {}) {
        super({
            id,
...
class SetTreeViewModeAction extends ViewAction<SCMViewPane> {
    constructor(id = "workbench.scm.action.setTreeViewMode", menu: Partial<IAction2Options["menu"]> = {}) {
        super({
            id,
...
class SCMInputWidgetActionRunner extends ActionRunner {
    ...
    constructor(private readonly input: ISCMInput, 
    @IStorageService
...
class SCMInputWidgetToolbar extends WorkbenchToolBar {
    ...
    constructor(container: HTMLElement, options: IMenuWorkbenchToolBarOptions | undefined, 
    @IMenuService
    ...
    public setInput(input: ISCMInput): void {
        ...
        this._disposables.value.add(this.actionRunner.onWillRun((e) => {
            if ((this.actionRunner as SCMInputWidgetActionRunner)
...
class SCMInputWidgetEditorOptions {
    ...
    constructor(private readonly overflowWidgetsDomNode: HTMLElement, private readonly configurationService: IConfigurationService) {
...
class SCMInputWidget {
    ...
    set input(input: ISCMInput | undefined) {
        ...
        this.repositoryDisposables.add(input.onDidChange(({ value, reason }) => {
            ...
            textModel.pushEditOperations(null, [
                EditOperation.replaceMove(textModel.getFullModelRange(), value),
            ], () => []);
    ...
    private setValidation(validation: IInputValidation | undefined, options?: {
        focus?: boolean;
        timeout?: boolean;
    }) {
    ...
    constructor(container: HTMLElement, overflowWidgetsDomNode: HTMLElement, 
    @IContextKeyService
    ...
    private readonly openerService: IOpenerService) {
        ...
        this.toolbar = instantiationService2.createInstance(SCMInputWidgetToolbar, this.toolbarContainer, {
            actionViewItemProvider: (action, options) => {
                if (action instanceof MenuItemAction &&
                    this.toolbar.dropdownActions.length > 1) {
                    return instantiationService.createInstance(DropdownWithPrimaryActionViewItem, action, this.toolbar.dropdownAction, this.toolbar.dropdownActions, "", {
    ...
    getContentHeight(): number {
        ...
        const inputMinLines = typeof inputMinLinesConfig === "number"
        ...
        const inputMaxLines = typeof inputMaxLinesConfig === "number"
...
export class SCMViewPane extends ViewPane {
    ...
    hoverService: IHoverService) {
        ...
        this.viewModeContextKey =
            ContextKeys.SCMViewMode.bindTo(contextKeyService);
        this.viewModeContextKey.set(this._viewMode);
        this.viewSortKeyContextKey =
            ContextKeys.SCMViewSortKey.bindTo(contextKeyService);
        ...
        this.scmProviderContextKey =
            ContextKeys.SCMProvider.bindTo(contextKeyService);
        this.scmProviderRootUriContextKey =
            ContextKeys.SCMProviderRootUri.bindTo(contextKeyService);
    ...
    private async open(e: IOpenEvent<TreeElement | undefined>): Promise<void> {
        if (!e.element) {
            ...
            if (e.element.command?.id === API_OPEN_EDITOR_COMMAND_ID ||
                ...
                if (isPointerEvent(e.browserEvent) &&
    ...
    private onDidActiveEditorChange(): void {
        ...
        if (this.tree
            .getFocus()
            .some((e) => isSCMResource(e) &&
            this.uriIdentityService.extUri.isEqual(e.sourceUri, uri)) &&
            this.tree
                .getSelection()
                .some((e) => isSCMResource(e) &&
                this.uriIdentityService.extUri.isEqual(e.sourceUri, uri))) {
    ...
    private getSelectedRepositories(): ISCMRepository[] {
        ...
        const selectedRepositories = this.tree
            .getSelection()
            .filter((r) => !!r && isSCMRepository(r))! as ISCMRepository[];
        return Array.from(new Set<ISCMRepository>([
            ...focusedRepositories,
    ...
    private getViewMode(): ViewMode {
        let mode = this.configurationService.getValue<"tree" | "list">("scm.defaultViewMode") === "list"
            ? ViewMode.List
            : ViewMode.Tree;
    ...
    private updateIndentStyles(theme: IFileIconTheme): void {
        ...
        this.treeContainer.classList.toggle("align-icons-and-twisties", (this.viewMode === ViewMode.List && theme.hasFileIcons) ||
            (theme.hasFileIcons && !theme.hasFolderIcons));
        this.treeContainer.classList.toggle("hide-arrows", this.viewMode === ViewMode.Tree &&
    ...
    private updateRepositoryCollapseAllContextKeys(): void {
        ...
        this.areAllRepositoriesCollapsedContextKey.set(this.scmViewService.visibleRepositories.every((r) => this.tree.hasNode(r) &&
    ...
    private async focusResourceGroup(delta: number): Promise<void> {
        ...
        const focusedResourceGroupIndex = treeHasDomFocus && focusedResourceGroup
...
class SCMTreeDataSource extends Disposable implements IAsyncDataSource<ISCMViewService, TreeElement> {
    ...
    async getChildren(inputOrElement: ISCMViewService | TreeElement): Promise<Iterable<TreeElement>> {
        ...
        if (isSCMViewService(inputOrElement) &&
        ...
        else if ((isSCMViewService(inputOrElement) &&
            repositoryCount === 1 &&
            ...
            if (this.viewMode() === ViewMode.List) {
                ...
                for (const node of inputOrElement.resourceTree.root.children) {
                    children.push(node.element && node.childrenCount === 0
                        ? node.element
                        : node);
                }
                return children;
...
export class SCMActionButton implements IDisposable {
    ...
    constructor(private readonly container: HTMLElement, private readonly contextMenuService: IContextMenuService, private readonly commandService: ICommandService, private readonly notificationService: INotificationService) { }
    dispose(): void {
        this.disposables?.dispose();
    }
