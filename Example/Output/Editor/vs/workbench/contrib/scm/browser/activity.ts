...
import { ISCMRepository, ISCMService, ISCMViewService, VIEW_PANE_ID, } from "../common/scm.js";
...
export class SCMActiveRepositoryController extends Disposable implements IWorkbenchContribution {
    ...
    private readonly _repositories = observableFromEvent(this, Event.any(this.scmService.onDidAddRepository, this.scmService.onDidRemoveRepository), () => this.scmService.repositories);
    ...
    private readonly titleService: ITitleService) {
        ...
        this._activeRepositoryNameContextKey =
            ActiveRepositoryContextKeys.ActiveRepositoryName.bindTo(this.contextKeyService);
    ...
    private _updateStatusBar(repository: ISCMRepository | undefined, commands: readonly Command[], store: DisposableStore): void {
        ...
        for (let index = 0; index < commands.length; index++) {
            ...
            store.add(index === 0
                ...
                : this.statusbarService.addEntry(statusbarEntry, `status.scm.${index}`, MainThreadStatusBarAlignment.LEFT, {
