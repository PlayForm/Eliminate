...
export function isSCMViewService(element: any): element is ISCMViewService {
    return (Array.isArray((element as ISCMViewService).repositories) &&
...
export function isSCMResourceGroup(element: any): element is ISCMResourceGroup {
    return (!!(element as ISCMResourceGroup).provider &&
...
export function isSCMHistoryItemViewModelTreeElement(element: any): element is SCMHistoryItemViewModelTreeElement {
    return ((element as SCMHistoryItemViewModelTreeElement).type ===
        "historyItemViewModel");
}
export function isSCMHistoryItemLoadMoreTreeElement(element: any): element is SCMHistoryItemLoadMoreTreeElement {
    return ((element as SCMHistoryItemLoadMoreTreeElement).type ===
        "historyItemLoadMore");
}
...
export class StatusBarAction extends Action {
    constructor(private command: Command, private commandService: ICommandService) {
...
export function compareHistoryItemRefs(ref1: ISCMHistoryItemRef, ref2: ISCMHistoryItemRef, currentHistoryItemRef?: ISCMHistoryItemRef, currentHistoryItemRemoteRef?: ISCMHistoryItemRef, currentHistoryItemBaseRef?: ISCMHistoryItemRef): number {
