...
import { EXTENSION_INSTALL_SOURCE_CONTEXT, ExtensionInstallSource, ExtensionsLocalizedLabel, IExtensionGalleryService, IExtensionManagementService, PreferencesLocalizedLabel, } from "../../../../platform/extensionManagement/common/extensionManagement.js";
...
import { EnablementState, extensionsConfigurationNodeBase, IExtensionManagementServerService, IWorkbenchExtensionEnablementService, IWorkbenchExtensionManagementService, } from "../../../services/extensionManagement/common/extensionManagement.js";
...
import { AutoUpdateConfigurationKey, CONTEXT_HAS_GALLERY, ExtensionEditorTab, ExtensionRuntimeActionType, extensionsSearchActionsMenu, HasOutdatedExtensionsContext, IExtensionArg, IExtensionsViewPaneContainer, IExtensionsWorkbenchService, INSTALL_ACTIONS_GROUP, INSTALL_EXTENSION_FROM_VSIX_COMMAND_ID, IWorkspaceRecommendedExtensionsView, LIST_WORKSPACE_UNSUPPORTED_EXTENSIONS_COMMAND_ID, OUTDATED_EXTENSIONS_VIEW_ID, SELECT_INSTALL_VSIX_EXTENSION_COMMAND_ID, THEME_ACTIONS_GROUP, TOGGLE_IGNORE_EXTENSION_ACTION_ID, UPDATE_ACTIONS_GROUP, VIEWLET_ID, WORKSPACE_RECOMMENDATIONS_VIEW_ID, } from "../common/extensions.js";
...
import { ClearLanguageAction, ConfigureWorkspaceFolderRecommendedExtensionsAction, ConfigureWorkspaceRecommendedExtensionsAction, InstallAction, InstallAnotherVersionAction, InstallSpecificVersionOfExtensionAction, ReinstallAction, SetColorThemeAction, SetFileIconThemeAction, SetProductIconThemeAction, ToggleAutoUpdateForExtensionAction, ToggleAutoUpdatesForPublisherAction, TogglePreReleaseExtensionAction, } from "./extensionsActions.js";
...
import { BuiltInExtensionsContext, DefaultViewsContext, ExtensionsSortByContext, ExtensionsViewletViewsContribution, ExtensionsViewPaneContainer, MaliciousExtensionChecker, RecommendedExtensionsContext, SearchHasTextContext, SearchMarketplaceExtensionsContext, StatusUpdater, } from "./extensionsViewlet.js";
...
// Editor
Registry.as<IEditorPaneRegistry>(EditorExtensions.EditorPane).registerEditorPane(EditorPaneDescriptor.create(ExtensionEditor, ExtensionEditor.ID, localize("extension", "Extension")), [new SyncDescriptor(ExtensionsInput)]);
...
CommandsRegistry.registerCommand({
    ...
    handler: async (accessor, arg: string | UriComponents, options?: {
...
class ExtensionsContributions extends Disposable implements IWorkbenchContribution {
    ...
    private registerGlobalActions(): void {
        ...
        this.registerExtensionAction({
            ...
            run: (accessor: ServicesAccessor) => accessor
                .get(IExtensionsWorkbenchService)
                .updateAutoUpdateForAllExtensions(true),
        });
        ...
        this.registerExtensionAction({
            ...
            run: (accessor: ServicesAccessor) => accessor
                .get(IExtensionsWorkbenchService)
                .updateAutoUpdateForAllExtensions(false),
        });
        this.registerExtensionAction({
        ...
        this.registerExtensionAction({
            ...
            run: async (accessor: ServicesAccessor, resources: URI[] | URI) => {
                ...
                const vsixs = Array.isArray(resources)
                    ? resources
                    : [resources];
                ...
                if (requireReload) {
                    notificationService.prompt(Severity.Info, localize("InstallVSIXAction.successReload", "Completed installing extension from VSIX. Please reload Visual Studio Code to enable it."), [
                        {
                    ...
                    notificationService.prompt(Severity.Info, localize("InstallVSIXAction.successRestart", "Completed installing extension from VSIX. Please restart extensions to enable it."), [
                        {
                    ...
                    notificationService.prompt(Severity.Info, localize("InstallVSIXAction.successNoReload", "Completed installing extension."), []);
                }
            },
        });
        this.registerExtensionAction({
        ...
        this.registerExtensionAction({
            ...
            run: async (accessor: ServicesAccessor) => {
                const view = accessor
                    .get(IViewsService)
                    .getActiveViewWithId(WORKSPACE_RECOMMENDATIONS_VIEW_ID) as IWorkspaceRecommendedExtensionsView;
    ...
    private registerContextMenuActions(): void {
            ...
            run: async (accessor: ServicesAccessor, extensionId: string) => {
                ...
                if (extension) {
                    const action = instantiationService.createInstance(InstallAction, {
                        installPreReleaseVersion: this.extensionsWorkbenchService
                            .preferPreReleases,
                    });
                    action.extension = extension;
                    return action.run();
        ...
        this.registerExtensionAction({
            ...
            run: async (accessor: ServicesAccessor, id: string) => accessor
                .get(IPreferencesService)
                .openSettings({ jsonEditor: false, query: `@ext:${id}` }),
        });
        this.registerExtensionAction({
            ...
            run: (accessor: ServicesAccessor, id: string) => accessor
                .get(ICommandService)
                .executeCommand("_manageAccountPreferencesForExtension", id),
        });
        this.registerExtensionAction({
            ...
            run: async (accessor: ServicesAccessor, id: string) => accessor
                .get(IPreferencesService)
                .openGlobalKeybindingSettings(false, {
                query: `@ext:${id}`,
            }),
        });
        this.registerExtensionAction({
        ...
        this.registerExtensionAction({
            ...
            run: (accessor: ServicesAccessor, id: string) => accessor
                .get(IWorkspaceExtensionsConfigService)
