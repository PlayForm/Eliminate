...
import { Extensions, IExtensionFeatureDescriptor, IExtensionFeatureMarkdownAndTableRenderer, IExtensionFeatureMarkdownRenderer, IExtensionFeatureRenderer, IExtensionFeaturesManagementService, IExtensionFeaturesRegistry, IExtensionFeatureTableRenderer, IRenderedData, ITableData, } from "../../../services/extensionManagement/common/extensionFeatures.js";
        ...
        if (this.feature.access.canToggle) {
            ...
            this._register(button.onDidClick(async () => {
                ...
                const confirmationResult = await this.dialogService.confirm({
                    ...
                    message: enabled
                        ? localize("disableAccessExtensionFeatureMessage", "Would you like to revoke '{0}' extension to access '{1}' feature?", this.manifest.displayName ??
                            this.extensionId.value, this.feature.label)
                        : localize("enableAccessExtensionFeatureMessage", "Would you like to allow '{0}' extension to access '{1}' feature?", this.manifest.displayName ??
                            this.extensionId.value, this.feature.label),
                    custom: true,
