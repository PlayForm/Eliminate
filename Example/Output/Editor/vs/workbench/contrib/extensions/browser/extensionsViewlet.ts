...
import { $, addDisposableListener, append, clearNode, Dimension, DragAndDropObserver, EventType, hide, show, trackFocus, } from "../../../../base/browser/dom.js";
...
import { Extensions, IAddedViewDescriptorRef, IViewDescriptor, IViewDescriptorService, IViewsRegistry, ViewContainer, ViewContainerLocation, } from "../../../common/views.js";
...
import { IExtensionManagementServer, IExtensionManagementServerService, IWorkbenchExtensionEnablementService, } from "../../../services/extensionManagement/common/extensionManagement.js";
...
import { AutoCheckUpdatesConfigurationKey, AutoRestartConfigurationKey, CloseExtensionDetailsOnViewChangeKey, CONTEXT_HAS_GALLERY, extensionsSearchActionsMenu, IExtensionsViewPaneContainer, IExtensionsWorkbenchService, INSTALL_EXTENSION_FROM_VSIX_COMMAND_ID, OUTDATED_EXTENSIONS_VIEW_ID, VIEWLET_ID, WORKSPACE_RECOMMENDATIONS_VIEW_ID, } from "../common/extensions.js";
...
export class ExtensionsViewPaneContainer extends ViewPaneContainer implements IExtensionsViewPaneContainer {
    ...
    override create(parent: HTMLElement): void {
        ...
        this._register(new DragAndDropObserver(this.root, {
            ...
            onDrop: async (e: DragEvent) => {
                if (this.isSupportedDragElement(e)) {
                    hide(overlay);
                    const vsixs = coalesce((await this.instantiationService.invokeFunction((accessor) => extractEditorsAndFilesDropData(accessor, e))).map((editor) => editor.resource &&
    ...
    private normalizedQuery(): string {
        return this.searchBox
            ? this.searchBox
                ...
                .replace(/@popular/g, this.extensionManagementServerService
                .webExtensionManagementServer &&
                !this.extensionManagementServerService
                    .localExtensionManagementServer &&
                !this.extensionManagementServerService
    ...
    private doSearch(refresh?: boolean): Promise<void> {
        ...
        this.renderNotificaiton();
        return this.progress(Promise.all(this.panes.map((view) => (<ExtensionsListView>view)
    ...
    protected override onDidAddViewDescriptors(added: IAddedViewDescriptorRef[]): ViewPane[] {
        ...
        this.progress(Promise.all(addedViews.map((addedView) => (<ExtensionsListView>addedView)
...
export class MaliciousExtensionChecker implements IWorkbenchContribution {
    ...
    private checkForMaliciousExtensions(): Promise<void> {
        return this.extensionsManagementService
            ...
            .then((extensionsControlManifest) => {
            return this.extensionsManagementService
                ...
                if (maliciousExtensions.length) {
                    return Promises.settled(maliciousExtensions.map((e) => this.extensionsManagementService
                        .uninstall(e)
                        .then(() => {
