...
import { IExtensionGalleryService, IExtensionManagementService, InstallExtensionResult, InstallOperation, } from "../../../../platform/extensionManagement/common/extensionManagement.js";
...
export class ExtensionRecommendationsService extends Disposable implements IExtensionRecommendationsService {
    ...
    private async activate(): Promise<void> {
        ...
        this._register(Event.any(this.workspaceRecommendations.onDidChangeRecommendations, this.configBasedRecommendations.onDidChangeRecommendations, this.extensionRecommendationsManagementService
            .onDidChangeIgnoredRecommendations)(() => this._onDidChangeRecommendations.fire()));
        this._register(this.extensionRecommendationsManagementService.onDidChangeGlobalIgnoredRecommendation(({ extensionId, isRecommended }) => {
            if (!isRecommended) {
                ...
                if (reason && reason.reasonId) {
                    ...
                    }, IgnoreRecommendationClassification>("extensionsRecommendations:ignoreRecommendation", {
                        extensionId,
    ...
    private isEnabled(): boolean {
        return (this.galleryService.isEnabled() &&
    ...
    private async promptWorkspaceRecommendations(): Promise<void> {
        ...
        const allowedRecommendations = [
            ...
            .filter((extension) => !isString(extension) ||
            this.isExtensionAllowedToBeRecommended(extension));
