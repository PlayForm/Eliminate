...
import { ExtensionContainers, ExtensionState, IExtension, IExtensionsWorkbenchService, } from "../common/extensions.js";
import { ButtonWithDropDownExtensionAction, ButtonWithDropdownExtensionActionViewItem, ClearLanguageAction, DropDownExtensionAction, ExtensionRuntimeStateAction, ExtensionStatusAction, ExtensionStatusLabelAction, InstallDropdownAction, InstallingLabelAction, LocalInstallAction, ManageExtensionAction, MigrateDeprecatedExtensionAction, RemoteInstallAction, SetLanguageAction, UpdateAction, WebInstallAction, } from "./extensionsActions.js";
import { verifiedPublisherIcon as verifiedPublisherThemeIcon } from "./extensionsIcons.js";
import { ExtensionActivationStatusWidget, ExtensionHoverWidget, ExtensionPackCountWidget as ExtensionPackBadgeWidget, extensionVerifiedPublisherIconColor, InstallCountWidget, PreReleaseBookmarkWidget, RatingsWidget, RecommendationWidget, RemoteBadgeWidget, SyncIgnoredWidget, VerifiedPublisherWidget, } from "./extensionsWidgets.js";
...
export class Renderer implements IPagedRenderer<IExtension, ITemplateData> {
    constructor(private extensionViewState: IExtensionsViewState, private readonly options: ExtensionListRendererOptions, 
    ...
    renderElement(extension: IExtension, index: number, data: ITemplateData): void {
        ...
        if (extension.state !== ExtensionState.Uninstalled &&
            ...
            extension =
                this.extensionsWorkbenchService.local.filter((e) => e.server === extension.server &&
                    areSameExtensions(e.identifier, extension.identifier))[0] || extension;
        }
        data.extensionDisposables = dispose(data.extensionDisposables);
        const updateEnablement = () => {
            const disabled = extension.state === ExtensionState.Installed &&
                extension.local &&
