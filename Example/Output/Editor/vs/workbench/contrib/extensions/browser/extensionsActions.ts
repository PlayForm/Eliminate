...
import { ExtensionManagementErrorCode, IExtensionGalleryService, IGalleryExtension, ILocalExtension, InstallOperation, InstallOptions, TargetPlatformToString, } from "../../../../platform/extensionManagement/common/extensionManagement.js";
import { areSameExtensions, getExtensionId, } from "../../../../platform/extensionManagement/common/extensionManagementUtil.js";
import { ExtensionIdentifier, ExtensionType, getWorkspaceSupportTypeMessage, IExtensionDescription, IExtensionManifest, isApplicationScopedExtension, isLanguagePackExtension, TargetPlatform, } from "../../../../platform/extensions/common/extensions.js";
...
import { buttonBackground, buttonForeground, buttonHoverBackground, buttonSeparator, editorErrorForeground, editorInfoForeground, editorWarningForeground, registerColor, } from "../../../../platform/theme/common/colorRegistry.js";
...
import { EnablementState, IExtensionManagementServer, IExtensionManagementServerService, IWorkbenchExtensionEnablementService, IWorkbenchExtensionManagementService, } from "../../../services/extensionManagement/common/extensionManagement.js";
...
import { IWorkbenchColorTheme, IWorkbenchFileIconTheme, IWorkbenchProductIconTheme, IWorkbenchTheme, IWorkbenchThemeService, } from "../../../services/themes/common/workbenchThemeService.js";
import { AutoUpdateConfigurationKey, ExtensionEditorTab, ExtensionRuntimeActionType, ExtensionState, IExtension, IExtensionArg, IExtensionContainer, IExtensionsWorkbenchService, INSTALL_ACTIONS_GROUP, SELECT_INSTALL_VSIX_EXTENSION_COMMAND_ID, THEME_ACTIONS_GROUP, TOGGLE_IGNORE_EXTENSION_ACTION_ID, UPDATE_ACTIONS_GROUP, } from "../common/extensions.js";
...
export class PromptExtensionInstallFailureAction extends Action {
    constructor(private readonly extension: IExtension, private readonly options: InstallOptions | undefined, private readonly version: string, private readonly installOperation: InstallOperation, private readonly error: Error, 
    @IProductService
    ...
    override async run(): Promise<void> {
        ...
        if (ExtensionManagementErrorCode.ReleaseVersionNotFound ===
        ...
        if (ExtensionManagementErrorCode.PackageNotSigned ===
            <ExtensionManagementErrorCode>this.error.name) {
            await this.dialogService.prompt({
                type: "error",
        ...
        if (ExtensionManagementErrorCode.SignatureVerificationFailed ===
            <ExtensionManagementErrorCode>this.error.name ||
        ...
        const operationMessage = this.installOperation === InstallOperation.Update
            ? localize("update operation", "Error while updating '{0}' extension.", this.extension.displayName ||
                this.extension.identifier.id)
            : localize("install operation", "Error while installing '{0}' extension.", this.extension.displayName ||
                this.extension.identifier.id);
...
export class ButtonWithDropDownExtensionAction extends ExtensionAction {
    ...
    constructor(id: string, clazz: string, private readonly actionsGroups: ExtensionAction[][]) {
...
export class ButtonWithDropdownExtensionActionViewItem extends ActionWithDropdownActionViewItem {
    ...
    protected override updateClass(): void {
        ...
        if (this.element && this.dropdownMenuActionViewItem?.element) {
            ...
            const isMenuEmpty = (<ButtonWithDropDownExtensionAction>this._action).menuActions
                .length === 0;
            ...
            if (this.extension.deprecationInfo.extension) {
                ...
                buttons.push({
                    label: localize({
                        ...
                        comment: ["&& denotes a mnemonic"],
                    }, "&&Open {0}", this.extension.deprecationInfo.extension.displayName),
                    run: async () => {
    ...
    private async install(extension: IExtension): Promise<IExtension | undefined> {
        try {
            ...
            await this.instantiationService
                .createInstance(PromptExtensionInstallFailureAction, extension, this.options, extension.latestVersion, InstallOperation.Install, error)
                .run();
            return undefined;
        }
    }
...
export abstract class InstallInOtherServerAction extends ExtensionAction {
    ...
    constructor(id: string, private readonly server: IExtensionManagementServer | null, private readonly canInstallAnyWhere: boolean, 
    @IExtensionsWorkbenchService
    private readonly extensionsWorkbenchService: IExtensionsWorkbenchService, 
    @IExtensionManagementServerService
    ...
    update(): void {
        ...
        if (this.canInstall()) {
            ...
            if (extensionInOtherServer) {
                ...
                if (extensionInOtherServer.state ===
...
export class RemoteInstallAction extends InstallInOtherServerAction {
    constructor(canInstallAnyWhere: boolean, 
    @IExtensionsWorkbenchService
    extensionsWorkbenchService: IExtensionsWorkbenchService, 
    @IExtensionManagementServerService
    ...
    protected getInstallLabel(): string {
        return this.extensionManagementServerService
            ...
            }, "Install in {0}", this.extensionManagementServerService
    ...
    private async install(extension: IExtension): Promise<void> {
        ...
        try {
            ...
            this.instantiationService
                .createInstance(PromptExtensionInstallFailureAction, extension, options, extension.latestVersion, InstallOperation.Update, err)
                .run();
        }
    }
}
export class ToggleAutoUpdateForExtensionAction extends ExtensionAction {
    ...
    override update() {
        ...
        if (this.extensionsWorkbenchService.getAutoUpdateValue() ===
...
export class MigrateDeprecatedExtensionAction extends ExtensionAction {
    ...
    private static readonly DisabledClass = `${this.EnabledClass} disabled`;
    constructor(private readonly small: boolean, 
    @IExtensionsWorkbenchService
...
export abstract class DropDownExtensionAction extends ExtensionAction {
    constructor(id: string, label: string, cssClass: string, enabled: boolean, 
    @IInstantiationService
    ...
    public override run({ actionGroups, disposeActionsOnHide, }: {
...
export class DropDownExtensionActionViewItem extends ActionViewItem {
    constructor(action: DropDownExtensionAction, options: IActionViewItemOptions, 
    @IContextMenuService
...
async function getContextMenuActionsGroups(extension: IExtension | undefined | null, contextKeyService: IContextKeyService, instantiationService: IInstantiationService): Promise<[
    string,
    ...
    return instantiationService.invokeFunction(async (accessor) => {
        ...
        if (extension) {
            ...
            cksOverlay.push([
                "extensionIsUnsigned",
                extension.gallery && !extension.gallery.isSigned,
            ]);
            ...
            cksOverlay.push([
                "extensionHasAccountPreferences",
                extensionUsesAuth,
            ]);
            cksOverlay.push([
                "canSetLanguage",
...
function toActions(actionsGroups: [
    string,
    Array<MenuItemAction | SubmenuItemAction>
][], instantiationService: IInstantiationService): IAction[][] {
...
export class ManageExtensionAction extends DropDownExtensionAction {
    ...
    private static readonly Class = `${ExtensionAction.ICON_ACTION_CLASS} manage ` +
...
export class ExtensionEditorManageExtensionAction extends DropDownExtensionAction {
    constructor(private readonly contextKeyService: IContextKeyService, instantiationService: IInstantiationService) {
...
export class MenuItemExtensionAction extends ExtensionAction {
    ...
    update() {
        ...
        if (this.action.id === TOGGLE_IGNORE_EXTENSION_ACTION_ID) {
            ...
            this.checked =
                this.extensionsWorkbenchService.isAutoUpdateEnabledFor(this.extension.publisher);
        }
        else {
...
export class InstallAnotherVersionAction extends ExtensionAction {
    ...
    constructor(extension: IExtension | null, private readonly whenInstalled: boolean, 
    @IExtensionsWorkbenchService
    private readonly extensionsWorkbenchService: IExtensionsWorkbenchService, 
    ...
    override async run(): Promise<any> {
        ...
        if (pick) {
            ...
            try {
                ...
                this.instantiationService
                    .createInstance(PromptExtensionInstallFailureAction, this.extension, options, pick.id, InstallOperation.Install, error)
                    .run();
            }
        }
        return null;
...
export class ExtensionRuntimeStateAction extends ExtensionAction {
    ...
    update(): void {
        ...
        const state = this.extension.state;
        if (state === ExtensionState.Installing ||
...
function getQuickPickEntries(themes: IWorkbenchTheme[], currentTheme: IWorkbenchTheme, extension: IExtension | null | undefined, showCurrentTheme: boolean): QuickPickItem[] {
    ...
    for (const theme of themes) {
        if (isThemeFromExtension(theme, extension) &&
...
export class SetColorThemeAction extends ExtensionAction {
    ...
    override async run({ showCurrentTheme, ignoreFocusLost, }: {
    ...
    override async run(): Promise<any> {
        ...
        if (extension) {
            ...
            try {
                ...
                this.instantiationService
                    .createInstance(PromptExtensionInstallFailureAction, extension, undefined, extension.latestVersion, InstallOperation.Install, err)
                    .run();
            }
        }
    }
...
export abstract class AbstractConfigureRecommendedExtensionsAction extends Action {
    ...
    protected openExtensionsFile(extensionsFileResource: URI): Promise<any> {
        return this.getOrCreateExtensionsFile(extensionsFileResource).then(({ created, content }) => this.getSelectionPosition(content, extensionsFileResource, [
            "recommendations",
        ...
        return Promise.resolve(this.fileService.readFile(workspaceConfigurationFile)).then((content) => {
            ...
            if (!workspaceRecommendations ||
                ...
                return this.jsonEditingService
                    .write(workspaceConfigurationFile, [
                    {
                        path: ["extensions"],
    ...
    private getSelectionPosition(content: string, resource: URI, path: json.JSONPath): Promise<ITextEditorSelection | undefined> {
        ...
        if (node && node.parent && node.parent.children) {
            ...
            const lastExtensionNode = recommendationsValueNode.children &&
    ...
    public override run(): Promise<void> {
        switch (this.contextService.getWorkbenchState()) {
            case WorkbenchState.FOLDER:
                return this.openExtensionsFile(this.contextService
                    .getWorkspace()
...
export class ExtensionStatusLabelAction extends Action implements IExtensionContainer {
    ...
    private computeLabel(): string | null {
        ...
        if (currentStatus !== null) {
            if (currentStatus === ExtensionState.Installing &&
                this.status === ExtensionState.Installed) {
                if (this.initialStatus === ExtensionState.Uninstalled &&
                    canAddExtension()) {
                    return localize("installed", "Installed");
                }
                if (this.initialStatus === ExtensionState.Installed &&
            ...
            if (currentStatus === ExtensionState.Uninstalling &&
...
export class ExtensionStatusAction extends ExtensionAction {
    ...
    private async computeAndUpdateStatus(): Promise<void> {
        ...
        if (this.extension.enablementState ===
            EnablementState.DisabledByEnvironment) {
            this.updateStatus({
            ...
            (this.extension.enablementState ===
                ...
                (this.extension.enablementState ===
                    ...
                    this.workbenchExtensionEnablementService
                        ...
                        .every(([, enablementState]) => this.workbenchExtensionEnablementService.isEnabledEnablementState(enablementState) ||
                        enablementState ===
                            EnablementState.DisabledByTrustRequirement)))) {
            this.enabled = true;
        ...
        if (this.extension.enablementState ===
            ...
            if (!this.extensionsWorkbenchService.installed.some((e) => areSameExtensions(e.identifier, this.extension!.identifier) && e.server !== this.extension!.server)) {
                ...
                else if (this.extensionManagementServerService
                    .remoteExtensionManagementServer ===
                    this.extension.server) {
            ...
            if (isLanguagePackExtension(this.extension.local.manifest)) {
                if (!this.extensionsWorkbenchService.installed.some((e) => areSameExtensions(e.identifier, this.extension!.identifier) && e.server !== this.extension!.server)) {
                    const message = this.extension.server ===
                        this.extensionManagementServerService
                            .localExtensionManagementServer
                        ? new MarkdownString(localize("Install language pack also in remote server", "Install the language pack extension on '{0}' to enable it there also.", this.extensionManagementServerService
                            .remoteExtensionManagementServer
                            .label))
    ...
    private updateStatus(status: ExtensionStatus | undefined, updateClass: boolean): void {
        if (status) {
            if (this._status.some((s) => s.message.value === status.message.value &&
...
export class ReinstallAction extends Action {
    ...
    constructor(id: string = ReinstallAction.ID, label: string = ReinstallAction.LABEL, 
    @IExtensionsWorkbenchService
    private readonly extensionsWorkbenchService: IExtensionsWorkbenchService, 
    @IExtensionManagementServerService
    private readonly extensionManagementServerService: IExtensionManagementServerService, 
    ...
    override run(): Promise<any> {
        return this.quickInputService
            ...
            placeHolder: localize("selectExtensionToReinstall", "Select Extension to Reinstall"),
        })
            .then((pick) => pick && this.reinstallExtension(pick.extension));
    }
    private getEntries(): Promise<(IQuickPickItem & {
    ...
    private reinstallExtension(extension: IExtension): Promise<void> {
        return this.extensionsWorkbenchService
            ...
            return this.extensionsWorkbenchService
                .reinstall(extension)
                .then((extension) => {
                const requireReload = !(extension.local &&
...
export class InstallSpecificVersionOfExtensionAction extends Action {
    ...
    constructor(id: string = InstallSpecificVersionOfExtensionAction.ID, label: string = InstallSpecificVersionOfExtensionAction.LABEL, 
    @IExtensionsWorkbenchService
    private readonly extensionsWorkbenchService: IExtensionsWorkbenchService, 
    @IQuickInputService
    private readonly quickInputService: IQuickInputService, 
...
export abstract class AbstractInstallExtensionsInServerAction extends Action {
    ...
    private async selectAndInstallExtensions(): Promise<void> {
        ...
        if (localExtensionsToInstall.length) {
            ...
            quickPick.items = localExtensionsToInstall.map<IExtensionPickItem>((extension) => ({
                extension,
                label: extension.displayName,
...
export class InstallLocalExtensionsInRemoteAction extends AbstractInstallExtensionsInServerAction {
    ...
    override get label(): string {
        if (this.extensionManagementServerService &&
            this.extensionManagementServerService
                .remoteExtensionManagementServer) {
            return localize("select and install local extensions", "Install Local Extensions in '{0}'...", this.extensionManagementServerService
                .remoteExtensionManagementServer.label);
        }
        return "";
    }
    protected getQuickPickTitle(): string {
        return localize("install local extensions title", "Install Local Extensions in '{0}'", this.extensionManagementServerService
            .remoteExtensionManagementServer!.label);
    }
    ...
    protected async installExtensions(localExtensionsToInstall: IExtension[]): Promise<void> {
        ...
        await Promises.settled(localExtensionsToInstall.map(async (extension) => {
            if (this.extensionGalleryService.isEnabled()) {
                ...
                ], { targetPlatform, compatible: true }, CancellationToken.None))[0];
                if (gallery) {
...
export class InstallRemoteExtensionsInLocalAction extends AbstractInstallExtensionsInServerAction {
    ...
    protected getExtensionsToInstall(local: IExtension[]): IExtension[] {
        return local.filter((extension) => extension.type === ExtensionType.User &&
            extension.server !==
                this.extensionManagementServerService
                    .localExtensionManagementServer &&
            !this.extensionsWorkbenchService.installed.some((e) => e.server ===
                this.extensionManagementServerService
                    .localExtensionManagementServer &&
