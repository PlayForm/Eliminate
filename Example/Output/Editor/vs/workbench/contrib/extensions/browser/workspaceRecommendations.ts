...
export class WorkspaceRecommendations extends ExtensionRecommendations {
    ...
    protected async doActivate(): Promise<void> {
        ...
        this._register(this.fileService.onDidFilesChange((e) => {
            if (this.contextService
                .getWorkspace()
                .folders.some((folder) => e.affects(this.uriIdentityService.extUri.joinPath(folder.uri, WORKSPACE_EXTENSIONS_FOLDER), FileChangeType.ADDED, FileChangeType.DELETED))) {
    ...
    private async validateExtensions(contents: IExtensionsConfigContent[]): Promise<{
