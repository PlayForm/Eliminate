...
class CommentingRangeDecorator {
    ...
    public getMatchedCommentAction(commentRange: Range | undefined): MergedCommentRangeActions[] {
        ...
        // keys is ownerId
        const foundHoverActions = new Map<string, {
            range: Range;
            action: CommentRangeAction;
        }>();
...
* @param type
*/
export function moveToNextCommentInThread(commentInfo: {
...
export function revealCommentThread(commentService: ICommentService, editorService: IEditorService, uriIdentityService: IUriIdentityService, commentThread: languages.CommentThread<IRange>, comment: languages.Comment | undefined, focusReply?: boolean, pinned?: boolean, preserveFocus?: boolean, sideBySide?: boolean): void {
...
export class CommentController implements IEditorContribution {
    ...
    private _pendingNewCommentCache: {
        [key: string]: {
            [key: string]: languages.PendingComment;
        };
    };
    ...
    private async displayCommentThread(uniqueOwner: string, thread: languages.CommentThread, shouldReveal: boolean, pendingComment: languages.PendingComment | undefined, pendingEdits: {
        [key: number]: languages.PendingComment;
