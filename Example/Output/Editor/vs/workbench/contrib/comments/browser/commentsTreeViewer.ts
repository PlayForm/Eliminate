...
export class CommentsMenus implements IDisposable {
    ...
    private getActions(menuId: MenuId, element: CommentNode): {
        primary: IAction[];
        secondary: IAction[];
    } {
...
export class CommentNodeRenderer implements IListRenderer<ITreeNode<CommentNode>, ICommentThreadTemplateData> {
    ...
    constructor(private actionViewItemProvider: IActionViewItemProvider, private menus: CommentsMenus, 
    @IOpenerService
...
export class CommentsList extends WorkbenchObjectTree<CommentsModel | ResourceWithCommentThreads | CommentNode, any> {
    ...
    constructor(labels: ResourceLabels, container: HTMLElement, options: ICommentsListOptions, 
    @IContextKeyService
