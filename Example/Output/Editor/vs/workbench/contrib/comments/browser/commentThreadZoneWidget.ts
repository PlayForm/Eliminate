...
export function isMouseUpEventDragFromMouseDown(mouseDownInfo: {
    lineNumber: number;
} | null, e: IEditorMouseEvent) {
    if (!mouseDownInfo) {
        return null;
    }
...
export function isMouseUpEventMatchMouseDown(mouseDownInfo: {
    lineNumber: number;
} | null, e: IEditorMouseEvent) {
    if (!mouseDownInfo) {
        return null;
...
export class ReviewZoneWidget extends ZoneWidget implements ICommentThreadWidget {
    ...
    constructor(editor: ICodeEditor, private _uniqueOwner: string, private _commentThread: languages.CommentThread, private _pendingComment: languages.PendingComment | undefined, private _pendingEdits: {
    ...
    protected _fillContainer(container: HTMLElement): void {
        ...
        this._commentThreadWidget = this._scopedInstantiationService.createInstance(CommentThreadWidget, container, this.editor, this._uniqueOwner, this.editor.getModel()!.uri, this._contextKeyService, this._scopedInstantiationService, this._commentThread as unknown as languages.CommentThread<IRange | ICellRange>, this._pendingComment, this._pendingEdits, { editor: this.editor, codeBlockFontSize: '', codeBlockFontFamily: this.configurationService.getValue<IEditorOptions>('editor').fontFamily || EDITOR_FONT_DEFAULTS.fontFamily }, this._commentOptions, {
            actionRunner: async () => {
