...
import { WalkThroughArrowDown, WalkThroughArrowUp, WalkThroughPageDown, WalkThroughPageUp, } from "./walkThroughActions.js";
import { WalkThroughInput } from "./walkThroughInput.js";
import { WalkThroughPart } from "./walkThroughPart.js";
Registry.as<IEditorPaneRegistry>(EditorExtensions.EditorPane).registerEditorPane(EditorPaneDescriptor.create(WalkThroughPart, WalkThroughPart.ID, localize("walkThrough.editor.label", "Playground")), [new SyncDescriptor(WalkThroughInput)]);
