...
import { ITerminalService as IIntegratedTerminalService, ITerminalGroupService, } from "../../terminal/browser/terminal.js";
    ...
    CommandsRegistry.registerCommand({
        ...
        handler: async (accessor, resource: URI) => {
            ...
            return fileService
                ...
                const useIntegratedTerminal = remoteAgentService.getConnection() ||
                ...
                if (useIntegratedTerminal) {
                    ...
                    distinct(targets.map(({ stat }) => stat!.isDirectory
                        ? stat!.resource.fsPath
                        : dirname(stat!.resource.fsPath))).forEach((cwd) => {
...
export class ExternalTerminalContribution extends Disposable implements IWorkbenchContribution {
    ...
    private isWindows(): boolean {
        const config = this._configurationService.getValue<IExternalTerminalConfiguration>()
            .terminal;
