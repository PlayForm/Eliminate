...
import { EditorInputCapabilities, EditorResourceAccessor, GroupIdentifier, IMoveResult, IRevertOptions, ISaveOptions, IUntypedEditorInput, } from "../../../common/editor.js";
...
import { SearchConfiguration, SearchEditorFindMatchClass, SearchEditorInputTypeId, SearchEditorScheme, SearchEditorWorkingCopyTypeId, } from "./constants.js";
...
export class SearchEditorInput extends EditorInput {
    ...
    constructor(public readonly modelUri: URI, public readonly backingUri: URI | undefined, 
    @IModelService
    ...
    storageService: IStorageService) {
        ...
        const workingCopyAdapter = new (class implements IWorkingCopy {
            ...
            readonly capabilities = input.hasCapability(EditorInputCapabilities.Untitled)
    ...
    override getName(maxLength = 12): string {
        const trimToMax = (label: string) => label.length < maxLength
            ? label
    ...
    override matches(other: EditorInput | IUntypedEditorInput): boolean {
        ...
        if (other instanceof SearchEditorInput) {
            return (!!(other.modelUri.fragment &&
...
export const getOrMakeSearchEditorInput = (accessor: ServicesAccessor, existingData: {
    from: "model";
    ...
    if (!searchEditorModelFactory.models.has(modelUri)) {
        if (existingData.from === "existingFile") {
            ...
            const priorConfig: SearchConfiguration = reuseOldSettings
                ? new Memento(SearchEditorInput.ID, storageService).getMemento(StorageScope.WORKSPACE, StorageTarget.MACHINE).searchConfig
                : {};
            ...
            if (defaultNumberOfContextLines !== null &&
