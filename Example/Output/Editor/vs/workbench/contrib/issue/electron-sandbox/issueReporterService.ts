...
export class IssueReporter extends BaseIssueReporterService {
    ...
    constructor(disableExtensions: boolean, data: IssueReporterData, os: {
        ...
        arch: string;
        release: string;
    }, product: IProductConfiguration, window: Window, 
    @INativeHostService
    ...
    public override async submitToGitHub(issueTitle: string, issueBody: string, gitHubDetails: {
        owner: string;
    ...
    private updateSystemInfo(state: IssueReporterModelData) {
        ...
        if (target) {
            ...
            const renderedDataTable = $("table", undefined, $("tr", undefined, $("td", undefined, "CPUs"), $("td", undefined, systemInfo.cpus || "")), $("tr", undefined, $("td", undefined, "GPU Status" as string), $("td", undefined, Object.keys(systemInfo.gpuStatus)
                .map((key) => `${key}: ${systemInfo.gpuStatus[key]}`)
                .join("\n"))), $("tr", undefined, $("td", undefined, "Load (avg)" as string), $("td", undefined, systemInfo.load || "")), $("tr", undefined, $("td", undefined, "Memory (System)" as string), $("td", undefined, systemInfo.memory)), $("tr", undefined, $("td", undefined, "Process Argv" as string), $("td", undefined, systemInfo.processArgs)), $("tr", undefined, $("td", undefined, "Screen Reader" as string), $("td", undefined, systemInfo.screenReader)), $("tr", undefined, $("td", undefined, "VM"), $("td", undefined, systemInfo.vmHint)));
