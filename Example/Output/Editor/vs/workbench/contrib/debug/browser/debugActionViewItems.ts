...
import { asCssVariable, selectBackground, selectBorder, } from "../../../../platform/theme/common/colorRegistry.js";
import { IWorkspaceContextService, WorkbenchState, } from "../../../../platform/workspace/common/workspace.js";
import { AccessibilityVerbositySettingId } from "../../accessibility/browser/accessibilityConfiguration.js";
import { AccessibilityCommandId } from "../../accessibility/common/accessibilityCommands.js";
import { IConfig, IDebugConfiguration, IDebugService, IDebugSession, ILaunch, State, } from "../common/debug.js";
...
export class StartDebugActionViewItem extends BaseActionViewItem {
    ...
    override render(container: HTMLElement): void {
        ...
        this.toDispose.push(this.selectBox.onDidSelect(async (e) => {
            ...
            const shouldBeSelected = target.handler
...
export class FocusSessionActionViewItem extends SelectActionViewItem<IDebugSession> {
    constructor(action: IAction, session: IDebugSession | undefined, 
    @IDebugService
