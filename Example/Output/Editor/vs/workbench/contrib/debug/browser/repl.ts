...
export class Repl extends FilterViewPane implements IHistoryNavigationWidget {
    ...
    private createReplTree(): void {
        ...
        const tree = this.tree = <WorkbenchAsyncDataTree<IDebugSession, IReplElement, FuzzyScore>>this.instantiationService.createInstance(WorkbenchAsyncDataTree, 'DebugRepl', this.treeContainer, this.replDelegate, [
...
class ReplOptions extends Disposable implements IReplOptions {
    ...
    constructor(viewId: string, private readonly backgroundColorDelegate: () => string, 
    @IConfigurationService
