...
export class DebugSession implements IDebugSession, IDisposable {
    ...
    constructor(private id: string, private _configuration: {
        resolved: IConfig;
        unresolved: IConfig | undefined;
    }, public root: IWorkspaceFolder | undefined, private model: DebugModel, options: IDebugSessionOptions | undefined, 
    @IDebugService
    ...
    private async _dataBreakpointInfo(args: DebugProtocol.DataBreakpointInfoArguments): Promise<{
        dataId: string | null;
        description: string;
        canPersist?: boolean;
    } | undefined> {
