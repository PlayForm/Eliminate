...
export const topStackFrameColor = registerColor("editor.stackFrameHighlightBackground", {
    dark: "#ffff0033",
    light: "#ffff6673",
    hcDark: "#ffff0033",
    hcLight: "#ffff6673",
}, localize("topStackFrameLineHighlight", "Background color for the highlight of line at the top stack frame position."));
export const focusedStackFrameColor = registerColor("editor.focusedStackFrameHighlightBackground", {
    dark: "#7abd7a4d",
    light: "#cee7ce73",
    hcDark: "#7abd7a4d",
    hcLight: "#cee7ce73",
}, localize("focusedStackFrameLineHighlight", "Background color for the highlight of line at focused stack frame position."));
                ...
                if (t.stopped) {
                    ...
                    stackFrames.forEach((candidateStackFrame) => {
                        if (candidateStackFrame &&
                            ...
                            if (candidateStackFrame.range.startLineNumber >
                            ...
                            const noCharactersBefore = editor
                                .getModel()
                                .getLineFirstNonWhitespaceColumn(candidateStackFrame.range
                                .startLineNumber) >=
