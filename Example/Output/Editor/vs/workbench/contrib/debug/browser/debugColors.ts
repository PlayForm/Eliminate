...
import { badgeBackground, badgeForeground, contrastBorder, editorInfoForeground, editorWarningForeground, errorForeground, foreground, inputBorder, listDeemphasizedForeground, registerColor, toolbarHoverBackground, } from "../../../../platform/theme/common/colorRegistry.js";
...
export function registerColors() {
    ...
    const debugTokenExpressionType = registerColor("debugTokenExpression.type", {
        dark: "#4A90E2",
        light: "#4A90E2",
        hcDark: foreground,
        hcLight: foreground,
    }, "Foreground color for the token types shown in the debug views (ie. the Variables or Watch view).");
    const debugTokenExpressionValue = registerColor("debugTokenExpression.value", {
        dark: "#cccccc99",
        light: "#6c6c6ccc",
        hcDark: foreground,
        hcLight: foreground,
    }, "Foreground color for the token values shown in the debug views (ie. the Variables or Watch view).");
    const debugTokenExpressionString = registerColor("debugTokenExpression.string", {
        dark: "#ce9178",
        light: "#a31515",
        hcDark: "#f48771",
        hcLight: "#a31515",
    }, "Foreground color for strings in the debug views (ie. the Variables or Watch view).");
    const debugTokenExpressionBoolean = registerColor("debugTokenExpression.boolean", {
        dark: "#4e94ce",
        light: "#0000ff",
        hcDark: "#75bdfe",
        hcLight: "#0000ff",
    }, "Foreground color for booleans in the debug views (ie. the Variables or Watch view).");
    const debugTokenExpressionNumber = registerColor("debugTokenExpression.number", {
        dark: "#b5cea8",
        light: "#098658",
        hcDark: "#89d185",
        hcLight: "#098658",
    }, "Foreground color for numbers in the debug views (ie. the Variables or Watch view).");
    const debugTokenExpressionError = registerColor("debugTokenExpression.error", {
        dark: "#f48771",
        light: "#e51400",
        hcDark: "#f48771",
        hcLight: "#e51400",
    ...
    const debugViewExceptionLabelForeground = registerColor("debugView.exceptionLabelForeground", {
        dark: foreground,
        light: "#FFF",
        hcDark: foreground,
        hcLight: foreground,
    }, "Foreground color for a label shown in the CALL STACK view when the debugger breaks on an exception.");
    const debugViewExceptionLabelBackground = registerColor("debugView.exceptionLabelBackground", {
        dark: "#6C2022",
        light: "#A31515",
        hcDark: "#6C2022",
        hcLight: "#A31515",
