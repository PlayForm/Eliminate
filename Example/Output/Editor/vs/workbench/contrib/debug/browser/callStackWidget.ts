...
export class CallStackFrame {
    constructor(public readonly name: string, public readonly source?: URI, public readonly line = 1, public readonly column = 1) { }
}
export class SkippedCallFrames {
    constructor(public readonly label: string, public readonly load: (token: CancellationToken) => Promise<AnyStackFrame[]>) { }
}
...
const isFrameLike = (item: unknown): item is IFrameLikeItem => item instanceof WrappedCallStackFrame ||
...
export class CallStackWidget extends Disposable {
    ...
    constructor(container: HTMLElement, containingEditor: ICodeEditor | undefined, 
