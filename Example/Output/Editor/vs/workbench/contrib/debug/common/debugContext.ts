...
import { CONTEXT_CAN_VIEW_MEMORY, CONTEXT_DEBUG_PROTOCOL_VARIABLE_MENU_CONTEXT, CONTEXT_DEBUG_TYPE, CONTEXT_VARIABLE_EVALUATE_NAME_PRESENT, CONTEXT_VARIABLE_IS_READONLY, } from "./debug.js";
import { Variable } from "./debugModel.js";
/**
 * Gets a context key overlay that has context for the given variable.
 */
export function getContextForVariable(parentContext: IContextKeyService, variable: Variable, additionalContext: [
    string,
    unknown
][] = []) {
    ...
    const contextKeys: [
        ...
        [
            ...
            !!session?.capabilities.supportsReadMemoryRequest &&
                variable.memoryReference !== undefined,
        ],
        [
