...
import { DebugConfigurationProviderTriggerKind, debuggerDisabledMessage, IAdapterManager, IConfig, IDebugAdapter, IDebugger, IDebuggerContribution, IDebuggerMetadata, IDebugService, IDebugSession, } from "./debug.js";
...
export class Debugger implements IDebugger, IDebuggerMetadata {
    ...
    get strings() {
        return (this.debuggerContribution.strings ??
    ...
    getCustomTelemetryEndpoint(): ITelemetryEndpoint | undefined {
        ...
        const sendErrorTelemtry = cleanRemoteAuthority(this.environmentService.remoteAuthority) !==
            "other";
        return {
