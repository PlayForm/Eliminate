...
export const CONTEXT_HAS_DEBUGGED = new RawContextKey<boolean>("hasDebugged", false, {
    type: "boolean",
...
export const CONTEXT_BREAKPOINT_ITEM_IS_DATA_BYTES = new RawContextKey<boolean>("breakpointItemBytes", undefined, {
    type: "boolean",
    description: nls.localize("breakpointItemIsDataBytes", "Whether the breakpoint item is a data breakpoint on a byte range."),
});
export const CONTEXT_BREAKPOINT_HAS_MODES = new RawContextKey<boolean>("breakpointHasModes", false, {
    type: "boolean",
...
export const CONTEXT_FOCUSED_SESSION_IS_NO_DEBUG = new RawContextKey<boolean>("focusedSessionIsNoDebug", false, {
    type: "boolean",
...
export const CONTEXT_DEBUG_EXTENSION_AVAILABLE = new RawContextKey<boolean>("debugExtensionAvailable", true, {
    type: "boolean",
...
export const CONTEXT_SET_DATA_BREAKPOINT_BYTES_SUPPORTED = new RawContextKey<boolean>("debugSetDataBreakpointAddressSupported", false, {
    type: "boolean",
...
export const CONTEXT_SET_EXPRESSION_SUPPORTED = new RawContextKey<boolean>("debugSetExpressionSupported", false, {
    type: "boolean",
...
export const CONTEXT_TERMINATE_DEBUGGEE_SUPPORTED = new RawContextKey<boolean>("terminateDebuggeeSupported", false, {
    type: "boolean",
...
export const CONTEXT_SUSPEND_DEBUGGEE_SUPPORTED = new RawContextKey<boolean>("suspendDebuggeeSupported", false, {
    type: "boolean",
...
export const CONTEXT_VARIABLE_IS_READONLY = new RawContextKey<boolean>("variableIsReadonly", false, {
    type: "boolean",
    description: nls.localize("variableIsReadonly", "True when the focused variable is read-only."),
});
export const CONTEXT_VARIABLE_VALUE = new RawContextKey<boolean>("variableValue", false, {
    type: "string",
    description: nls.localize("variableValue", "Value of the variable, present for debug visualization clauses."),
});
export const CONTEXT_VARIABLE_TYPE = new RawContextKey<boolean>("variableType", false, {
    type: "string",
    description: nls.localize("variableType", "Type of the variable, present for debug visualization clauses."),
});
export const CONTEXT_VARIABLE_INTERFACES = new RawContextKey<boolean>("variableInterfaces", false, {
    type: "array",
...
export const CONTEXT_VARIABLE_NAME = new RawContextKey<boolean>("variableName", false, {
    type: "string",
    description: nls.localize("variableName", "Name of the variable, present for debug visualization clauses."),
});
export const CONTEXT_VARIABLE_LANGUAGE = new RawContextKey<boolean>("variableLanguage", false, {
    type: "string",
    description: nls.localize("variableLanguage", "Language of the variable source, present for debug visualization clauses."),
});
export const CONTEXT_VARIABLE_EXTENSIONID = new RawContextKey<boolean>("variableExtensionId", false, {
    type: "string",
...
export const CONTEXT_DISASSEMBLE_REQUEST_SUPPORTED = new RawContextKey<boolean>("disassembleRequestSupported", false, {
    type: "boolean",
...
export const CONTEXT_LANGUAGE_SUPPORTS_DISASSEMBLE_REQUEST = new RawContextKey<boolean>("languageSupportsDisassembleRequest", false, {
    type: "boolean",
...
export const CONTEXT_FOCUSED_STACK_FRAME_HAS_INSTRUCTION_POINTER_REFERENCE = new RawContextKey<boolean>("focusedStackFrameHasInstructionReference", false, {
    type: "boolean",
