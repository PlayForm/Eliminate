...
import { DataBreakpointSetType, DataBreakpointSource, DEBUG_MEMORY_SCHEME, DebugTreeItemCollapsibleState, IBaseBreakpoint, IBreakpoint, IBreakpointData, IBreakpointsChangeEvent, IBreakpointUpdateData, IDataBreakpoint, IDebugEvaluatePosition, IDebugModel, IDebugSession, IDebugVisualizationTreeItem, IEnablement, IExceptionBreakpoint, IExceptionInfo, IExpression, IExpressionContainer, IFunctionBreakpoint, IInstructionBreakpoint, IMemoryInvalidationEvent, IMemoryRegion, IRawModelUpdate, IRawStoppedDetails, IScope, isFrameDeemphasized, IStackFrame, IThread, ITreeElement, MemoryRange, MemoryRangeType, State, } from "./debug.js";
import { getUriFromSource, Source, UNKNOWN_SOURCE_LABEL, } from "./debugSource.js";
...
export class ExpressionContainer implements IExpressionContainer {
    ...
    constructor(protected session: IDebugSession | undefined, protected readonly threadId: number | undefined, private _reference: number | undefined, private readonly id: string, public namedVariables: number | undefined = 0, public indexedVariables: number | undefined = 0, public memoryReference: string | undefined = undefined, private startOfVariables: number | undefined = 0, public presentationHint: DebugProtocol.VariablePresentationHint | undefined = undefined, public valueLocationReference: number | undefined = undefined) { }
    ...
    async evaluateExpression(expression: string, session: IDebugSession | undefined, stackFrame: IStackFrame | undefined, context: string, keepLazyVars = false, location?: IDebugEvaluatePosition): Promise<boolean> {
...
export class VisualizedExpression implements IExpression {
    ...
    get hasChildren() {
        return (this.treeItem.collapsibleState !==
            DebugTreeItemCollapsibleState.None);
    }
    constructor(private readonly session: IDebugSession | undefined, private readonly visualizer: IDebugVisualizerService, public readonly treeId: string, public readonly treeItem: IDebugVisualizationTreeItem, public readonly original?: Variable) { }
...
export class Scope extends ExpressionContainer implements IScope {
    constructor(public readonly stackFrame: IStackFrame, id: number, public readonly name: string, reference: number, public expensive: boolean, namedVariables?: number, indexedVariables?: number, public readonly range?: IRange) {
...
export class StackFrame implements IStackFrame {
        ...
        if (!this.scopes) {
            this.scopes = this.thread.session
                ...
                return response.body.scopes.map((rs) => {
                    ...
                    usedIds.add(id);
                    return new Scope(this, id, rs.name, rs.variablesReference, rs.expensive, rs.namedVariables, rs.indexedVariables, rs.line &&
                        rs.column &&
                        rs.endLine &&
                        rs.endColumn
    ...
    toString(): string {
        const lineNumberToString = typeof this.range.startLineNumber === "number"
...
export class Thread implements IThread {
    ...
    getTopStackFrame(): IStackFrame | undefined {
        ...
        const firstAvailableStackFrame = callStack.find((sf) => !!(((stopReason === "instruction breakpoint" ||
            ...
            (sf.source &&
                sf.source.available &&
                (KEEP_SUBTLE_FRAME_AT_TOP_REASONS.includes(stopReason!) ||
        ...
        if (this.stoppedDetails) {
            return (this.stoppedDetails.description ||
                (this.stoppedDetails.reason
                    ...
                    }, "Paused on {0}", this.stoppedDetails.reason)
 ...
 */
export const getUriForDebugMemory = (sessionId: string, memoryReference: string, range?: {
    fromOffset: number;
    toOffset: number;
}, displayName = "memory") => {
    return URI.from({
...
export class Enablement implements IEnablement {
    constructor(public enabled: boolean, private readonly id: string) { }
    getId(): string {
        return this.id;
    }
}
...
export class Breakpoint extends BaseBreakpoint implements IBreakpoint {
    ...
    constructor(opts: IBreakpointOptions, private readonly textFileService: ITextFileService, private readonly uriIdentityService: IUriIdentityService, private readonly logService: ILogService, id = generateUuid()) {
        super(id, opts);
        this._uri = opts.uri;
    ...
    override toJSON(): IBreakpointOptions & {
        id: string;
    } {
        return {
            ...super.toJSON(),
...
export class FunctionBreakpoint extends BaseBreakpoint implements IFunctionBreakpoint {
    ...
    override toJSON(): IFunctionBreakpointOptions & {
        id: string;
    } {
        return {
            ...super.toJSON(),
...
export class DataBreakpoint extends BaseBreakpoint implements IDataBreakpoint {
    ...
    override toJSON(): IDataBreakpointOptions & {
        id: string;
    } {
        return {
            ...super.toJSON(),
...
export class ExceptionBreakpoint extends BaseBreakpoint implements IExceptionBreakpoint {
    ...
    override toJSON(): IExceptionBreakpointOptions & {
        id: string;
    } {
        return {
            ...super.toJSON(),
...
export class InstructionBreakpoint extends BaseBreakpoint implements IInstructionBreakpoint {
    ...
    override toJSON(): IInstructionBreakpointOptions & {
        id: string;
    } {
        return {
            ...super.toJSON(),
...
export class DebugModel extends Disposable implements IDebugModel {
    ...
    private schedulers = new Map<string, {
        scheduler: RunOnceScheduler;
        completeDeferred: DeferredPromise<void>;
    }>();
    ...
    constructor(debugStorage: DebugStorage, 
    @ITextFileService
    ...
    addSession(session: IDebugSession): void {
        ...
        if (session.parentSession) {
            ...
            index = findLastIdx(this.sessions, (s) => s.parentSession === session.parentSession ||
    ...
    async fetchCallstack(thread: IThread, levels?: number): Promise<void> {
        ...
        const remainingFrames = typeof totalFrames === "number"
    ...
    refreshTopOfCallstack(thread: Thread, fetchFullStack = true): {
                        ...
                        this.schedulers.set(thread.getId(), {
                            ...
                            scheduler: new RunOnceScheduler(() => {
                                thread
                                    ...
                                    for (let i = 1; i < stale.length &&
                                        !bottomOfCallStackChanged; i++) {
