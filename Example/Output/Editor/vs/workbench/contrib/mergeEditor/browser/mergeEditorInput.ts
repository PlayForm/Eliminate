...
export class MergeEditorInputData {
    constructor(readonly uri: URI, readonly title: string | undefined, readonly detail: string | undefined, readonly description: string | undefined) { }
}
export class MergeEditorInput extends AbstractTextResourceEditorInput implements ILanguageSupport {
    ...
    private get useWorkingCopy() {
        return (this.configurationService.getValue("mergeEditor.useWorkingCopy") ??
            false);
    }
    constructor(public readonly base: URI, public readonly input1: MergeEditorInputData, public readonly input2: MergeEditorInputData, public readonly result: URI, 
    ...
    private readonly mergeEditorModeFactory = this._instaService.createInstance(this.useWorkingCopy
