...
export class MergeMarkersController extends Disposable {
    ...
    public constructor(public readonly editor: ICodeEditor, public readonly mergeEditorViewModel: IObservable<MergeEditorViewModel | undefined>) {
        super();
...
function getBlocks(document: ITextModel, configuration: ProjectionConfiguration): {
    blocks: Block[];
