...
export class LineRangeMapping {
    ...
    constructor(public readonly inputRange: LineRange, public readonly outputRange: LineRange) { }
    public extendInputRange(extendedInputRange: LineRange): LineRangeMapping {
        ...
        const startDelta = extendedInputRange.startLineNumber -
            this.inputRange.startLineNumber;
        const endDelta = extendedInputRange.endLineNumberExclusive -
    ...
    public get resultingDeltaFromOriginalToModified(): number {
        return (this.outputRange.endLineNumberExclusive -
            this.inputRange.endLineNumberExclusive);
    }
...
export class DocumentLineRangeMap {
     ...
     */
    public readonly lineRangeMappings: LineRangeMapping[], public readonly inputLineCount: number) {
        assertFn(() => {
...
export class MappingAlignment<T extends LineRangeMapping> {
    ...
    constructor(public readonly inputRange: LineRange, public readonly output1Range: LineRange, public readonly output1LineMappings: T[], public readonly output2Range: LineRange, public readonly output2LineMappings: T[]) { }
    public toString(): string {
