...
export class EditorGutter<T extends IGutterItemInfo = IGutterItemInfo> extends Disposable {
    private readonly scrollTop = observableFromEvent(this, this._editor.onDidScrollChange, (e) => 
    ...
    private readonly modelAttached = observableFromEvent(this, this._editor.onDidChangeModel, (e) => 
    ...
    private render(reader: IReader): void {
        ...
        if (visibleRanges.length > 0) {
            ...
            for (const gutterItem of gutterItems) {
                ...
                const top = gutterItem.range.startLineNumber <=
