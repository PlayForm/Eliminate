...
import { getLogLevel, ILoggerService, ILogService, LogLevel, LogLevelToString, parseLogLevel, } from "../../../../platform/log/common/log.js";
...
class DefaultLogLevelsService extends Disposable implements IDefaultLogLevelsService {
    ...
    async getDefaultLogLevels(): Promise<DefaultLogLevels> {
        ...
        return {
            ...
            extensions: argvLogLevel?.extensions ??
