...
import { CONTEXT_LOG_LEVEL, ILoggerResource, ILoggerService, ILogService, isLogLevel, LogLevel, LogLevelToString, } from "../../../../platform/log/common/log.js";
import { Registry } from "../../../../platform/registry/common/platform.js";
import { IUriIdentityService } from "../../../../platform/uriIdentity/common/uriIdentity.js";
import { IWorkbenchContribution, IWorkbenchContributionsRegistry, Extensions as WorkbenchExtensions, } from "../../../common/contributions.js";
import { LifecyclePhase } from "../../../services/lifecycle/common/lifecycle.js";
import { showWindowLogActionId, windowLogId, } from "../../../services/log/common/logConstants.js";
...
class LogOutputChannels extends Disposable implements IWorkbenchContribution {
    ...
    private registerLogChannel(logger: ILoggerResource): void {
        ...
        if (channel &&
            this.uriIdentityService.extUri.isEqual(channel.file, logger.resource)) {
            return;
        }
        ...
        const promise = createCancelablePromise(async (token) => {
            ...
            try {
                ...
                const remoteLogger = existingChannel?.file?.scheme === Schemas.vscodeRemote
                    ? this.loggerService.getRegisteredLogger(existingChannel.file)
                    : undefined;
                if (remoteLogger) {
                    this.deregisterLogChannel(remoteLogger);
                }
                const hasToAppendRemote = existingChannel &&
