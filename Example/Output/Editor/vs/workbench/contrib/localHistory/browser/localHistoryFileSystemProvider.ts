...
import { FileSystemProviderCapabilities, FileType, hasReadWriteCapability, IFileDeleteOptions, IFileOverwriteOptions, IFileService, IFileSystemProvider, IFileSystemProviderWithFileReadWriteCapability, IFileWriteOptions, IStat, IWatchOptions, } from "../../../../platform/files/common/files.js";
