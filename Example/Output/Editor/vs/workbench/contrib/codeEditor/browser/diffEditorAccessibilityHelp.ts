...
export class DiffEditorAccessibilityHelp implements IAccessibleViewImplentation {
    ...
    getProvider(accessor: ServicesAccessor) {
        ...
        return new AccessibleContentProvider(AccessibleViewProviderId.DiffEditor, { type: AccessibleViewType.Help }, () => content.join('\n'), () => codeEditor.focus(), AccessibilityVerbositySettingId.DiffEditor);
    }
}
