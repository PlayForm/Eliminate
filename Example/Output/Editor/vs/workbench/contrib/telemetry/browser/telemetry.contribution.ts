...
import { basename, extname, isEqual, isEqualOrParent, } from "../../../../base/common/resources.js";
...
import { ITextFileResolveEvent, ITextFileSaveEvent, ITextFileService, } from "../../../services/textfile/common/textfiles.js";
...
export class TelemetryContribution extends Disposable implements IWorkbenchContribution {
    ...
    private onTextFileModelResolved(e: ITextFileResolveEvent): void {
        ...
        if (settingsType) {
            ...
            this.telemetryService.publicLog2<{
                settingsType: string;
            }, SettingsReadClassification>("settingsRead", { settingsType }); // Do not log read to user settings.json and .vscode folder as a fileGet event as it ruins our JSON usage data
        }
        else {
    ...
    private onTextFileModelSaved(e: ITextFileSaveEvent): void {
        ...
        if (settingsType) {
            ...
            this.telemetryService.publicLog2<{
                settingsType: string;
            }, SettingsWrittenClassification>("settingsWritten", { settingsType }); // Do not log write to user settings.json and .vscode folder as a filePUT event as it ruins our JSON usage data
        }
        else {
...
class ConfigurationTelemetryContribution extends Disposable implements IWorkbenchContribution {
    ...
    private getValueToReport(key: string, target: ConfigurationTarget.USER_LOCAL | ConfigurationTarget.WORKSPACE): string | undefined {
        ...
        const value = target === ConfigurationTarget.USER_LOCAL
