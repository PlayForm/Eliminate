...
import { isWeb, platform, PlatformName, PlatformToString, } from "../../../../base/common/platform.js";
...
import { IQuickInputButton, IQuickInputService, QuickPickItem, } from "../../../../platform/quickinput/common/quickInput.js";
...
export class RemoteStatusIndicator extends Disposable implements IWorkbenchContribution {
    ...
    private registerActions(): void {
        ...
        if (RemoteStatusIndicator.SHOW_CLOSE_REMOTE_COMMAND_ID) {
            this._register(registerAction2(class extends Action2 {
                ...
                run = () => that.hostService.openWindow({
    ...
    private withNetworkStatus(initialText: string, initialTooltip?: string | MarkdownString, showProgress?: boolean): {
        text: string;
            ...
            for (const actionGroup of actionGroups) {
                ...
                for (const action of actionGroup[1]) {
                    if (action instanceof MenuItemAction) {
                        ...
                        const label = typeof action.item.title === "string"
                            ? action.item.title
