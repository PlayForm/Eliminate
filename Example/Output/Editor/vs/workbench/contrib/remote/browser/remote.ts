...
class HelpModel {
    ...
    constructor(private viewModel: IViewModel, private openerService: IOpenerService, private quickInputService: IQuickInputService, private commandService: ICommandService, private remoteExplorerService: IRemoteExplorerService, private environmentService: IWorkbenchEnvironmentService, private workspaceContextService: IWorkspaceContextService, private walkthroughsService: IWalkthroughsService) {
        this.updateItems();
    ...
    private createHelpItemValue(info: HelpInformation, infoKey: Exclude<keyof HelpInformation, "extensionDescription" | "remoteName" | "virtualWorkspace">) {
        return new HelpItemValue(this.commandService, this.walkthroughsService, info.extensionDescription, typeof info.remoteName === "string"
            ? [info.remoteName]
            : info.remoteName, info.virtualWorkspace, info[infoKey]);
    }
    private updateItems() {
...
class HelpItemValue {
    ...
    constructor(private commandService: ICommandService, private walkthroughService: IWalkthroughsService, public extensionDescription: IExtensionDescription, public readonly remoteAuthority: string[] | undefined, public readonly virtualWorkspace: string | undefined, private urlOrCommandOrId?: string | {
        id: string;
    }) { }
...
abstract class HelpItemBase implements IHelpItem {
    ...
    constructor(public icon: ThemeIcon, public label: string, public values: HelpItemValue[], private quickInputService: IQuickInputService, private environmentService: IWorkbenchEnvironmentService, private remoteExplorerService: IRemoteExplorerService, private workspaceContextService: IWorkspaceContextService) {
    ...
    protected async getActions(): Promise<{
        ...
        return (await Promise.all(this.values.map(async (value) => {
            return {
                label: value.extensionDescription.displayName ||
...
class GetStartedHelpItem extends HelpItemBase {
    constructor(icon: ThemeIcon, label: string, values: HelpItemValue[], quickInputService: IQuickInputService, environmentService: IWorkbenchEnvironmentService, private openerService: IOpenerService, remoteExplorerService: IRemoteExplorerService, workspaceContextService: IWorkspaceContextService, private commandService: ICommandService) {
...
class HelpItem extends HelpItemBase {
    constructor(icon: ThemeIcon, label: string, values: HelpItemValue[], quickInputService: IQuickInputService, environmentService: IWorkbenchEnvironmentService, private openerService: IOpenerService, remoteExplorerService: IRemoteExplorerService, workspaceContextService: IWorkspaceContextService) {
        super(icon, label, values, quickInputService, environmentService, remoteExplorerService, workspaceContextService);
    }
...
class IssueReporterItem extends HelpItemBase {
    constructor(icon: ThemeIcon, label: string, values: HelpItemValue[], quickInputService: IQuickInputService, environmentService: IWorkbenchEnvironmentService, private commandService: ICommandService, private openerService: IOpenerService, remoteExplorerService: IRemoteExplorerService, workspaceContextService: IWorkspaceContextService) {
        super(icon, label, values, quickInputService, environmentService, remoteExplorerService, workspaceContextService);
    }
...
class HelpPanel extends ViewPane {
    ...
    constructor(protected viewModel: IViewModel, options: IViewPaneOptions, 
    @IKeybindingService
    ...
    protected override renderBody(container: HTMLElement): void {
        ...
        this.tree = <WorkbenchAsyncDataTree<HelpModel, IHelpItem, IHelpItem>>(this.instantiationService.createInstance(WorkbenchAsyncDataTree, "RemoteHelp", treeContainer, new HelpTreeVirtualDelegate(), [new HelpTreeRenderer()], new HelpDataSource(), {
...
class RemoteViewPaneContainer extends FilterViewPaneContainer implements IViewModel {
    ...
    viewDescriptorService: IViewDescriptorService) {
        ...
        this._register((this.remoteSwitcher =
    ...
    private _handleRemoteInfoExtensionPoint(extension: IExtensionPointUser<HelpInformation>, helpInformation: HelpInformation[]) {
        ...
        if (!extension.value.documentation &&
...
export class RemoteAgentConnectionStatusListener extends Disposable implements IWorkbenchContribution {
    ...
    telemetryService: ITelemetryService) {
        ...
        if (connection) {
            ...
            function showProgress(location: ProgressLocation.Dialog | ProgressLocation.Notification | null, buttons: {
                label: string;
                callback: () => void;
            }[], initialReport: string | null = null): VisibleProgress {
                if (visibleProgress) {
