...
import { IEditableData, IViewDescriptor, IViewDescriptorService, } from "../../../common/views.js";
import { IWorkbenchEnvironmentService } from "../../../services/environment/common/environmentService.js";
import { IRemoteExplorerService, ITunnelItem, TUNNEL_VIEW_ID, TunnelEditId, TunnelType, } from "../../../services/remote/common/remoteExplorerService.js";
import { Attributes, CandidatePort, forwardedPortsViewEnabled, makeAddress, mapHasAddressLocalhostOrAllInterfaces, parseAddress, Tunnel, TunnelCloseReason, TunnelModel, TunnelSource, } from "../../../services/remote/common/tunnelModel.js";
...
class PortColumn implements ITableColumn<ITunnelItem, ActionBarCell> {
    ...
    project(row: ITunnelItem): ActionBarCell {
        ...
        return {
            ...
            editId: row.tunnelType === TunnelType.Add
                ? TunnelEditId.New
                : TunnelEditId.Label,
            tooltip,
        };
            ...
            validationOptions: {
                validation: (value) => {
                    ...
                    return {
                        ...
                        formatContent: true,
                        type: message.severity === Severity.Error
                            ? MessageType.ERROR
                            : MessageType.INFO,
                    };
                },
...
class TunnelItem implements ITunnelItem {
    static createFromTunnel(remoteExplorerService: IRemoteExplorerService, tunnelService: ITunnelService, tunnel: Tunnel, type: TunnelType = TunnelType.Forwarded, closeable?: boolean) {
    ...
    constructor(public tunnelType: TunnelType, public remoteHost: string, public remotePort: number, public source: {
        source: TunnelSource;
        description: string;
    }, public hasRunningProcess: boolean, public protocol: TunnelProtocol, public localUri?: URI, public localAddress?: string, public localPort?: number, public closeable?: boolean, public name?: string, private runningProcess?: string, private pid?: number, private _privacy?: TunnelPrivacyId | string, private remoteExplorerService?: IRemoteExplorerService, private tunnelService?: ITunnelService) { }
    get label(): string {
...
export class TunnelPanel extends ViewPane {
    ...
    constructor(protected viewModel: ITunnelViewModel, options: IViewPaneOptions, 
    @IKeybindingService
    ...
    private createTable(): void {
        ...
        this.tableDisposables.add(Event.debounce(this.viewModel.onForwardedPortsChanged, (_last, e) => e, 50)(() => {
            ...
            if ((lastPortCount === 0 || newPortCount === 0) &&
...
namespace LabelTunnelAction {
    ...
    export function handler(): ICommandHandler {
        return async (accessor, arg): Promise<{
            port: number;
            label: string;
        } | undefined> => {
            ...
            if (isITunnelItem(arg)) {
                ...
                const context = accessor
                    ...
                    .getContextKeyValue<string | undefined>(TunnelViewSelectionKeyName);
...
export namespace ForwardPortAction {
    ...
    function validateInput(remoteExplorerService: IRemoteExplorerService, tunnelService: ITunnelService, value: string, canElevate: boolean): {
        content: string;
        severity: Severity;
    } | null {
...
namespace OpenPortInBrowserCommandPaletteAction {
    ...
    export function handler(): ICommandHandler {
        return async (accessor, arg) => {
            ...
            const picked = await quickPickService.pick<QuickPickTunnel>(options, {
...
namespace CopyAddressAction {
    ...
    async function copyAddress(remoteExplorerService: IRemoteExplorerService, clipboardService: IClipboardService, tunnelItem: {
        remoteHost: string;
        remotePort: number;
    }) {
...
namespace ChangeLocalPortAction {
    ...
    function validateInput(tunnelService: ITunnelService, value: string, canElevate: boolean): {
        content: string;
        severity: Severity;
    } | null {
        if (!value.match(/^[0-9]+$/)) {
