...
import { getWorkbenchContribution, IWorkbenchContributionsRegistry, Extensions as WorkbenchExtensions, } from "../../../common/contributions.js";
...
export class PerfviewContrib {
    ...
    textModelResolverService: ITextModelService) {
        this._registration =
            textModelResolverService.registerTextModelContentProvider("perf", _instaService.createInstance(PerfModelContentProvider));
    }
    dispose(): void {
...
class PerfModelContentProvider implements ITextModelContentProvider {
    ...
    private _addSummary(md: MarkdownBuilder): void {
        ...
        if (typeof metrics.totalmem === "number" &&
...
class MarkdownBuilder {
    ...
    private toMarkdownTable(header: string[], rows: Array<Array<{
        toString(): string;
    } | undefined>>): string {
        let result = "";
