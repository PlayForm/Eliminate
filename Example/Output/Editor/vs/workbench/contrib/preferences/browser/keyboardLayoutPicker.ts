...
import { areKeyboardLayoutsEqual, getKeyboardLayoutId, IKeyboardLayoutInfo, IKeyboardLayoutService, parseKeyboardLayoutDescription, } from "../../../../platform/keyboardLayout/common/keyboardLayout.js";
    ...
    async run(accessor: ServicesAccessor): Promise<void> {
        ...
        const picks: QuickPickInput[] = layouts
            ...
            return {
                ...
                id: (layout as IUnknownLayout).text ||
