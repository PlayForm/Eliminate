...
import { Node, parseTree } from "../../../../base/common/json.js";
...
import { IModelDeltaDecoration, ITextModel, OverviewRulerLane, TrackedRangeStickiness, } from "../../../../editor/common/model.js";
    ...
    private _getDecorationForEntry(model: ITextModel, entry: Node): IModelDeltaDecoration | null {
        ...
        for (let i = 0, len = entry.children.length; i < len; i++) {
            ...
            if (typeof expectedUserSettingsLabel === "string" &&
                !KeybindingEditorDecorationsRenderer._userSettingsFuzzyEquals(value.value, expectedUserSettingsLabel)) {
                return this._createDecoration(false, resolvedKeybinding.getLabel(), usLabel, model, value);
            }
            return null;
        }
