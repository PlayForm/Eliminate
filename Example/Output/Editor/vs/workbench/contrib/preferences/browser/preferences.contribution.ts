...
Registry.as<IEditorPaneRegistry>(EditorExtensions.EditorPane).registerEditorPane(EditorPaneDescriptor.create(SettingsEditor2, SettingsEditor2.ID, nls.localize("settingsEditor2", "Settings Editor 2")), [new SyncDescriptor(SettingsEditor2Input)]);
Registry.as<IEditorPaneRegistry>(EditorExtensions.EditorPane).registerEditorPane(EditorPaneDescriptor.create(KeybindingsEditor, KeybindingsEditor.ID, nls.localize("keybindingsEditor", "Keybindings Editor")), [new SyncDescriptor(KeybindingsEditorInput)]);
            ...
            constructor() {
                super({
                    ...
                    menu: {
                        ...
                        when: ContextKeyExpr.notEquals(CURRENT_PROFILE_CONTEXT.key, that.userDataProfilesService.defaultProfile
                            .id),
                    },
                });
            }
        ...
        this._register(registerAction2(class extends Action2 {
            ...
            run(accessor: ServicesAccessor) {
                return accessor
                    ...
                    .createInstance(ConfigureLanguageBasedSettingsAction, ConfigureLanguageBasedSettingsAction.ID, ConfigureLanguageBasedSettingsAction.LABEL
                    .value)
                    .run();
            }
        }));
    ...
    private registerSettingsEditorActions() {
        ...
        this._register(registerAction2(class extends Action2 {
            ...
            run(accessor: ServicesAccessor): void {
                ...
                const activeElement = preferencesEditor.getContainer()?.ownerDocument
                    .activeElement;
        ...
        this._register(registerAction2(class extends Action2 {
            ...
            run(accessor: ServicesAccessor): void {
                ...
                if (preferencesEditor.currentFocusContext ===
                    SettingsFocusContext.SettingControl) {
                    preferencesEditor.focusSettings();
                }
                else if (preferencesEditor.currentFocusContext ===
            ...
            profileScopedActionDisposables.add(registerAction2(class DefineKeybindingAction extends Action2 {
                ...
                async run(accessor: ServicesAccessor): Promise<void> {
                    ...
                    if (isCodeEditor(codeEditor)) {
                        codeEditor
                            .getContribution<IDefineKeybindingEditorContribution>(DEFINE_KEYBINDING_EDITOR_CONTRIB_ID)
        ...
        for (const folder of this.workspaceContextService.getWorkspace()
            ...
            if (!CommandsRegistry.getCommand(commandId)) {
                ...
                MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
                    ...
                    when: ContextKeyExpr.and(ResourceContextKey.Resource.isEqualTo(this.preferencesService
                        .getFolderSettingsResource(folder.uri)!
                        .toString()), ContextKeyExpr.not("isInDiffEditor")),
                    group: "navigation",
                    order: 1,
                });
            }
