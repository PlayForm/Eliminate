...
import { asCssVariable, badgeBackground, badgeForeground, contrastBorder, editorBackground, foreground, listActiveSelectionBackground, listActiveSelectionForeground, listFocusBackground, listFocusForeground, listHoverBackground, listHoverForeground, listInactiveSelectionBackground, listInactiveSelectionForeground, registerColor, tableOddRowsBackgroundColor, } from "../../../../platform/theme/common/colorRegistry.js";
...
import { KEYBINDING_ENTRY_TEMPLATE_ID, KeybindingsEditorModel, } from "../../../services/preferences/browser/keybindingsEditorModel.js";
...
import { CONTEXT_KEYBINDING_FOCUS, CONTEXT_KEYBINDINGS_EDITOR, CONTEXT_KEYBINDINGS_SEARCH_FOCUS, CONTEXT_WHEN_FOCUS, KEYBINDINGS_EDITOR_COMMAND_ADD, KEYBINDINGS_EDITOR_COMMAND_CLEAR_SEARCH_RESULTS, KEYBINDINGS_EDITOR_COMMAND_COPY, KEYBINDINGS_EDITOR_COMMAND_COPY_COMMAND, KEYBINDINGS_EDITOR_COMMAND_COPY_COMMAND_TITLE, KEYBINDINGS_EDITOR_COMMAND_DEFINE, KEYBINDINGS_EDITOR_COMMAND_DEFINE_WHEN, KEYBINDINGS_EDITOR_COMMAND_RECORD_SEARCH_KEYS, KEYBINDINGS_EDITOR_COMMAND_REMOVE, KEYBINDINGS_EDITOR_COMMAND_RESET, KEYBINDINGS_EDITOR_COMMAND_SHOW_SIMILAR, KEYBINDINGS_EDITOR_COMMAND_SORTBY_PRECEDENCE, } from "../common/preferences.js";
...
import { keybindingsAddIcon, keybindingsEditIcon, keybindingsRecordKeysIcon, keybindingsSortIcon, preferencesClearInputIcon, } from "./preferencesIcons.js";
const $ = DOM.$;
export class KeybindingsEditor extends EditorPane implements IKeybindingsEditorPane {
    ...
    private createOverlayContainer(parent: HTMLElement): void {
        ...
        this._register(this.defineKeybindingWidget.onDidChange((keybindingStr) => this.defineKeybindingWidget.printExisting(this.keybindingsEditorModel!.fetch(`"${keybindingStr}"`)
            .length)));
        ...
        this.keybindingsTable = this._register(this.instantiationService.createInstance(WorkbenchTable, "KeybindingsEditor", this.keybindingsTableContainer, new Delegate(), [
            {
                ...
                project(row: IKeybindingItemEntry): IKeybindingItemEntry {
                    return row;
                },
            },
            {
            ...
            keyboardNavigationLabelProvider: {
                getKeyboardNavigationLabel: (e: IKeybindingItemEntry) => e.keybindingItem.commandLabel ||
    ...
    private renderKeybindingsEntries(reset: boolean, preserveFocus?: boolean): void {
        if (this.keybindingsEditorModel) {
            ...
            if (reset) {
                ...
                else if (this.editorService.activeEditorPane === this &&
                    !preserveFocus) {
                    this.focus();
                }
            }
    ...
    private getNewIndexOfUnassignedKeybinding(unassignedKeybinding: IKeybindingItemEntry): number {
        for (let index = 0; index < this.tableEntries.length; index++) {
            ...
            if (entry.templateId === KEYBINDING_ENTRY_TEMPLATE_ID) {
                ...
                if (keybindingItemEntry.keybindingItem.command ===
...
class Delegate implements ITableVirtualDelegate<IKeybindingItemEntry> {
    ...
    getHeight(element: IKeybindingItemEntry) {
        if (element.templateId === KEYBINDING_ENTRY_TEMPLATE_ID) {
            const commandIdMatched = (<IKeybindingItemEntry>element).keybindingItem.commandLabel &&
...
class CommandColumnRenderer implements ITableRenderer<IKeybindingItemEntry, ICommandColumnTemplateData> {
    ...
    renderElement(keybindingItemEntry: IKeybindingItemEntry, index: number, templateData: ICommandColumnTemplateData, height: number | undefined): void {
        ...
        if (keybindingItemEntry.commandIdMatches ||
...
class WhenInputWidget extends Disposable {
    ...
    constructor(parent: HTMLElement, keybindingsEditor: KeybindingsEditor, 
    @IInstantiationService
