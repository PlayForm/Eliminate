...
import { Disposable, DisposableStore, dispose, MutableDisposable, type IDisposable, } from "../../../../base/common/lifecycle.js";
...
import { CONTEXT_SETTINGS_EDITOR, CONTEXT_SETTINGS_ROW_FOCUS, CONTEXT_SETTINGS_SEARCH_FOCUS, CONTEXT_TOC_ROW_FOCUS, ENABLE_LANGUAGE_FILTER, EXTENSION_FETCH_TIMEOUT_MS, EXTENSION_SETTING_TAG, FEATURE_SETTING_TAG, getExperimentalExtensionToggleData, ID_SETTING_TAG, IPreferencesSearchService, ISearchProvider, LANGUAGE_SETTING_TAG, MODIFIED_SETTING_TAG, POLICY_SETTING_TAG, REQUIRE_TRUSTED_WORKSPACE_SETTING_TAG, SETTINGS_EDITOR_COMMAND_CLEAR_SEARCH_RESULTS, SETTINGS_EDITOR_COMMAND_SUGGEST_FILTERS, WORKSPACE_TRUST_SETTING_TAG, } from "../common/preferences.js";
...
export class SettingsEditor2 extends EditorPane {
    ...
    override async setInput(input: SettingsEditor2Input, options: ISettingsEditorOptions | undefined, context: IEditorOpenContext, token: CancellationToken): Promise<void> {
        ...
        if (!this.viewState.settingsTarget ||
            ...
            const optionsHasViewStateTarget = options.viewState &&
    ...
    private _setOptions(options: ISettingsEditorOptions): void {
        ...
        const target: SettingsTarget | undefined = options.folderUri ??
    ...
    layout(dimension: DOM.Dimension): void {
        ...
        const innerWidth = Math.min(this.headerContainer.clientWidth, dimension.width) -
    ...
    clearSearchFilters(): void {
        ...
        const splitQuery = query.split(" ").filter((word) => {
            return (word.length &&
                !SettingsEditor2.SUGGESTIONS.some((suggestion) => word.startsWith(suggestion)));
        });
    ...
    private onDidDismissExtensionSetting(extensionId: string): void {
        ...
        this.storageService.store(this.DISMISSED_EXTENSION_SETTINGS_STORAGE_KEY, this.dismissedExtensionSettings.join(this.DISMISSED_EXTENSION_SETTINGS_DELIMITER), StorageScope.PROFILE, StorageTarget.USER);
        this.onConfigUpdate(undefined, true);
    }
    ...
    private createBody(parent: HTMLElement): void {
        ...
        this._register(this.splitView.onDidSashReset(() => {
            const totalSize = this.splitView.getViewSize(0) +
    ...
    private updateChangedSetting(key: string, value: any, manualReset: boolean, languageFilter: string | undefined, scope: ConfigurationScope | undefined): Promise<void> {
        ...
        const configurationTarget = <ConfigurationTarget | null>((resource
        ...
        const configurationTargetIsWorkspace = configurationTarget === ConfigurationTarget.WORKSPACE ||
        ...
        return this.configurationService
            ...
            const reportModifiedProps = {
                ...
                showConfiguredOnly: !!this.viewState.tagFilters &&
    ...
    private reportModifiedSetting(props: {
        ...
        const reportedTarget = props.settingsTarget === ConfigurationTarget.USER_LOCAL
            ? "user"
    ...
    private async onConfigUpdate(keys?: ReadonlySet<string>, forceRefresh = false, schemaChange = false): Promise<void> {
        ...
        if (settingsResult.leftoverSettings.size &&
    ...
    private renderTree(key?: string, force = false): void {
        ...
        const focusedSetting = activeElement &&
            this.settingRenderers.getSettingDOMElementForDOMElement(activeElement);
    ...
    private _filterOrSearchPreferencesModel(filter: string, model: ISettingsEditorModel, provider?: ISearchProvider, token?: CancellationToken): Promise<ISearchResult | null> {
        ...
        return searchP.then<ISearchResult, ISearchResult | null>(undefined, (err) => {
    ...
    private layoutSplitView(dimension: DOM.Dimension): void {
        ...
        if (!hideTocForSearch) {
            ...
            const firstViewVisible = this.bodyContainer.clientWidth >=
...
class SyncControls extends Disposable {
    ...
    constructor(window: CodeWindow, container: HTMLElement, 
    @ICommandService
    ...
    telemetryService: ITelemetryService) {
        ...
        this.turnOnSyncButton = this._register(new Button(turnOnSyncButtonContainer, {
            title: true,
            ...defaultButtonStyles,
        }));
