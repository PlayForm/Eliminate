...
export class ScmMultiDiffSourceResolver implements IMultiDiffSourceResolver {
    ...
    async resolveDiffSource(uri: URI): Promise<IResolvedMultiDiffSource> {
        ...
        const repository = await waitForState(observableFromEvent(this, this._scmService.onDidAddRepository, () => [...this._scmService.repositories].find((r) => r.provider.rootUri?.toString() ===
...
class ScmResolvedMultiDiffSource implements IResolvedMultiDiffSource {
    private readonly _resources = observableFromEvent<MultiDiffEditorItem[]>(this._group.onDidChangeResources, () => 
