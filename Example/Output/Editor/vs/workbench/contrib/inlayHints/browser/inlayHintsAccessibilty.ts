...
import { asCommandLink, InlayHintItem, } from "../../../../editor/contrib/inlayHints/browser/inlayHints.js";
...
export class InlayHintsAccessibility implements IEditorContribution {
    static readonly IsReading = new RawContextKey<boolean>("isReadingLineWithInlayHints", false, {
        type: "boolean",
