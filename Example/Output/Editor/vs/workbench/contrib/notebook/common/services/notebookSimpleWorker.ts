...
class MirrorCell {
    ...
    constructor(public readonly handle: number, uri: URI, source: string[], private readonly _eol: string, versionId: number, public language: string, public cellKind: CellKind, public outputs: IOutputDto[], public metadata?: NotebookCellMetadata, public internalMetadata?: NotebookCellInternalMetadata) {
...
class MirrorNotebookDocument {
    constructor(readonly uri: URI, public cells: MirrorCell[], public metadata: NotebookDocumentMetadata, public transientDocumentMetadata: TransientDocumentMetadata) { }
...
export class NotebookEditorSimpleWorker implements IRequestHandler, IDisposable {
    ...
    private _models: {
        [uri: string]: MirrorNotebookDocument;
    };
    constructor() {
 ...
 */
        ...
        return {
            metadataChanged: JSON.stringify(originalMetadata) !==
