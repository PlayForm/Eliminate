...
export class NotebookHorizontalTracker extends Disposable {
    constructor(private readonly _notebookEditor: INotebookEditorDelegate, private readonly _listViewScrollablement: HTMLElement) {
        super();
        this._register(addDisposableListener(this._listViewScrollablement, EventType.MOUSE_WHEEL, (event: IMouseWheelEvent) => {
            ...
            const evt = {
                ...
                deltaY: 0,
                deltaZ: 0,
                wheelDelta: wheelDelta && isChrome
                    ? wheelDelta / targetWindow.devicePixelRatio
                    : wheelDelta,
                wheelDeltaX: wheelDeltaX && isChrome
