...
import { CELL_TITLE_CELL_GROUP_ID, cellExecutionArgs, CellToolbarOrder, executeNotebookCondition, getContextFromActiveEditor, getContextFromUri, INotebookActionContext, INotebookCellActionContext, INotebookCellToolbarActionContext, INotebookCommandContext, NOTEBOOK_EDITOR_WIDGET_ACTION_WEIGHT, NotebookAction, NotebookCellAction, NotebookMultiCellAction, parseMultiCellExecutionArgs, } from "./coreActions.js";
...
registerAction2(class ExecuteCellInsertBelow extends NotebookCellAction {
    ...
    async runWithContext(accessor: ServicesAccessor, context: INotebookCellActionContext): Promise<void> {
        ...
        const idx = context.notebookEditor.getCellIndex(context.cell);
        const languageService = accessor.get(ILanguageService);
        const newFocusMode = context.cell.focusMode === CellFocusMode.Editor
            ? "editor"
            : "container";
