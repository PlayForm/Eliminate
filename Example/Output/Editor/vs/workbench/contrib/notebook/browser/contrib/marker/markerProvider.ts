...
import { IMarkerListProvider, IMarkerNavigationService, MarkerList, } from "../../../../../../editor/contrib/gotoError/browser/markerNavigationService.js";
...
class MarkerListProvider implements IMarkerListProvider {
    ...
    markerNavigation: IMarkerNavigationService, 
...
class NotebookMarkerDecorationContribution extends Disposable implements INotebookEditorContribution {
    ...
    private readonly _markerService: IMarkerService) {
        ...
        this._register(this._markerService.onMarkerChanged((e) => {
            if (e.some((uri) => this._notebookEditor
                .getCellsInRange()
    ...
    private _update() {
        ...
        this._notebookEditor.getCellsInRange().forEach((cell) => {
            ...
            marker.forEach((m) => {
                const color = m.severity === MarkerSeverity.Error
        ...
        this._markersOverviewRulerDecorations =
            this._notebookEditor.deltaCellDecorations(this._markersOverviewRulerDecorations, cellDecorations);
    }
}
