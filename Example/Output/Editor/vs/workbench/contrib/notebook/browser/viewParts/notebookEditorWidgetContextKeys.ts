...
export class NotebookEditorContextKeys {
    ...
    constructor(private readonly _editor: INotebookEditorDelegate, 
    ...
    private readonly _notebookExecutionStateService: INotebookExecutionStateService) {
        ...
        this._hasVariableProvider =
            KERNEL_HAS_VARIABLE_PROVIDER.bindTo(contextKeyService);
    ...
    private async _updateForInstalledExtension(): Promise<void> {
        ...
        this._missingKernelExtension.set(!!kernelExtensionId &&
