...
import { DiffElementCellViewModelBase, DiffElementPlaceholderViewModel, getFormattedOutputJSON, IDiffElementViewModelBase, NotebookDocumentMetadataViewModel, OUTPUT_EDITOR_HEIGHT_MAGIC, OutputComparison, outputEqual, PropertyFoldingState, SideBySideDiffElementViewModel, SingleSideDiffElementViewModel, } from "./diffElementViewModel.js";
import { DiffNestedCellViewModel } from "./diffNestedCellViewModel.js";
import { CellDiffPlaceholderRenderTemplate, CellDiffSideBySideRenderTemplate, CellDiffSingleSideRenderTemplate, DIFF_CELL_MARGIN, DiffSide, IDiffCellMarginOverlay, INotebookTextDiffEditor, NOTEBOOK_DIFF_CELL_IGNORE_WHITESPACE, NOTEBOOK_DIFF_CELL_INPUT, NOTEBOOK_DIFF_CELL_PROPERTY, NOTEBOOK_DIFF_CELL_PROPERTY_EXPANDED, NOTEBOOK_DIFF_METADATA, NotebookDocumentDiffElementRenderTemplate, } from "./notebookDiffEditorBrowser.js";
...
class PropertyHeader extends Disposable {
    ...
    constructor(readonly cell: IDiffElementViewModelBase, readonly propertyHeaderContainer: HTMLElement, readonly notebookEditor: INotebookTextDiffEditor, readonly accessor: {
...
export class NotebookDocumentMetadataElement extends Disposable {
    ...
    constructor(readonly notebookEditor: INotebookTextDiffEditor, readonly viewModel: NotebookDocumentMetadataViewModel, readonly templateData: NotebookDocumentDiffElementRenderTemplate, 
    ...
    updateSourceEditor(): void {
        ...
        const updateSourceEditor = () => {
            if (this.viewModel.cellFoldingState ===
                PropertyFoldingState.Collapsed) {
        ...
        const renderSourceEditor = () => {
            ...
            this._editor.layout({
                width: this.notebookEditor.getLayoutInfo().width -
                    2 * DIFF_CELL_MARGIN,
                height: editorHeight,
            });
        ...
        inputChanged.set(this.viewModel.originalMetadata.getHash() !==
            this.viewModel.modifiedMetadata.getHash());
        this._toolbar = this.templateData.toolbar;
        this._toolbar.context = this.viewModel;
        const refreshToolbar = () => {
            const hasChanges = this.viewModel.originalMetadata.getHash() !==
                this.viewModel.modifiedMetadata.getHash();
...
abstract class AbstractElementRenderer extends Disposable {
    ...
    private _applySanitizedMetadataChanges(currentMetadata: NotebookCellMetadata, newMetadata: any) {
        ...
        try {
                ...
                switch (key as keyof NotebookCellMetadata) {
                    ...
                    case "outputCollapsed":
                        ...
                        if (typeof newMetadataObj[key] === "boolean") {
                            ...
                            result[key] =
                                currentMetadata[key as keyof NotebookCellMetadata];
                        }
                        break;
                    default:
                        result[key] = newMetadataObj[key];
            ...
            this.notebookEditor.textModel!.applyEdits([{ editType: CellEditType.Metadata, index, metadata: result }], true, undefined, () => undefined, undefined, true);
        }
        catch { }
    }
    private async _buildMetadataEditor() {
        ...
        if (this.cell instanceof SideBySideDiffElementViewModel) {
            ...
            this._metadataEditorDisposeStore.add(this.cell.modified.textModel.onDidChangeMetadata(() => {
                ...
                const modifiedMetadataSource = getFormattedMetadataJSON(this.notebookEditor.textModel?.transientOptions
                    .transientCellMetadata, this.cell.modified?.metadata || {}, this.cell.modified?.language);
            ...
            const originalMetadataSource = getFormattedMetadataJSON(this.notebookEditor.textModel?.transientOptions
                .transientCellMetadata, this.cell.type === "insert"
    ...
    private _buildOutputEditor() {
        ...
        if ((this.cell.type === "modified" || this.cell.type === "unchanged") &&
            ...
            if (originalOutputsSource !== modifiedOutputsSource) {
                ...
                const lineHeight = this.notebookEditor.getLayoutInfo().fontInfo.lineHeight ||
                    17;
                ...
                this._outputEditor = this.instantiationService.createInstance(DiffEditorWidget, this._outputEditorContainer!, {
                    ...
                    automaticLayout: false,
                    dimension: {
                        height: Math.min(OUTPUT_EDITOR_HEIGHT_MAGIC, this.cell.layoutInfo.rawOutputHeight ||
        ...
        this._outputEditor = this.instantiationService.createInstance(CodeEditorWidget, this._outputEditorContainer!, {
            ...fixedEditorOptions,
            dimension: {
                width: Math.min(OUTPUT_EDITOR_HEIGHT_MAGIC, this.cell.getComputedCellContainerWidth(this.notebookEditor.getLayoutInfo(), false, this.cell.type === "unchanged" ||
                    this.cell.type === "modified") - 32),
...
export class DeletedElement extends SingleSideDiffElement {
    constructor(notebookEditor: INotebookTextDiffEditor, cell: SingleSideDiffElementViewModel, templateData: CellDiffSingleSideRenderTemplate, 
    @ILanguageService
...
export class ModifiedElement extends AbstractElementRenderer {
    ...
    constructor(notebookEditor: INotebookTextDiffEditor, cell: SideBySideDiffElementViewModel, templateData: CellDiffSideBySideRenderTemplate, 
    @IInstantiationService
    instantiationService: IInstantiationService, 
    @ILanguageService
    languageService: ILanguageService, 
        ...
        if (!this._outputViewContainer) {
            ...
            if (outputMetadataChangeOnly) {
                ...
                this._outputMetadataEditor =
                    this.instantiationService.createInstance(DiffEditorWidget, this._outputMetadataContainer, {
                        ...fixedDiffEditorOptions,
                        overflowWidgetsDomNode: this.notebookEditor.getOverflowContainerDomNode(),
                        readOnly: true,
                        ignoreTrimWhitespace: false,
