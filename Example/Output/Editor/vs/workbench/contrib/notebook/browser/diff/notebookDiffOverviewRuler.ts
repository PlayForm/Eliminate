...
export class NotebookDiffOverviewRuler extends Themable {
    ...
    private applyColors(theme: IColorTheme): boolean {
        ...
        const hasChanges = !newInsertColor.equals(this._insertColor) ||
    ...
    private _scheduleRender(): void {
        if (this._renderAnimationFrame === null) {
            this._renderAnimationFrame =
                DOM.runAtThisOrScheduleAtNextAnimationFrame(DOM.getWindow(this._domNode.domNode), this._onRenderScheduled.bind(this), 16);
        }
    }
    ...
    private _computeOverviewViewport(): {
        ...
        const computedSliderRatio = (computedRepresentableSize - computedSliderSize) /
