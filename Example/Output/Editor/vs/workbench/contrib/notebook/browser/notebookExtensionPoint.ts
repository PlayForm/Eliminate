...
import { ContributedNotebookRendererEntrypoint, NotebookEditorPriority, RendererMessagingSpec, } from "../common/notebookCommon.js";
...
export const notebooksExtensionPoint = ExtensionsRegistry.registerExtensionPoint<INotebookEditorContribution[]>({
    ...
    activationEventsGenerator: (contribs: INotebookEditorContribution[], result: {
...
export const notebookRendererExtensionPoint = ExtensionsRegistry.registerExtensionPoint<INotebookRendererContribution[]>({
    ...
    activationEventsGenerator: (contribs: INotebookRendererContribution[], result: {
        push(item: string): void;
    }) => {
        for (const contrib of contribs) {
            if (contrib.id) {
