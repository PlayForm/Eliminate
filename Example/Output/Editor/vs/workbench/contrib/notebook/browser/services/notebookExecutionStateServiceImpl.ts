...
export class NotebookExecutionStateService extends Disposable implements INotebookExecutionStateService {
    ...
    private _createNotebookExecution(notebook: NotebookTextModel): [
        NotebookExecution,
        IDisposable
    ] {
        const notebookUri = notebook.uri;
...
class NotebookCellExecutionEvent implements ICellExecutionStateChangedEvent {
    ...
    constructor(readonly notebook: URI, readonly cellHandle: number, readonly changed?: CellExecution) { }
...
class NotebookExecutionEvent implements IExecutionStateChangedEvent {
    ...
    constructor(readonly notebook: URI, readonly changed?: NotebookExecution) { }
    affectsNotebook(notebook: URI): boolean {
        return isEqual(this.notebook, notebook);
    }
}
...
class CellExecution extends Disposable implements INotebookCellExecution {
    ...
    constructor(readonly cellHandle: number, private readonly _notebookModel: NotebookTextModel, 
    @ILogService
    private readonly _logService: ILogService) {
        super();
    ...
    update(updates: ICellExecuteUpdate[]): void {
        ...
        if (!this._didPause &&
            updates.some((u) => u.editType === CellExecutionUpdateType.ExecutionState &&
                u.didPause)) {
            this._didPause = true;
        }
        const lastIsPausedUpdate = [...updates]
            .reverse()
            .find((u) => u.editType === CellExecutionUpdateType.ExecutionState &&
...
class NotebookExecution extends Disposable implements INotebookExecution {
    ...
    constructor(private readonly _notebookModel: NotebookTextModel, 
    @ILogService
    private readonly _logService: ILogService) {
        super();
