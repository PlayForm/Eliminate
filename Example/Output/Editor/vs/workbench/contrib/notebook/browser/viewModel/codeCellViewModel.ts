...
export class CodeCellViewModel extends BaseCellViewModel implements ICellViewModel {
    ...
    constructor(viewType: string, model: NotebookCellTextModel, initialNotebookLayoutInfo: NotebookLayoutInfo | null, readonly viewContext: ViewContext, 
    ...
    instantiationService: IInstantiationService) {
        ...
        this._register(this.model.onDidChangeOutputs((splice) => {
            ...
            for (let i = splice.start; i < splice.start + splice.deleteCount; i++) {
                if (this._outputCollection[i] !== undefined &&
    ...
    layoutChange(state: CodeCellLayoutChangeEvent, source?: string) {
        ...
        if (!this.isInputCollapsed) {
            ...
            if (!state.editorHeight &&
                ...
                const estimate = this.estimateEditorHeight(state.font?.lineHeight ??
    ...
    getOutputOffset(index: number): number {
        return (this.layoutInfo.outputContainerOffset +
