...
import { NOTEBOOK_EDITOR_ID, NotebookCellInternalMetadata, } from "../../../common/notebookCommon.js";
import { NOTEBOOK_CELL_LINE_NUMBERS, NOTEBOOK_EDITOR_FOCUSED, } from "../../../common/notebookContextKeys.js";
import { INotebookCellToolbarActionContext, INotebookCommandContext, NOTEBOOK_ACTIONS_CATEGORY, NotebookMultiCellAction, } from "../../controller/coreActions.js";
...
export class CellEditorOptions extends CellContentPart implements ITextModelUpdateOptions {
    ...
    private _computeEditorOptions() {
        ...
        const cellEditorOverridesRaw = this.notebookOptions.getDisplayOptions()
...
registerAction2(class ToggleActiveLineNumberAction extends NotebookMultiCellAction {
    ...
    private updateCell(configurationService: IConfigurationService, cell: ICellViewModel) {
        ...
        // 'off', 'off'		-> 'off'
        // 'off', 'on'		-> 'on'
        const currentLineNumberIsOn = cellLineNumbers === "on" ||
