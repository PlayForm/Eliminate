...
export class CodeCell extends Disposable {
    ...
    notebookExecutionStateService: INotebookExecutionStateService) {
        ...
        this._outputContainerRenderer =
            this.instantiationService.createInstance(CellOutputContainer, notebookEditor, viewCell, templateData, { limit: outputDisplayLimit });
    ...
    private initializeEditor(initEditorHeight: number) {
        ...
        raceCancellation(this.viewCell.resolveTextModel(), cts.token).then((model) => {
            ...
            if (model && this.templateData.editor) {
                ...
                this.viewCell.attachTextEditor(this.templateData.editor, this.viewCell.layoutInfo
                ...
                if (realContentHeight !== undefined &&
    ...
    private updateEditorOptions() {
        ...
        if (options.get(EditorOption.readOnly) !== isReadonly ||
    ...
    private registerCellEditorEventListeners() {
        this._register(this.templateData.editor.onDidContentSizeChange((e) => {
            if (e.contentHeightChanged) {
                if (this.viewCell.layoutInfo.editorHeight !==
                    e.contentHeight) {
