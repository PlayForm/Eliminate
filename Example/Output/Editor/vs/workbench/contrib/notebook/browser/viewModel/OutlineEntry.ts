...
export class OutlineEntry {
    ...
    constructor(readonly index: number, readonly level: number, readonly cell: ICellViewModel, readonly label: string, readonly isExecuting: boolean, readonly isPaused: boolean, readonly range?: IRange, readonly symbolKind?: SymbolKind) { }
