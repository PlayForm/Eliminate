...
StartFindAction.addImplementation(100, (accessor: ServicesAccessor, codeEditor: ICodeEditor, args: any) => {
    ...
    if (!editor.hasEditorFocus() && !editor.hasWebviewFocus()) {
        ...
        const textEditor = codeEditorService.getFocusedCodeEditor() ||
    ...
    const searchStringOptions = getSearchStringOptions(codeEditor, {
        ...
        seedSearchStringFromSelection: codeEditor.getOption(EditorOption.find)
            .seedSearchStringFromSelection !== "never"
            ? "single"
            : "none",
        seedSearchStringFromNonEmptySelection: codeEditor.getOption(EditorOption.find)
