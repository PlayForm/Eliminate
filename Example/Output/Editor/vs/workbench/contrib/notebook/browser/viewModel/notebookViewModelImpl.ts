...
export class NotebookViewModel extends Disposable implements EditorFoldingStateDelegate, INotebookViewModel {
    ...
    constructor(public viewType: string, private _notebook: NotebookTextModel, private _viewContext: ViewContext, private _layoutInfo: NotebookLayoutInfo | null, private _options: NotebookViewModelOptions, 
