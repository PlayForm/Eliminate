...
export function registerCellToolbarStickyScroll(notebookEditor: INotebookEditor, cell: ICellViewModel, element: HTMLElement, opts?: {
    extraOffset?: number;
    min?: number;
}): IDisposable {
    ...
    const updateForScroll = () => {
        if (cell.isInputCollapsed) {
            ...
            const maxTop = cell.layoutInfo.editorHeight +
