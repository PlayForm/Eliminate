...
export class NotebookVariablesView extends ViewPane {
    ...
    protected override renderBody(container: HTMLElement): void {
        ...
        this.tree = <WorkbenchAsyncDataTree<INotebookScope | IEmptyScope, INotebookVariableElement>>this.instantiationService.createInstance(WorkbenchAsyncDataTree, "notebookVariablesTree", container, new NotebookVariablesDelegate(), [
