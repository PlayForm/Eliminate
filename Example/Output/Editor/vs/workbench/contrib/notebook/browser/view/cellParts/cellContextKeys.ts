...
export class CellContextKeyPart extends CellContentPart {
    ...
    constructor(notebookEditor: INotebookEditorDelegate, 
...
export class CellContextKeyManager extends Disposable {
    ...
    constructor(private readonly notebookEditor: INotebookEditorDelegate, private element: ICellViewModel | undefined, 
    @IContextKeyService
    ...
    private readonly _notebookExecutionStateService: INotebookExecutionStateService) {
        ...
        this._contextKeyService.bufferChangeEvents(() => {
            ...
            this.cellHasErrorDiagnostics =
                NOTEBOOK_CELL_HAS_ERROR_DIAGNOSTICS.bindTo(this._contextKeyService);
            if (element) {
