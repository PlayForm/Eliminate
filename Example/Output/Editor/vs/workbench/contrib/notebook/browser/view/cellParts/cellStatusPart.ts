...
export class CellEditorStatusBar extends CellContentPart {
    ...
    private readonly _themeService: IThemeService) {
        ...
        this._register(this._themeService.onDidColorThemeChange(() => this.currentContext &&
                ...
                if (this._editor &&
                    (this._editor.hasWidgetFocus() ||
                        (this.statusBarContainer.ownerDocument.activeElement &&
                            this.statusBarContainer.contains(this.statusBarContainer.ownerDocument
                                .activeElement)))) {
    ...
    private updateActiveCell(): void {
        const isActiveCell = this.currentContext!.notebookEditor.getActiveCell() ===
