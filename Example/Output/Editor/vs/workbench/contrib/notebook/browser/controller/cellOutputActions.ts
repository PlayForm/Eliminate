...
import { getNotebookEditorFromEditorPane, ICellOutputViewModel, ICellViewModel, INotebookEditor, } from "../notebookBrowser.js";
...
registerAction2(class CopyCellOutputAction extends Action2 {
    ...
    private getNoteboookEditor(editorService: IEditorService, outputContext: INotebookOutputActionContext | {
        outputViewModel: ICellOutputViewModel;
    } | undefined): INotebookEditor | undefined {
    ...
    async run(accessor: ServicesAccessor, outputContext: INotebookOutputActionContext | {
        outputViewModel: ICellOutputViewModel;
...
registerAction2(class OpenCellOutputInEditorAction extends Action2 {
    ...
    async run(accessor: ServicesAccessor, outputContext: INotebookOutputActionContext | {
        ...
        if (outputViewModel?.model.outputId &&
