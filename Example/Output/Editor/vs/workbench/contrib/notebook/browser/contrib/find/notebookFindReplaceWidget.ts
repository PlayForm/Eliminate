...
class NotebookFindFilterActionViewItem extends DropdownMenuActionViewItem {
    constructor(readonly filters: NotebookFindFilters, action: IAction, options: IActionViewItemOptions, actionRunner: IActionRunner, 
    @IContextMenuService
...
export class NotebookFindInputFilterButton extends Disposable {
    ...
    constructor(readonly filters: NotebookFindFilters, readonly contextMenuService: IContextMenuService, readonly instantiationService: IInstantiationService, options: IFindInputOptions, tooltip: string = NOTEBOOK_FIND_FILTERS) {
        super();
...
export class NotebookFindInput extends FindInput {
    ...
    constructor(readonly filters: NotebookFindFilters, contextKeyService: IContextKeyService, readonly contextMenuService: IContextMenuService, readonly instantiationService: IInstantiationService, parent: HTMLElement | null, contextViewProvider: IContextViewProvider, options: IFindInputOptions) {
...
export abstract class SimpleFindReplaceWidget extends Widget {
    ...
    @IHoverService
    hoverService: IHoverService, protected readonly _state: FindReplaceState<NotebookFindFilters> = new FindReplaceState<NotebookFindFilters>(), protected readonly _notebookEditor: INotebookEditor) {
        super();
    ...
    private _getDomWidth() {
        return (dom.getTotalWidth(this._domNode) -
