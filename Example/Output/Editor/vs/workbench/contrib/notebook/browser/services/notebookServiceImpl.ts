...
export class NotebookProviderInfoStore extends Disposable {
        ...
        for (const extension of extensions) {
            for (const notebookContribution of extension.value) {
                ...
                this.add(new NotebookProviderInfo({
                    ...
                    providerDisplayName: extension.description.displayName ??
    ...
    private _registerContributionPoint(notebookProviderInfo: NotebookProviderInfo): IDisposable {
        ...
        for (const selector of notebookProviderInfo.selectors) {
            const globPattern = (selector as INotebookExclusiveDocumentFilter).include ||
            ...
            const notebookEditorOptions = {
                ...
                canSupportResource: (resource: URI) => resource.scheme === Schemas.untitled ||
            ...
            disposables.add(this._editorResolverService.registerEditor(`${Schemas.vscodeNotebookCell}:/**/${globPattern}`, {
                ...notebookEditorInfo,
                priority: RegisteredEditorPriority.exclusive,
            }, notebookEditorOptions, notebookCellFactoryObject));
        }
        return disposables;
    }
    private _clear(): void {
...
export class NotebookOutputRendererInfoStore {
    ...
    /* rendererId */ string, NotebookOutputRendererInfo>();
...
class ModelData implements IDisposable, INotebookDocument {
    ...
    constructor(readonly model: NotebookTextModel, onWillDispose: (model: INotebookTextModel) => void) {
...
export class NotebookService extends Disposable implements INotebookService {
    ...
    private readonly _notebookDocumentService: INotebookDocumentService) {
        ...
        const updateOrder = () => {
            this._displayOrder = new MimeTypeDisplayOrder(this._configurationService.getValue<string[]>(NotebookSetting.displayOrder) || [], this._accessibilityService.isScreenReaderOptimized()
