...
export class CellDecorations extends CellContentPart {
    constructor(readonly notebookEditor: INotebookEditorDelegate, readonly rootContainer: HTMLElement, readonly decorationContainer: HTMLElement) {
        super();
    }
    override didRenderCell(element: ICellViewModel): void {
        ...
        this.cellDisposables.add(element.onCellDecorationsChanged((e) => {
            const modified = e.added.find((e) => e.topClassName) ||
