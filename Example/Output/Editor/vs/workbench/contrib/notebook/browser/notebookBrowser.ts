...
import { CellKind, ICellOutput, INotebookCellStatusBarItem, INotebookFindOptions, INotebookRendererInfo, IOrderedMimeType, NOTEBOOK_EDITOR_ID, NotebookCellInternalMetadata, NotebookCellMetadata, } from "../common/notebookCommon.js";
...
export function getNotebookEditorFromEditorPane(editorPane?: IEditorPane): INotebookEditor | undefined {
    ...
    if (isCompositeNotebook) {
        return (editorPane.getControl() as {
            notebookEditor: INotebookEditor | undefined;
        } | undefined)?.notebookEditor;
    }
    return undefined;
}
/**
