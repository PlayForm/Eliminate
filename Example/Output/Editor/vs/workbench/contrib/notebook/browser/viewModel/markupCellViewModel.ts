...
export class MarkupCellViewModel extends BaseCellViewModel implements ICellViewModel {
    ...
    constructor(viewType: string, model: NotebookCellTextModel, initialNotebookLayoutInfo: NotebookLayoutInfo | null, readonly foldingDelegate: EditorFoldingStateDelegate, readonly viewContext: ViewContext, 
    ...
    private _computeTotalHeight(): number {
        ...
        if (this.getEditState() === CellEditState.Editing) {
            ...
            return Math.max(1, this._previewHeight +
                bottomToolbarGap +
                foldHintHeight +
                this._commentHeight);
        }
    ...
    layoutChange(state: MarkupCellLayoutChangeEvent) {
        ...
        if (!this.isInputCollapsed) {
            ...
            totalHeight =
                this.viewContext.notebookOptions.computeCollapsedMarkdownCellHeight(this.viewType);
