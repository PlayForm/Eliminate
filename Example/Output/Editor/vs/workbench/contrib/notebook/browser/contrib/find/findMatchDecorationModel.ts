...
import { overviewRulerFindMatchForeground, overviewRulerSelectionHighlightForeground, } from "../../../../../../platform/theme/common/colorRegistry.js";
...
export class FindMatchDecorationModel extends Disposable {
    ...
    public async highlightCurrentFindMatchDecorationInCell(cell: ICellViewModel, cellRange: Range): Promise<number | null> {
        ...
        this._currentMatchCellDecorations =
            this._notebookEditor.deltaCellDecorations(this._currentMatchCellDecorations, [
                {
                    handle: cell.handle,
                    options: {
                        overviewRuler: {
    ...
    public setAllFindMatchesDecorations(cellFindMatches: CellFindMatchWithIndex[]) {
        ...
        this._allMatchesCellDecorations =
            this._notebookEditor.deltaCellDecorations(this._allMatchesCellDecorations, cellFindMatches.map((cellFindMatch) => {
                return {
                    ownerId: cellFindMatch.cell.handle,
