...
import { CELL_TITLE_CELL_GROUP_ID, cellExecutionArgs, CellOverflowToolbarGroups, CellToolbarOrder, INotebookCellActionContext, INotebookCellToolbarActionContext, INotebookCommandContext, NotebookCellAction, NotebookMultiCellAction, parseMultiCellExecutionArgs, } from "../../controller/coreActions.js";
...
registerAction2(class ToggleCellOutputScrolling extends NotebookMultiCellAction {
    ...
    async runWithContext(accessor: ServicesAccessor, context: INotebookCommandContext | INotebookCellToolbarActionContext): Promise<void> {
        const globalScrolling = accessor
            ...
            .getValue<boolean>(NotebookSetting.outputScrolling);
        if (context.ui) {
