...
import { CellEditState, CHANGE_CELL_LANGUAGE, DETECT_CELL_LANGUAGE, getNotebookEditorFromEditorPane, QUIT_EDIT_CELL_COMMAND_ID, } from "../notebookBrowser.js";
import * as icons from "../notebookIcons.js";
import { changeCellToKind, runDeleteAction } from "./cellOperations.js";
import { CELL_TITLE_CELL_GROUP_ID, CELL_TITLE_OUTPUT_GROUP_ID, CellToolbarOrder, executeNotebookCondition, findTargetCellEditor, INotebookActionContext, INotebookCellActionContext, INotebookCommandContext, NOTEBOOK_EDITOR_WIDGET_ACTION_WEIGHT, NotebookAction, NotebookCellAction, NotebookMultiCellAction, } from "./coreActions.js";
import { NotebookChangeTabDisplaySize, NotebookIndentationToSpacesAction, NotebookIndentationToTabsAction, NotebookIndentUsingSpaces, NotebookIndentUsingTabs, } from "./notebookIndentationActions.js";
...
registerAction2(class EditCellAction extends NotebookCellAction {
    constructor() {
        super({
            ...
            keybinding: {
                when: ContextKeyExpr.and(NOTEBOOK_CELL_LIST_FOCUSED, ContextKeyExpr.not(InputFocusedContextKey), NOTEBOOK_EDITOR_EDITABLE.isEqualTo(true), EditorContextKeys.hoverFocused.toNegated(), NOTEBOOK_OUTPUT_INPUT_FOCUSED.toNegated()),
...
async function setCellToLanguage(languageId: string, context: IChangeCellContext) {
    if (languageId === "markdown" && context.cell?.language !== "markdown") {
        ...
        await changeCellToKind(CellKind.Code, {
            cell: context.cell,
            notebookEditor: context.notebookEditor,
            ui: true,
        }, languageId);
