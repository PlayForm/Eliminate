...
export class NotebookStatusBarController extends Disposable {
    ...
    constructor(private readonly _notebookEditor: INotebookEditor, private readonly _itemFactory: (vm: INotebookViewModel, cell: ICellViewModel) => IDisposable) {
        super();
...
class ExecutionStateCellStatusBarItem extends Disposable {
    ...
    constructor(private readonly _notebookViewModel: INotebookViewModel, private readonly _cell: ICellViewModel, 
    ...
    private _getItemsForCell(): INotebookCellStatusBarItem[] | undefined {
        ...
        if (runState?.state === NotebookCellExecutionState.Executing &&
            ...
            typeof this._showedExecutingStateTime === "number") {
            const timeUntilMin = ExecutionStateCellStatusBarItem.MIN_SPINNER_TIME -
...
class TimerCellStatusBarItem extends Disposable {
    ...
    private _getTimeItem(startTime: number, endTime: number, adjustment: number = 0, runtimeInformation?: {
        renderDuration: {
            [key: string]: number;
        };
