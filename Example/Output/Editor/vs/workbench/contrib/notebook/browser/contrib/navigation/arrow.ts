...
import { IS_COMPOSITE_NOTEBOOK, NOTEBOOK_CELL_EDITOR_FOCUSED, NOTEBOOK_CELL_HAS_OUTPUTS, NOTEBOOK_CELL_MARKDOWN_EDIT_MODE, NOTEBOOK_CELL_TYPE, NOTEBOOK_CURSOR_NAVIGATION_MODE, NOTEBOOK_EDITOR_FOCUSED, NOTEBOOK_OUTPUT_FOCUSED, NOTEBOOK_OUTPUT_INPUT_FOCUSED, } from "../../../common/notebookContextKeys.js";
import { CTX_NOTEBOOK_CHAT_OUTER_FOCUS_POSITION } from "../../controller/chat/notebookChatContext.js";
import { findTargetCellEditor, INotebookActionContext, INotebookCellActionContext, NOTEBOOK_EDITOR_WIDGET_ACTION_WEIGHT, NotebookAction, NotebookCellAction, } from "../../controller/coreActions.js";
...
registerAction2(class FocusNextCellAction extends NotebookCellAction {
    ...
    async runWithContext(accessor: ServicesAccessor, context: INotebookCellActionContext): Promise<void> {
        ...
        const foundEditor: ICodeEditor | undefined = targetCell
