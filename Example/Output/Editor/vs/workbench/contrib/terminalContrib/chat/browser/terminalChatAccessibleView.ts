...
export class TerminalInlineChatAccessibleView implements IAccessibleViewImplentation {
    ...
    getProvider(accessor: ServicesAccessor) {
        ...
        const contextKeyService = TerminalChatController.activeChatController
        ...
        return new AccessibleContentProvider(AccessibleViewProviderId.TerminalChat, { type: AccessibleViewType.View }, () => {
