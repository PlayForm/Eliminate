...
export class TerminalChatWidget extends Disposable {
    ...
    constructor(private readonly _terminalElement: HTMLElement, private readonly _instance: ITerminalInstance, private readonly _xterm: IXtermTerminal & {
    ...
    instantiationService: IInstantiationService) {
        ...
        this._focusedContextKey =
            TerminalChatContextKeys.focused.bindTo(_contextKeyService);
        this._visibleContextKey =
            TerminalChatContextKeys.visible.bindTo(_contextKeyService);
            ...
            statusMenuId: {
                ...
                options: {
                    buttonConfigProvider: (action) => {
                        if (action.id ===
                            TerminalChatCommandId.ViewInChat ||
                            action.id ===
        ...
        this._requestActiveContextKey =
            TerminalChatContextKeys.requestActive.bindTo(this._contextKeyService);
        this._responseContainsCodeBlockContextKey =
            TerminalChatContextKeys.responseContainsCodeBlock.bindTo(this._contextKeyService);
        this._responseContainsMulitpleCodeBlocksContextKey =
            TerminalChatContextKeys.responseContainsMultipleCodeBlocks.bindTo(this._contextKeyService);
    ...
    private _doLayout(heightInPixel: number) {
        ...
        const width = Math.min(640, xtermElement.clientWidth -
            12 /* padding */ -
            2 /* border */ -
    ...
    private _updateVerticalPosition(adjustedHeight?: number): void {
        ...
        if (top > terminalWrapperHeight - widgetHeight &&
            terminalWrapperHeight - widgetHeight > 0) {
