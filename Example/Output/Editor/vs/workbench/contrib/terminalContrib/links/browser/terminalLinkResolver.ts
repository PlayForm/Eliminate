...
import { removeLinkQueryString, removeLinkSuffix, winDrivePrefix, } from "./terminalLinkParsing.js";
export class TerminalLinkResolver implements ITerminalLinkResolver {
    ...
    async resolveLink(processManager: Pick<ITerminalProcessManager, "initialCwd" | "os" | "remoteAuthority" | "userHome"> & {
