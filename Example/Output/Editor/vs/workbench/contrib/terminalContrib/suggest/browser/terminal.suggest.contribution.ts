...
class TerminalSuggestContribution extends DisposableStore implements ITerminalContribution {
    ...
    private readonly _storageService: IStorageService) {
        ...
        this._terminalSuggestWidgetVisibleContextKey =
            TerminalContextKeys.suggestWidgetVisible.bindTo(this._contextKeyService);
    ...
    private _loadSuggestAddon(xterm: RawXtermTerminal): void {
        ...
        if (sendingKeybindingsToShell ||
            this._ctx.instance.shellType !== "pwsh") {
            this._addon.clear();
            return;
        }
        if (this._terminalSuggestWidgetVisibleContextKey) {
            const addon = (this._addon.value =
                this._instantiationService.createInstance(SuggestAddon, TerminalSuggestContribution._cachedPwshCommands, this._ctx.instance.capabilities, this._terminalSuggestWidgetVisibleContextKey));
