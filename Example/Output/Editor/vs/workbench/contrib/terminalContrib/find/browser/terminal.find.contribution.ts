...
import { IDetachedTerminalInstance, isDetachedTerminalInstance, ITerminalContribution, ITerminalInstance, ITerminalService, IXtermTerminal, } from "../../../terminal/browser/terminal.js";
...
registerActiveXtermAction({
    ...
    run: (_xterm, _accessor, activeInstance) => {
        const contr = TerminalFindContribution.activeFindWidget ||
