...
import { combinedDisposable, Disposable, DisposableMap, DisposableStore, dispose, IDisposable, MutableDisposable, } from "../../../../../base/common/lifecycle.js";
        ...
        if (promptInputModel) {
            ...
            if (!this._statusbarEntryAccessor.value) {
                this._statusbarEntryAccessor.value =
                    this._statusbarService.addEntry(this._statusbarEntry, `terminal.promptInput.${this._ctx.instance.instanceId}`, StatusbarAlignment.LEFT);
            }
            else {
