...
import { IWorkspaceTaskSource, RunOnOptions, Task, TaskRunSource, TASKS_CATEGORY, TaskSource, TaskSourceKind, WorkspaceFileTaskSource, } from "../common/tasks.js";
    ...
    private _getTaskSource(source: TaskSource): URI | undefined {
        ...
        switch (taskKind) {
            ...
            case ConfigurationTarget.WORKSPACE: {
                return ((<WorkspaceFileTaskSource>source).config.workspace
                    ?.configuration ?? undefined);
            }
        }
        return undefined;
    }
    private _findAutoTasks(taskService: ITaskService, workspaceTaskResult: Map<string, IWorkspaceFolderTaskResult>): {
            ...
            workspaceTaskResult.forEach((resultElement) => {
                ...
                if (resultElement.configurations) {
                    for (const configuredTask of Object.values(resultElement.configurations.byIdentifier)) {
                        if (configuredTask.runOptions.runOn ===
