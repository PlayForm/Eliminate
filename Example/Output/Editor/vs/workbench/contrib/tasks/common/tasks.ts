...
export namespace RunOptions {
    export const defaults: IRunOptions = {
...
export class CustomTask extends CommonTask {
    ...
    public constructor(id: string, source: FileBasedTaskSource, label: string, type: string, command: ICommandConfiguration | undefined, hasDefinedMatchers: boolean, runOptions: IRunOptions, configurationProperties: IConfigurationProperties) {
    ...
    public override getDefinition(useSource: boolean = false): KeyedTaskIdentifier {
        if (useSource && this._source.customizes !== undefined) {
            ...
            let type: string;
            const commandRuntime = this.command
...
export class ConfiguringTask extends CommonTask {
    ...
    public constructor(id: string, source: FileBasedTaskSource, label: string | undefined, type: string | undefined, configures: KeyedTaskIdentifier, runOptions: IRunOptions, configurationProperties: IConfigurationProperties) {
...
export class ContributedTask extends CommonTask {
     ...
     */
    hide?: boolean;
    public constructor(id: string, source: IExtensionTaskSource, label: string, type: string | undefined, defines: KeyedTaskIdentifier, command: ICommandConfiguration, hasDefinedMatchers: boolean, runOptions: IRunOptions, configurationProperties: IConfigurationProperties) {
        super(id, label, type, runOptions, configurationProperties, source);
    ...
    protected getFolderId(): string | undefined {
        if (this._source.scope === TaskScope.Folder &&
            this._source.workspaceFolder) {
...
export class InMemoryTask extends CommonTask {
    ...
    public constructor(id: string, source: IInMemoryTaskSource, label: string, type: string, runOptions: IRunOptions, configurationProperties: IConfigurationProperties) {
        super(id, label, type, runOptions, configurationProperties, source);
        this._source = source;
    }
    ...
    function common(task: Task): ITaskCommon {
        return {
            ...
            runType: task.configurationProperties.isBackground
                ? TaskRunType.Background
                : TaskRunType.SingleRun,
...
export namespace TaskDefinition {
    export function createTaskIdentifier(external: ITaskIdentifier, reporter: {
