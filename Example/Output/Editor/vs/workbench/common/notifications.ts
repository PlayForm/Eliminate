...
import { INotification, INotificationActions, INotificationHandle, INotificationProgress, INotificationProgressProperties, INotificationSource, IPromptChoice, IPromptChoiceWithMenu, isNotificationSource, IStatusMessageOptions, NoOpNotification, NotificationMessage, NotificationPriority, NotificationsFilter, Severity, } from "../../platform/notification/common/notification.js";
...
export class NotificationViewItem extends Disposable implements INotificationViewItem {
    ...
    private constructor(readonly id: string | undefined, private _severity: Severity, private _sticky: boolean | undefined, private _priority: NotificationPriority, private _message: INotificationMessage, private _source: string | INotificationSource | undefined, progress: INotificationProgressProperties | undefined, actions?: INotificationActions) {
        super();
        if (progress) {
    ...
    equals(other: INotificationViewItem): boolean {
        ...
        if (typeof this._source === "object") {
            if (this._source.label !== other.source ||
    ...
    constructor(id: string, choice: IPromptChoice) {
        ...
        this._menu =
            !choice.isSecondary && (<IPromptChoiceWithMenu>choice).menu
                ? (<IPromptChoiceWithMenu>choice).menu.map((c, index) => new ChoiceAction(`${id}.${index}`, c))
                : undefined;
    }
