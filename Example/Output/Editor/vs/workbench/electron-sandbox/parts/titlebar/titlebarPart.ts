...
import { isBigSurOrNewer, isLinux, isMacintosh, isNative, isWindows, } from "../../../../base/common/platform.js";
...
import { DEFAULT_CUSTOM_TITLEBAR_HEIGHT, hasNativeTitlebar, useWindowControlsOverlay, } from "../../../../platform/window/common/window.js";
...
export class NativeTitlebarPart extends BrowserTitlebarPart {
    ...
    override get minimumHeight(): number {
        ...
        return ((this.isCommandCenterVisible
    ...
    protected override createContentArea(parent: HTMLElement): HTMLElement {
        ...
        if (isWindows && !hasNativeTitlebar(this.configurationService)) {
            this._register(this.nativeHostService.onDidTriggerWindowSystemContextMenu(({ windowId, x, y }) => {
                ...
                this.onContextMenu(new MouseEvent("mouseup", {
