...
import { IMenubarData, IMenubarKeybinding, IMenubarMenu, IMenubarMenuItemAction, IMenubarMenuItemSubmenu, MenubarMenuItem, } from "../../../../platform/menubar/common/menubar.js";
...
export class NativeMenubarControl extends MenubarControl {
    ...
    private populateMenuItems(menuActions: readonly IAction[], menuToPopulate: IMenubarMenu, keybindings: {
        [id: string]: IMenubarKeybinding | undefined;
    }) {
