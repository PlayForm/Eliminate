...
import { applyZoom, ApplyZoomTarget, MAX_ZOOM_LEVEL, MIN_ZOOM_LEVEL, } from "../../../platform/window/electron-sandbox/window.js";
            ...
            if (auxiliaryWindows) {
                for (const auxiliaryWindow of auxiliaryWindows) {
                    const pick: IWindowPickItem = {
                        ...
                        iconClasses: getIconClasses(modelService, languageService, auxiliaryWindow.filename
                            ? URI.file(auxiliaryWindow.filename)
                            : undefined, FileKind.FILE),
