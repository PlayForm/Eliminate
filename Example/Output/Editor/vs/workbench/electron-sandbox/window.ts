...
import { getZoomFactor, getZoomLevel, onDidChangeZoomLevel, setFullscreen, } from "../../base/browser/browser.js";
import { addDisposableListener, EventHelper, EventType, getActiveElement, getWindow, getWindowById, getWindows, hasWindow, ModifierKeyEmitter, } from "../../base/browser/dom.js";
...
import { IAddress, IAddressProvider, } from "../../platform/remote/common/remoteAgentConnection.js";
import { IRemoteAuthorityResolverService } from "../../platform/remote/common/remoteAuthorityResolver.js";
import { IStorageService, StorageScope, StorageTarget, } from "../../platform/storage/common/storage.js";
import { ITelemetryService } from "../../platform/telemetry/common/telemetry.js";
import { extractLocalHostUriMetaDataForPortMapping, extractQueryLocalHostUriMetaDataForPortMapping, ITunnelService, RemoteTunnel, } from "../../platform/tunnel/common/tunnel.js";
import { IUriIdentityService } from "../../platform/uriIdentity/common/uriIdentity.js";
import { hasNativeTitlebar, IAddFoldersRequest, INativeOpenFileRequest, INativeRunActionInWindowRequest, INativeRunKeybindingInWindowRequest, IOpenFileRequest, WindowMinimumSize, } from "../../platform/window/common/window.js";
import { applyZoom, ApplyZoomTarget, } from "../../platform/window/electron-sandbox/window.js";
...
import { EditorResourceAccessor, IEditorPane, IResourceDiffEditorInput, IResourceMergeEditorInput, isResourceEditorInput, IUntitledTextResourceEditorInput, IUntypedEditorInput, pathsToEditors, SideBySideEditor, } from "../common/editor.js";
...
import { IWorkbenchLayoutService, Parts, Position, positionFromString, } from "../services/layout/browser/layoutService.js";
import { BeforeShutdownErrorEvent, BeforeShutdownEvent, ILifecycleService, LifecyclePhase, ShutdownReason, WillShutdownEvent, } from "../services/lifecycle/common/lifecycle.js";
...
export class NativeWindow extends BaseWindow {
    ...
    protected registerListeners(): void {
        ...
        ipcRenderer.on("vscode:openFiles", (event: unknown, request: IOpenFileRequest) => {
            this.onOpenFiles(request);
        });
        // Support addFolders event if we have a workspace opened
        ipcRenderer.on("vscode:addFolders", (event: unknown, request: IAddFoldersRequest) => {
            ...
            this.notificationService.prompt(Severity.Warning, localize("showArgvParseWarning", "The runtime arguments file 'argv.json' contains errors. Please correct them and restart."), [
                {
                    ...
                    run: () => this.editorService.openEditor({
                        resource: this.nativeEnvironmentService
                            .argvResource,
                    }),
                },
            ], {
        ...
        // Proxy Login Dialog
        ipcRenderer.on("vscode:openProxyAuthenticationDialog", async (event: unknown, payload: {
            authInfo: AuthInfo;
            username?: string;
            password?: string;
            replyChannel: string;
        ...
        if (reason === ShutdownReason.CLOSE) {
            ...
            if (confirmBeforeClose) {
                ...
                return veto((async () => {
                    ...
                    if (confirmBeforeClose) {
                        confirmed =
                            await this.instantiationService.invokeFunction((accessor) => NativeWindow.confirmOnShutdown(accessor, actualReason));
                    }
    ...
    private doUpdateTouchbarMenu(scheduler: RunOnceScheduler): void {
        ...
        const disabled = this.configurationService.getValue("keyboard.touchbar.enabled") ===
            false;
...
class ZoomStatusEntry extends Disposable {
    ...
    private createZoomEntry(visibleOrText: string): void {
        ...
        zoomResetAction.tooltip = localize("zoomResetLabel", "{0} ({1})", zoomResetAction.label, this.keybindingService
