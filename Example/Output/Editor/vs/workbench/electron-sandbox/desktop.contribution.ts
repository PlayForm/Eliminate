...
import { ConfigureRuntimeArgumentsAction, OpenUserDataFolderAction, ReloadWindowWithExtensionsDisabledAction, ShowGPUInfoAction, ToggleDevToolsAction, } from "./actions/developerActions.js";
import { InstallShellScriptAction, UninstallShellScriptAction, } from "./actions/installActions.js";
import { CloseWindowAction, MergeWindowTabsHandlerHandler, MoveWindowTabToNewWindowHandler, NewWindowTabHandler, QuickSwitchWindowAction, ShowNextWindowTabHandler, ShowPreviousWindowTabHandler, SwitchWindowAction, ToggleWindowTabsBarHandler, ZoomInAction, ZoomOutAction, ZoomResetAction, } from "./actions/windowActions.js";
        ...
        "properties": {
            ...
            "window.zoomPerWindow": {
                ...
                "markdownDescription": localize({
                    ...
                    key: "zoomPerWindow",
                }, "Controls if the 'Zoom In' and 'Zoom Out' commands apply the zoom level to all windows or only the active window. See {0} for configuring a default zoom level for all windows.", "`#window.zoomLevel#`"),
                tags: ["accessibility"],
            },
