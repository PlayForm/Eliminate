...
import { IsDevelopmentContext, IsIOSContext, IsMacNativeContext, IsWebContext, } from "../../../platform/contextkey/common/contextkeys.js";
...
import { IKeyMods, IQuickInputButton, IQuickInputService, IQuickPickItem, IQuickPickSeparator, } from "../../../platform/quickinput/common/quickInput.js";
...
abstract class BaseOpenRecentAction extends Action2 {
    ...
    override async run(accessor: ServicesAccessor): Promise<void> {
        ...
        const autoFocusSecondEntry: boolean = firstEntry &&
            contextService.isCurrentWorkspace(isRecentWorkspace(firstEntry)
    ...
    constructor() {
        super({
            ...
            keybinding: {
                ...
                primary: isWeb
                    ? isWindows
                        ? KeyChord(KeyMod.CtrlCmd | KeyCode.KeyK, KeyMod.Shift | KeyCode.KeyN)
                        : KeyMod.CtrlCmd |
                            KeyMod.Alt |
                            KeyMod.Shift |
                            KeyCode.KeyN
