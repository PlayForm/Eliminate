...
import { InputFocusedContext, IsDevelopmentContext, IsIOSContext, IsLinuxContext, IsMacContext, IsMacNativeContext, IsMobileContext, IsWebContext, IsWindowsContext, ProductQualityContext, } from "../../platform/contextkey/common/contextkeys.js";
...
import { ActiveEditorGroupEmptyContext, ActiveEditorGroupIndexContext, ActiveEditorGroupLastContext, ActiveEditorGroupLockedContext, AuxiliaryBarVisibleContext, DirtyWorkingCopiesContext, EditorsVisibleContext, EditorTabsVisibleContext, EmbedderIdentifierContext, EmptyWorkspaceSupportContext, EnterMultiRootWorkspaceSupportContext, HasWebFileSystemAccess, InEditorZenModeContext, IsAuxiliaryWindowFocusedContext, IsMainEditorCenteredLayoutContext, IsMainWindowFullscreenContext, MainEditorAreaVisibleContext, MultipleEditorGroupsContext, OpenFolderWorkspaceSupportContext, PanelAlignmentContext, PanelMaximizedContext, PanelPositionContext, PanelVisibleContext, RemoteNameContext, SideBarVisibleContext, SplitEditorsVertically, TemporaryWorkspaceContext, TitleBarStyleContext, TitleBarVisibleContext, VirtualWorkspaceContext, WorkbenchStateContext, WorkspaceFolderCountContext, } from "../common/contextkeys.js";
...
export class WorkbenchContextKeysHandler extends Disposable {
    ...
    private readonly workingCopyService: IWorkingCopyService) {
        ...
        IsDevelopmentContext.bindTo(this.contextKeyService).set(!this.environmentService.isBuilt ||
            this.environmentService.isExtensionDevelopment);
        setConstantContextKey(IsDevelopmentContext.key, !this.environmentService.isBuilt ||
            this.environmentService.isExtensionDevelopment);
        // Product Service
        ...
        this.openFolderWorkspaceSupportContext.set(isNative ||
        ...
        this.emptyWorkspaceSupportContext.set(isNative ||
            typeof this.environmentService.remoteAuthority === "string");
        ...
        this.enterMultiRootWorkspaceSupportContext =
            EnterMultiRootWorkspaceSupportContext.bindTo(this.contextKeyService);
        this.enterMultiRootWorkspaceSupportContext.set(isNative ||
            typeof this.environmentService.remoteAuthority === "string");
        // Editor Layout
        this.splitEditorsVerticallyContext = SplitEditorsVertically.bindTo(this.contextKeyService);
        this.updateSplitEditorsVerticallyContext();
        // Window
        this.isMainWindowFullscreenContext =
            IsMainWindowFullscreenContext.bindTo(this.contextKeyService);
        ...
        this.isMainEditorCenteredLayoutContext =
            IsMainEditorCenteredLayoutContext.bindTo(this.contextKeyService);
        // Editor Area
    ...
    private registerListeners(): void {
        ...
        this._register(this.layoutService.onDidChangeActiveContainer(() => this.isAuxiliaryWindowFocusedContext.set(this.layoutService.activeContainer !==
