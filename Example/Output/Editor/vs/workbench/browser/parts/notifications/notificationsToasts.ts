...
import { addDisposableListener, Dimension, EventType, getWindow, isAncestorOfActiveElement, scheduleAtNextAnimationFrame, } from "../../../../base/browser/dom.js";
...
import { NotificationPriority, NotificationsFilter, Severity, } from "../../../../platform/notification/common/notification.js";
import { widgetShadow } from "../../../../platform/theme/common/colorRegistry.js";
import { IThemeService, Themable, } from "../../../../platform/theme/common/themeService.js";
import { NotificationsToastsVisibleContext } from "../../../common/contextkeys.js";
import { INotificationChangeEvent, INotificationsModel, INotificationViewItem, NotificationChangeType, NotificationViewItemContentChangeKind, } from "../../../common/notifications.js";
...
export class NotificationsToasts extends Themable implements INotificationsToastController {
    ...
    private addToast(item: INotificationViewItem): void {
        ...
        if (this.addedToastsIntervalCounter.increment() >
