 ...
 *--------------------------------------------------------------------------------------------*/
import { $, addDisposableListener, clearNode, EventHelper, EventType, isEventLike, } from "../../../../base/browser/dom.js";
...
import { INotificationService, isNotificationSource, NotificationsFilter, Severity, } from "../../../../platform/notification/common/notification.js";
import { IOpenerService } from "../../../../platform/opener/common/opener.js";
import { defaultButtonStyles, defaultProgressBarStyles, } from "../../../../platform/theme/browser/defaultStyles.js";
import { ChoiceAction, INotificationMessage, INotificationViewItem, NotificationViewItem, NotificationViewItemContentChangeKind, } from "../../../common/notifications.js";
import { ClearNotificationAction, CollapseNotificationAction, ConfigureNotificationAction, ExpandNotificationAction, } from "./notificationsActions.js";
            ...
            if (typeof node === "string") {
                ...
                if (actionHandler) {
                    ...
                    const onSpaceOrEnter = Event.chain(onKeydown, ($) => $.filter((e) => {
                        ...
                        return (event.equals(KeyCode.Space) ||
                ...
                if (action instanceof ConfigureNotificationAction) {
                    return data.toDispose.add(new DropdownMenuActionViewItem(action, {
                        getActions() {
                            ...
                            if (Array.isArray(action.notification.actions
                                ?.secondary)) {
                                actions.push(...action.notification.actions
                                    .secondary);
                            }
                            return actions;
                        },
...
export class NotificationTemplateRenderer extends Disposable {
    ...
    constructor(private template: INotificationTemplateData, private actionRunner: IActionRunner, 
    @IOpenerService
    ...
    private readonly hoverService: IHoverService) {
        ...
        if (!NotificationTemplateRenderer.closeNotificationAction) {
            NotificationTemplateRenderer.closeNotificationAction =
                instantiationService.createInstance(ClearNotificationAction, ClearNotificationAction.ID, ClearNotificationAction.LABEL);
            NotificationTemplateRenderer.expandNotificationAction =
                instantiationService.createInstance(ExpandNotificationAction, ExpandNotificationAction.ID, ExpandNotificationAction.LABEL);
            NotificationTemplateRenderer.collapseNotificationAction =
                instantiationService.createInstance(CollapseNotificationAction, CollapseNotificationAction.ID, CollapseNotificationAction.LABEL);
        }
    }
