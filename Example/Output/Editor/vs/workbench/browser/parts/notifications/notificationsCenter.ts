...
import { INotificationChangeEvent, INotificationsModel, NotificationChangeType, NotificationViewItemContentChangeKind, } from "../../../common/notifications.js";
import { NOTIFICATIONS_CENTER_BORDER, NOTIFICATIONS_CENTER_HEADER_BACKGROUND, NOTIFICATIONS_CENTER_HEADER_FOREGROUND, } from "../../../common/theme.js";
import { IEditorGroupsService } from "../../../services/editor/common/editorGroupsService.js";
import { IWorkbenchLayoutService, Parts, } from "../../../services/layout/browser/layoutService.js";
import { ClearAllNotificationsAction, ConfigureDoNotDisturbAction, HideNotificationsCenterAction, ToggleDoNotDisturbAction, ToggleDoNotDisturbBySourceAction, } from "./notificationsActions.js";
                        ...
                        getActions() {
                            const actions = [
                                toAction({
                                    ...
                                    label: that.notificationService.getFilter() ===
                                    ...
                                    run: () => that.notificationService.setFilter(that.notificationService.getFilter() ===
                                        NotificationsFilter.OFF
