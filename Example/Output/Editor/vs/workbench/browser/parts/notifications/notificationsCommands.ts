        ...
        handler: (accessor) => {
            ...
            for (const notification of model.notifications) {
                if (notification.visible) {
                    telemetryService.publicLog2<NotificationMetrics, NotificationMetricsClassification>("notification:hide", notificationToMetrics(notification.message.original, notification.sourceId, notification.priority ===
