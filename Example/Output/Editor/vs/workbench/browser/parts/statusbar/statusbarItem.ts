 ...
 *--------------------------------------------------------------------------------------------*/
import { addDisposableListener, append, EventHelper, EventType, hide, show, } from "../../../../base/browser/dom.js";
...
export class StatusbarEntryItem extends Disposable {
    ...
    constructor(private container: HTMLElement, entry: IStatusbarEntry, private readonly hoverDelegate: IHoverDelegate, 
    @ICommandService
    ...
    update(entry: IStatusbarEntry): void {
        ...
        const hasBackgroundColor = !!entry.backgroundColor ||
    ...
    private isEqualTooltip({ tooltip }: IStatusbarEntry, { tooltip: otherTooltip }: IStatusbarEntry) {
        ...
        if (isMarkdownString(tooltip)) {
            return (isMarkdownString(otherTooltip) &&
