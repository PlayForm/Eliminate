...
import { addDisposableListener, clearNode, createStyleSheet, EventHelper, EventType, getWindow, } from "../../../../base/browser/dom.js";
...
import { STATUS_BAR_BACKGROUND, STATUS_BAR_BORDER, STATUS_BAR_FOCUS_BORDER, STATUS_BAR_FOREGROUND, STATUS_BAR_ITEM_COMPACT_HOVER_BACKGROUND, STATUS_BAR_ITEM_FOCUS_BORDER, STATUS_BAR_ITEM_HOVER_BACKGROUND, STATUS_BAR_NO_FOLDER_BACKGROUND, STATUS_BAR_NO_FOLDER_BORDER, STATUS_BAR_NO_FOLDER_FOREGROUND, } from "../../../common/theme.js";
import { IWorkbenchLayoutService, Parts, } from "../../../services/layout/browser/layoutService.js";
import { isStatusbarEntryLocation, isStatusbarEntryPriority, IStatusbarEntry, IStatusbarEntryAccessor, IStatusbarEntryLocation, IStatusbarEntryPriority, IStatusbarService, IStatusbarStyleOverride, StatusbarAlignment, } from "../../../services/statusbar/browser/statusbar.js";
...
class StatusbarPart extends Part implements IStatusbarEntryContainer {
    ...
    private doAddPendingEntry(entry: IStatusbarEntry, id: string, alignment: StatusbarAlignment, priority: IStatusbarEntryPriority): IStatusbarEntryAccessor {
        const pendingEntry: IPendingStatusbarEntry = {
            entry,
            id,
            alignment,
            priority,
    ...
    private appendStatusbarEntries(): void {
        ...
        for (const entry of [
            ...
            const target = entry.alignment === StatusbarAlignment.LEFT
                ? leftItemsContainer
                : rightItemsContainer;
    ...
    private appendStatusbarEntry(entry: IStatusbarViewModelEntry): void {
        ...
        const target = assertIsDefined(entry.alignment === StatusbarAlignment.LEFT
    ...
    override updateStyles(): void {
        ...
        const styleOverride: IStatusbarStyleOverride | undefined = [
            ...this.styleOverrides,
...
export class ScopedStatusbarService extends Disposable implements IStatusbarService {
    declare readonly _serviceBrand: undefined;
    constructor(private readonly statusbarEntryContainer: IStatusbarEntryContainer, 
    @IStatusbarService
