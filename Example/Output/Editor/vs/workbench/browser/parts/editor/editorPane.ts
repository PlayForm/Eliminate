...
import { IExtUri, isEqual, joinPath, } from "../../../../base/common/resources.js";
...
import { GroupIdentifier, IEditorMemento, IEditorOpenContext, IEditorPane, isEditorInput, } from "../../../common/editor.js";
import { EditorInput } from "../../../common/editor/editorInput.js";
import { MementoObject } from "../../../common/memento.js";
import { IEditorGroup, IEditorGroupsService, } from "../../../services/editor/common/editorGroupsService.js";
import { Composite } from "../../composite.js";
import { DEFAULT_EDITOR_MAX_DIMENSIONS, DEFAULT_EDITOR_MIN_DIMENSIONS, } from "./editor.js";
/**
...
export abstract class EditorPane extends Composite implements IEditorPane {
    ...
    constructor(id: string, readonly group: IEditorGroup, telemetryService: ITelemetryService, themeService: IThemeService, storageService: IStorageService) {
...
export class EditorMemento<T> extends Disposable implements IEditorMemento<T> {
    ...
    constructor(readonly id: string, private readonly key: string, private readonly memento: MementoObject, private readonly limit: number, private readonly editorGroupService: IEditorGroupsService, private readonly configurationService: ITextResourceConfigurationService) {
        super();
    ...
    private updateConfiguration(e: ITextResourceConfigurationChangeEvent | undefined): void {
        if (!e ||
            e.affectsConfiguration(undefined, "workbench.editor.sharedViewState")) {
    ...
    private cleanUp(): void {
        ...
        for (const [resource, mapGroupToMementos] of entries) {
            for (const group of Object.keys(mapGroupToMementos)) {
                ...
                if (groupId === EditorMemento.SHARED_EDITOR_STATE &&
                    this.shareEditorState) {
