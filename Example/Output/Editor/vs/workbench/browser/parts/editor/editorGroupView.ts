...
export class EditorGroupView extends Themable implements IEditorGroupView {
    ...
    constructor(from: IEditorGroupView | ISerializedEditorGroupModel | null, private readonly editorPartsView: IEditorPartsView, readonly groupsView: IEditorGroupsView, private groupsLabel: string, private _index: number, options: IEditorGroupViewOptions | undefined, 
    ...
    private doShowEditor(editor: EditorInput, context: {
        active: boolean;
        isNew: boolean;
    }, options?: IEditorOptions, internalOptions?: IInternalEditorOpenOptions): Promise<IEditorPane | undefined> {
    ...
    private async doHandleCloseConfirmation(editor: EditorInput, options?: {
    ...
    private _onDidChange = this._register(new Relay<{
        width: number;
        height: number;
    } | undefined>());
