 ...
 *--------------------------------------------------------------------------------------------*/
import { Dimension, getActiveElement, getWindowById, hide, IDomNodePagePosition, isAncestor, isEditableElement, show, } from "../../../../base/browser/dom.js";
...
import { EditorExtensions, EditorInputCapabilities, IEditorOpenContext, isEditorOpenError, IVisibleEditorPane, } from "../../../common/editor.js";
import { EditorInput } from "../../../common/editor/editorInput.js";
import { IHostService } from "../../../services/host/browser/host.js";
import { IWorkbenchLayoutService } from "../../../services/layout/browser/layoutService.js";
import { IEditorPaneDescriptor, IEditorPaneRegistry } from "../../editor.js";
import { DEFAULT_EDITOR_MAX_DIMENSIONS, DEFAULT_EDITOR_MIN_DIMENSIONS, IEditorGroupView, IInternalEditorOpenOptions, } from "./editor.js";
...
export class EditorPanes extends Disposable {
    ...
    private _onDidChangeSizeConstraints = this._register(new Emitter<{
        width: number;
        height: number;
    } | undefined>());
    ...
    //#endregion
    get minimumWidth() {
        return (this._activeEditorPane?.minimumWidth ??
            DEFAULT_EDITOR_MIN_DIMENSIONS.width);
    }
    get minimumHeight() {
        return (this._activeEditorPane?.minimumHeight ??
            DEFAULT_EDITOR_MIN_DIMENSIONS.height);
    }
    get maximumWidth() {
        return (this._activeEditorPane?.maximumWidth ??
            DEFAULT_EDITOR_MAX_DIMENSIONS.width);
    }
    get maximumHeight() {
        return (this._activeEditorPane?.maximumHeight ??
    ...
    private async doSetInput(editorPane: EditorPane, editor: EditorInput, options: IEditorOptions | undefined, context: IEditorOpenContext): Promise<{
        changed: boolean;
        cancelled: boolean;
    }> {
