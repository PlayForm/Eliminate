...
import { IDiffEditorModel, IDiffEditorViewModel, IDiffEditorViewState, ScrollType, } from "../../../../editor/common/editorCommon.js";
...
import { createTooLargeFileError, EditorExtensions, IEditorFactoryRegistry, IEditorOpenContext, isEditorInput, isTextEditorViewState, ITextDiffEditorPane, TEXT_DIFF_EDITOR_ID, } from "../../../common/editor.js";
...
export class TextDiffEditor extends AbstractTextEditor<IDiffEditorViewState> implements ITextDiffEditorPane {
    ...
    protected override getConfigurationOverrides(configuration: IEditorConfiguration): IDiffEditorOptions {
        return {
            ...
            originalEditable: this.input instanceof DiffEditorInput &&
    ...
    private isFileBinaryError(error: Error | Error[]): boolean {
        ...
        return ((<TextFileOperationError>error).textFileOperationResult ===
