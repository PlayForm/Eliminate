...
import { compareItemsByFuzzyScore, FuzzyScorerCache, prepareQuery, scoreItemFuzzy, } from "../../../../base/common/fuzzyScorer.js";
...
import { IQuickPick, IQuickPickItemWithResource, IQuickPickSeparator, quickPickItemScorerAccessor, } from "../../../../platform/quickinput/common/quickInput.js";
import { EditorResourceAccessor, EditorsOrder, GroupIdentifier, IEditorIdentifier, SideBySideEditor, } from "../../../common/editor.js";
...
export abstract class BaseEditorQuickAccessProvider extends PickerQuickAccessProvider<IEditorQuickPickItem> {
    ...
    override provide(picker: IQuickPick<IEditorQuickPickItem, {
        useSeparators: true;
        ...
        if (query.normalized) {
            ...
            filteredEditorEntries.sort((entryA, entryB) => {
                if (entryA.groupId !== entryB.groupId) {
                    return (groups.indexOf(entryA.groupId) -
                        groups.indexOf(entryB.groupId)); // older groups first
                }
    ...
    private doGetEditorPickItems(): Array<IEditorQuickPickItem> {
        ...
        return this.doGetEditors().map(({ editor, groupId }): IEditorQuickPickItem => {
            ...
            return {
                ...
                italic: !this.editorGroupService
                    .getGroup(groupId)
                    ?.isPinned(editor),
                buttons: (() => {
                    return [
