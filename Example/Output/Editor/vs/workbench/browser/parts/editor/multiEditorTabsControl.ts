...
import { addDisposableListener, clearNode, Dimension, DragAndDropObserver, EventHelper, EventType, findParentWithClass, getWindow, isMouseEvent, scheduleAtNextAnimationFrame, } from "../../../../base/browser/dom.js";
...
import { DEFAULT_EDITOR_ASSOCIATION, EditorCloseMethod, EditorInputCapabilities, EditorResourceAccessor, EditorsOrder, IEditorPartOptions, IToolbarActions, IUntypedEditorInput, preventEditorClose, SideBySideEditor, Verbosity, } from "../../../common/editor.js";
import { IReadonlyEditorGroupModel } from "../../../common/editor/editorGroupModel.js";
import { EditorInput } from "../../../common/editor/editorInput.js";
import { StickyEditorGroupModel, UnstickyEditorGroupModel, } from "../../../common/editor/filteredEditorGroupModel.js";
import { EDITOR_DRAG_AND_DROP_BACKGROUND, EDITOR_GROUP_HEADER_TABS_BACKGROUND, EDITOR_GROUP_HEADER_TABS_BORDER, TAB_ACTIVE_BACKGROUND, TAB_ACTIVE_BORDER, TAB_ACTIVE_BORDER_TOP, TAB_ACTIVE_MODIFIED_BORDER, TAB_BORDER, TAB_HOVER_BACKGROUND, TAB_HOVER_BORDER, TAB_HOVER_FOREGROUND, TAB_INACTIVE_BACKGROUND, TAB_INACTIVE_MODIFIED_BORDER, TAB_LAST_PINNED_BORDER, TAB_SELECTED_BORDER_TOP, TAB_UNFOCUSED_ACTIVE_BACKGROUND, TAB_UNFOCUSED_ACTIVE_BORDER, TAB_UNFOCUSED_ACTIVE_BORDER_TOP, TAB_UNFOCUSED_ACTIVE_MODIFIED_BORDER, TAB_UNFOCUSED_HOVER_BACKGROUND, TAB_UNFOCUSED_HOVER_BORDER, TAB_UNFOCUSED_HOVER_FOREGROUND, TAB_UNFOCUSED_INACTIVE_BACKGROUND, TAB_UNFOCUSED_INACTIVE_MODIFIED_BORDER, WORKBENCH_BACKGROUND, } from "../../../common/theme.js";
...
import { DraggedEditorGroupIdentifier, DraggedEditorIdentifier, extractTreeDropData, isWindowDraggedOver, ResourcesDropHandler, } from "../../dnd.js";
import { computeEditorAriaLabel } from "../../editor.js";
import { DEFAULT_LABELS_CONTAINER, IResourceLabel, ResourceLabels, } from "../../labels.js";
...
export class MultiEditorTabsControl extends EditorTabsControl {
    ...
    private dimensions: IEditorTitleControlDimensions & {
        used?: Dimension;
    } = {
    ...
    constructor(parent: HTMLElement, editorPartsView: IEditorPartsView, groupsView: IEditorGroupsView, groupView: IEditorGroupView, tabsModel: IReadonlyEditorGroupModel, 
    @IContextMenuService
    ...
    @IEditorService
    private readonly editorService: EditorServiceImpl, 
    @IPathService
    ...
    private registerTabsContainerListeners(tabsContainer: HTMLElement, tabsScrollbar: ScrollableElement): void {
        ...
        for (const eventType of [TouchEventType.Tap, EventType.DBLCLICK]) {
            this._register(addDisposableListener(tabsContainer, eventType, (e: MouseEvent | GestureEvent) => {
                if (eventType === EventType.DBLCLICK) {
                    ...
                    if ((<GestureEvent>e).initialTarget !==
                        tabsContainer) {
                        return; // ignore if target is not tabs container
                    }
                }
        ...
        this._register(new DragAndDropObserver(tabsContainer, {
            ...
            onDrop: (e) => {
                ...
                if (e.target === tabsContainer) {
                    ...
                    this.onDrop(e, isGroupTransfer
                        ? this.groupView.count
                        : this.tabsModel.count, tabsContainer);
                }
            },
        }));
        ...
        this._register(addDisposableListener(tabsContainer, EventType.MOUSE_WHEEL, (e: WheelEvent) => {
            ...
            const nextEditor = this.groupView.getEditorByIndex(this.groupView.getIndexOfEditor(activeEditor) +
                tabSwitchDirection);
            if (!nextEditor) {
                return;
            }
    ...
    override updateOptions(oldOptions: IEditorPartOptions, newOptions: IEditorPartOptions): void {
        ...
        if (oldOptions.alwaysShowEditorActions !==
            newOptions.alwaysShowEditorActions) {
            this.updateEditorActionsToolbar();
        }
        // Update tabs sizing
        if (oldOptions.tabSizingFixedMinWidth !==
    ...
    private createTab(tabIndex: number, tabsContainer: HTMLElement, tabsScrollbar: ScrollableElement): HTMLElement {
        ...
        const editorLabel = this.tabResourceLabels.create(tabContainer, {
            hoverTargetOverrride: tabContainer,
        });
        // Tab Actions
    ...
    private registerTabListeners(tab: HTMLElement, tabIndex: number, tabsContainer: HTMLElement, tabsScrollbar: ScrollableElement): IDisposable {
            ...
            if (editor) {
                if (e.shiftKey) {
                    ...
                    const inactiveSelection = this.tabsModel.isSelected(editor)
                        ...
                        : [];
                    await this.groupView.openEditor(editor, {
                        preserveFocus,
        ...
        disposables.add(addDisposableListener(tab, TouchEventType.Change, (e: GestureEvent) => {
            tabsScrollbar.setScrollPosition({
                scrollLeft: tabsScrollbar.getScrollPosition().scrollLeft -
                    e.translationX,
            });
        }));
        ...
        for (const eventType of [TouchEventType.Tap, EventType.DBLCLICK]) {
            disposables.add(addDisposableListener(tab, eventType, (e: MouseEvent | GestureEvent) => {
                ...
                if (editor && this.tabsModel.isPinned(editor)) {
                    switch (this.groupsView.partOptions
        ...
        disposables.add(new DragAndDropObserver(tab, {
            onDragStart: (e) => {
                ...
                this.editorTransfer.setData(selectedEditors.map((e) => new DraggedEditorIdentifier({
                    editor: e,
                    groupId: this.groupView.id,
    ...
    private updateDropTarget(newTarget: {
        leftElement: HTMLElement | undefined;
        rightElement: HTMLElement | undefined;
    } | undefined): void {
    ...
    private redrawTabLabel(editor: EditorInput, tabIndex: number, tabContainer: HTMLElement, tabLabelWidget: IResourceLabel, tabLabel: IEditorInputLabel): void {
        ...
        if (options.pinnedTabSizing === "compact" &&
    ...
    private doRedrawTabActive(isGroupActive: boolean, allowBorderTop: boolean, editor: EditorInput, tabContainer: HTMLElement, tabActionBar: ActionBar): void {
        ...
        if (allowBorderTop) {
            if (isActive) {
                tabBorderColorTop = this.getColor(isGroupActive
        ...
        if (this.visible) {
            if (!this.layoutScheduler.value) {
                ...
                const disposable = scheduleAtNextAnimationFrame(getWindow(this.parent), () => {
                    this.doLayout(this.dimensions, this.layoutScheduler.value
    ...
    private doLayout(dimensions: IEditorTitleControlDimensions, options?: IMultiEditorTabsControlLayoutOptions): void {
        // Layout tabs
        if (dimensions.container !== Dimension.None &&
    ...
    private doLayoutTabsWrapping(dimensions: IEditorTitleControlDimensions): boolean {
        ...
        function updateTabsWrapping(enabled: boolean): void {
            ...
            tabsContainer.style.setProperty("--last-tab-margin-right", tabsWrapMultiLine
        ...
        if (this.groupsView.partOptions.wrapTabs) {
            ...
            const lastTabFitsWrapped = () => {
                ...
                const lastTabOverlapWithToolbarWidth = lastTab.offsetWidth +
    ...
    private doLayoutTabsNonWrapping(options?: IMultiEditorTabsControlLayoutOptions): void {
        ...
        const dimensionsChanged = oldVisibleTabsWidth !== visibleTabsWidth ||
        ...
        //
        //
        else if (tabsContainerScrollPosX > adjustedActiveTabPosX ||
            !activeTabFits) {
            tabsScrollbar.setScrollPosition({
    ...
    private getTabAndIndex(editor: EditorInput): [
        HTMLElement,
        number /* index */
    ] | undefined {
...
registerThemingParticipant((theme, collector) => {
    ...
    if (!isHighContrast(theme.type) &&
        ...
        if (tabUnfocusedActiveBackground &&
            adjustedTabBackground &&
            adjustedTabDragBackground) {
        ...
        if (tabUnfocusedInactiveBackground &&
            adjustedTabBackground &&
            adjustedTabDragBackground) {
