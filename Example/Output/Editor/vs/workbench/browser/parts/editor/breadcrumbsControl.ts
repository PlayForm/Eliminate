...
class FileItem extends BreadcrumbsItem {
    ...
    render(container: HTMLElement): void {
        ...
        label.setFile(this.element.uri, {
            hidePath: true,
            hideIcon: this.element.kind === FileKind.FOLDER ||
...
export class BreadcrumbsControl {
    ...
    breadcrumbsService: IBreadcrumbsService) {
        ...
        this._ckBreadcrumbsPossible =
            BreadcrumbsControl.CK_BreadcrumbsPossible.bindTo(this._contextKeyService);
        this._ckBreadcrumbsVisible =
            BreadcrumbsControl.CK_BreadcrumbsVisible.bindTo(this._contextKeyService);
        this._ckBreadcrumbsActive =
            BreadcrumbsControl.CK_BreadcrumbsActive.bindTo(this._contextKeyService);
    ...
    update(): boolean {
        ...
        const updateBreadcrumbs = () => {
            ...
            const items = model
                ...
                ? new FileItem(model, element, options, this._labels, this._hoverDelegate)
    ...
    private _onSelectEvent(event: IBreadcrumbsItemEvent): void {
        ...
        this._contextViewService.showContextView({
            render: (parent: HTMLElement) => {
                ...
                const selectListener = picker.onWillPickElement(() => this._contextViewService.hideContextView({
                    source: this,
                    didPick: true,
                }));
