...
import { $, clearNode, Dimension, EventHelper, size, } from "../../../../base/browser/dom.js";
...
import { isSingleFolderWorkspaceIdentifier, IWorkspaceContextService, toWorkspaceIdentifier, } from "../../../../platform/workspace/common/workspace.js";
...
export class ErrorPlaceholderEditor extends EditorPlaceholder {
    ...
    protected async getContents(input: EditorInput, options: IErrorEditorPlaceholderOptions, disposables: DisposableStore): Promise<IEditorPlaceholderContents> {
        ...
        const isFileNotFound = (<FileOperationError | undefined>error)?.fileOperationResult ===
