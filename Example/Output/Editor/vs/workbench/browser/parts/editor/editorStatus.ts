...
import { compare, format, splitLines, } from "../../../../base/common/strings.js";
...
import { ChangeTabDisplaySize, DetectIndentation, IndentationToSpacesAction, IndentationToTabsAction, IndentUsingSpaces, IndentUsingTabs, } from "../../../../editor/contrib/indentation/browser/indentation.js";
...
import { FILES_ASSOCIATIONS_CONFIG, IFileService, } from "../../../../platform/files/common/files.js";
import { IInstantiationService } from "../../../../platform/instantiation/common/instantiation.js";
import { KeybindingWeight } from "../../../../platform/keybinding/common/keybindingsRegistry.js";
import { IMarker, IMarkerData, IMarkerService, MarkerSeverity, } from "../../../../platform/markers/common/markers.js";
import { IQuickInputService, IQuickPickItem, QuickPickInput, } from "../../../../platform/quickinput/common/quickInput.js";
import { ITelemetryService } from "../../../../platform/telemetry/common/telemetry.js";
import { IWorkbenchContribution } from "../../../common/contributions.js";
import { EditorResourceAccessor, IEditorPane, IFileEditorInput, SideBySideEditor, } from "../../../common/editor.js";
...
class TabFocusMode extends Disposable {
    ...
    private readonly configurationService: IConfigurationService) {
        ...
        const tabFocusModeConfig = configurationService.getValue<boolean>("editor.tabFocusMode") ===
            true
            ? true
            : false;
...
class EditorStatus extends Disposable {
    ...
    constructor(private readonly targetWindowId: number, 
    @IEditorService
    ...
    private async showIndentationPicker(): Promise<unknown> {
        ...
        const picks: QuickPickInput<IQuickPickItem & {
            run(): void;
        }>[] = [
    ...
    private doRenderNow(): void {
        ...
        this.updateEOLElement(this.state.EOL
            ? this.state.EOL === "\r\n"
                ? nlsEOLCRLF
                : nlsEOLLF
            : undefined);
    ...
    private onEncodingChange(editor: IEditorPane | undefined, editorWidget: ICodeEditor | undefined): void {
        ...
        if (editor && editorWidget?.hasModel()) {
            ...
            if (encodingSupport) {
                ...
                const encodingInfo = typeof rawEncoding === "string"
...
class ShowCurrentMarkerInStatusbarContribution extends Disposable {
                ...
                if (!this.statusBarEntryAccessor.value) {
                    this.statusBarEntryAccessor.value =
                        this.statusbarService.addEntry({
                            ...
                            text: "",
                            ariaLabel: "",
                        }, "statusbar.currentProblem", StatusbarAlignment.LEFT);
                }
    ...
    private hasToUpdateStatus(previousMarker: IMarker | null, currentMarker: IMarker | null): boolean {
        ...
        return (IMarkerData.makeKey(previousMarker) !==
...
export class ChangeLanguageAction extends Action2 {
    ...
    override async run(accessor: ServicesAccessor, languageMode?: string): Promise<void> {
        ...
        const picks: QuickPickInput[] = languages.map(({ languageName, languageId }) => {
                    ...
                    if (textModel) {
                        ...
                        if (resource) {
                            ...
                            if (!languageId || languageId === "unknown") {
                                detectedLanguage =
                                    await languageDetectionService.detectLanguage(resource);
                    ...
                    if (resource) {
                        ...
                        languageDetectionService
                            ...
                            if (detectedLanguageId === currentLanguageId &&
                                ...
                                const modelPreference = configurationService.getValue<boolean>("workbench.editor.preferHistoryBasedLanguageDetection")
                                    ? "history"
                                    : "classic";
        ...
        setTimeout(async () => {
            ...
            if (language) {
                ...
                if (fileAssociationsConfig.workspaceValue &&
                    !!(fileAssociationsConfig.workspaceValue as any)[associationKey]) {
                    target = ConfigurationTarget.WORKSPACE;
                }
                // Make sure to write into the value of the target and not the merged value from USER and WORKSPACE config
                const currentAssociations = deepClone(target === ConfigurationTarget.WORKSPACE
...
export class ChangeEncodingAction extends Action2 {
    ...
    async run(accessor: ServicesAccessor): Promise<void> {
        ...
        const picks: QuickPickInput[] = Object.keys(SUPPORTED_ENCODINGS)
            ...
            return (SUPPORTED_ENCODINGS[k1].order -
            ...
            else if (SUPPORTED_ENCODINGS[key].alias ===
        ...
        if (typeof encoding.id !== "undefined" && activeEncodingSupport) {
            await activeEncodingSupport.setEncoding(encoding.id, isReopenWithEncoding
                ? EncodingMode.Decode
                : EncodingMode.Encode); // Set new encoding
        }
        activeTextEditorControl.focus();
    }
}
