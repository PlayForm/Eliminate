...
import { IEditorCommandsContext, IEditorIdentifier, isEditorCommandsContext, isEditorIdentifier, } from "../../../common/editor.js";
...
function getEditorAndGroupFromContext(commandContext: IEditorCommandsContext, editorGroupsService: IEditorGroupsService): {
    group: IEditorGroup;
