...
import { EditorResourceAccessor, IEditorCloseEvent, IEditorMemento, IEditorOpenContext, SideBySideEditor, } from "../../../common/editor.js";
...
export abstract class AbstractEditorWithViewState<T extends object> extends EditorPane {
    ...
    private shouldRestoreEditorViewState(input: EditorInput, context?: IEditorOpenContext): boolean {
        ...
        if (context?.newInGroup) {
            return this.textResourceConfigurationService.getValue<boolean>(EditorResourceAccessor.getOriginalUri(input, {
