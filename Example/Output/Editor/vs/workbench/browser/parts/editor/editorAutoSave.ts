...
import { EditorInputCapabilities, GroupIdentifier, IEditorIdentifier, SaveReason, } from "../../../common/editor.js";
import { EditorInput } from "../../../common/editor/editorInput.js";
import { IEditorGroupsService } from "../../../services/editor/common/editorGroupsService.js";
import { IEditorService } from "../../../services/editor/common/editorService.js";
import { AutoSaveDisabledReason, AutoSaveMode, IFilesConfigurationService, } from "../../../services/filesConfiguration/common/filesConfigurationService.js";
...
export class EditorAutoSave extends Disposable implements IWorkbenchContribution {
    ...
    private readonly uriIdentityService: IUriIdentityService) {
        ...
        for (const dirtyWorkingCopy of this.workingCopyService
            .dirtyWorkingCopies) {
    ...
    private maybeTriggerAutoSave(reason: SaveReason.WINDOW_CHANGE | SaveReason.FOCUS_CHANGE, editorIdentifier?: IEditorIdentifier): void {
        if (editorIdentifier) {
            ...
            if (autoSaveMode.mode !== AutoSaveMode.OFF) {
                ...
                if ((reason === SaveReason.WINDOW_CHANGE &&
