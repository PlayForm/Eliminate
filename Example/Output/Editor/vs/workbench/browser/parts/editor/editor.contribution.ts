...
import { IMenuItem, MenuId, MenuRegistry, registerAction2, } from "../../../../platform/actions/common/actions.js";
...
import { ActiveCompareEditorCanSwapContext, ActiveEditorAvailableEditorIdsContext, ActiveEditorCanSplitInGroupContext, ActiveEditorDirtyContext, ActiveEditorGroupLockedContext, ActiveEditorLastInGroupContext, ActiveEditorPinnedContext, ActiveEditorStickyContext, EditorGroupEditorsCountContext, EditorPartMaximizedEditorGroupContext, EditorPartMultipleEditorGroupsContext, EditorTabsVisibleContext, InEditorZenModeContext, IsAuxiliaryEditorPartContext, MultipleEditorGroupsContext, MultipleEditorsSelectedInGroupContext, SideBySideEditorActiveContext, TextCompareEditorActiveContext, } from "../../../common/contextkeys.js";
...
Registry.as<IEditorPaneRegistry>(EditorExtensions.EditorPane).registerEditorPane(EditorPaneDescriptor.create(TextResourceEditor, TextResourceEditor.ID, localize("textEditor", "Text Editor")), [
    new SyncDescriptor(UntitledTextEditorInput),
    new SyncDescriptor(TextResourceEditorInput),
]);
Registry.as<IEditorPaneRegistry>(EditorExtensions.EditorPane).registerEditorPane(EditorPaneDescriptor.create(TextDiffEditor, TextDiffEditor.ID, localize("textDiffEditor", "Text Diff Editor")), [new SyncDescriptor(DiffEditorInput)]);
Registry.as<IEditorPaneRegistry>(EditorExtensions.EditorPane).registerEditorPane(EditorPaneDescriptor.create(BinaryResourceDiffEditor, BinaryResourceDiffEditor.ID, localize("binaryDiffEditor", "Binary Diff Editor")), [new SyncDescriptor(DiffEditorInput)]);
Registry.as<IEditorPaneRegistry>(EditorExtensions.EditorPane).registerEditorPane(EditorPaneDescriptor.create(SideBySideEditor, SideBySideEditor.ID, localize("sideBySideEditor", "Side by Side Editor")), [new SyncDescriptor(SideBySideEditorInput)]);
...
if (isMacintosh) {
    MenuRegistry.appendMenuItem(MenuId.TouchBarContext, {
        command: {
            ...
            icon: {
                dark: FileAccess.asFileUri("vs/workbench/browser/parts/editor/media/back-tb.png"),
            },
        },
        group: "navigation",
        order: 0,
