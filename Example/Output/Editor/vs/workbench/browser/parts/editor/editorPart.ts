 ...
 *--------------------------------------------------------------------------------------------*/
import { $, addDisposableGenericMouseDownListener, Dimension, EventHelper, getActiveElement, getWindow, isAncestorOfActiveElement, isHTMLElement, } from "../../../../base/browser/dom.js";
import { CenteredViewLayout } from "../../../../base/browser/ui/centered/centeredViewLayout.js";
import { createSerializedGrid, Direction, Grid, GridBranchNode, GridNode, ISerializedGrid, ISerializedNode, isGridBranchNode, IView, IViewSize, LayoutPriority, Orientation, orthogonal, SerializableGrid, Sizing, } from "../../../../base/browser/ui/grid/grid.js";
...
import { assertIsDefined, assertType, DeepPartial, } from "../../../../base/common/types.js";
...
import { getEditorPartOptions, IEditorGroupsView, IEditorGroupView, IEditorGroupViewOptions, IEditorPartCreationOptions, IEditorPartsView, impactsEditorPartOptions, } from "./editor.js";
...
export class EditorPart extends Part implements IEditorPart, IEditorGroupsView {
    ...
    private readonly onDidSetGridWidget = this._register(new Emitter<{
        width: number;
        height: number;
    } | undefined>());
    private readonly _onDidChangeSizeConstraints = this._register(new Relay<{
        width: number;
        height: number;
    } | undefined>());
    ...
    constructor(protected readonly editorPartsView: IEditorPartsView, id: string, private readonly groupsLabel: string, readonly windowId: number, 
    ...
    private doFindGroupByDirection(direction: GroupDirection, source: IEditorGroupView | GroupIdentifier, wrap?: boolean): IEditorGroupView | undefined {
        ...
        neighbours.sort((n1, n2) => this.mostRecentActiveGroups.indexOf(n1.id) -
    ...
    setGroupOrientation(orientation: GroupOrientation): void {
        ...
        const newOrientation = orientation === GroupOrientation.HORIZONTAL
    ...
    getLayout(): EditorGroupLayout {
        ...
        const orientation = serializedGrid.orientation === Orientation.HORIZONTAL
            ? GroupOrientation.HORIZONTAL
            : GroupOrientation.VERTICAL;
    ...
    private doRestoreGroup(group: IEditorGroupView): void {
        ...
        try {
            ...
            if (viewSize.width === group.minimumWidth ||
    ...
    mergeGroup(group: IEditorGroupView | GroupIdentifier, target: IEditorGroupView | GroupIdentifier, options?: IMergeGroupOptions): boolean {
        ...
        let index = options && typeof options.index === "number"
            ? options.index
            : targetView.count;
    ...
    override updateStyles(): void {
        ...
        const separatorBorderStyle = {
            ...
            background: this.theme.getColor(EDITOR_PANE_BACKGROUND) ||
                Color.transparent,
        };
    ...
    private setupDragAndDropSupport(parent: HTMLElement, container: HTMLElement): void {
        ...
        const openPartAtPosition = (position: Position) => {
            ...
            else if (!this.layoutService.isVisible(Parts.AUXILIARYBAR_PART) &&
                position ===
