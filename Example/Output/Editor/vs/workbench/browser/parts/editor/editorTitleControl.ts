...
export class EditorTitleControl extends Themable {
    ...
    constructor(private readonly parent: HTMLElement, private readonly editorPartsView: IEditorPartsView, private readonly groupsView: IEditorGroupsView, private readonly groupView: IEditorGroupView, private readonly model: IReadonlyEditorGroupModel, 
    ...
    getHeight(): IEditorGroupTitleHeight {
        ...
        const breadcrumbsControlHeight = this.breadcrumbsControl?.isHidden() === false
