...
import { EditorExtensions, EditorInputCapabilities, EditorsOrder, GroupIdentifier, GroupModelChangeKind, IEditorFactoryRegistry, IEditorIdentifier, IEditorPartOptionsChangeEvent, } from "../../../common/editor.js";
import { EditorInput } from "../../../common/editor/editorInput.js";
import { SideBySideEditorInput } from "../../../common/editor/sideBySideEditorInput.js";
import { GroupsOrder, IEditorGroup, IEditorGroupsContainer, IEditorGroupsService, } from "../../../services/editor/common/editorGroupsService.js";
...
export class EditorsObserver extends Disposable {
    ...
    private onGroupAdded(group: IEditorGroup): void {
        ...
        if (this.editorGroupsContainer.activeGroup === group &&
            group.activeEditor) {
