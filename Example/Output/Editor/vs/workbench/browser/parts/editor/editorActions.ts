...
import { ActiveEditorMoveCopyArguments, CLOSE_EDITOR_COMMAND_ID, COPY_ACTIVE_EDITOR_COMMAND_ID, COPY_EDITOR_GROUP_INTO_NEW_WINDOW_COMMAND_ID, COPY_EDITOR_INTO_NEW_WINDOW_COMMAND_ID, LAYOUT_EDITOR_GROUPS_COMMAND_ID, MOVE_ACTIVE_EDITOR_COMMAND_ID, MOVE_EDITOR_GROUP_INTO_NEW_WINDOW_COMMAND_ID, MOVE_EDITOR_INTO_NEW_WINDOW_COMMAND_ID, NEW_EMPTY_EDITOR_WINDOW_COMMAND_ID, SPLIT_EDITOR, SPLIT_EDITOR_DOWN, SPLIT_EDITOR_LEFT, SPLIT_EDITOR_RIGHT, SPLIT_EDITOR_UP, splitEditor, TOGGLE_MAXIMIZE_EDITOR_GROUP, UNPIN_EDITOR_COMMAND_ID, } from "./editorCommands.js";
...
class ExecuteCommandAction extends Action2 {
    constructor(desc: Readonly<IAction2Options>, private readonly commandId: string, private readonly commandArgs?: unknown) {
        super(desc);
    }
...
abstract class AbstractFocusGroupAction extends Action2 {
    constructor(desc: Readonly<IAction2Options>, private readonly scope: IFindGroupScope) {
        super(desc);
    }
    override async run(accessor: ServicesAccessor): Promise<void> {
        const editorGroupService = accessor.get(IEditorGroupsService);
...
export class CloseLeftEditorsInGroupAction extends Action2 {
    ...
    private getTarget(editorGroupService: IEditorGroupsService, context?: IEditorIdentifier): {
...
abstract class AbstractCloseAllAction extends Action2 {
    ...
    override async run(accessor: ServicesAccessor): Promise<void> {
        ...
        for (const { editor, groupId } of editorService.getEditors(EditorsOrder.SEQUENTIAL, { excludeSticky: this.excludeSticky })) {
            ...
            else if (!editor.hasCapability(EditorInputCapabilities.Untitled) &&
...
abstract class AbstractMoveCopyGroupAction extends Action2 {
    constructor(desc: Readonly<IAction2Options>, private readonly direction: GroupDirection, private readonly isMove: boolean) {
        super(desc);
    }
    override async run(accessor: ServicesAccessor, context?: IEditorIdentifier): Promise<void> {
        const editorGroupService = accessor.get(IEditorGroupsService);
...
abstract class AbstractQuickAccessEditorAction extends Action2 {
    constructor(desc: Readonly<IAction2Options>, private readonly prefix: string, private readonly itemActivation: ItemActivation | undefined) {
        super(desc);
    }
    override async run(accessor: ServicesAccessor): Promise<void> {
...
abstract class AbstractCreateEditorGroupAction extends Action2 {
    constructor(desc: Readonly<IAction2Options>, private readonly direction: GroupDirection) {
        super(desc);
    }
    override async run(accessor: ServicesAccessor): Promise<void> {
        const editorGroupService = accessor.get(IEditorGroupsService);
        ...
        const focusNewGroup = layoutService.hasFocus(Parts.EDITOR_PART) ||
...
abstract class BaseMoveCopyEditorToNewWindowAction extends Action2 {
    constructor(id: string, title: ICommandActionTitle, keybinding: Omit<IKeybindingRule, "id"> | undefined, private readonly move: boolean) {
        super({
            id,
            title,
            category: Categories.View,
...
abstract class BaseMoveCopyEditorGroupToNewWindowAction extends Action2 {
    constructor(id: string, title: ICommandActionTitle, private readonly move: boolean) {
        super({
            id,
            title,
            category: Categories.View,
