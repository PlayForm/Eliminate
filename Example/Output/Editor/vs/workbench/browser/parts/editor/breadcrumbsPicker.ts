...
import { IAsyncDataSource, ITreeFilter, ITreeNode, ITreeRenderer, ITreeSorter, TreeVisibility, } from "../../../../base/browser/ui/tree/tree.js";
...
class FileRenderer implements ITreeRenderer<IFileStat | IWorkspaceFolder, FuzzyScore, IResourceLabel> {
    ...
    renderElement(node: ITreeNode<IWorkspaceFolder | IFileStat, [
        number,
        number,
        number
    ]>, index: number, templateData: IResourceLabel): void {
...
export class BreadcrumbsFilePicker extends BreadcrumbsPicker {
    constructor(parent: HTMLElement, resource: URI, 
    @IInstantiationService
