...
import { ActiveEditorAvailableEditorIdsContext, ActiveEditorCanSplitInGroupContext, ActiveEditorFirstInGroupContext, ActiveEditorGroupLockedContext, ActiveEditorLastInGroupContext, ActiveEditorPinnedContext, ActiveEditorStickyContext, applyAvailableEditorIds, ResourceContextKey, SideBySideEditorActiveContext, } from "../../../common/contextkeys.js";
import { EditorInputCapabilities, EditorResourceAccessor, EditorsOrder, GroupIdentifier, IEditorCommandsContext, IEditorPartOptions, IToolbarActions, SideBySideEditor, Verbosity, } from "../../../common/editor.js";
...
export class EditorCommandsContextActionRunner extends ActionRunner {
    ...
    override run(action: IAction, context?: {
...
export abstract class EditorTabsControl extends Themable implements IEditorTabsControl {
    ...
    constructor(protected readonly parent: HTMLElement, protected readonly editorPartsView: IEditorPartsView, protected readonly groupsView: IEditorGroupsView, protected readonly groupView: IEditorGroupView, protected readonly tabsModel: IReadonlyEditorGroupModel, 
    @IContextMenuService
    ...
    private readonly hostService: IHostService) {
        ...
        this.editorAvailableEditorIds =
            ActiveEditorAvailableEditorIdsContext.bindTo(this.contextMenuContextKeyService);
        this.editorCanSplitInGroupContext =
            ActiveEditorCanSplitInGroupContext.bindTo(this.contextMenuContextKeyService);
    ...
    private getEditorPaneAwareContextKeyService(): IContextKeyService {
        return (this.groupView.activeEditorPane?.scopedContextKeyService ??
    ...
    protected async maybeCreateAuxiliaryEditorPartAt(e: DragEvent, offsetElement: HTMLElement): Promise<IAuxiliaryEditorPart | undefined> {
        ...
        const offsetY = 30 /* take title bar height into account (approximation) */ +
    ...
    updateOptions(oldOptions: IEditorPartOptions, newOptions: IEditorPartOptions): void {
        ...
        if (oldOptions.editorActionsLocation !==
