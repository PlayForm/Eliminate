...
export class OutlineElement2 {
    constructor(readonly element: IOutline<any> | any, readonly outline: IOutline<any>) { }
}
export class BreadcrumbsModel {
    ...
    getElements(): ReadonlyArray<FileElement | OutlineElement2> {
        ...
        else if (this._cfgFilePath.getValue() === "last" &&
        ...
        for (let i = this._cfgSymbolPath.getValue() === "last" &&
    ...
    private _initFilePathInfo(uri: URI): FileInfo {
        ...
        if (info.folder &&
            this._workspaceService.getWorkbenchState() ===
