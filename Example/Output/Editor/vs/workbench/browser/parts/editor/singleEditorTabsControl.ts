...
import { addDisposableListener, Dimension, DragAndDropObserver, EventHelper, EventType, isAncestor, isHTMLElement, } from "../../../../base/browser/dom.js";
...
import { EditorCloseMethod, EditorResourceAccessor, IEditorPartOptions, IToolbarActions, preventEditorClose, SideBySideEditor, Verbosity, } from "../../../common/editor.js";
import { EditorInput } from "../../../common/editor/editorInput.js";
import { TAB_ACTIVE_FOREGROUND, TAB_UNFOCUSED_ACTIVE_FOREGROUND, } from "../../../common/theme.js";
import { IResourceLabel, ResourceLabel } from "../../labels.js";
        ...
        // Inactive: only show "Close, "Unlock" and secondary actions
            ...
            return {
                primary: this.groupsView.partOptions.alwaysShowEditorActions
                    ...
                    : editorActions.primary.filter((action) => action.id === CLOSE_EDITOR_COMMAND_ID ||
