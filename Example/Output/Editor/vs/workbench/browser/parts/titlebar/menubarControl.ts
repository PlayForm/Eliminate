...
import { IMenuBarOptions, MenuBar, } from "../../../../base/browser/ui/menu/menubar.js";
import { mainWindow } from "../../../../base/browser/window.js";
import { Action, ActionRunner, IAction, IActionRunner, Separator, SubmenuAction, toAction, WorkbenchActionExecutedClassification, WorkbenchActionExecutedEvent, } from "../../../../base/common/actions.js";
import { RunOnceScheduler } from "../../../../base/common/async.js";
import { Emitter, Event } from "../../../../base/common/event.js";
import { KeyCode, KeyMod } from "../../../../base/common/keyCodes.js";
import { mnemonicMenuLabel, unmnemonicLabel, } from "../../../../base/common/labels.js";
import { Disposable, DisposableStore, } from "../../../../base/common/lifecycle.js";
import { isIOS, isMacintosh, isNative, isWeb, } from "../../../../base/common/platform.js";
import { URI } from "../../../../base/common/uri.js";
import { localize, localize2 } from "../../../../nls.js";
import { IAccessibilityService } from "../../../../platform/accessibility/common/accessibility.js";
import { isICommandActionToggleInfo } from "../../../../platform/action/common/action.js";
import { createAndFillInContextMenuActions } from "../../../../platform/actions/browser/menuEntryActionViewItem.js";
import { Action2, IMenu, IMenuService, MenuId, MenuItemAction, MenuRegistry, registerAction2, SubmenuItemAction, } from "../../../../platform/actions/common/actions.js";
...
import { getMenuBarVisibility, hasNativeTitlebar, IWindowOpenable, MenuBarVisibility, TitleBarSetting, } from "../../../../platform/window/common/window.js";
import { IRecent, IRecentlyOpened, isRecentFolder, isRecentWorkspace, IWorkspacesService, } from "../../../../platform/workspaces/common/workspaces.js";
...
export abstract class MenubarControl extends Disposable {
        ...
        for (const mainMenuAction of mainMenuActions) {
            if (mainMenuAction instanceof SubmenuItemAction &&
                ...
                this.menus[mainMenuAction.item.title.original] =
                    this.mainMenuDisposables.add(this.menuService.createMenu(mainMenuAction.item.submenu, this.contextKeyService, { emitEventsForSubmenuChanges: true }));
    ...
    protected getOpenRecentActions(): (Separator | IOpenRecentAction)[] {
        ...
        if (workspaces.length > 0) {
            for (let i = 0; i < MenubarControl.MAX_MENU_RECENT_ENTRIES &&
                i < workspaces.length; i++) {
...
export class CustomMenubarControl extends MenubarControl {
    ...
    private getUpdateAction(): IAction | null {
        ...
        switch (state.type) {
            case StateType.Idle:
                ...
                }, "Check for &&Updates..."), undefined, true, () => this.updateService.checkForUpdates(true));
            ...
            case StateType.AvailableForDownload:
                return new Action("update.downloadNow", localize({
                    key: "download now",
                    comment: ["&& denotes a mnemonic"],
                }, "D&&ownload Update"), undefined, true, () => this.updateService.downloadUpdate());
            case StateType.Downloading:
                return new Action("update.downloading", localize("DownloadingUpdate", "Downloading Update..."), undefined, false);
            case StateType.Downloaded:
                return isMacintosh
                    ? null
                    : new Action("update.install", localize({
                        key: "installUpdate...",
                        comment: ["&& denotes a mnemonic"],
                    }, "Install &&Update..."), undefined, true, () => this.updateService.applyUpdate());
            ...
            case StateType.Ready:
                return new Action("update.restart", localize({
                    key: "restartToUpdate",
                    comment: ["&& denotes a mnemonic"],
                }, "Restart to &&Update"), undefined, true, () => this.updateService.quitAndInstall());
            default:
                return null;
        }
    }
    ...
    private get currentCompactMenuMode(): IMenuDirection | undefined {
        ...
        const horizontalDirection = currentSidebarLocation === "right"
            ? HorizontalDirection.Left
            : HorizontalDirection.Right;
        const activityBarLocation = this.configurationService.getValue<string>("workbench.activityBar.location");
        const verticalDirection = activityBarLocation === ActivityBarPosition.BOTTOM
    ...
    private setupCustomMenubar(firstTime: boolean): void {
        ...
        const updateActions = (menuActions: readonly IAction[], target: IAction[], topLevelTitle: string) => {
            ...
            for (const menuItem of menuActions) {
                ...
                else if (menuItem instanceof SubmenuItemAction ||
