...
export class WindowTitle extends Disposable {
    ...
    get fileName() {
        ...
        const dirty = activeEditor?.isDirty() && !activeEditor.isSaving()
    ...
    constructor(targetWindow: CodeWindow, editorGroupsContainer: IEditorGroupsContainer | "main", 
    ...
    updateProperties(properties: ITitleProperties): void {
        const isAdmin = typeof properties.isAdmin === "boolean"
            ? properties.isAdmin
            : this.properties.isAdmin;
        const isPure = typeof properties.isPure === "boolean"
            ? properties.isPure
    ...
    getWindowTitle(): string {
        ...
        const folderPath = folder
            ...
            : "";
        const dirty = editor?.isDirty() && !editor.isSaving()
            ? WindowTitle.TITLE_DIRTY
            : "";
    ...
    isCustomTitleFormat(): boolean {
        ...
        return (title.value !== title.defaultValue ||
