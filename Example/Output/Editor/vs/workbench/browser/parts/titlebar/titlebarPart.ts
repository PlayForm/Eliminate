...
import { $, addDisposableListener, append, Dimension, EventHelper, EventType, getActiveDocument, getWindow, getWindowId, isAncestor, isHTMLElement, prepend, reset, } from "../../../../base/browser/dom.js";
...
import { DEFAULT_CUSTOM_TITLEBAR_HEIGHT, getMenuBarVisibility, getTitleBarStyle, hasCustomTitlebar, hasNativeTitlebar, MenuBarVisibility, TitlebarStyle, } from "../../../../platform/window/common/window.js";
...
export class BrowserTitlebarPart extends Part implements ITitlebarPart {
    ...
    get minimumHeight(): number {
        ...
        let value = this.isCommandCenterVisible || wcoEnabled
    ...
    private onEditorPartConfigurationChange({ oldPartOptions, newPartOptions, }: IEditorPartOptionsChangeEvent): void {
        if (oldPartOptions.editorActionsLocation !==
    ...
    protected override createContentArea(parent: HTMLElement): HTMLElement {
        ...
        if (!hasNativeTitlebar(this.configurationService, this.titleBarStyle)) {
            ...
            if (isMacintosh &&
                ...
                this.windowControlsContainer = append(primaryWindowControlsLocation === "left"
                    ? this.leftContent
                    : this.rightContent, $("div.window-controls-container"));
                if (isWeb) {
                    ...
                    append(primaryWindowControlsLocation === "left"
                        ? this.rightContent
                        : this.leftContent, $("div.window-controls-container"));
                }
                if (isWCOEnabled()) {
    ...
    private getKeybinding(action: IAction): ResolvedKeybinding | undefined {
        const editorPaneAwareContextKeyService = this.editorGroupsContainer.activeGroup?.activeEditorPane
    ...
    private createActionToolBarMenus(update: true | {
    ...
    override updateStyles(): void {
        ...
        if (this.element) {
            ...
            const titleBackground = this.getColor(this.isInactive
                ? TITLE_BAR_INACTIVE_BACKGROUND
                : TITLE_BAR_ACTIVE_BACKGROUND, (color, theme) => {
            ...
            const titleForeground = this.getColor(this.isInactive
    ...
    private get layoutControlEnabled(): boolean {
        return (!this.isAuxiliary &&
            this.configurationService.getValue<boolean>(LayoutSettings.LAYOUT_ACTIONS) !== false);
    }
    ...
    get hasZoomableElements(): boolean {
        ...
        const hasToolBarActions = this.layoutControlEnabled ||
