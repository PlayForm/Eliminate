...
export class PaneCompositeBar extends Disposable {
    ...
    private readonly compositeActions = new Map<string, {
    ...
    constructor(protected readonly options: IPaneCompositeBarOptions, private readonly part: Parts, private readonly paneCompositePart: IPaneCompositePart, 
    ...
    private onDidChangeViewContainers(added: readonly {
...
class ViewContainerActivityAction extends CompositeBarAction {
    ...
    private lastRun = 0;
    constructor(compositeBarActionItem: ICompositeBarActionItem, private readonly part: Parts, private readonly paneCompositePart: IPaneCompositePart, 
    @IWorkbenchLayoutService
