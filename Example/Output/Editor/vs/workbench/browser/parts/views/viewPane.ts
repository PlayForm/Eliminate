...
import { asCSSUrl, asCssValueWithDefault, } from "../../../../base/browser/cssValue.js";
import { $, addDisposableListener, after, append, createCSSRule, Dimension, EventType, reset, trackFocus, } from "../../../../base/browser/dom.js";
...
import { Action2, IAction2Options, MenuId, SubmenuItemAction, } from "../../../../platform/actions/common/actions.js";
...
import { defaultViewIcon, IView, IViewContentDescriptor, IViewDescriptorService, IViewsRegistry, Extensions as ViewContainerExtensions, ViewContainerLocation, ViewContainerLocationToString, } from "../../../common/views.js";
...
class ViewWelcomeController {
    ...
    constructor(private readonly container: HTMLElement, private readonly delegate: IViewWelcomeDelegate, 
            ...
            for (let line of lines) {
                ...
                if (linkedText.nodes.length === 1 &&
                    ...
                    const button = new Button(buttonContainer, {
                        title: node.title,
                        supportIcons: true,
                        secondary: renderSecondaryButtons && buttonsCount > 0
                            ? true
                            : false,
                        ...defaultButtonStyles,
                    });
                    ...
                    button.onDidClick((_) => {
                        this.telemetryService.publicLog2<{
                            viewId: string;
                            uri: string;
                        }, WelcomeActionClassification>("views.welcomeAction", {
                    ...
                    buttonsCount++;
                    if (precondition) {
                        const updateEnablement = () => (button.enabled =
                            this.contextKeyService.contextMatchesRules(precondition));
                        updateEnablement();
                    ...
                    for (const node of linkedText.nodes) {
                        if (typeof node === "string") {
                            ...
                            if (precondition &&
                                ...
                                const updateEnablement = () => (link.enabled =
                                    this.contextKeyService.contextMatchesRules(precondition));
                                updateEnablement();
                                const keys = new Set(precondition.keys());
                                const onDidChangeContext = Event.filter(this.contextKeyService.onDidChangeContext, (e) => e.affectsSome(keys));
...
export abstract class ViewPane extends Pane implements IView {
    ...
    protected telemetryService: ITelemetryService, 
    @IHoverService
    protected readonly hoverService: IHoverService, protected readonly accessibleViewInformationService?: IAccessibleViewInformationService) {
        super({
            ...options,
            ...{
                orientation: viewDescriptorService.getViewLocationById(options.id) ===
        ...
        const childInstantiationService = this._register(this.instantiationService.createChild(new ServiceCollection([
            IContextKeyService,
            this.scopedContextKeyService,
        ])));
        this.menuActions = this._register(childInstantiationService.createInstance(CompositeMenuActions, options.titleMenuId ?? MenuId.ViewTitle, MenuId.ViewTitleContext, {
    ...
    private getIcon(): ThemeIcon | URI {
        return (this.viewDescriptorService.getViewDescriptorById(this.id)
    ...
    private calculateTitle(title: string): string {
        ...
        const isDefault = this.viewDescriptorService.getDefaultContainerById(this.id) ===
            viewContainer;
        if (!isDefault &&
        ...
        if (this.progressIndicator === undefined) {
            ...
            this.progressIndicator = this._register(new ScopedProgressIndicator(assertIsDefined(this.progressBar), new (class extends AbstractProgressScope {
                constructor() {
                    ...
                    this._register(that.onDidChangeBodyVisibility((isVisible) => isVisible
...
export abstract class FilterViewPane extends ViewPane {
    ...
    @IHoverService
    hoverService: IHoverService, accessibleViewService?: IAccessibleViewInformationService) {
        ...
        const childInstantiationService = this._register(instantiationService.createChild(new ServiceCollection([
            IContextKeyService,
            this.scopedContextKeyService,
        ])));
