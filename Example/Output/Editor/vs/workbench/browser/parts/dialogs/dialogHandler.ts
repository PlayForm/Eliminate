...
import { AbstractDialogHandler, DialogType, IAsyncPromptResult, ICheckbox, IConfirmation, IConfirmationResult, ICustomDialogOptions, IInput, IInputElement, IInputResult, IPrompt, } from "../../../../platform/dialogs/common/dialogs.js";
...
export class BrowserDialogHandler extends AbstractDialogHandler {
    ...
    async confirm(confirmation: IConfirmation): Promise<IConfirmationResult> {
        ...
        const { button, checkboxChecked } = await this.doShow(confirmation.type ?? "question", confirmation.message, buttons, confirmation.detail, buttons.length - 1, confirmation.checkbox, undefined, typeof confirmation?.custom === "object"
            ? confirmation.custom
            : undefined);
