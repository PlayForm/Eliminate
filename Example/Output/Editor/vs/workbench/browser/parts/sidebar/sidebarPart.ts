...
import { ACTIVITY_BAR_BADGE_BACKGROUND, ACTIVITY_BAR_BADGE_FOREGROUND, ACTIVITY_BAR_TOP_ACTIVE_BORDER, ACTIVITY_BAR_TOP_DRAG_AND_DROP_BORDER, ACTIVITY_BAR_TOP_FOREGROUND, ACTIVITY_BAR_TOP_INACTIVE_FOREGROUND, SIDE_BAR_BACKGROUND, SIDE_BAR_BORDER, SIDE_BAR_DRAG_AND_DROP_BACKGROUND, SIDE_BAR_FOREGROUND, SIDE_BAR_TITLE_FOREGROUND, } from "../../../common/theme.js";
...
export class SidebarPart extends AbstractPaneCompositePart {
    ...
    menuService: IMenuService) {
        super(Parts.SIDEBAR_PART, {
            hasTitle: true,
            borderWidth: () => this.getColor(SIDE_BAR_BORDER) ||
                this.getColor(contrastBorder)
                ? 1
                : 0,
        }, SidebarPart.activeViewletSettingsKey, ActiveViewletContext.bindTo(contextKeyService), SidebarFocusContext.bindTo(contextKeyService), "sideBar", "viewlet", SIDE_BAR_TITLE_FOREGROUND, notificationService, storageService, contextMenuService, layoutService, keybindingService, hoverService, instantiationService, themeService, viewDescriptorService, contextKeyService, extensionService, menuService);
    ...
    protected getCompositeBarOptions(): IPaneCompositeBarOptions {
        return {
            ...
            activityHoverOptions: {
                position: () => this.getCompositeBarPosition() ===
    ...
    protected shouldShowCompositeBar(): boolean {
        ...
        return (activityBarPosition === ActivityBarPosition.TOP ||
    ...
    private registerActions(): void {
        ...
        this._register(registerAction2(class extends Action2 {
            ...
            run(): Promise<void> {
                const value = that.configurationService.getValue(LayoutSettings.ACTIVITY_BAR_LOCATION) === ActivityBarPosition.HIDDEN
