...
import { detectFullscreen, domContentLoaded, getCookieValue, getWindow, } from "../../base/browser/dom.js";
...
import { connectionTokenCookieName, Schemas, } from "../../base/common/network.js";
...
import { IndexedDBFileSystemProvider, IndexedDBFileSystemProviderErrorData, IndexedDBFileSystemProviderErrorDataClassification, } from "../../platform/files/browser/indexedDBFileSystemProvider.js";
...
import { ConsoleLogger, getLogLevel, ILogger, ILoggerService, ILogService, } from "../../platform/log/common/log.js";
...
import { IAnyWorkspaceIdentifier, isTemporaryWorkspace, isWorkspaceIdentifier, IWorkspaceContextService, UNKNOWN_EMPTY_WINDOW_WORKSPACE, } from "../../platform/workspace/common/workspace.js";
...
import { ITunnel, IWorkbench, IWorkbenchConstructionOptions, IWorkspace, } from "./web.api.js";
...
export class BrowserMain extends Disposable {
    ...
    constructor(private readonly domElement: HTMLElement, private readonly configuration: IWorkbenchConstructionOptions) {
        super();
        this.init();
    }
    private init(): void {
        ...
        return instantiationService.invokeFunction((accessor) => {
            ...
            return {
                ...
                logger: {
                    log: (level, message) => {
                        if (!logger) {
                            logger = instantiationService.createInstance(DelayedLogChannel, "webEmbedder", productService.embedderIdentifier ||
                                productService.nameShort, joinPath(dirname(environmentService.logFile), "webEmbedder.log"));
                        }
    ...
    private async initServices(): Promise<{
        ...
        const remoteResourceLoader = this.configuration.remoteResourceProvider
            ...
            : undefined;
        const resourceUriProvider = this.configuration.resourceUriProvider ??
    ...
    private async createWorkspaceService(workspace: IAnyWorkspaceIdentifier, environmentService: IBrowserWorkbenchEnvironmentService, userDataProfileService: IUserDataProfileService, userDataProfilesService: IUserDataProfilesService, fileService: FileService, remoteAgentService: IRemoteAgentService, uriIdentityService: IUriIdentityService, logService: ILogService): Promise<WorkspaceService> {
        ...
        const configurationCache = new ConfigurationCache([
            ...
            Schemas.tmp,
        ] /* Cache all non native resources */, environmentService, fileService);
        const workspaceService = new WorkspaceService({
            remoteAuthority: this.configuration.remoteAuthority,
            configurationCache,
        }, environmentService, userDataProfileService, userDataProfilesService, fileService, remoteAgentService, uriIdentityService, logService, new NullPolicyService());
        try {
    ...
    private async getCurrentProfile(workspace: IAnyWorkspaceIdentifier, userDataProfilesService: BrowserUserDataProfilesService, environmentService: BrowserWorkbenchEnvironmentService): Promise<IUserDataProfile> {
        const profileName = environmentService.options?.profile?.name ??
