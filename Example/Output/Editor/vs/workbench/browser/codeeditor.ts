...
import { ICodeEditor, IOverlayWidget, IOverlayWidgetPosition, isCodeEditor, isCompositeEditor, OverlayWidgetPositionPreference, } from "../../editor/browser/editorBrowser.js";
...
export class RangeHighlightDecorations extends Disposable {
    ...
    highlightRange(range: IRangeHighlightDecoration, editor?: any) {
        ...
        else if (isCompositeEditor(editor) &&
...
export class FloatingEditorClickWidget extends FloatingClickWidget implements IOverlayWidget {
    constructor(private editor: ICodeEditor, label: string, keyBindingAction: string | null, 
    @IKeybindingService
    keybindingService: IKeybindingService) {
        super(keyBindingAction &&
