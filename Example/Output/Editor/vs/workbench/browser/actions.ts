...
import { IMenu, IMenuActionOptions, IMenuService, MenuId, SubmenuItemAction, } from "../../platform/actions/common/actions.js";
...
class MenuActions extends Disposable {
    ...
    constructor(menuId: MenuId, private readonly options: IMenuActionOptions | undefined, private readonly menuService: IMenuService, private readonly contextKeyService: IContextKeyService) {
        super();
        ...
        for (const action of actions) {
            if (action instanceof SubmenuItemAction &&
                ...
                const menu = (submenus[action.item.submenu.id] =
                    disposables.add(this.menuService.createMenu(action.item.submenu, this.contextKeyService)));
...
export class CompositeMenuActions extends Disposable {
    ...
    constructor(readonly menuId: MenuId, private readonly contextMenuId: MenuId | undefined, private readonly options: IMenuActionOptions | undefined, 
    @IContextKeyService
