...
class WorkspaceProvider implements IWorkspaceProvider {
    ...
    static create(config: IWorkbenchConstructionOptions & {
    ...
    private constructor(readonly workspace: IWorkspace, readonly payload: object, private readonly config: IWorkbenchConstructionOptions) {
    }
    async open(workspace: IWorkspace, options?: {
        reuse?: boolean;
        payload?: object;
    }): Promise<boolean> {
    ...
    private createTargetUrl(workspace: IWorkspace, options?: {
        reuse?: boolean;
        payload?: object;
    }): string | undefined {
        // Empty
