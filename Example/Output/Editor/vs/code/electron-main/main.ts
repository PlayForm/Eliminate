...
class CodeMain {
    ...
    private createServices(): [
        ...
        new ServiceCollection().set(IProtocolMainService, new ProtocolMainService(new EnvironmentMainService(this.resolveArgs(), productService), userDataProfilesMainService, logService));
