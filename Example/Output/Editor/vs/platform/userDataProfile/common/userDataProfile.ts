...
export class UserDataProfilesService extends Disposable implements IUserDataProfilesService {
        ...
        if (!this._profilesObject) {
            ...
            try {
                for (const storedProfile of this.getStoredProfiles()) {
                    ...
                    profiles.push(toUserDataProfile(basename(storedProfile.location), storedProfile.name, storedProfile.location, this.profilesCacheHome, {
    ...
    private createDefaultProfile() {
        ...
        return {
            ...defaultProfile,
            extensionsResource: this.getDefaultProfileExtensionsLocation() ??
                defaultProfile.extensionsResource,
            isDefault: true,
        };
    }
