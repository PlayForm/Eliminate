...
export function createAndFillInContextMenuActions(menu: IMenu, options: IMenuActionOptions | undefined, target: IAction[] | {
    primary: IAction[];
    secondary: IAction[];
}, primaryGroup?: string): void;
export function createAndFillInContextMenuActions(menu: [
    string,
...
export function createAndFillInContextMenuActions(menu: IMenu | [
    string,
    Array<MenuItemAction | SubmenuItemAction>
][], optionsOrTarget: IMenuActionOptions | undefined | IAction[] | {
    primary: IAction[];
    secondary: IAction[];
}, targetOrPrimaryGroup?: IAction[] | {
    primary: IAction[];
    secondary: IAction[];
} | string, primaryGroupOrUndefined?: string): void {
    let target: IAction[] | {
        primary: IAction[];
        secondary: IAction[];
    };
    ...
    if (Array.isArray(menu)) {
        groups = menu;
        target = optionsOrTarget as IAction[] | {
            primary: IAction[];
            secondary: IAction[];
        };
        ...
        target = targetOrPrimaryGroup as IAction[] | {
            primary: IAction[];
            secondary: IAction[];
        };
...
export function createAndFillInActionBarActions(menu: IMenu, options: IMenuActionOptions | undefined, target: IAction[] | {
    primary: IAction[];
    secondary: IAction[];
...
export function createAndFillInActionBarActions(menu: [
    string,
    Array<MenuItemAction | SubmenuItemAction>
][], target: IAction[] | {
    primary: IAction[];
...
export function createAndFillInActionBarActions(menu: IMenu | [
    string,
    Array<MenuItemAction | SubmenuItemAction>
][], optionsOrTarget: IMenuActionOptions | undefined | IAction[] | {
    primary: IAction[];
    ...
    if (Array.isArray(menu)) {
        ...
        useSeparatorsInPrimaryActions =
            shouldInlineSubmenuOrUseSeparatorsInPrimaryActions as boolean | undefined;
    }
    else {
        const options: IMenuActionOptions | undefined = optionsOrTarget as IMenuActionOptions | undefined;
        groups = menu.getActions(options);
        ...
        shouldInlineSubmenu =
            shouldInlineSubmenuOrUseSeparatorsInPrimaryActions as (action: SubmenuAction, group: string, groupSize: number) => boolean;
        useSeparatorsInPrimaryActions =
...
function fillInActions(groups: ReadonlyArray<[
    string,
    ReadonlyArray<MenuItemAction | SubmenuItemAction>
]>, target: IAction[] | {
    primary: IAction[];
    secondary: IAction[];
}, useAlternativeActions: boolean, isPrimaryAction: (actionGroup: string) => boolean = (actionGroup) => actionGroup === "navigation", shouldInlineSubmenu: (action: SubmenuAction, group: string, groupSize: number) => boolean = () => false, useSeparatorsInPrimaryActions: boolean = false): void {
...
export class MenuEntryActionViewItem<T extends IMenuEntryActionViewItemOptions = IMenuEntryActionViewItemOptions> extends ActionViewItem {
    ...
    constructor(action: MenuItemAction, protected _options: T | undefined, 
    @IKeybindingService
    ...
    protected get _commandAction(): MenuItemAction {
        return ((this._wantsAltCommand && this._menuItemAction.alt) ||
    ...
    protected override getTooltip() {
        ...
        if (!this._wantsAltCommand && this._menuItemAction.alt?.enabled) {
            const altTooltip = this._menuItemAction.alt.tooltip ||
...
export class SubmenuEntryActionViewItem extends DropdownMenuActionViewItem {
    constructor(action: SubmenuItemAction, options: IDropdownMenuActionViewItemOptions | undefined, 
    @IKeybindingService
        ...
        const dropdownOptions: IDropdownMenuActionViewItemOptions = {
            ...
            classNames: options?.classNames ??
                (ThemeIcon.isThemeIcon(action.item.icon)
                    ...
                    : undefined),
            keybindingProvider: options?.keybindingProvider ??
...
export class DropdownWithDefaultActionViewItem extends BaseActionViewItem {
    ...
    constructor(submenuAction: SubmenuItemAction, options: IDropdownWithDefaultActionViewItemOptions | undefined, 
    @IKeybindingService
    protected readonly _keybindingService: IKeybindingService, 
    @INotificationService
    protected _notificationService: INotificationService, 
    ...
    protected _storageService: IStorageService) {
        ...
        this._defaultAction = this._instaService.createInstance(MenuEntryActionViewItem, <MenuItemAction>defaultAction, {
...
class SubmenuEntrySelectActionViewItem extends SelectActionViewItem {
    constructor(action: SubmenuItemAction, 
    @IContextViewService
