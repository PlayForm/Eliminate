...
import { IMenuActionOptions, IMenuService, MenuId, MenuItemAction, } from "../common/actions.js";
...
export class WorkbenchButtonBar extends ButtonBar {
    ...
    constructor(container: HTMLElement, private readonly _options: IWorkbenchButtonBarOptions | undefined, 
    @IContextMenuService
    ...
    private readonly _hoverService: IHoverService) {
        ...
        if (_options?.telemetrySource) {
            this._actionRunner.onDidRun((e) => {
                telemetryService.publicLog2<WorkbenchActionExecutedEvent, WorkbenchActionExecutedClassification>("workbenchActionExecuted", {
                    id: e.action.id,
    ...
    update(actions: IAction[], secondary: IAction[]): void {
        const conifgProvider: IButtonConfigProvider = this._options?.buttonConfigProvider ??
            (() => ({ showLabel: true }));
...
export class MenuWorkbenchButtonBar extends WorkbenchButtonBar {
    constructor(container: HTMLElement, menuId: MenuId, options: IMenuWorkbenchButtonBarOptions | undefined, 
    @IMenuService
