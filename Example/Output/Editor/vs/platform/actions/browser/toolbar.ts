...
export class WorkbenchToolBar extends ToolBar {
    ...
    constructor(container: HTMLElement, private _options: IWorkbenchToolBarOptions | undefined, 
    @IMenuService
...
export class MenuWorkbenchToolBar extends WorkbenchToolBar {
    ...
    constructor(container: HTMLElement, menuId: MenuId, options: IMenuWorkbenchToolBarOptions | undefined, 
    @IMenuService
    ...
    actionViewService: IActionViewItemService, 
