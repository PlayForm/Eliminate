...
export class DropdownWithPrimaryActionViewItem extends BaseActionViewItem {
    ...
    constructor(primaryAction: MenuItemAction, dropdownAction: IAction, dropdownMenuActions: readonly IAction[], className: string, private readonly _options: IDropdownWithPrimaryActionViewItemOptions | undefined, 
    @IContextMenuService
