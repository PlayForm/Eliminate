...
import { ICommonProperties, ITelemetryData, ITelemetryService, TELEMETRY_CRASH_REPORTER_SETTING_ID, TELEMETRY_OLD_SETTING_ID, TELEMETRY_SECTION_ID, TELEMETRY_SETTING_ID, TelemetryConfiguration, TelemetryLevel, } from "./telemetry.js";
...
function getTelemetryLevelSettingDescription(): string {
    ...
    const restartString = !isWeb
        ? localize("telemetry.restart", "A full restart of the application is necessary for crash reporting changes to take effect.")
        : "";
