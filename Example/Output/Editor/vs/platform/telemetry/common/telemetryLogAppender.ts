...
import { ILogger, ILoggerService, ILogService, LogLevel, } from "../../log/common/log.js";
import { IProductService } from "../../product/common/productService.js";
import { isLoggingOnly, ITelemetryAppender, supportsTelemetry, telemetryLogId, validateTelemetryData, } from "./telemetryUtils.js";
export class TelemetryLogAppender extends Disposable implements ITelemetryAppender {
    ...
    productService: IProductService, private readonly prefix: string = "") {
        ...
        if (logger) {
            ...
            const isVisible = () => supportsTelemetry(productService, environmentService) &&
