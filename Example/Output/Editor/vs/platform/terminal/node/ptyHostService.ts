...
export class PtyHostService extends Disposable implements IPtyHostService {
    ...
    private readonly _resolveVariablesRequestStore: RequestStore<string[], {
        workspaceId: string;
        originalText: string[];
    }>;
    ...
    private _handleHeartbeatFirstTimeout() {
        ...
        this._heartbeatSecondTimeout = setTimeout(() => this._handleHeartbeatSecondTimeout(), HeartbeatConstants.BeatInterval *
