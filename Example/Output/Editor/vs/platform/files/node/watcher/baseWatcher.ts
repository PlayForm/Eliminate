...
import { ILogMessage, IRecursiveWatcherWithSubscribe, isWatchRequestWithCorrelation, IUniversalWatchRequest, IWatcher, IWatcherErrorEvent, IWatchRequestWithCorrelation, requestFilterToString, } from "../../common/watcher.js";
    ...
    async watch(requests: IUniversalWatchRequest[]): Promise<void> {
        ...
        try {
            ...
            for (const [id] of this.suspendedWatchRequests) {
                if (!this.nonCorrelatedWatchRequests.has(id) &&
