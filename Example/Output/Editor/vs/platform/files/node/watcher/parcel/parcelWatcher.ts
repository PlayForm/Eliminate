...
import { isEqual, isEqualOrParent, randomPath, } from "../../../../../base/common/extpath.js";
...
import { coalesceEvents, IRecursiveWatcherWithSubscribe, IRecursiveWatchRequest, isFiltered, IWatcherErrorEvent, parseWatcherPatterns, } from "../../../common/watcher.js";
import { BaseWatcher } from "../baseWatcher.js";
export class ParcelWatcherInstance extends Disposable {
    private readonly _onDidStop = this._register(new Emitter<{
     ...
     */
    readonly ready: Promise<unknown>, readonly request: IRecursiveWatchRequest, 
    /**
     ...
     */
    readonly worker: RunOnceWorker<IFileChange>, private readonly stopFn: () => Promise<void>) {
        super();
...
export class ParcelWatcher extends BaseWatcher implements IRecursiveWatcherWithSubscribe {
    ...
    private startPolling(request: IRecursiveWatchRequest, pollingInterval: number, restarts = 0): void {
        ...
        const watcher: ParcelWatcherInstance = new ParcelWatcherInstance(instance.p, request, restarts, cts.token, new RunOnceWorker<IFileChange>((events) => this.handleParcelEvents(events, watcher), ParcelWatcher.FILE_CHANGES_HANDLER_DELAY), async () => {
            cts.dispose(true);
    ...
    private filterEvents(events: IFileChange[], watcher: ParcelWatcherInstance): {
        events: IFileChange[];
        rootDeleted?: boolean;
    } {
