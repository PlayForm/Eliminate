...
export class AccessibilitySignalService extends Disposable implements IAccessibilitySignalService {
    ...
    private readonly screenReaderAttached = observableFromEvent(this, this.accessibilityService.onDidChangeScreenReaderOptimized, () => 
    ...
    public async playSignal(signal: AccessibilitySignal, options: IAccessbilitySignalOptions = {}): Promise<void> {
        const shouldPlayAnnouncement = options.modality === "announcement" ||
    ...
    public async playSignals(signals: (AccessibilitySignal | {
        signal: AccessibilitySignal;
        source: string;
    })[]): Promise<void> {
    ...
    private readonly _signalEnabledState = new CachedFunction({ getCacheKey: getStructuralKey }, (arg: {
        signal: AccessibilitySignal;
        userGesture: boolean;
    ...
    public getDelayMs(signal: AccessibilitySignal, modality: AccessibilityModality, mode: "line" | "positional"): number {
        ...
        if (signal.name === AccessibilitySignal.errorAtPosition.name &&
            mode === "positional") {
...
export class AccessibilitySignal {
    private constructor(public readonly sound: SoundSource, public readonly name: string, public readonly legacySoundSettingsKey: string | undefined, public readonly settingsKey: string, public readonly legacyAnnouncementSettingsKey: string | undefined, public readonly announcementMessage: string | undefined) { }
    ...
    private static register(options: {
        ...
        const soundSource = new SoundSource("randomOneOf" in options.sound
