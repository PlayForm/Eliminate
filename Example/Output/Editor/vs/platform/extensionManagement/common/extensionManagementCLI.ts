...
import { EXTENSION_CATEGORIES, ExtensionType, IExtensionManifest, } from "../../extensions/common/extensions.js";
import { ILogger } from "../../log/common/log.js";
import { EXTENSION_IDENTIFIER_REGEX, IExtensionGalleryService, IExtensionInfo, IExtensionManagementService, IGalleryExtension, ILocalExtension, InstallExtensionInfo, InstallOperation, InstallOptions, } from "./extensionManagement.js";
...
export class ExtensionManagementCLI {
            ...
            const addInstallExtensionInfo = (id: string, version: string | undefined, isBuiltin: boolean) => {
                installExtensionInfos.push({
                    ...
                    installOptions: {
                        ...installOptions,
                        isBuiltin,
                        installPreReleaseVersion: version === "prerelease" ||
    ...
    public async updateExtensions(profileLocation?: URI): Promise<void> {
        ...
        }, "Fetching latest versions for {0} extensions", installedExtensionsQuery.length));
        ...
        this.logger.info(localize("updateExtensionsNewVersionsAvailable", "Updating extensions: {0}", extensionsToUpdate
        ...
        await Promise.all(installExtensionInfos.map(async ({ id, version, installOptions }) => {
            ...
            extensionsToInstall.push({
                ...
                options: {
                    ...
                    isApplicationScoped: installOptions.isApplicationScoped ||
