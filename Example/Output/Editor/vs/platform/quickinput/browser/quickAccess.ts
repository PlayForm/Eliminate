...
export class QuickAccessController extends Disposable implements IQuickAccessController {
    ...
    private doShowOrPick(value: string, pick: boolean, options?: IQuickAccessOptions): Promise<IQuickPickItem[] | undefined> | void {
        ...
        if (typeof options?.itemActivation === "number" ||
    ...
    private adjustValueSelection(picker: IQuickPick<IQuickPickItem, {
        useSeparators: true;
    }>, descriptor?: IQuickAccessProviderDescriptor, options?: IQuickAccessOptions): void {
        let valueSelection: [
            number,
            number
        ];
    ...
    private registerPickerListeners(picker: IQuickPick<IQuickPickItem, {
        useSeparators: true;
    }>, provider: IQuickAccessProvider | undefined, descriptor: IQuickAccessProviderDescriptor | undefined, value: string, options?: IQuickAccessOptions): IDisposable {
        const disposables = new DisposableStore();
    ...
    private getOrInstantiateProvider(value: string, enabledProviderPrefixes?: string[]): [
