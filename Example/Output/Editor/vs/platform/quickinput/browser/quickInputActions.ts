...
import { ICommandAndKeybindingRule, KeybindingsRegistry, KeybindingWeight, } from "../../keybinding/common/keybindingsRegistry.js";
...
function registerQuickPickCommandAndKeybindingRule(rule: PartialExcept<ICommandAndKeybindingRule, "id" | "handler">, options: {
    withAltMod?: boolean;
    withCtrlMod?: boolean;
    withCmdMod?: boolean;
} = {}) {
...
function getSecondary(primary: number, secondary: number[], options: {
    withAltMod?: boolean;
    withCtrlMod?: boolean;
    withCmdMod?: boolean;
} = {}): number[] {
