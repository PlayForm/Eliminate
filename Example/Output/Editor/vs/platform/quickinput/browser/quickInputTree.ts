...
import { getCodiconAriaLabel, IParsedLabelWithIcons, matchesFuzzyIconAware, parseLabelWithIcons, } from "../../../base/common/iconLabels.js";
...
class BaseQuickPickItemElement implements IQuickPickElement {
    ...
    constructor(readonly index: number, readonly hasCheckbox: boolean, mainItem: QuickPickItem) {
        this._init = new Lazy(() => {
...
class QuickPickItemElement extends BaseQuickPickItemElement {
    ...
    constructor(index: number, hasCheckbox: boolean, readonly fireButtonTriggered: (event: IQuickPickItemButtonEvent<IQuickPickItem>) => void, private _onChecked: Emitter<{
        element: IQuickPickElement;
        checked: boolean;
    }>, readonly item: IQuickPickItem, private _separator: IQuickPickSeparator | undefined) {
        super(index, hasCheckbox, item);
        this.onChecked = hasCheckbox
            ? Event.map(Event.filter<{
                element: IQuickPickElement;
                checked: boolean;
            }>(this._onChecked.event, (e) => e.element === this), (e) => e.checked)
            : Event.None;
...
class QuickPickSeparatorElement extends BaseQuickPickItemElement {
    ...
    constructor(index: number, readonly fireSeparatorButtonTriggered: (event: IQuickPickSeparatorButtonEvent) => void, readonly separator: IQuickPickSeparator) {
...
class QuickPickItemElementRenderer extends BaseQuickInputListRenderer<QuickPickItemElement> {
    ...
    constructor(hoverDelegate: IHoverDelegate | undefined, 
    @IThemeService
...
export class QuickInputTree extends Disposable {
    ...
    constructor(private parent: HTMLElement, private hoverDelegate: IHoverDelegate, private linkOpenerDelegate: (content: string) => void, id: string, 
    ...
    private readonly accessibilityService: IAccessibilityService) {
        ...
        this._tree = this._register(instantiationService.createInstance(WorkbenchObjectTree<IQuickPickElement, void>, "QuickInput", this._container, new QuickInputItemDelegate(), [this._itemRenderer, this._separatorRenderer], {
            filter: {
                filter(element) {
    ...
    private _registerSeparatorActionShowingListeners() {
        this._register(this._tree.onDidChangeFocus((e) => {
            ...
            for (const separator of this._separatorRenderer
                ...
                const currentActive = !!(separator.focusInsideSeparator &
        ...
        this._register(this._tree.onMouseOver((e) => {
            ...
            for (const separator of this._separatorRenderer
                ...
                const currentMouse = !!(separator.focusInsideSeparator &
