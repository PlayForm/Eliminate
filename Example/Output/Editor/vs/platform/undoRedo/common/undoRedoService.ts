...
class ResourceReasonPair {
    constructor(public readonly resourceLabel: string, public readonly reason: RemovedResourceReason) { }
}
...
export class UndoRedoService implements IUndoRedoService {
        ...
        return {
            dispose: () => {
                for (let i = 0, len = this._uriComparisonKeyComputers.length; i < len; i++) {
                    if (this._uriComparisonKeyComputers[i][1] ===
                        uriComparisonKeyComputer) {
    ...
    private _splitPastWorkspaceElement(toRemove: WorkspaceStackElement & {
        actual: {
            split(): IResourceUndoRedoElement[];
        };
    ...
    private _splitFutureWorkspaceElement(toRemove: WorkspaceStackElement & {
        actual: {
            split(): IResourceUndoRedoElement[];
        };
    }, ignoreResources: RemovedResources | null): void {
    ...
    public removeElements(resource: URI | string): void {
        const strResource = typeof resource === "string"
            ? resource
    ...
    private _findClosestUndoElementWithSource(sourceId: number): [
        StackElement | null,
        string | null
    ] {
        if (!sourceId) {
    ...
    private _invokeResourcePrepare(element: ResourceStackElement, callback: (disposable: IDisposable) => Promise<void> | void): void | Promise<void> {
        if (element.actual.type !== UndoRedoElementType.Workspace ||
    ...
    private _findClosestUndoElementInGroup(groupId: number): [
        StackElement | null,
        string | null
    ] {
        if (!groupId) {
    ...
    private _findClosestRedoElementWithSource(sourceId: number): [
        StackElement | null,
        string | null
    ] {
        if (!sourceId) {
    ...
    private _findClosestRedoElementInGroup(groupId: number): [
        StackElement | null,
        string | null
    ] {
        if (!groupId) {
