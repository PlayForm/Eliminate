...
import { hasNativeTitlebar, INativeRunActionInWindowRequest, INativeRunKeybindingInWindowRequest, IWindowOpenable, } from "../../window/common/window.js";
...
export class Menubar extends Disposable {
    ...
    private readonly fallbackMenuHandlers: {
        [id: string]: (menuItem: MenuItem, browserWindow: BaseWindow | undefined, event: KeyboardEvent) => void;
    } = Object.create(null);
    constructor(
    @IUpdateService
    ...
    private install(): void {
        ...
        if (isMacintosh && !this.appMenuInstalled) {
            ...
            dockMenu.append(new MenuItem({
                label: this.mnemonicLabel(nls.localize({
                    key: "miNewWindow",
    ...
    private createOpenRecentMenuItem(item: IMenubarMenuRecentItemAction): MenuItem {
        ...
        const openable: IWindowOpenable = commandId === "openRecentFile"
            ? { fileUri: revivedUri }
    ...
    private createMenuItem(arg1: string, arg2: any, arg3?: boolean, arg4?: boolean): MenuItem {
        ...
        const click: () => void = typeof arg2 === "function"
            ? arg2
            : (menuItem: MenuItem & IMenuItemWithKeybinding, win: BrowserWindow, event: KeyboardEvent) => {
    ...
    private withKeybinding(commandId: string | undefined, options: MenuItemConstructorOptions & IMenuItemWithKeybinding): MenuItemConstructorOptions {
        const binding = typeof commandId === "string"
