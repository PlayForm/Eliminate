...
class IconRegistry implements IIconRegistry {
    ...
    private iconsById: {
        [key: string]: IconContribution;
    };
    private iconSchema: IJSONSchema & {
    ...
    } = { type: 'string', pattern: `^${ThemeIcon.iconNameExpression}$`, enum: [], enumDescriptions: [] };
    private iconFontsById: {
        [key: string]: IconFontDefinition;
    };
    constructor() {
        this.iconsById = {};
        this.iconFontsById = {};
