...
import { contrastBorder, focusBorder, foreground, iconForeground, } from "./baseColors.js";
...
export const buttonSeparator = registerColor("button.separator", transparent(buttonForeground, 0.4), nls.localize("buttonSeparator", "Button separator color."));
