...
export class TokenStyle implements Readonly<TokenStyleData> {
    constructor(public readonly foreground: Color | undefined, public readonly bold: boolean | undefined, public readonly underline: boolean | undefined, public readonly strikethrough: boolean | undefined, public readonly italic: boolean | undefined) { }
}
export namespace TokenStyle {
    export function toJSONObject(style: TokenStyle): any {
        return {
            _foreground: style.foreground === undefined
                ? null
...
export function parseClassifierString(s: string, defaultLanguage: string | undefined): {
    type: string;
    modifiers: string[];
    language: string | undefined;
} {
