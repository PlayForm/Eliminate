...
class ConfigAwareContextValuesContainer extends Context {
    ...
    constructor(id: number, private readonly _configurationService: IConfigurationService, emitter: Emitter<IContextKeyChangeEvent>) {
        super(id, null);
...
export abstract class AbstractContextKeyService extends Disposable implements IContextKeyService {
    ...
    createOverlay(overlay: Iterable<[
        string,
        any
    ]> = Iterable.empty()): IContextKeyService {
        if (this._isDisposed) {
            throw new Error(`AbstractContextKeyService has been disposed`);
        }
...
class OverlayContextKeyService implements IContextKeyService {
    ...
    constructor(private parent: AbstractContextKeyService | OverlayContextKeyService, overlay: Iterable<[
        string,
        any
    ]>) {
