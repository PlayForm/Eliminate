...
import { hasNativeTitlebar, IOpenEmptyWindowOptions, IWindowOpenable, IWindowSettings, TitlebarStyle, useNativeFullScreen, useWindowControlsOverlay, WindowMinimumSize, zoomLevelToZoomFactor, } from "../../window/common/window.js";
...
export function defaultBrowserWindowOptions(accessor: ServicesAccessor, windowState: IWindowState, overrides?: IDefaultBrowserWindowOptionsOverrides, webPreferences?: electron.WebPreferences): electron.BrowserWindowConstructorOptions & {
    ...
    const options: electron.BrowserWindowConstructorOptions & {
        ...
        show: windowState.mode !== WindowMode.Maximized &&
    ...
    if (hideNativeTitleBar) {
        ...
        if (useWindowControlsOverlay(configurationService)) {
            ...
            const titleBarColor = themeMainService.getWindowSplash()?.colorInfo
                .titleBarBackground ??
