...
class ActionItemRenderer<T> implements IListRenderer<IActionListItem<T>, IActionMenuTemplateData> {
    ...
    constructor(private readonly _supportsPreview: boolean, 
    @IKeybindingService
...
export class ActionList<T> extends Disposable {
    ...
    constructor(user: string, preview: boolean, items: readonly IActionListItem<T>[], private readonly _delegate: IActionListDelegate<T>, 
    @IContextViewService
    ...
    private readonly _keybindingService: IKeybindingService) {
        ...
        const virtualDelegate: IListVirtualDelegate<IActionListItem<T>> = {
            getHeight: (element) => element.kind === ActionListItemKind.Header
        ...
        this._list = this._register(new List(user, this.domNode, virtualDelegate, [
            ...
            accessibilityProvider: {
                ...
                getRole: (e) => e.kind === ActionListItemKind.Action
                    ? "option"
                    : "separator",
    ...
    layout(minWidth: number): number {
        ...
        const heightWithHeaders = itemsHeight +
