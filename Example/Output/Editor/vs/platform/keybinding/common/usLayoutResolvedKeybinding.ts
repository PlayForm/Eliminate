 ...
 *--------------------------------------------------------------------------------------------*/
import { Chord, Keybinding, KeyCodeChord, SingleModifierChord, } from "../../../base/common/keybindings.js";
import { IMMUTABLE_CODE_TO_KEY_CODE, KeyCode, KeyCodeUtils, ScanCode, } from "../../../base/common/keyCodes.js";
...
export class USLayoutResolvedKeybinding extends BaseResolvedKeybinding<KeyCodeChord> {
    ...
    protected _getSingleModifierChordDispatch(keybinding: KeyCodeChord): SingleModifierChord | null {
        if (keybinding.keyCode === KeyCode.Ctrl &&
            !keybinding.shiftKey &&
            !keybinding.altKey &&
            !keybinding.metaKey) {
            return "ctrl";
        }
        if (keybinding.keyCode === KeyCode.Shift &&
            !keybinding.ctrlKey &&
            !keybinding.altKey &&
            !keybinding.metaKey) {
            return "shift";
        }
        if (keybinding.keyCode === KeyCode.Alt &&
            !keybinding.ctrlKey &&
            !keybinding.shiftKey &&
            !keybinding.metaKey) {
            return "alt";
        }
        if (keybinding.keyCode === KeyCode.Meta &&
            !keybinding.ctrlKey &&
            !keybinding.shiftKey &&
            !keybinding.altKey) {
            return "meta";
