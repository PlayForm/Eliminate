...
import { KeybindingResolver, NoMatchingKb, ResolutionResult, ResultKind, } from "./keybindingResolver.js";
...
export abstract class AbstractKeybindingService extends Disposable implements IKeybindingService {
    ...
    constructor(private _contextKeyService: IContextKeyService, protected _commandService: ICommandService, protected _telemetryService: ITelemetryService, private _notificationService: INotificationService, protected _logService: ILogService) {
        super();
        this._currentChords = [];
        ...
        switch (this._currentChords.length) {
            ...
            case 1:
                ...
                this._currentChordStatusMessage =
                    this._notificationService.status(nls.localize("first.chord", "({0}) was pressed. Waiting for second key of chord...", keypressLabel));
                break;
            default: {
                const fullKeypressLabel = this._currentChords
                    ...
                    .join(", ");
                this._currentChordStatusMessage =
                    this._notificationService.status(nls.localize("next.chord", "({0}) was pressed. Waiting for next key of chord...", fullKeypressLabel));
            }
        }
                ...
                if (resolveResult.commandId === null ||
                    ...
                    if (!HIGH_FREQ_COMMANDS.test(resolveResult.commandId)) {
                        this._telemetryService.publicLog2<WorkbenchActionExecutedEvent, WorkbenchActionExecutedClassification>("workbenchActionExecuted", {
                            ...
                            from: "keybinding",
                            detail: userKeypress.getUserSettingsLabel() ??
                                undefined,
                        });
                    }
                }
