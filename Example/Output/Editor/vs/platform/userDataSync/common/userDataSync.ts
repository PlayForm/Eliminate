...
import { allSettings, Extensions as ConfigurationExtensions, ConfigurationScope, getAllConfigurationProperties, IConfigurationRegistry, IRegisteredConfigurationPropertySchema, parseScope, } from "../../configuration/common/configurationRegistry.js";
...
export class UserDataSyncError extends Error {
    constructor(message: string, readonly code: UserDataSyncErrorCode, readonly resource?: SyncResource, readonly operationId?: string) {
        super(message);
