...
import { ISyncResourceHandle, IUserDataManualSyncTask, IUserDataSyncResource, IUserDataSyncResourceConflicts, IUserDataSyncResourceError, IUserDataSyncService, IUserDataSyncTask, SyncResource, SyncStatus, UserDataSyncError, } from "./userDataSync.js";
type ManualSyncTaskEvent<T> = {
...
export class UserDataSyncServiceChannel implements IServerChannel {
    ...
    private readonly onManualSynchronizeResources = new Emitter<ManualSyncTaskEvent<[
        SyncResource,
        URI[]
    ][]>>();
...
export class UserDataSyncServiceChannelClient extends Disposable implements IUserDataSyncService {
    ...
    private readonly userDataProfilesService: IUserDataProfilesService) {
        ...
        this._register(this.channel.listen<IUserDataSyncResourceError[]>("onSyncErrors")((errors) => this._onSyncErrors.fire(errors.map((syncError) => ({
            ...syncError,
