...
export class SmallImmutableSet<T> {
    ...
    private constructor(private readonly items: number, private readonly additionalItems: readonly number[]) { }
    ...
    public merge(other: SmallImmutableSet<T>): SmallImmutableSet<T> {
        ...
        if (this.additionalItems === emptyArr &&
        ...
        for (let i = 0; i <
            Math.max(this.additionalItems.length, other.additionalItems.length); i++) {
    ...
    public intersects(other: SmallImmutableSet<T>): boolean {
        ...
        for (let i = 0; i <
            Math.min(this.additionalItems.length, other.additionalItems.length); i++) {
