...
export class Token {
    constructor(readonly length: Length, readonly kind: TokenKind, 
    /**
     ...
     */
    readonly bracketIds: SmallImmutableSet<OpeningBracketId>, readonly astNode: BracketAstNode | TextAstNode | undefined) { }
}
    ...
    public read(): Token | null {
        ...
        while (true) {
            ...
            if (this.lineTokenOffset < tokenCount) {
                ...
                const isOther = TokenMetadata.getTokenType(tokenMetadata) ===
                    StandardTokenType.Other;
                const containsBracketType = TokenMetadata.containsBalancedBrackets(tokenMetadata);
                const endOffset = lineTokens.getEndOffset(this.lineTokenOffset);
                // Is there a bracket token next? Only consume text.
                if (containsBracketType &&
                    isOther &&
                ...
                if (peekedBracketToken) {
                    ...
                    if (startLineIdx !== this.lineIdx ||
                        ...
                        this.lineCharOffset +=
                            lengthGetColumnCountIfZeroLineCount(peekedBracketToken.length);
