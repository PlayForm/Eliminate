...
export function combineTextEditInfos(textEditInfoFirst: TextEditInfo[], textEditInfoSecond: TextEditInfo[]): TextEditInfo[] {
    ...
    const s1ToS2Map = toLengthMapping(textEditInfoSecond) as (LengthMapping | {
...
class LengthMapping {
     ...
     */
    public readonly modified: boolean, public readonly lengthBefore: Length, public readonly lengthAfter: Length) {
    }
    splitAt(lengthAfter: Length): [
        LengthMapping,
