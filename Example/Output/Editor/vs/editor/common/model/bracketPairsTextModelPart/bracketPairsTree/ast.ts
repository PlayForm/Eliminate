...
abstract class BaseAstNode {
     ...
     */
    public abstract canBeReused(openBracketIds: SmallImmutableSet<OpeningBracketId>): boolean;
    /**
...
export class PairAstNode extends BaseAstNode {
    public static create(openingBracket: BracketAstNode, child: AstNode | null, closingBracket: BracketAstNode | null) {
        ...
        return new PairAstNode(length, openingBracket, child, closingBracket, child
    ...
    private constructor(length: Length, public readonly openingBracket: BracketAstNode, public readonly child: AstNode | null, public readonly closingBracket: BracketAstNode | null, public readonly missingOpeningBracketIds: SmallImmutableSet<OpeningBracketId>) {
        super(length);
    }
...
export abstract class ListAstNode extends BaseAstNode {
     ...
     */
    constructor(length: Length, public readonly listHeight: number, private _missingOpeningBracketIds: SmallImmutableSet<OpeningBracketId>) {
        super(length);
    }
    ...
    public makeLastElementMutable(): AstNode | undefined {
        ...
        const mutable = lastChild.kind === AstNodeKind.List
            ? lastChild.toMutable()
            : lastChild;
    ...
    public makeFirstElementMutable(): AstNode | undefined {
        ...
        const mutable = firstChild.kind === AstNodeKind.List
...
class TwoThreeListAstNode extends ListAstNode {
    ...
    public constructor(length: Length, listHeight: number, private _item1: AstNode, private _item2: AstNode, private _item3: AstNode | null, missingOpeningBracketIds: SmallImmutableSet<OpeningBracketId>) {
...
class ArrayListAstNode extends ListAstNode {
    ...
    constructor(length: Length, listHeight: number, private readonly _children: AstNode[], missingOpeningBracketIds: SmallImmutableSet<OpeningBracketId>) {
        super(length, listHeight, missingOpeningBracketIds);
    }
...
export class TextAstNode extends ImmutableLeafAstNode {
    ...
    public computeMinIndentation(offset: Length, textModel: ITextModel): number {
        ...
        const startLineNumber = (start.columnCount === 0 ? start.lineCount : start.lineCount + 1) +
            1;
...
export class BracketAstNode extends ImmutableLeafAstNode {
    ...
    private constructor(length: Length, public readonly bracketInfo: BracketKind, 
    /**
