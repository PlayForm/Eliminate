...
export class TreeSitterTokens extends AbstractTokens {
    ...
    private _initialize() {
        ...
        if (!this._tokenizationSupport || this._lastLanguageId !==
            this.getLanguageId()) {
            this._lastLanguageId =
                this.getLanguageId();
            this._tokenizationSupport = TreeSitterTokenizationRegistry.get(this.getLanguageId());
    ...
    public override get hasTokens(): boolean {
        ;
        return this._treeSitterService.getParseResult(this._textModel) !== undefined;
    }
}
