...
export class Cursor {
    ...
    private static _validateViewState(viewModel: ICursorSimpleModel, viewState: SingleCursorState): SingleCursorState {
        ...
        if (position.equals(viewModel.normalizePosition(position, PositionAffinity.None)) && viewState.selectionStart.getStartPosition().equals(this._validatePositionWithCache(viewModel, viewState.selectionStart.getStartPosition(), position, viewModel.normalizePosition(position, PositionAffinity.None))) && viewState.selectionStart.getEndPosition().equals(this._validatePositionWithCache(viewModel, viewState.selectionStart.getEndPosition(), viewState.selectionStart.getStartPosition(), this._validatePositionWithCache(viewModel, viewState.selectionStart.getStartPosition(), position, viewModel.normalizePosition(position, PositionAffinity.None))))) {
            // fast path: the state is valid
            return viewState;
        }
        return new SingleCursorState(Range.fromPositions(this._validatePositionWithCache(viewModel, viewState.selectionStart.getStartPosition(), position, viewModel.normalizePosition(position, PositionAffinity.None)), this._validatePositionWithCache(viewModel, viewState.selectionStart.getEndPosition(), viewState.selectionStart.getStartPosition(), this._validatePositionWithCache(viewModel, viewState.selectionStart.getStartPosition(), position, viewModel.normalizePosition(position, PositionAffinity.None)))), viewState.selectionStartKind, viewState.selectionStartLeftoverVisibleColumns + viewState.selectionStart.getStartPosition().column - this._validatePositionWithCache(viewModel, viewState.selectionStart.getStartPosition(), position, viewModel.normalizePosition(position, PositionAffinity.None)).column, viewModel.normalizePosition(position, PositionAffinity.None), viewState.leftoverVisibleColumns + position.column - viewModel.normalizePosition(position, PositionAffinity.None).column);
    }
