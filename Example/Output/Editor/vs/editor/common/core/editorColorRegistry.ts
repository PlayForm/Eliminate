...
import { activeContrastBorder, contrastBorder, editorBackground, editorFindMatchHighlight, editorInfoBorder, editorInfoForeground, editorWarningBackground, editorWarningBorder, editorWarningForeground, registerColor, } from "../../../platform/theme/common/colorRegistry.js";
...
registerThemingParticipant((theme, collector) => {
    ...
    const imeBackground = lineHighlight && !lineHighlight.isTransparent()
        ? lineHighlight
        : background;
    if (imeBackground) {
