...
export class TextChange {
    ...
    constructor(public readonly oldPosition: number, public readonly oldText: string, public readonly newPosition: number, public readonly newText: string) { }
...
class TextChangeCompressor {
    ...
    private static _splitPrev(edit: TextChange, offset: number): [
        TextChange,
        TextChange
    ] {
    ...
    private static _splitCurr(edit: TextChange, offset: number): [
        TextChange,
        TextChange
    ] {
