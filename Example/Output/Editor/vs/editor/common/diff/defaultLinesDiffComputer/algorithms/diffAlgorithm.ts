...
export class DiffAlgorithmResult {
    ...
    constructor(public readonly diffs: SequenceDiff[], 
    /**
...
export class SequenceDiff {
    ...
    constructor(public readonly seq1Range: OffsetRange, public readonly seq2Range: OffsetRange) { }
