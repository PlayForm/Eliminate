...
export class LanguageBracketsConfiguration {
    ...
    public getBracketInfo(bracketText: string): BracketKind | undefined {
        return (this.getOpeningBracketInfo(bracketText) ||
...
export class BracketKindBase {
    constructor(protected readonly config: LanguageBracketsConfiguration, public readonly bracketText: string) { }
...
export class ClosingBracketKind extends BracketKindBase {
     ...
     */
    public readonly openingBrackets: ReadonlySet<OpeningBracketKind>, private readonly openingColorizedBrackets: ReadonlySet<OpeningBracketKind>) {
        super(config, bracketText);
    }
    /**
