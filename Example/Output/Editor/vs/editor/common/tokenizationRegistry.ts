...
class TokenizationSupportFactoryData<TSupport> extends Disposable {
    ...
    constructor(private readonly _registry: TokenizationRegistry<TSupport>, private readonly _languageId: string, private readonly _factory: ILazyTokenizationSupport<TSupport>) {
        super();
    }
