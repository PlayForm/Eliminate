...
export class AutoIndentOnPasteCommand implements ICommand {
    ...
    public getEditOperations(model: ITextModel, builder: IEditOperationBuilder): void {
        ...
        if (Array.isArray(this._edits) &&
            ...
            if (this._edits[0].range.startColumn ===
            ...
            else if (this._edits[0].range.endColumn ===
...
export class AutoIndentOnPaste implements IEditorContribution {
    ...
    private update(): void {
        ...
        // we are disabled
        if (this.editor.getOption(EditorOption.autoIndent) <
...
function isStartOrEndInString(model: ITextModel, range: Range): boolean {
    ...
    return (isPositionInString(range.getStartPosition()) ||
