...
export class HoverResult<TArgs, TResult> {
    constructor(public readonly value: TResult[], public readonly isComplete: boolean, public readonly hasLoadingMessage: boolean, public readonly options: TArgs) { }
}
/**
...
export class HoverOperation<TArgs, TResult> extends Disposable {
    ...
    constructor(private readonly _editor: ICodeEditor, private readonly _computer: IHoverComputer<TArgs, TResult>) {
        super();
    }
    ...
    private _triggerSyncComputation(options: TArgs): void {
        ...
        this._setState(this._asyncIterableDone
            ? HoverOperationState.Idle
            : HoverOperationState.WaitingForAsync, options);
    }
    ...
    private _fireResult(options: TArgs): void {
        if (this._state === HoverOperationState.FirstWait ||
