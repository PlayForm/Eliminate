...
export class ContentHoverWidgetWrapper extends Disposable implements IHoverWidget {
    ...
    private _startShowingOrUpdateHover(anchor: HoverAnchor | null, mode: HoverStartMode, source: HoverStartSource, focus: boolean, mouseEvent: IEditorMouseEvent | null): boolean {
        ...
        const currentAnchorEqualsPreviousAnchor = this._currentResult &&
    ...
    private _startHoverOperationIfNecessary(anchor: HoverAnchor, mode: HoverStartMode, source: HoverStartSource, shouldFocus: boolean, insistOnKeepingHoverVisible: boolean): void {
        const currentAnchorEqualToPreviousHover = this._hoverOperation.options &&
    ...
    private _withResult(hoverResult: ContentHoverResult): void {
        const previousHoverIsVisibleWithCompleteResult = this._contentHoverWidget.position &&
            this._currentResult &&
    ...
    private _findHoverAnchorCandidates(mouseEvent: IEditorMouseEvent): HoverAnchor[] {
        ...
        switch (target.type) {
            ...
            case MouseTargetType.CONTENT_EMPTY: {
                const epsilon = this._editor.getOption(EditorOption.fontInfo)
    ...
    private _onMouseLeave(e: MouseEvent): void {
        ...
        const isMousePositionOutsideOfEditor = !editorDomNode ||
