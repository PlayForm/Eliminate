...
export class MarkerHover implements IHoverPart {
    constructor(public readonly owner: IEditorHoverParticipant<MarkerHover>, public readonly range: Range, public readonly marker: IMarker) { }
    ...
    private renderMarkerStatusbar(context: IEditorHoverRenderContext, markerHover: MarkerHover, disposables: DisposableStore): void {
        ...
        if (!this._editor.getOption(EditorOption.readOnly)) {
            ...
            const updatePlaceholderDisposable = this.recentMarkerCodeActionsInfo &&
                ...
                ? Disposable.None
                : disposableTimeout(() => (quickfixPlaceholderElement.textContent =
                    nls.localize("checkingForQuickFixes", "Checking for quick fixes...")), 200, disposables);
