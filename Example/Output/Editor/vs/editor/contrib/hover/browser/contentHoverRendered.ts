...
export class RenderedContentHover extends Disposable {
    ...
    public static computeHoverPositions(editor: ICodeEditor, anchorRange: Range, hoverParts: IHoverPart[]): {
        ...
        for (const hoverPart of hoverParts) {
            ...
            const hoverPartRangeIsOnAnchorLine = hoverPartRangeOnAnchorStartLine &&
...
class RenderedContentHoverParts extends Disposable {
    ...
    constructor(editor: ICodeEditor, participants: IEditorHoverParticipant<IHoverPart>[], hoverParts: IHoverPart[], keybindingService: IKeybindingService, context: IEditorHoverContext) {
        super();
    ...
    private _updateMarkdownAndColorParticipantInfo(participants: IEditorHoverParticipant<IHoverPart>[]) {
        const markdownHoverParticipant = participants.find((p) => {
            return (p instanceof MarkdownHoverParticipant &&
