    ...
    public getEditOperations(model: ITextModel, builder: IEditOperationBuilder): void {
        ...
        if (this.selection.containsPosition(this.targetPosition) &&
            !((this.copy &&
                (this.selection
                    ...
                    this.selection
                        .getStartPosition()
                        .equals(this.targetPosition))) // we allow users to paste content beside the selection
            )) {
        ...
        if (this.selection.endColumn <= this.targetPosition.column) {
            ...
            this.targetSelection = new Selection(this.targetPosition.lineNumber -
                ...
                : this.targetPosition.column -
                    this.selection.endColumn +
                    this.selection.startColumn, this.targetPosition.lineNumber, this.selection.startLineNumber === this.selection.endLineNumber
                ? this.targetPosition.column
                : this.selection.endColumn);
        }
        else {
            ...
            this.targetSelection = new Selection(this.targetPosition.lineNumber -
                this.selection.endLineNumber +
                this.selection.startLineNumber, this.targetPosition.column, this.targetPosition.lineNumber, this.targetPosition.column +
                this.selection.endColumn -
                this.selection.startColumn);
        }
    }
