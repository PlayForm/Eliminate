...
export class DropIntoEditorController extends Disposable implements IEditorContribution {
        ...
        const p = createCancelablePromise(async (token) => {
            ...
            try {
                ...
                if (editSession.edits.length) {
                    ...
                    const canShowWidget = editor.getOption(EditorOption.dropIntoEditor)
    ...
    private getInitialActiveEditIndex(model: ITextModel, edits: ReadonlyArray<DocumentDropEdit & {
