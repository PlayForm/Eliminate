...
class InlayHintsHoverAnchor extends HoverForeignElementAnchor {
    constructor(readonly part: RenderedInlayHintLabelPart, owner: InlayHintsHover, initialMousePosX: number | undefined, initialMousePosY: number | undefined) {
    ...
    override computeAsync(anchor: HoverAnchor, _lineDecorations: IModelDecoration[], token: CancellationToken): AsyncIterableObject<MarkdownHover> {
        ...
        return new AsyncIterableObject<MarkdownHover>(async (executor) => {
            ...
            if (isNonEmptyArray(part.item.hint.textEdits)) {
                executor.emitOne(new MarkdownHover(this, anchor.range, [
            ...
            if (part.part.location || part.part.command) {
                ...
                const useMetaKey = this._editor.getOption(EditorOption.multiCursorModifier) ===
                    "altKey";
                const kb = useMetaKey
