...
export class InlayHintsController implements IEditorContribution {
    ...
    @IInlayHintsCache
    private readonly _inlayHintsCache: IInlayHintsCache, 
    @ICommandService
    ...
    private _update(): void {
        ...
        if (options.enabled === "on") {
            ...
            this._sessionDisposables.add(ModifierKeyEmitter.getInstance().event((e) => {
                ...
                const newRenderMode = e.altKey && e.ctrlKey && !(e.shiftKey || e.metaKey)
                    ? altMode
                    : defaultMode;
    ...
    private _updateHintsDecorators(ranges: readonly Range[], items: readonly InlayHintItem[]): void {
            ...
            newDecorationsData.push({
                ...
                decoration: {
                    ...
                    options: {
                        ...
                        [item.anchor.direction]: this._activeRenderMode === RenderMode.Normal
                            ? opts
                            : undefined,
                    },
                },
        ...
        const addInjectedWhitespace = (item: InlayHintItem, isLast: boolean): void => {
            ...
            addInjectedText(item, marginRule, "\u200a", isLast
                ? InjectedTextCursorStops.Right
                : InjectedTextCursorStops.None, InlayHintsController._whitespaceData);
        };
        //
