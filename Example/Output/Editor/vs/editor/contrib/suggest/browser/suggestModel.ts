...
export class SuggestModel implements IDisposable {
    ...
    @IEnvironmentService
    private readonly _envService: IEnvironmentService) {
    ...
    private _onCursorChange(e: ICursorSelectionChangedEvent): void {
        ...
        else if (this._triggerState !== undefined &&
            e.reason === CursorChangeReason.Explicit) {
    ...
    private _doTriggerQuickSuggest(): void {
        ...
        if (this._editor.getOption(EditorOption.suggest)
