...
export class FindWidget extends Widget implements IOverlayWidget, IVerticalSashLayoutProvider {
    ...
    private _onStateChanged(e: FindReplaceStateChangedEvent): void {
        ...
        if (e.searchString || e.matchesCount || e.matchesPosition) {
            const showRedOutline = this._state.searchString.length > 0 &&
    ...
    private _updateButtons(): void {
        ...
        this._prevBtn.setEnabled(this._isVisible &&
            findInputIsNonEmpty &&
            matchesCount &&
            this._state.canNavigateBack());
        this._nextBtn.setEnabled(this._isVisible &&
            findInputIsNonEmpty &&
            matchesCount &&
    ...
    private _reveal(): void {
        ...
        if (!this._isVisible) {
            ...
            const selection = this._codeEditor.getSelection();
            switch (this._codeEditor.getOption(EditorOption.find)
                .autoFindInSelection) {
                case "always":
                    this._toggleSelectionFind.checked = true;
                    break;
            ...
            if (this._codeEditor.getOption(EditorOption.find)
                ...
                if (domNode) {
                    ...
                    const startLeft = editorCoords.left +
                    ...
                    if (this._viewZone &&
                        ...
                        const endLeft = editorCoords.left +
        ...
        if (this._toggleSelectionFind.checked) {
            ...
            selections
                ...
                if (selection.endColumn === 1 &&
                    ...
                    selection = selection.setEndPosition(selection.endLineNumber - 1, this._codeEditor
                        .getModel()!
    ...
    private _buildDomNode(): void {
        ...
        this._register(this._resizeSash.onDidChange((evt: ISashEvent) => {
            ...
            const maxWidth = parseFloat(dom.getComputedStyle(this._domNode).maxWidth) ||
                0;
            if (width > maxWidth) {
                return;
            }
