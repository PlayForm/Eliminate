    ...
    public getFindScopes(): Range[] | null {
        if (this._findScopeDecorationIds.length) {
            const scopes = this._findScopeDecorationIds
                .map((findScopeDecorationId) => this._editor
                .getModel()
            ...
            this._editor.changeDecorations((changeAccessor: IModelDecorationsChangeAccessor) => {
                ...
                if (newCurrentDecorationId !== null) {
                    ...
                    this._rangeHighlightDecorationId =
                        changeAccessor.addDecoration(rng, FindDecorations._RANGE_HIGHLIGHT_DECORATION);
                }
            });
        }
        ...
        this._editor.changeDecorations((accessor) => {
            ...
            if (findMatches.length > 1000) {
                ...
                for (let i = 1, len = findMatches.length; i < len; i++) {
                    ...
                    if (prevEndLineNumber + mergeLinesDelta >=
            ...
            this._overviewRulerApproximateDecorations =
                accessor.deltaDecorations(this._overviewRulerApproximateDecorations, newOverviewRulerApproximateDecorations);
            // Range highlight
