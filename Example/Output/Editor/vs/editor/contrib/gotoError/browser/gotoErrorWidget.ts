...
class MessageWidget {
    ...
    constructor(parent: HTMLElement, editor: ICodeEditor, onRelatedInformation: (related: IRelatedInformation) => void, private readonly _openerService: IOpenerService, private readonly _labelService: ILabelService) {
        this._editor = editor;
    ...
    update(marker: IMarker): void {
        ...
        const scrollWidth = Math.ceil(fontInfo.typicalFullwidthCharacterWidth *
