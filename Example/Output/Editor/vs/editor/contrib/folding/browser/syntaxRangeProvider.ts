...
export class SyntaxRangeProvider implements RangeProvider {
    ...
    constructor(private readonly editorModel: ITextModel, private readonly providers: FoldingRangeProvider[], readonly handleFoldingRangesChange: () => void, private readonly foldingRangesLimit: FoldingLimitReporter, private readonly fallbackRangeProvider: RangeProvider | undefined) {
...
class RangesCollector {
    ...
    public add(startLineNumber: number, endLineNumber: number, type: string | undefined, nestingLevel: number) {
        ...
        this._length++;
        if (nestingLevel < 30) {
            this._nestingLevelCounts[nestingLevel] =
