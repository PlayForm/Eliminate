...
export class SyntaxRangeProvider implements RangeProvider {
    ...
    constructor(private readonly editorModel: ITextModel, private readonly providers: FoldingRangeProvider[], readonly handleFoldingRangesChange: () => void, private readonly foldingRangesLimit: FoldingLimitReporter, private readonly fallbackRangeProvider: RangeProvider | undefined // used when all providers return null
    ) {
