...
export class DocumentSemanticTokensFeature extends Disposable {
    ...
    semanticTokensStylingService: ISemanticTokensStylingService, 
    @IModelService
...
class SemanticTokensResponse {
    constructor(public readonly provider: DocumentSemanticTokensProvider, public readonly resultId: string | undefined, public readonly data: Uint32Array) { }
    public dispose(): void {
