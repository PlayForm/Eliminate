...
export abstract class ReferencesController implements IEditorContribution {
    ...
    constructor(private readonly _defaultTreeKeyboardSupport: boolean, private readonly _editor: ICodeEditor, 
    @IContextKeyService
                ...
                if (this._widget &&
                    ...
                    if (selection) {
                        return this._widget
                            ...
                            .then(() => {
                            if (this._widget &&
                                this._editor.getOption(EditorOption.peekWidgetDefaultFocus) === "editor") {
