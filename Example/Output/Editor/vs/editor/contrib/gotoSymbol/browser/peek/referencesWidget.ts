...
class DecorationsManager implements IDisposable {
    ...
    private _addDecorations(reference: FileReferences): void {
        ...
        this._callOnModelChange.add(this._editor
            .getModel()
...
export class ReferenceWidget extends peekView.PeekViewWidget {
    ...
    constructor(editor: ICodeEditor, private _defaultTreeKeyboardSupport: boolean, public layoutData: LayoutData, 
    @IThemeService
    ...
    @ILabelService
    private readonly _uriLabel: ILabelService, 
    @IKeybindingService
    ...
    private _applyTheme(theme: IColorTheme) {
        ...
        this.style({
            ...
            headerBackgroundColor: theme.getColor(peekView.peekViewTitleBackground) ||
                Color.transparent,
    ...
    protected _fillBody(containerElement: HTMLElement): void {
        ...
        this._previewNotAvailableMessage =
            this._instantiationService.createInstance(TextModel, nls.localize("missingPreviewMessage", "no preview available"), PLAINTEXT_LANGUAGE_ID, TextModel.DEFAULT_CREATION_OPTIONS, null);
        // tree
    ...
    private _onNewModel(): Promise<any> {
        ...
        this._disposeOnNewModel.add(this._preview.onMouseDown((e) => {
            ...
            this._onDidSelectReference.fire({
                ...
                kind: event.ctrlKey || event.metaKey || event.altKey
                    ? "side"
                    : "open",
                source: "editor",
            });
        ...
        return this._tree.setInput(this._model.groups.length === 1
