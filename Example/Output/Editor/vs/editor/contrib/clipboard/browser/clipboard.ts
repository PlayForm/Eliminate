...
function registerExecCommandImpl(target: MultiCommand | undefined, browserCommand: "cut" | "copy"): void {
    ...
    target.addImplementation(10000, "code-editor", (accessor: ServicesAccessor, args: any) => {
        ...
        if (focusedEditor && focusedEditor.hasTextFocus()) {
            ...
            if (focusedEditor.getOption(EditorOption.experimentalEditContextEnabled) &&
                browserCommand === "cut") {
...
if (PasteAction) {
    ...
    PasteAction.addImplementation(10000, "code-editor", (accessor: ServicesAccessor, args: any) => {
        ...
        if (focusedEditor && focusedEditor.hasTextFocus()) {
            ...
            const result = canDoDocumentExecCommand &&
                focusedEditor
                    .getContainerDomNode()
            ...
            if (result) {
                ...
                return (async () => {
                    ...
                    if (clipboardText !== "") {
                        ...
                        if (metadata) {
                            pasteOnNewLine =
                                focusedEditor.getOption(EditorOption.emptySelectionClipboard) && !!metadata.isFromEmptySelection;
                            multicursorText =
