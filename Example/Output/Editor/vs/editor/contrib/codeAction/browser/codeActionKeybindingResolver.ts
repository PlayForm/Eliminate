...
export class CodeActionKeybindingResolver {
    ...
    public getResolver(): (action: CodeAction) => ResolvedKeybinding | undefined {
        ...
        const allCodeActionBindings = new Lazy<readonly ResolveCodeActionKeybinding[]>(() => this.keybindingService
            .getKeybindings()
    ...
    private bestKeybindingForCodeAction(action: CodeAction, candidates: readonly ResolveCodeActionKeybinding[]): ResolveCodeActionKeybinding | undefined {
        if (!action.kind) {
            return undefined;
        }
