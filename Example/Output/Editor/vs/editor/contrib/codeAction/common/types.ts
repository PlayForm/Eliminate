...
export class CodeActionCommandArgs {
    public static fromUser(arg: any, defaults: {
    ...
    private constructor(public readonly kind: HierarchicalKind, public readonly apply: CodeActionAutoApply, public readonly preferred: boolean) { }
}
export class CodeActionItem {
    constructor(public readonly action: languages.CodeAction, public readonly provider: languages.CodeActionProvider | undefined, public highlightRange?: boolean) { }
