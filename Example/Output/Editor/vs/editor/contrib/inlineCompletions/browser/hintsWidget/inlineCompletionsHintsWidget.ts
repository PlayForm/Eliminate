...
import { autorun, autorunWithStore, derived, derivedObservableWithCache, derivedWithStore, IObservable, observableFromEvent, } from "../../../../../base/common/observable.js";
...
export class InlineCompletionsHintsWidget extends Disposable {
    private readonly alwaysShowToolbar = observableFromEvent(this, this.editor.onDidChangeConfiguration, () => this.editor.getOption(EditorOption.inlineSuggest).showToolbar ===
        "always");
    private sessionPosition: Position | undefined = undefined;
    private readonly position = derived(this, (reader) => {
        const ghostText = this.model
            .read(reader)
            ?.primaryGhostText.read(reader);
        if (!this.alwaysShowToolbar.read(reader) ||
            !ghostText ||
    ...
    constructor(private readonly editor: ICodeEditor, private readonly model: IObservable<InlineCompletionsModel | undefined>, 
        ...
        this._register(autorunWithStore((reader, store) => {
            ...
            const contentWidgetValue = derivedWithStore((reader, store) => {
                ...
                store.add(autorun((reader) => {
                    ...
                    if (model.lastTriggerKind.read(reader) !==
...
export class InlineSuggestionHintsContentWidget extends Disposable implements IContentWidget {
    ...
    private readonly nodes = h("div.inlineSuggestionsHints", { className: this.withBorder ? ".withBorder" : "" }, [h("div@toolBar")]);
    ...
    private readonly inlineCompletionsActionsMenus = this._register(this._menuService.createMenu(MenuId.InlineCompletionsActions, this._contextKeyService));
    ...
    constructor(private readonly editor: ICodeEditor, private readonly withBorder: boolean, private readonly _position: IObservable<Position | null>, private readonly _currentSuggestionIdx: IObservable<number>, private readonly _suggestionCount: IObservable<number | undefined>, private readonly _extraCommands: IObservable<Command[]>, 
    @ICommandService
...
export class CustomizedMenuWorkbenchToolBar extends WorkbenchToolBar {
    private readonly menu = this._store.add(this.menuService.createMenu(this.menuId, this.contextKeyService, {
        emitEventsForSubmenuChanges: true,
    }));
    private additionalActions: IAction[] = [];
    private prependedPrimaryActions: IAction[] = [];
    private additionalPrimaryActions: IAction[] = [];
    constructor(container: HTMLElement, private readonly menuId: MenuId, private readonly options2: IMenuWorkbenchToolBarOptions | undefined, 
    @IMenuService
