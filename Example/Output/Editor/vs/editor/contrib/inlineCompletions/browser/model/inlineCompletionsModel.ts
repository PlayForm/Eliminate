...
export class InlineCompletionsModel extends Disposable {
    ...
    public readonly activeCommands = derivedOpts<Command[]>({ owner: this, equalsFn: itemsEquals() }, r => this.selectedInlineCompletion.read(r)?.inlineCompletion.source.inlineCompletions.commands ?? []);
    ...
    public readonly state = derivedOpts<{
        ...
        if (item?.inlineEditCompletion) {
            ...
            if (!shouldShow && item.inlineEditCompletion.request.context.triggerKind === InlineCompletionTriggerKind.Automatic && this._shouldHideInlineEdit.read(reader) && !cursorAtInlineEdit) {
                return undefined;
            }
