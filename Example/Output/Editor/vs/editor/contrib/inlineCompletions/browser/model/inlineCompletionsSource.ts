...
import { derivedOpts, disposableObservableValue, IObservable, IReader, ITransaction, observableValue, transaction, } from "../../../../../base/common/observable.js";
...
export class InlineCompletionsSource extends Disposable {
    ...
    constructor(private readonly _textModel: ITextModel, private readonly _versionId: IObservable<number | null>, private readonly _debounceValue: IFeatureDebounceInformation, 
        ...
        const promise = (async () => {
            ...
            if (this._loggingEnabled.get()) {
                this._log({
                    kind: "start",
                    requestId,
                    uri: this._textModel.uri.toString(),
            ...
            if (activeInlineCompletion) {
                ...
                if (activeInlineCompletion.canBeReused(this._textModel, position) &&
...
class UpdateRequest {
    constructor(public readonly position: Position, public readonly context: InlineCompletionContext, public readonly versionId: number) { }
...
class UpdateOperation implements IDisposable {
    constructor(public readonly request: UpdateRequest, public readonly cancellationTokenSource: CancellationTokenSource, public readonly promise: Promise<boolean>) { }
    dispose() {
...
export class UpToDateInlineCompletions implements IDisposable {
    ...
    constructor(private readonly inlineCompletionProviderResult: InlineCompletionProviderResult, public readonly request: UpdateRequest, private readonly _textModel: ITextModel, private readonly _versionId: IObservable<number | null>) {
        ...
        this._inlineCompletions =
            inlineCompletionProviderResult.completions.map((i, index) => new InlineCompletionWithUpdatedRange(i, ids[index], this._textModel, this._versionId, this.request));
    }
    public clone(): this {
        this._refCount++;
        return this;
...
export class InlineCompletionWithUpdatedRange {
    ...
    public get forwardStable() {
        return (this.inlineCompletion.source.inlineCompletions
    ...
    constructor(public readonly inlineCompletion: InlineCompletionItem, public readonly decorationId: string, private readonly _textModel: ITextModel, private readonly _modelVersion: IObservable<number | null>, public readonly request: UpdateRequest) { }
