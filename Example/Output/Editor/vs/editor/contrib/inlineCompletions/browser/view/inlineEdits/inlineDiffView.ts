...
import { diffAddDecoration, diffAddDecorationEmpty, diffLineAddDecorationBackground, diffLineAddDecorationBackgroundWithIndicator, diffLineDeleteDecorationBackground, diffLineDeleteDecorationBackgroundWithIndicator, diffWholeLineAddDecoration, } from "../../../../../browser/widget/diffEditor/registrations.contribution.js";
...
export class OriginalEditorInlineDiffView extends Disposable {
    ...
    constructor(private readonly _originalEditor: ICodeEditor, private readonly _state: IObservable<IOriginalEditorInlineDiffViewState | undefined>) {
        super();
                    ...
                    if (m.original.contains(i.originalRange.startLineNumber)) {
                        originalDecorations.push({
                            ...
                            options: {
                                ...
                                className: classNames("char-delete", i.originalRange.isEmpty() &&
...
function allowsTrueInlineDiffRendering(mapping: DetailedLineRangeMapping): boolean {
    ...
    return mapping.innerChanges.every((c) => rangeIsSingleLine(c.modifiedRange) &&
