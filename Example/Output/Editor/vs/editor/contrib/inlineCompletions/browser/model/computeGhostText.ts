 ...
 */
export function computeGhostText(edit: SingleTextEdit, model: ITextModel, mode: "prefix" | "subword" | "subwordSmart", cursorPosition?: Position, previewSuffixLength = 0): GhostText | undefined {
    ...
    if (suggestionTouchesIndentation) {
        ...
        const newStartPosition = startPosition.column + replacedIndentation.length <=
            endPosition.column
