...
import { autorun, IObservable, IReader, ISettableObservable, observableValue, transaction, } from "../../../../base/common/observable.js";
...
export class ColumnRange {
    constructor(public readonly startColumn: number, public readonly endColumnExclusive: number) {
...
export function subtractPositions(pos1: Position, pos2: Position): Position {
    return new Position(pos1.lineNumber - pos2.lineNumber + 1, pos1.lineNumber - pos2.lineNumber === 0
