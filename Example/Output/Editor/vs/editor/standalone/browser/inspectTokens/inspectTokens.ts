...
import { ILanguageIdCodec, IState, ITokenizationSupport, Token, TokenizationRegistry, } from "../../../common/languages.js";
...
class InspectTokensWidget extends Disposable implements IContentWidget {
    ...
    private _compute(position: Position): void {
        ...
        const metadata = (token2Index << 1) + 1 < data.tokens2.length
            ...
            : null;
        append(this._domNode, $("table.tm-metadata-table", undefined, $("tbody", undefined, $("tr", undefined, $("td.tm-metadata-key", undefined, "language"), $("td.tm-metadata-value", undefined, `${metadata ? metadata.languageId : "-?-"}`)), $("tr", undefined, $("td.tm-metadata-key", undefined, "token type" as string), $("td.tm-metadata-value", undefined, `${metadata ? this._tokenTypeToString(metadata.tokenType) : "-?-"}`)), $("tr", undefined, $("td.tm-metadata-key", undefined, "font style" as string), $("td.tm-metadata-value", undefined, `${metadata ? this._fontStyleToString(metadata.fontStyle) : "-?-"}`)), $("tr", undefined, $("td.tm-metadata-key", undefined, "foreground"), $("td.tm-metadata-value", undefined, `${metadata ? Color.Format.CSS.formatHex(metadata.foreground) : "-?-"}`)), $("tr", undefined, $("td.tm-metadata-key", undefined, "background"), $("td.tm-metadata-value", undefined, `${metadata ? Color.Format.CSS.formatHex(metadata.background) : "-?-"}`)))));
