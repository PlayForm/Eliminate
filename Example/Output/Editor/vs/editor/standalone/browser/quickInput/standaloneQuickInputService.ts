...
import { IQuickInputControllerHost, QuickInputController, } from "../../../../platform/quickinput/browser/quickInputController.js";
...
export class StandaloneQuickInputService implements IQuickInputService {
    ...
    private get activeService(): IQuickInputService {
        ...
        if (!quickInputService) {
            const newQuickInputService = (quickInputService =
                this.instantiationService.createInstance(EditorScopedQuickInputService, editor));
    ...
    pick<T extends IQuickPickItem, O extends IPickOptions<T>>(picks: Promise<QuickPickInput<T>[]> | QuickPickInput<T>[], options?: O, token: CancellationToken = CancellationToken.None): Promise<(O extends {
        canPickMany: true;
    } ? T[] : T) | undefined> {
