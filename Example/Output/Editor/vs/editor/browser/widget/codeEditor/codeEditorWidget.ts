...
export class CodeEditorWidget extends Disposable implements editorBrowser.ICodeEditor {
    ...
    private readonly _onDropIntoEditor = this._register(new InteractionEmitter<{
    ...
    private _contentWidgets: {
        [key: string]: IContentWidgetData;
    };
    private _overlayWidgets: {
        [key: string]: IOverlayWidgetData;
    };
    ...
    private _decorationTypeKeysToIds: {
        [decorationTypeKey: string]: string[];
    };
    ...
    constructor(domElement: HTMLElement, _options: Readonly<IEditorConstructionOptions>, codeEditorWidgetOptions: ICodeEditorWidgetOptions, 
    ...
    languageFeaturesService: ILanguageFeaturesService) {
        ...
        for (const action of EditorExtensionsRegistry.getEditorActions()) {
            ...
            const internalAction = new InternalEditorAction(action.id, action.label, action.alias, action.metadata, action.precondition ?? undefined, (args: unknown): Promise<void> => {
    ...
    public getScrolledVisiblePosition(rawPosition: IPosition): {
        top: number;
        left: number;
        height: number;
    } | null {
    ...
    protected _createView(viewModel: ViewModel): [
        View,
        boolean
    ] {
...
class ModelData {
    constructor(public readonly model: ITextModel, public readonly viewModel: ViewModel, public readonly view: View, public readonly hasRealView: boolean, public readonly listenersToRemove: IDisposable[], public readonly attachedView: IAttachedView) {
    }
    public dispose(): void {
...
class InteractionEmitter<T> extends Emitter<T> {
    constructor(private readonly _contributions: CodeEditorContributions, deliveryQueue: EventDeliveryQueue) {
        super({ deliveryQueue });
    }
...
class EditorContextKeysManager extends Disposable {
    ...
    constructor(editor: CodeEditorWidget, contextKeyService: IContextKeyService) {
        super();
        this._editor = editor;
...
export class EditorModeContext extends Disposable {
    ...
    constructor(private readonly _editor: CodeEditorWidget, private readonly _contextKeyService: IContextKeyService, private readonly _languageFeaturesService: ILanguageFeaturesService) {
        super();
...
class EditorDecorationsCollection implements editorCommon.IEditorDecorationsCollection {
    ...
    constructor(private readonly _editor: editorBrowser.ICodeEditor, decorations: IModelDeltaDecoration[] | undefined) {
