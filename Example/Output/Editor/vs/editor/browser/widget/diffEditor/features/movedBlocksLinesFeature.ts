...
export class MovedBlocksLinesFeature extends Disposable {
    ...
    constructor(private readonly _rootElement: HTMLElement, private readonly _diffModel: IObservable<DiffEditorViewModel | undefined>, private readonly _originalEditorLayoutInfo: IObservable<EditorLayoutInfo | null>, private readonly _modifiedEditorLayoutInfo: IObservable<EditorLayoutInfo | null>, private readonly _editors: DiffEditorEditors) {
        super();
...
class LinesLayout {
    ...
    private constructor(private readonly _trackCount: number, private readonly trackPerLineIdx: number[]) { }
...
class MovedBlockOverlayWidget extends ViewZoneOverlayWidget {
    ...
    constructor(private readonly _editor: ICodeEditor, _viewZone: PlaceholderViewZone, private readonly _move: MovedText, private readonly _kind: 'original' | 'modified', private readonly _diffModel: DiffEditorViewModel) {
