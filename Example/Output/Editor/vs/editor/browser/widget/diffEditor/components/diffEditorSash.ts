...
export class SashLayout {
    ...
    constructor(private readonly _options: DiffEditorOptions, public readonly dimensions: {
...
export class DiffEditorSash extends Disposable {
    ...
    constructor(private readonly _domNode: HTMLElement, private readonly _dimensions: {
        height: IObservable<number>;
        width: IObservable<number>;
    }, private readonly _enabled: IObservable<boolean>, private readonly _boundarySashes: IObservable<IBoundarySashes | undefined, void>, public readonly sashLeft: ISettableObservable<number>, private readonly _resetSash: () => void) {
        super();
