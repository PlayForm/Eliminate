...
class MouseDownOperation extends Disposable {
    ...
    constructor(private readonly _context: ViewContext, private readonly _viewController: ViewController, private readonly _viewHelper: IPointerHandlerHelper, private readonly _mouseTargetFactory: MouseTargetFactory, createMouseTarget: (e: EditorMouseEvent, testEventTarget: boolean) => IMouseTarget, getMouseColumn: (e: EditorMouseEvent) => number) {
        super();
    ...
    public start(targetType: MouseTargetType, e: EditorMouseEvent, pointerId: number): void {
        ...
        if (!options.get(EditorOption.readOnly)
            ...
            this._isActive = true;
            this._mouseMoveMonitor.startMonitoring(this._viewHelper.viewLinesDomNode, pointerId, e.buttons, (e) => this._onMouseDownThenMove(e), (browserEvent?: MouseEvent | KeyboardEvent) => {
...
class TopBottomDragScrolling extends Disposable {
    ...
    constructor(private readonly _context: ViewContext, private readonly _viewHelper: IPointerHandlerHelper, private readonly _mouseTargetFactory: MouseTargetFactory, private readonly _dispatchMouse: (position: IMouseTarget, inSelectionMode: boolean, revealType: NavigationCommandRevealType) => void) {
        super();
...
class TopBottomDragScrollingOperation extends Disposable {
    ...
    constructor(private readonly _context: ViewContext, private readonly _viewHelper: IPointerHandlerHelper, private readonly _mouseTargetFactory: MouseTargetFactory, private readonly _dispatchMouse: (position: IMouseTarget, inSelectionMode: boolean, revealType: NavigationCommandRevealType) => void, position: IMouseTargetOutsideEditor, mouseEvent: EditorMouseEvent) {
        super();
