...
import { EditorOption, EditorOptions, IComputedEditorOptions, RenderLineNumbersType, } from "../../../../common/config/editorOptions.js";
...
import { HorizontalPosition, LineVisibleRanges, RenderingContext, RestrictedRenderingContext, } from "../../../view/renderingContext.js";
...
class VisibleTextAreaData {
    ...
    constructor(private readonly _context: ViewContext, public readonly modelLineNumber: number, public readonly distanceToModelLineStart: number, public readonly widthOfHiddenLineTextBefore: number, public readonly distanceToModelLineEnd: number) { }
    prepareRender(visibleRangeProvider: IVisibleRangeProvider): void {
        ...
        if (this.startPosition.lineNumber === this.endPosition.lineNumber) {
            this.visibleTextareaStart =
                visibleRangeProvider.visibleRangeForPosition(this.startPosition);
...
export class TextAreaEditContext extends AbstractEditContext {
    ...
    constructor(context: ViewContext, overflowGuardContainer: FastDomNode<HTMLElement>, viewController: ViewController, visibleRangeProvider: IVisibleRangeProvider, 
    @IKeybindingService
    ...
    private readonly _instantiationService: IInstantiationService) {
            ...
            getScreenReaderContent: (): TextAreaState => {
                if (this._accessibilitySupport === AccessibilitySupport.Disabled) {
                    ...
                    if (platform.isMacintosh &&
                        !selection.isEmpty() &&
                        simpleModel.getValueLengthInRange(selection, EndOfLinePreference.TextDefined) < LIMIT_CHARS) {
                ...
                const screenReaderContentState = PagedScreenReaderStrategy.fromEditorSelection(simpleModel, this._selections[0], this._accessibilityPageSize, this._accessibilitySupport ===
        ...
        this._register(this._textAreaInput.onCompositionStart((e) => {
            ...
            const { distanceToModelLineStart, widthOfHiddenTextBefore } = (() => {
                ...
                const distanceToModelLineStart = startModelPosition.column -
                    1 -
                    visibleBeforeCharCount;
                const hiddenLineTextBefore = lineTextBeforeSelection.substring(0, lineTextBeforeSelection.length -
                    visibleBeforeCharCount);
                const { tabSize } = this._context.viewModel.model.getOptions();
            ...
            this._context.viewModel.revealRange("keyboard", true, Range.fromPositions(this._selections[0].getStartPosition()), viewEvents.VerticalRevealType.Simple, ScrollType.Immediate);
            ...
            this.textArea.setAttribute("wrap", this._textAreaWrapping && !this._visibleTextArea
                ? "on"
                : "off");
    ...
    private _getAndroidWordAtPosition(position: Position): [
        string,
        number
    ] {
    ...
    private _render(): void {
        if (this._visibleTextArea) {
            ...
            if (startPosition &&
                ...
                const presentation = this._visibleTextArea.definePresentation(textareaSpansSingleToken
    ...
    private _doRender(renderData: IRenderData): void {
        ...
        if (options.get(EditorOption.glyphMargin)) {
            ...
            if (options.get(EditorOption.lineNumbers).renderType !==
