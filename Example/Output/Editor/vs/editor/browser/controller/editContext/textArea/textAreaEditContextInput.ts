...
export class TextAreaInput extends Disposable {
    ...
    constructor(private readonly _host: ITextAreaInputHost, private readonly _textArea: ICompleteTextAreaWrapper, private readonly _OS: OperatingSystem, private readonly _browser: IBrowser, 
    ...
    private readonly _logService: ILogService) {
        ...
        this._register(Event.runAndSubscribe(this._accessibilityService.onDidChangeScreenReaderOptimized, () => {
            if (this._accessibilityService.isScreenReaderOptimized() &&
                ...
                this._asyncFocusGainWriteScreenReaderContent.value =
                    this._register(new RunOnceScheduler(() => this.writeNativeTextAreaContent("asyncFocusGain"), 0));
            }
            else {
        ...
        this._register(this._textArea.onFocus(() => {
            ...
            if (this._accessibilityService.isScreenReaderOptimized() &&
                ...
                if (!this._asyncFocusGainWriteScreenReaderContent.value) {
                    this._asyncFocusGainWriteScreenReaderContent.value =
                        new RunOnceScheduler(() => this.writeNativeTextAreaContent("asyncFocusGain"), 0);
                }
