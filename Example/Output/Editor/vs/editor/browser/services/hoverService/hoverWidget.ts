...
export class HoverWidget extends Widget implements IHoverWidget {
    ...
    private readonly _accessibilityService: IAccessibilityService) {
        ...
        if (typeof options.content === 'string') {
            ...
            const mdRenderer = this._instantiationService.createInstance(MarkdownRenderer, { codeBlockFontFamily: this._configurationService.getValue<IEditorOptions>('editor').fontFamily || EDITOR_FONT_DEFAULTS.fontFamily });
...
class CompositeMouseTracker extends Widget {
     ...
     */
    constructor(private _elements: HTMLElement[], private _eventDebounceDelay: number = 200) {
        super();
