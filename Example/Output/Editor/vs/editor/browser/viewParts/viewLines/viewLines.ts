...
class HorizontalRevealRangeRequest {
    ...
    constructor(public readonly minimalReveal: boolean, public readonly lineNumber: number, public readonly startColumn: number, public readonly endColumn: number, public readonly startScrollTop: number, public readonly stopScrollTop: number, public readonly scrollType: ScrollType) {
...
class HorizontalRevealSelectionsRequest {
    ...
    public readonly minLineNumber: number;
    public readonly maxLineNumber: number;
    constructor(public readonly minimalReveal: boolean, public readonly selections: Selection[], public readonly startScrollTop: number, public readonly stopScrollTop: number, public readonly scrollType: ScrollType) {
...
export class ViewLines extends ViewPart implements IViewLines {
        ...
        if (e.revealHorizontal) {
            if (e.range && e.range.startLineNumber !== e.range.endLineNumber) {
                ...
                this._horizontalRevealRequest =
                    new HorizontalRevealRangeRequest(e.minimalReveal, e.range.startLineNumber, e.range.startColumn, e.range.endColumn, this._context.viewLayout.getCurrentScrollTop(), newScrollPosition.scrollTop, e.scrollType);
            }
            else if (e.selections && e.selections.length > 0) {
                this._horizontalRevealRequest =
                    new HorizontalRevealSelectionsRequest(e.minimalReveal, e.selections, this._context.viewLayout.getCurrentScrollTop(), newScrollPosition.scrollTop, e.scrollType);
            }
        }
        else {
            this._horizontalRevealRequest = null;
        }
        const scrollTopDelta = Math.abs(this._context.viewLayout.getCurrentScrollTop() -
            newScrollPosition.scrollTop);
        const scrollType = scrollTopDelta <= this._lineHeight
    ...
    public getPositionFromDOMInfo(spanNode: HTMLElement, offset: number): Position | null {
        ...
        const rendStartLineNumber = this._visibleLines.getStartLineNumber();
        const rendEndLineNumber = this._visibleLines.getEndLineNumber();
        if (lineNumber < rendStartLineNumber ||
    ...
    public renderText(viewportData: ViewportData): void {
        ...
        if (this._horizontalRevealRequest) {
            ...
            if (viewportData.startLineNumber <=
    ...
    private _computeScrollTopToRevealRange(viewport: Viewport, source: string | null | undefined, minimalReveal: boolean, range: Range | null, selections: Selection[] | null, verticalType: viewEvents.VerticalRevealType): number {
        ...
        if (selections && selections.length > 0) {
            ...
            boxEndY =
                this._context.viewLayout.getVerticalOffsetForLineNumber(range.endLineNumber) + this._lineHeight;
        }
        else {
            return -1;
        }
        const shouldIgnoreScrollOff = (source === "mouse" || minimalReveal) &&
        ...
        if (!minimalReveal) {
            if (verticalType === viewEvents.VerticalRevealType.Simple ||
        ...
        else if (verticalType === viewEvents.VerticalRevealType.Center ||
            verticalType ===
    ...
    private _computeScrollLeftToReveal(horizontalRevealRequest: HorizontalRevealRequest): {
        ...
        if (horizontalRevealRequest.type === "selections" &&
