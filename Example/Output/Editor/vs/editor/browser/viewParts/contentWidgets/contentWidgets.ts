...
class Widget {
    ...
    private _layoutHorizontalSegmentInPage(windowSize: dom.Dimension, domNodePosition: dom.IDomNodePagePosition, left: number, width: number): [
        number,
        number
    ] {
...
class PositionPair {
    constructor(public readonly modelPosition: IPosition | null, public readonly viewPosition: Position | null) { }
}
class Coordinate {
...
class AnchorCoordinate {
    ...
    constructor(public readonly top: number, public readonly left: number, public readonly height: number) { }
}
