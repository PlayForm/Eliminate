...
export class SelectionsOverlay extends DynamicViewOverlay {
    ...
    private _enrichVisibleRangesWithStyle(viewport: Range, linesVisibleRanges: LineVisibleRangesWithStyle[], previousFrame: LineVisibleRangesWithStyle[] | null): void {
        ...
        for (let i = 0, len = linesVisibleRanges.length; i < len; i++) {
            ...
            if (i > 0) {
                ...
                const prevRight = linesVisibleRanges[i - 1].ranges[0].left +
            ...
            if (i + 1 < len) {
                ...
                const nextRight = linesVisibleRanges[i + 1].ranges[0].left +
                    linesVisibleRanges[i + 1].ranges[0].width;
    ...
    private _actualRenderOneSelection(output2: [
        string,
        string
    ][], visibleStartLineNumber: number, hasMultipleSelections: boolean, visibleRanges: LineVisibleRangesWithStyle[]): void {
            ...
            for (let j = 0, lenJ = lineVisibleRanges.ranges.length; j < lenJ; j++) {
                ...
                if (visibleRangesHaveStyle) {
                    ...
                    if (startStyle.top === CornerStyle.INTERN ||
                        ...
                        innerCornerOutput += this._createSelectionPiece(top, bottom, SelectionsOverlay.SELECTION_CLASS_NAME, visibleRange.left -
                            SelectionsOverlay.ROUNDED_PIECE_WIDTH, SelectionsOverlay.ROUNDED_PIECE_WIDTH);
                        ...
                        innerCornerOutput += this._createSelectionPiece(top, bottom, className, visibleRange.left -
                            SelectionsOverlay.ROUNDED_PIECE_WIDTH, SelectionsOverlay.ROUNDED_PIECE_WIDTH);
                    }
