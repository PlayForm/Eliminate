...
export async function buildUserEnvironment(startParamsEnv: {
...
class ConnectionData {
    constructor(public readonly socket: NodeSocket | WebSocketNodeSocket, public readonly initialDataChunk: VSBuffer) { }
...
function readCaseInsensitive(env: {
